...
test.describe("AnnouncementBanner component — visual", () => {
  test.describe("when a banner is configured", () => {
    ...
    test("shows the mobile message below the 768px breakpoint", async ({
      page,
    }) => {
    ...
    test("is 30px tall, fixed at the top, and offsets the header below it", async ({
      page,
    }) => {
