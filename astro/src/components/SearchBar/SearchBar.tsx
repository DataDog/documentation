...
// TODO: Avoid hardcoding the URL here
      ...
      {popupVisible &&
        ...
        createPortal(
          <div
            ...
            style={
              popupRect
                ? { top: `${popupRect.top}px`, left: `${popupRect.left}px` }
                : undefined
            }
          >
            <div
              class={[
                cl("search-bar__ai-suggestion", "placeholder"),
                aiSelected ? cl("search-bar__ai-suggestion--selected") : "",
              ]
                .filter(Boolean)
                .join(" ")}
            ...
            {totalHits === 0 ? (
              <div class={cl("search-bar__no-hits")}>
                {labels["No results."]}
              </div>
            ) : (
                      ...
                      {list.map((hit) => {
                        ...
                        return (
                          <li
                            class={[
                              cl("search-hit"),
                              isSelected ? cl("search-hit--selected") : "",
                            ]
                              .filter(Boolean)
                              .join(" ")}
                          ...
                          >
                            <a
                              ...
                              rel={
                                hit.isApi ? undefined : "noopener noreferrer"
                              }
                            >
                              <p class={cl("search-hit__subcategory")}>
                                {hit.subcategory}
                              </p>
