 ...
 * pages — into one list. Used by `pages.json` (via `buildPageIndex`), which
 * lists all pages flat and ignores sectioning. Does not dedupe; `buildPageIndex`
 * detects and rejects duplicate URLs.
 */
