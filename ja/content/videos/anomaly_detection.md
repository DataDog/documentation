...
language: en
placeholder: true
summary: Metrics change all the time, so how do you know if a change is anomalous?
  Datadog now offers 4 anomaly detection algorithms for different metrics and trends
