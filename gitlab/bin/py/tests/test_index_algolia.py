...
class TestBuildConfig(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.content_path = os.path.join(os.environ.get('CORPSITE'), 'content/blog') if \
            os.environ.get('CORPSITE', None) else os.path.join(os.getcwd(), '../../../../content/blog')
    ...
    def test_bad_content_path(self):
        ...
        self.assertEqual(m.exception.code, 'Content folder path incorrect')
