...
describe('Markdown parser', function () {
    const fence = '```';
    const tokenizer = new tokenizer_1.default({ allowComments: true });
    function convert(example, options) {
        const content = example.replace(/\n\s+/gm, '\n').trim();
        const tokens = tokenizer.tokenize(content);
        return (0, parser_1.default)(tokens, options);
    }
    describe('handling options', function () {
        it('no args', function () {
            const example = convert(`# This is a test`);
            expect(example.children[0]).toDeepEqual(Object.assign(Object.assign({}, (0, deep_assert_1.any)()), { type: 'heading', location: Object.assign(Object.assign({}, (0, deep_assert_1.any)()), { file: undefined }) }));
        });
        it('filename as string', function () {
            const example = convert(`# This is a test`, 'foo.md');
            expect(example.children[0]).toDeepEqual(Object.assign(Object.assign({}, (0, deep_assert_1.any)()), { type: 'heading', location: Object.assign(Object.assign({}, (0, deep_assert_1.any)()), { file: 'foo.md' }) }));
        });
    ...
    describe('handling frontmatter', function () {
      ...
      ---
      `);
            expect(example).toDeepEqual(Object.assign(Object.assign({}, (0, deep_assert_1.any)()), { type: 'document', attributes: {
                    frontmatter: 'foo: bar',
                }, children: [] }));
        });
      ...
      `);
            expect(example).toDeepEqual(Object.assign(Object.assign({}, (0, deep_assert_1.any)()), { type: 'document', attributes: {
                    frontmatter: 'foo: bar\ntest: true',
                }, children: [Object.assign({ type: 'heading', attributes: { level: 1 } }, (0, deep_assert_1.any)())] }));
        });
    });
    ...
    describe('handling annotations', function () {
        describe('in a header', function () {
            ...
            it('with complex values', function () {
                const example = convert(`# Sample Heading {% #asdf .foo-bar .test foo="bar" %}`);
                expect(example).toDeepEqualSubset({
                    type: 'document',
                    children: [
                        {
                        ...
                        children: [
                            {
                                ...
                                children: [
                                    {
                                        type: 'text',
                                        attributes: { content: new variable_1.default(['test'], null) },
                                    },
                                ],
                            },
                        ],
                                ...
                                children: [
                                    {
                                        type: 'text',
                                        attributes: {
                                            content: new variable_1.default(['bar', 'baz', 1, 'test'], null),
                                        },
                                    },
                                ],
                            },
...
{% /tag1 %}
    ...
    `);
        ...
        expect((_a = example.children[0].errors[0]) === null || _a === void 0 ? void 0 : _a.id).toEqual('no-inline-annotations');
    });
