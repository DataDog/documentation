...
exports.format = exports.truthy = exports.validator = exports.transformer = exports.parseTags = exports.Tokenizer = exports.Ast = exports.renderers = exports.transforms = exports.globalAttributes = exports.functions = exports.tags = exports.nodes = void 0;
exports.parse = parse;
...
Object.defineProperty(exports, "truthy", { enumerable: true, get: function () { return conditional_1.truthy; } });
...
Object.defineProperty(exports, "globalAttributes", { enumerable: true, get: function () { return transformer_1.globalAttributes; } });
const transforms_1 = __importDefault(require("./src/transforms"));
exports.transforms = transforms_1.default;
const utils_1 = require("./src/utils");
Object.defineProperty(exports, "parseTags", { enumerable: true, get: function () { return utils_1.parseTags; } });
const validator_1 = __importStar(require("./src/validator"));
exports.validator = validator_1.default;
__exportStar(require("./src/types"), exports);
const tokenizer = new tokenizer_1.default();
function mergeConfig(config = {}) {
    return Object.assign(Object.assign({}, config), { tags: Object.assign(Object.assign({}, tags_1.default), config.tags), nodes: Object.assign(Object.assign({}, nodes), config.nodes), functions: Object.assign(Object.assign({}, functions_1.default), config.functions) });
}
...
Barkdoc.nodes = nodes;
Barkdoc.tags = tags_1.default;
Barkdoc.functions = functions_1.default;
Barkdoc.globalAttributes = transformer_1.globalAttributes;
Barkdoc.renderers = renderers_1.default;
Barkdoc.transforms = transforms_1.default;
Barkdoc.Ast = ast_1.default;
Barkdoc.Tokenizer = tokenizer_1.default;
Barkdoc.parseTags = utils_1.parseTags;
Barkdoc.transformer = transformer_1.default;
Barkdoc.validator = validator_1.default;
Barkdoc.parse = parse;
Barkdoc.transform = transform;
Barkdoc.validate = validate;
Barkdoc.createElement = createElement;
Barkdoc.truthy = conditional_1.truthy;
Barkdoc.format = formatter_1.default;
exports.default = Barkdoc;
