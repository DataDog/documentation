...
- **This is a PUBLIC repository. NEVER include internal or sensitive information in commit messages, PR titles, PR descriptions, or code comments.** This includes: customer names, incident details (Sev 1s, outages, etc.), internal URLs, internal Slack conversations, Jira ticket details beyond the ticket key, or any context that isn't appropriate for public visibility. PR descriptions should describe *what changed in the docs*, not *why internally* (e.g., not "a customer hit a Sev 1 because..."). Keep descriptions concise and focused on the documentation change itself.
