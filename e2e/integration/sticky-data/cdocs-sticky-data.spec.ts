...
test.describe('Cdocs sticky data', () => {
    ...
    test('selection persists when the option is available on the target page', async ({ page }) => {
    ...
    test('default selection is applied when visiting the page directly', async ({ page }) => {
    ...
    test('default selection is applied when the previous selection is unavailable', async ({ page }) => {
    ...
    test('round-trip: unavailable selection falls back to default on both pages', async ({ page }) => {
