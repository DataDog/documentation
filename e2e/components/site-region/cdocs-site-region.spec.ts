...
test.describe('Cdocs site region component', () => {
    ...
    test('page renders as expected', async ({ page }) => {
        await expect(page.locator(CONTENT_AREA)).toHaveScreenshot('site-region-initial.png');
    });
    ...
    test('selecting a different site updates visible content', async ({ page }) => {
        ...
        await expect(page.locator(CONTENT_AREA)).toHaveScreenshot('site-region-eu-selected.png');
