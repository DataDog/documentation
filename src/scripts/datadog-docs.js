        ...
        client.search([{
            ...
            if (!err) {
                ...
                if (hits.length)
                {
                    ...
                    let btn_more;
                    let btn_less;
                    const listing_table = document.getElementsByClassName('content')[0];
                    const page_navigation = document.getElementsByClassName('page_navigation')[0];
                    ...
                    function initPageNums() {
                        const count = Math.min(numPages(), num_page_links_to_display);
                        page_nums = [];
                    ...
                    function less(e) {
                        ...
                        page_nums = [];
                        for(let i = (first-num_page_links_to_display); i < first; i++) {
                            page_nums.push(i);
                        }
                    ...
                    function more(e) {
                        ...
                        const count = Math.min(remaining_pages, num_page_links_to_display);
                        page_nums = [];
                        for(let i = last+1; i < last+(count+1); i++) {
                            page_nums.push(i);
                        }
                    ...
                    function btnHandlerPage(e) {
                        e.preventDefault();
                        let page = parseInt(e.target.getAttribute('data-pagenum'));
                        if (page > numPages()) {
                            page = numPages();
                        } else if(page <= 0) {
                            page = 1;
