...
describe(`filterExampleJson`, () => {
  ...
  it('should show full example when not matching key for object', () => {
    // Dashboard sharing
    const mockSchema = {
      "description": "Invitations data and metadata that exists for a public dashboard returned by the API.",
      "properties": {
        "data": {
          "description": "An object or list of objects containing the information for an invitation to a public dashboard.",
          "example": [
            {
              "attributes": {
