...
function handleAttrs(token, type) {
    switch (type) {
        ...
        case 'list': {
            ...
            return ordered && (attrs === null || attrs === void 0 ? void 0 : attrs.start)
        ...
        case 'fence': {
            ...
            return language === '' || language === utils_1.OPEN
...
function handleToken(token, nodes, file, handleSlots, addLocation, inlineParent) {
    ...
    const node = new node_1.default(typeName, attrs, undefined, tag || undefined);
...
function parser(tokens, args) {
    const doc = new node_1.default('document');
    const nodes = [doc];
    if (typeof args === 'string')
        args = { file: args };
    for (const token of tokens)
        handleToken(token, nodes, args === null || args === void 0 ? void 0 : args.file, args === null || args === void 0 ? void 0 : args.slots, args === null || args === void 0 ? void 0 : args.location);
    if (nodes.length > 1)
    ...
    for (const transform of index_1.default)
        transform(doc);
    return doc;
}
