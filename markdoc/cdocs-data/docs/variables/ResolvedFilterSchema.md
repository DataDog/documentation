...
[cdocs-data](../globals.md) / ResolvedFilterSchema

# Variable: ResolvedFilterSchema

> `const` **ResolvedFilterSchema**: `ZodObject`\<[`ResolvedFilter`](../type-aliases/ResolvedFilter.md)\>

Defined in: [src/schemas/pageFilters.ts:34](https://github.com/DataDog/documentation/blob/cd224ee345504c4db4f79b0b6511b02248729870/markdoc/cdocs-data/src/schemas/pageFilters.ts#L34)
