...
(() => {
  ...
  // dist/helperModules/ClientPrefsManager.js
  var require_ClientPrefsManager = __commonJS({
    "dist/helperModules/ClientPrefsManager.js"(exports) {
      "use strict";
      ...
      var _a;
      var _ClientPrefsManager_instance;
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.ClientPrefsManager = void 0;
      ...
      var ClientPrefsManager = class {
         ...
         */
        static get instance() {
          if (!__classPrivateFieldGet(_a, _a, "f", _ClientPrefsManager_instance)) {
            __classPrivateFieldSet(_a, _a, new _a(), "f", _ClientPrefsManager_instance);
            __classPrivateFieldGet(_a, _a, "f", _ClientPrefsManager_instance).retrieveStoredPreferences();
      ...
      exports.ClientPrefsManager = ClientPrefsManager;
      _a = ClientPrefsManager;
      _ClientPrefsManager_instance = { value: void 0 };
    }
  });

  // dist/markdoc-client-prefs-manager.js
  var require_markdoc_client_prefs_manager = __commonJS({
    "dist/markdoc-client-prefs-manager.js"(exports) {
      Object.defineProperty(exports, "__esModule", { value: true });
      var ClientPrefsManager_1 = require_ClientPrefsManager();
      window.clientPrefsManager = ClientPrefsManager_1.ClientPrefsManager.instance;
    }
  });
  require_markdoc_client_prefs_manager();
})();
