...
(() => {
  ...
  var require_Chooser = __commonJS({
    "dist/helperModules/PageBuilder/components/Chooser.js"(exports) {
      ...
      var Chooser = (resolvedPagePrefs) => {
        return (0, jsx_runtime_1.jsxs)("div", { children: [Object.keys(resolvedPagePrefs).map((prefId) => {
      ...
      var rerenderChooser = (p) => {
        const node = (0, incremental_dom_1.patch)(p.elementToPatch, () => renderChooserIncrementally(p.resolvedPagePrefs));
        return node;
      };
      exports.rerenderChooser = rerenderChooser;
      var renderChooserIncrementally = (resolvedPagePrefs) => {
      ...
      var ClientRenderer2 = class {
        ...
        rerenderPageContent() {
          ...
          Object.keys(this.ifFunctionsByRef).forEach((ref) => {
            ...
            const resolvedFunction = (0, markdoc_static_compiler_1.reresolveFunctionNode)(clientFunction, {
