...
{{< img src="faq/image1.png" alt="image1" responsive="true" >}}
...
{{< img src="faq/image6.png" alt="image6" responsive="true" >}}

The changes should be immediate. To confirm that the event log is accesible through the Win32_NTLogEvent WMI class, try the above query again. Then you can resume [adding events to the Event Viewer integration](https://help.datadoghq.com/hc/en-us/articles/204609289-How-to-monitor-events-from-the-Windows-Event-Logs) config file
...
{{< img src="faq/image8.png" alt="image8" responsive="true" >}}
