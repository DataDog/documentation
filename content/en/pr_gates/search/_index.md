...
{{< img src="pr_gates/rules_list_3.png" alt="PR Gate rules in Datadog displaying the rule name, evaluation, scope, blocking status, last modified date, and the creator avatar" style="width:100%" >}}
