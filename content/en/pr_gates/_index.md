...
| [**New Flaky Tests**][10] | - New flaky tests |
...
{{% tab "New Flaky Tests" %}}
You can create rules to block code changes from being merged when a pull request introduces tests that exhibit flaky behavior for the first time.

{{< img src="pr_gates/setup/new_flaky_tests.png" alt="A PR Gate rule that fails when new flaky tests are introduced" style="width:80%" >}}
