...
The infrastructure view provides a broad overview, grouping resources by Account, Region and VPC. This view is ideal for quickly generating architecture diagrams for troubleshooting or high-level review.
...
**Note**: The account name comes from your AWS account tags in the AWS integration.



### Explore resources

On any of the Cloudcraft presets, you can use the zoom and hover features to quickly identify the most important resources. As you zoom in, the names of additional resources become visible. Hovering over a resource opens a hover panel with basic information.  Clicking on a resource opens a side panel displaying its Datadog observability, cost information and security data where relevant, with crosslinks to other Datadog products.
