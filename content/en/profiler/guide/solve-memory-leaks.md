...
To help you get started, Datadog provides an end-to-end, guided workflow for Go services:
...
Following this workflow requires zero prior knowledge, and it is accessible for first-time investigations.

The workflow guides you through several steps to:
...
To investigate a memory leak using the guided workflow:
