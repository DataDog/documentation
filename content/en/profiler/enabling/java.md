...
The reason fora not enabling it by default for JDK 8 and 11 is that an allocation intensive
application can create a very large number of the related JFR events.
