...
Optionally, you can use a library (such as [ianlancetaylor/cgosymbolizer][10]) to add detailed C function call information to CPU profiles. To use the library:
