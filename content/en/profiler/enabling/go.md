...
4. After a minute or two, visualize your profiles in the [Datadog APM > Profiler page][7].

**Note**: By default only the CPU and Heap profile are enabled. Use [profiler.WithProfileTypes][8] to enable additional [profile types][9].
...
| ---------------- | ------------- | ------------------------------------------------------------------------------------------------------------ |
|  WithService     | String        | The Datadog [service][10] name, for example `my-web-app`.             |
|  WithEnv         | String        | The Datadog [environment][11] name, for example, `production`.         |
...
To add detailed C function call information to CPU profiles, you may opt to use library such as [ianlancetaylor/cgosymbolizer][12]. To use this library:
...
[8]: https://pkg.go.dev/gopkg.in/DataDog/dd-trace-go.v1/profiler#WithProfileTypes
[9]: https://pkg.go.dev/gopkg.in/DataDog/dd-trace-go.v1/profiler#ProfileType
[10]: /getting_started/tagging/unified_service_tagging
[11]: /getting_started/profiler/
[12]: https://pkg.go.dev/github.com/ianlancetaylor/cgosymbolizer#pkg-overview
