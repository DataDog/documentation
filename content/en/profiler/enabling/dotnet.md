...
<div class="alert alert-warning">
  <strong>Note:</strong> For containers, <strong>at least more than one core</strong> is required. Read the <a href="/profiler/profiler_troubleshooting/dotnet#linux-containers">Troubleshooting documentation</a> for more details.
</div>
