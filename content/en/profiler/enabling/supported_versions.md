...
| {{< ci-details title="Allocation" >}}Number and sizes of memory allocations made by each function/method, including allocations which were subsequently freed.{{< /ci-details >}}   |                [JDK&nbsp;11+][17]                 | Python 3.6+<br>tracer&nbsp;0.50+ | tracer&nbsp;1.47+ | tracer 2.3.0+ |       | .NET 6+<br>tracer&nbsp;2.18+ | tracer&nbsp;0.88+ | Preview<br>ddprof&nbsp;0.9.3 |
| {{< ci-details title="Heap" >}}The amount of heap memory allocated that remains in use.{{< /ci-details >}}   | [JDK&nbsp;11+][17]<br>tracer&nbsp;1.39.0+ | Python 3.6+<br> tracer&nbsp;0.50+ | tracer&nbsp;1.23+ | alpha<br>Ruby 2.7+<br>tracer&nbsp;2.3.0+ | tracer&nbsp;0.23+ | .NET 7+<br>tracer&nbsp;2.22+ |       | Preview<br>ddprof&nbsp;0.15+ |
