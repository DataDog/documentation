...
The widgets are the building blocks of your Dashboards. There are essentialy three different categories: 

* **Generic** widgets, meant to graph data from Datadog Products. 
* **Summary** widgets, meant to display synthetised monitoring information. 
* **Decoration** widgets, meant to visually structure and annotate Dashboards, for better readability.

{{< whatsnext desc="Generic Widgets:">}}
...
{{< whatsnext desc="Summary Widgets">}}
...
{{< whatsnext desc="Decoration Widgets">}}
...
Refer to our [guide][6] to customize interactions with data inline generic widgets. 
...
[6]: /dashboards/guide/custom_links/
