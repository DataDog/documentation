...
<div class="alert alert-info">Split graph widgets are not supported on screenboards and <a href="/dashboards/sharing/shared_dashboards">shared dashboards.</a></div>
...
You can also create a split graph by taking an existing widget and splitting it on a tag value using the {{< ui >}}Split Graph{{< /ui >}} tab. To open the {{< ui >}}Split Graph{{< /ui >}} tab:
- Add a new widget to your dashboard and click the {{< ui >}}Split Graph{{< /ui >}} tab at the top of the query editor.
- Open a widget in full screen mode by selecting either the edit or expand icons from the widget control options, then click on the {{< ui >}}Split Graph{{< /ui >}} tab.
- Open the context menu of a widget on your dashboard and select {{< ui >}}Split Graph{{< /ui >}}.

From the {{< ui >}}Split Graph{{< /ui >}} tab, you can configure how your graph is split, set the limit on the number of graphs, and configure the order.
...
2. Click {{< ui >}}Save to Dashboard{{< /ui >}} to create a new split graph widget at the bottom of your dashboard. Your original widget remains unchanged on your dashboard. 
...
1. Click {{< ui >}}Export to Dashboard{{< /ui >}}.
...
The split graph editor is composed of two separate sections: [{{< ui >}}Edit Graph{{< /ui >}}](#edit-graph) and [{{< ui >}}Split Graph{{< /ui >}}](#edit-split). To add a widget title, update the text input at the top of the editor.

**Note**: If you create a split graph from a widget, you only have the option to configure the split in the {{< ui >}}Split Graph{{< /ui >}} tab. You can always click on the {{< ui >}}Edit{{< /ui >}} tab to edit the query.
