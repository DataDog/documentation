...
Admins can choose how widget share links and previews work in [**Organization Settings > Public Sharing > Settings**][2]:
...
**Note**: Widget Share URLs is separate from the [Snapshots API][1], which programmatically captures metric graph snapshots.
...
[1]: /api/latest/snapshots/
[2]: https://app.datadoghq.com/organization-settings/public-sharing/settings
