...
To add a tab, click on the dropdown on the **Add Widgets** button at the top of the dashboard and click **Add New Tab**. New tabs are named automatically (for example, "Tab 1", "Tab 2") and a dashboard supports up to 100 tabs. Subsequent tabs can be added via the **+** button on the tabs bar. 
