...
Please note that if your query aggregates by a tag (for instance, using 'sum by' or 'avg by'), you will only be able to select a palette override. This prevents different series from using the same color, preserving readability.
