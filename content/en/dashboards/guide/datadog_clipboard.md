...
{{< img src="incident_response/incident_management/clipboard-full.png" alt="The main clipboard">}}
...
{{< img src="incident_response/incident_management/open-clipboard.png" alt="Open a graph in the Clipboard" style="width:80%;">}}
...
{{< img src="incident_response/incident_management/add-page.png" alt="Add a dashboard to the Clipboard" style="width:80%;">}}
...
{{< img src="incident_response/incident_management/managing-clips.png" alt="Manage your clips" style="width:80%;">}}
...
{{< img src="incident_response/incident_management/exporting.png" alt="Export from the Clipboard" style="width:80%;">}}
