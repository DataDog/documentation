...
{{< img src="dashboards/guide/wildcard_examples/multi_layer_histogram.png" alt="Multi-layer histogram comparing error durations against overall trace durations" style="width:100%;" >}}
...
This example demonstrates how to visualize GitHub repository activity over time, with each cell representing the number of PRs closed per day.

{{< img src="dashboards/guide/wildcard_examples/categorical_heatmap.png" alt="Categorical heatmap showing GitHub repository activity with time-based filtering and interactive tooltips" style="width:100%;" >}}

The following image shows a variation of the heatmap that displays hourly patterns instead of daily, allowing you to identify time-of-day trends in repository activity.

{{< img src="dashboards/guide/wildcard_examples/categorical_heatmap_hourly.png" alt="Hourly variation of the categorical heatmap showing time-of-day patterns in repository activity" style="width:100%;" >}}
...
<!-- {{< img src="dashboards/widgets/wildcard/lollipop_chart.png" alt="Lollipop chart showing ranked CPU usage by team with horizontal lines and endpoint circles for clear visual comparison" style="width:100%;" >}} -->
