...
| `template_variables` | array of object  | List of template variables for this dashboard. See the [template variable schema](#template-variable-schema) documentation for details. |
| `notify_list`        | array of strings | List of handles of users to notify when changes are made to this dashboard.                                                               |
| `widgets`            | array of object  | List of widgets to display on the dashboard. See the dedicated [Widget JSON schema][3] documentation to build the `WIDGET_SCHEMA`.        |
