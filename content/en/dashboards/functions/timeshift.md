...
{{< img src="dashboards/functions/timeshift/calendar_shift_example.png" alt="Example of a calendar_shift() function used to compare the `aws.cost.net.amortized ` metric value from a month ago and the present" style="width:80%;" >}}
