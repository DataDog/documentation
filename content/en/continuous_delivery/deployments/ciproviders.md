...
3. You are executing deployments in a CI job (or a [related level][9] in your CI provider). The concept of a CI pipeline may vary depending on your provider. For more information about how Datadog defines a CI pipeline, see the [Terminology section][9].
