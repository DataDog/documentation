...
If your repository contains a single service and you want all directories to be considered for code changes, you may skip this test. If you deploy 2 or more services from a repository, specifying source code path patterns is required.
