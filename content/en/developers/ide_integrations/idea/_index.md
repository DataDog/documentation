...
Code Insights include a detailed description of the issue, and include links to:
- the related source code location
- the Datadog platform for additional information.

Developer's can dismiss individual insights and set filters to view the categories of insights that they are most interested to see.
