...
## Code Insights
The **Code Insights** tab displays insights, generated by the Datadog platform and relevant to your current project, grouped into three categories:
- performance
- reliability
- security
...
Code Insights include a detailed description including links to:
- the related source code location
- the Datadog platform for additional information.

Developer's can dismiss individual insights and filter out categories of insights that they do not wish to see in their IDE.
