...
## Code Insights
The **Code Insights** window displays insights generated by the Datadog platform that are relevant to your current project. The insights are grouped into three categories: performance, reliability, and security.

{{< img src="/developers/ide_integrations/visual_studio/code-insights.png" alt="The Top-list view" style="width:50%;" >}}
