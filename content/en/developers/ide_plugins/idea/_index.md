...
Other features include links to the [CI Visibility Explorer][9] to show recent runs for any test, and flaky tests detected by [Test Optimization][18].
