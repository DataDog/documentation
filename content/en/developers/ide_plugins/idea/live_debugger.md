...
Activate, deactivate or delete the session, using the controls next to the selector. You can also open the session at Datadog in your default web browser.
