...
<div class="alert alert-danger"><strong>Note</strong>: The Agent install script automatically creates the socket file with the correct permissions, and <code>use_dogstatsd: true</code> & <code>dogstatsd_socket: "/var/run/datadog/dsd.socket"</code> are set by default. </div>
