...
| `metric_type`   | Mandatory          | The metric’s type, which determines how Datadog processes and stores the data. For a complete list of supported types, see [Datadog in-app metric types][6].                                                                                                                                                                                                                                                                                                                |
