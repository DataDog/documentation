...
If your secret was leaked and needs to be rotated, contact [ecosystems@datadog.com][11]. Only one secret can be active at a time. Once you regenerate your secret, the existing secret will be deleted. Customers do not need to re-authorize the integration.
