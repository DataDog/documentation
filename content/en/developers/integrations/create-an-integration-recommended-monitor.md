...
| ---  | ----------- | ----------- |
|Title | Allows users to quickly understand the underlying failure mode the alert is covering. Template variables should not be included.| - New flaky tests<br> - High CPU usage on hosts<br> - New Error Tracking issues</br> - Too many opened connections on databases|
