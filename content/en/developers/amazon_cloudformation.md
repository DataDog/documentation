...
|-------------------------|-------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Datadog-AWS integration | `Datadog::Integrations::AWS`  | [Manage your Datadog-Amazon Web Service integration][4] |
| Monitors                | `Datadog::Monitors::Monitor`  | [Create, update, and delete Datadog monitors][5].       |
| ​Downtimes                | `Datadog::Monitors::Downtime` | [Enable or Disable downtimes for your monitors][6].    |
| User                    | `Datadog::IAM::User`          | [ Create and manage Datadog users][7].                         |
...
1. Build [datadog-api-client-java][8]:
...
[2]: https://docs.aws.amazon.com/cli/latest/reference/cloudformation
[3]: https://console.aws.amazon.com/cloudformation/home
[4]: https://github.com/DataDog/datadog-cloudformation-resources/tree/master/datadog-integrations-aws-handler
[5]: https://github.com/DataDog/datadog-cloudformation-resources/tree/master/datadog-monitors-monitor-handler
[6]: https://github.com/DataDog/datadog-cloudformation-resources/tree/master/datadog-monitors-downtime-handler
[7]: https://github.com/DataDog/datadog-cloudformation-resources/tree/master/ddatadog-iam-user-handler
[8]: https://github.com/DataDog/datadog-api-client-java
