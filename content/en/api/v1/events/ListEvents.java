...
public class EventsApiExample {
    ...
    public static void main(String[] args) {
        ...
        EventPriority priority = ; // EventPriority | Priority of your events, either `low` or `normal`.
        ...
        Boolean unaggregated = true; // Boolean | Set unaggregated to `true` to return all events within the specified [`start`,`end`] timeframe.
