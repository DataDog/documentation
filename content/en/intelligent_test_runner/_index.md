...
- If GitHub is your source code management provider, you can label your pull requests with the `ITR:NoSkip` label (case insensitive). This label will prevent tests from being skipped in pull requests. To use this feature, you must configure the GitHub App using the [GitHub integration tile][9] with the `Software Delivery: Collect Pull Request Information` feature enabled.
