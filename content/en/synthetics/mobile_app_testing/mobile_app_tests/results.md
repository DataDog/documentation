...
In the Results Explorer, filter and search for crash reports with the following query to identify, view, and download crash reports for your iOS devices:
...
In the Results Explorer, filter and search for crash reports with the following query to identify, view, and download crash reports for your Andriod devices.
