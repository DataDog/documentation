...
This occurs when a user attempts to mount a single file in a Windows-based container, which is [currently not supported][14]. Make sure that the source of the bind mount is a local directory instead.
