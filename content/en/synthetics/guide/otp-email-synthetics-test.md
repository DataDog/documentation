...
{{< img src="synthetics/guide/otp-from-email-body/email_variable.png" alt="Add the email variable" style="width:80%;" >}}
...
{{< img src="synthetics/guide/otp-from-email-body/email_address_variable.png" alt="Inject the email variable" style="width:80%;" >}}
...
{{< img src="synthetics/guide/otp-from-email-body/otp_from_email.png" alt="OTP variable as used in the email body step" style="width:80%;" >}}
...
{{< img src="synthetics/guide/otp-from-email-body/js_assertion.png" alt="Javascript assertion" style="width:80%;" >}}
...
{{< img src="synthetics/guide/otp-from-email-body/bubble_otp.png" alt="example of an otp with individual numerical fields" style="width:50%;" >}}
