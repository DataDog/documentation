...
Once the OTP is inserted and verified, you can continue to add steps to your browser test to verify that the user has completed the sign-up flow of your application such as adding an [assertion][6] that specific text is present on the page.
