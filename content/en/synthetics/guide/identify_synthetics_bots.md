...
For browser tests, the value of the `user-agent` header varies depending on the browser and device executing the test. The `user-agent` header value however always ends with `Datadog/Synthetics` to allow you to easily identify our tests.
