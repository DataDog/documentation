...
**Note:** Apart in case of addition of new managed locations IPs, the listed IPs rarely change. That being said, if you want to be alerted in case of modification, you can create an API test on the above endpoint with a JSONPath assertion like `$.synthetics['prefixes_ipv4_by_location']['aws:ap-northeast-1'].length`.
