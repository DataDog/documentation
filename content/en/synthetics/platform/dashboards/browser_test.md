...
- {{< ui >}}Synthetic browser test analysis{{< /ui >}}: See a breakdown of success rate by browser type, a list of browser test alerts, and average test duration by browser type and location.
...
- {{< ui >}}Synthetic test web performance{{< /ui >}}: If you have Datadog RUM enabled, use the [RUM integration][2] to examine core web vitals and a list of third-party provider test resources.  
...
- {{< ui >}}Events{{< /ui >}}: Explore outstanding events from your Synthetic test alerts.
