...
{{< img src="synthetics/apm/synthetics_apm.png" alt="A failed API test with the side panel open on the Trace tab, showing the APM trace generated by the test run with color-coded spans across services" style="width:100%;" >}}
