...
Restricting a variable prevents other users from adding it to a test and using it, but they are still able to see the variable name if it was added to a test by an authorized user. 
