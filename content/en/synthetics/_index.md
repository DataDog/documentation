...
* Metrics starting with `synthetics.browser.*` come from your [browser tests][4].
* Metrics starting with `synthetics.http.*` come from your [API HTTP tests][5].
* Metrics starting with `synthetics.ssl.*` come from your [API SSL tests][6].
...
[5]: /synthetics/api_tests/?tab=httptest
