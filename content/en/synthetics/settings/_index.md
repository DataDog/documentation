...
Access restriction is available for customers with [custom roles](https://docs.datadoghq.com/account_management/rbac/?tab=datadogapplication#create-a-custom-role) enabled on their account.</div>
