...
{{< img src="synthetics/test_suites/test_suite_slo_panel.png" alt="Test Suite details page showing the SLO panel with a 7-day rolling window and error budget, the Primary Contributors section with top contributing tests, the Global Uptime timeline, and the Test Runs section." style="width:100%;">}}
