...
You can also **vertically scale** your private locations using the [`concurrency` parameter][11] value to adjust the number of available slots on your private locations (ie. number of tests your private location workers can run in parallel).
