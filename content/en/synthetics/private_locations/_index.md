...
| 443  | `intake-v2.synthetics.datadoghq.com` for versions <=1.4.0                                            | Used by the private location to push browser test artifacts such as screenshots, errors, and resources.                                                                         |
