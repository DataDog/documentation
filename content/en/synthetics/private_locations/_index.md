...
You can configure your private location by customizing the generated configuration file. Initial configuration parameters like [proxy] (#proxy-configuration) and [reserved IPs](#blocking-reserved-ips) to block can be added directly in **Step 2** and are automatically reflected in the **Step 3** configuration file. Depending on your internal network set up, you may also want to configure your private location with [advanced options](#advanced-configuration).
