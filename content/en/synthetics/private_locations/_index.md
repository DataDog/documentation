...
You can also **vertically scale** your private locations using the [`concurrency` parameter][11] to adjust the number of available slots on your private locations, for example: the number of tests your private location workers can run in parallel.
