...
The [Datadog Agent][7] enables in-depth visibility of your private locations by providing health metrics for the underlying containers (such as memory usage, limits, CPU, and disk). You can create a graph using these metrics and set an alert for low resources.
