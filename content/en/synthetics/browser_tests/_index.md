...
4. In addition to the automatically recorded steps, you can also use the [steps][13] available in the upper left corner to enrich your scenario:
...
[4]: /api/latest/synthetics/#get-all-locations-public-and-private
[5]: /help/
