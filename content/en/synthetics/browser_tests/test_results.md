...
To help during the investigation, click **Compare Screenshots** to receive a side-by-side screenshots of the failed result and the last successful execution. The comparison should help you to spot any difference that could have caused the test to fail.
