...
A test is considered `FAILED` if it does not satisfy its assertions or if a step failed for another reason. You can start troubleshooting your failed runs by looking at their screenshots, checking for potential [errors](#errors) at the step level and looking into [backend traces](#traces) generated by their steps.
