...
To identify the root cause of a failing Synthetic test, launch a [Bits Investigation][29]. Bits Investigation analyzes Synthetic test results and history alongside traces, logs, and metrics, then surfaces a likely root cause and identifies whether the failure reflects a real regression or a misconfiguration.
...
[29]: /bits_ai/bits_ai_sre/investigate_issues/#from-the-synthetic-test-details-page
