...
To help during the investigation, you can compare your failed result to the latest successful one by clicking on `Compare Screenshots`. It will showcase the two test execution side-by-side helping to spot any difference that could have caused the test to fail.
