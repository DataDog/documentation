...
To identify the root cause of a failing Synthetic test, launch a [Bits AI SRE investigation][26]. Bits AI SRE analyzes Synthetic test results and history alongside traces, logs, and metrics, then surfaces a likely root cause and identifies whether the failure reflects a real regression or a misconfiguration.
...
[26]: /bits_ai/bits_ai_sre/investigate_issues/#from-the-synthetic-test-details-page