...
You may create a test using one of the following options:
  ...
  - **Build a test from scratch**:
    ...
    1. Add `env` **Tags** as well as any other tag to your UDP test. You can then use these tags to filter through your Synthetic tests on the [Synthetic Monitoring & Continuous Testing page][3].
