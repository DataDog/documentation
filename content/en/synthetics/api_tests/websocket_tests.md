...
Assertions define what an expected test result is. When you click **Test URL**, a basic assertions on `response time` is added. You must define at least one assertion for your test to monitor.
