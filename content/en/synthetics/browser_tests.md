...
| `Check main page URL's content`                         | This takes the URL of the current page, and asserts whether a specific value (`string`, `number`, `regex`) is present within it. This assertion is made on the page the previous step was about. If you want to assert on a new tab, you first need to create a step to interact with that new page.|
