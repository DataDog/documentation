...
: The request couldn't be completed in a reasonable time. Two types of `TIMEOUT` can happen:
  ...
  - `TIMEOUT: Overall test execution couldn't be completed in a reasonable time.` indicates that the request and assertions duration hit the maximum duration (10min).
