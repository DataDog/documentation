...
Tools for [Data Observability][65], including searching data entities in the catalog, navigating data lineage, monitoring data quality, analyzing Spark and Databricks jobs, and managing entity metadata.
