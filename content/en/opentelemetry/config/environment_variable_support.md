...
: **Description**: Enables the Datadog SDK's OpenTelemetry interoperability for all signals. <br>
**Default**: `true`<br>
**Notes**: Setting this to `false` is equivalent to setting `OTEL_SDK_DISABLED=true`.
