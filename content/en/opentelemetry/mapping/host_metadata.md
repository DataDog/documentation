...
To use this feature, set the Boolean `datadog.host.use_as_metadata` resource attribute to `true` in all OTLP payloads that contain information about hosts. This will not work if `true` is passed as a string value.
