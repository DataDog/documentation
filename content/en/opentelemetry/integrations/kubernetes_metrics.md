...
{{< img src="/opentelemetry/integrations/kubernetes_metrics_dashboard.png" alt="The 'Kubernetes - Overview' dashboard, showing cluster metrics for nodes, pods, and deployments." style="width:100%;" >}}

This integration relies on two key components:

- **kube-state-metrics**: A required service that generates detailed metrics about the state of Kubernetes objects like deployments, nodes, and pods.
- **Two-Collector Architecture**: To effectively monitor your cluster, this setup uses two separate OpenTelemetry Collectors:
...
To edit a metric's metadata, navigate to **Metrics > Summary** in Datadog, search for the metric name, and click the pencil icon to edit.
    ...
    - name: my-container
      env:
        ...
        - name: OTEL_RESOURCE_ATTRIBUTES
          value: "service.name=$(OTEL_SERVICE_NAME),service.version=$(OTEL_VERSION),deployment.environment.name=$(OTEL_ENVIRONMENT)"
```
