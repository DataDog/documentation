...
As of OpenTelemetry Collector Contrib [modules v0.129.0][4] and newer, the Datadog Extension is included in [contrib distributions][5] and available for [custom builds][6] of OpenTelemetry Collector.
