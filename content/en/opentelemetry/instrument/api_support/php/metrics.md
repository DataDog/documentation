...
- **Datadog SDK**: dd-trace-php version TBD.
...
*Documentation will be added when PHP metrics support becomes available.*

## Examples

*Examples will be added when PHP metrics support becomes available.*

## Supported configuration

*Configuration details will be added when PHP metrics support becomes available.*
...
*Migration guidance will be added when PHP metrics support becomes available.*

## Troubleshooting

*Troubleshooting information will be added when PHP metrics support becomes available.*
