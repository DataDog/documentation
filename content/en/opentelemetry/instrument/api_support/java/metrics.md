---
title: Java OpenTelemetry Metrics API Support
code_lang: metrics
...
{{% otel-overview-native lang="Java" signal="Metrics" sdk_name="dd-trace-java" %}}

## Prerequisites

- **Datadog SDK**: dd-trace-java version [x.y.z] or later.
- **OpenTelemetry API**: `opentelemetry-api` version [x.y.z] or later. (The Datadog SDK provides the implementation for this API).

## Setup

Follow these steps to enable OTel Metrics API support in your Java application.
...
1. Add the Datadog SDK (`dd-trace-java`) to your project and enable its instrumentation.
