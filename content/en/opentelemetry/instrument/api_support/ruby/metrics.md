...
- **Datadog SDK**: dd-trace-rb version [x.y.z] or later.
- **OpenTelemetry SDK**: The standard opentelemetry-sdk package for Ruby.
- **OTLP Exporter**: The standard `opentelemetry-exporter-otlp` package for Ruby.
...
1. Add the Datadog SDK (`dd-trace-rb`) to your project and enable its instrumentation.
