...
<div class="alert alert-warning">This feature is affected by <a href="/containers/guide/docker-deprecation/">Docker deprecation</a> and you might not be able to use <code>dockerstatsreceiver</code> for OpenTelemetry.</div>
