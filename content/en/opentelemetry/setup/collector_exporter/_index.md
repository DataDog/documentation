...
This method is best for users who require a completely vendor-neutral setup or advanced processing capabilities not available in other setups. For most use cases the [Datadog Distribution of OTel Collector (DDOT)](/opentelemetry/setup/ddot_collector/install/) is the recommended approach.
