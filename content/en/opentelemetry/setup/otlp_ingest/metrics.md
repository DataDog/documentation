...
<div class="alert alert-danger">Host metadata sent to this endpoint will not populate the <a href="https://app.datadoghq.com/infrastructure">Infrastructure Host List</a>.</div>
