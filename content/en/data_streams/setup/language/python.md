...
| Google Pub/Sub | [google-cloud-pubsub](https://pypi.org/project/google-cloud-pubsub/) | {{< dsm-tracer-version lang="python" lib="google-cloud-pubsub" type="minimal" >}} | {{< dsm-tracer-version lang="python" lib="google-cloud-pubsub" type="recommended" >}} | Not supported |
