...
{{< card-grid >}}
  {{< image-card href="/data_streams/java/" src="integrations_logos/java.png" alt="java" img_width="200" >}}
  {{< image-card href="/data_streams/python" src="integrations_logos/python.png" alt="Python" img_width="200" >}}
  {{< image-card href="/data_streams/dotnet/" src="integrations_logos/dotnet_text.png" alt=".NET" img_width="200" >}}
  {{< image-card href="/data_streams/nodejs/" src="integrations_logos/node.png" alt="Node" img_width="200" >}}
  {{< image-card href="/data_streams/go" src="integrations_logos/go-metro.png" alt="Go" img_width="200" >}}
  {{< image-card href="/data_streams/ruby" src="integrations_logos/ruby.png" alt="Ruby" img_width="200" >}}
{{< /card-grid >}}
...
{{< card-grid >}}
  {{< image-card href="/data_streams/setup/technologies/kafka/" src="integrations_logos/kafka.png" alt="Kafka" img_width="200" >}}
  {{< image-card href="/data_streams/setup/technologies/sqs/" src="integrations_logos/sqs.png" alt="Amazon SQS" img_width="200" >}}
  {{< image-card href="/data_streams/setup/technologies/rabbitmq/" src="integrations_logos/rabbitmq.png" alt="RabbitMQ" img_width="200" >}}
  {{< image-card href="/data_streams/setup/technologies/sns/" src="integrations_logos/amazon_sns.png" alt="Amazon SNS" img_width="200" >}}
  {{< image-card href="/data_streams/setup/technologies/kinesis/" src="integrations_logos/amazon_kinesis.png" alt="Kinesis" img_width="200" >}}
  {{< image-card href="/data_streams/setup/technologies/google_pubsub/" src="integrations_logos/google_cloud_pubsub.png" alt="Google Cloud Pub/Sub" img_width="200" >}}
  {{< image-card href="/data_streams/setup/technologies/ibm_mq/" src="integrations_logos/ibm_mq.png" alt="IBM MQ" img_width="200" >}}
  {{< image-card href="/data_streams/setup/technologies/azure_service_bus/" src="integrations_logos/azure_service_bus.png" alt="Azure Service Bus" img_width="200" >}}
  {{< image-card href="/data_streams/setup/technologies/bullmq/" src="integrations_logos/bullmq2.png" alt="BullMQ" img_width="200" >}}
{{< /card-grid >}}
