---
title: (v2) Setup Data Streams Monitoring for Go
---

<div class="alert alert-info">[PREVIEW] This documentation is for v2.x preview of the Go Tracer. If you are looking for v1.x documentation, see the <a href="/data_streams/go">Data Streams Monitoring</a> documentation.</div>
...
[3]: https://docs.datadoghq.com/tracing/trace_collection/library_config/go-v2/
