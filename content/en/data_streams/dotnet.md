...
#### Additional Azure Service Bus Setup

Setting up Data Streams Monitoring for Azure Service Bus applications requires additional configuration the instrumented application.
...
[8]: #additional-azure-service-bus-setup
