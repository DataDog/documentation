...
aliases:
    - /developers/faq/use-our-webhook-integration-to-create-a-trello-card/
...
{{< img src="extend/faq/developer_api_key.png" alt="developer_api_key" >}}
...
{{< img src="extend/faq/trello_api_key.png" alt="trello_api_key" >}}
...
{{< img src="extend/faq/card_url.png" alt="card_url" >}}

From there, find the value of `idList`:
{{< img src="extend/faq/id_list.png" alt="id_list" >}}
...
{{< img src="extend/faq/integration_config.png" alt="integration_config" >}}

## Some points to consider

This flow involves Trello generating a server token for the application. As you can see in the token disclaimer:
{{< img src="extend/faq/trello_disclaimer.png" alt="trello_disclaimer" >}}
