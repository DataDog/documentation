...
If you are looking for the legacy implementation or <code>OpenMetricsBaseCheck</code> interface custom check guide, please see <a href="https://docs.datadoghq.com/extend/faq/legacy-openmetrics/">Custom Legacy OpenMetrics Check</a>.
</div>
