...
{{< whatsnext >}}
    {{< nextlink href="/extend/service_checks/agent_service_checks_submission" >}}Submit a custom Agent Check.{{< /nextlink >}}
    {{< nextlink href="/extend/service_checks/dogstatsd_service_checks_submission" >}}Submit a Service Check with DogStatsD.{{< /nextlink >}}
...
{{< img src="extend/service_checks/check_summary.png" alt="Check summary" >}}
...
{{< img src="extend/service_checks/check_widget_config.png" alt="Check widget config" >}}
...
{{< img src="extend/service_checks/service_check_monitor.png" alt="Check monitor" >}}
