...
aliases:
    - /developers/service_checks/agent_service_checks_submission/
further_reading:
...
{{< img src="extend/service_checks/agent_service_checks_submission/service_check.png" alt="Service Checks" style="width:80%;">}}
