...
aliases:
    - /developers/authorization/oauth2_in_datadog/
...
{{< img src="extend/authorization/oauth_process.png" alt="A diagram explaining how the OAuth authentication process works after a user clicks the Connect Account button in an integration tile." style="width:100%;">}}
...
[2]: /api/latest/scopes/
[3]: /extend/datadog_apps/#oauth-api-access
[4]: https://datatracker.ietf.org/doc/html/rfc6749#section-3.2.1
[5]: /extend/integrations/api_integration
[6]: /extend/authorization/oauth2_endpoints/?tab=authorizationendpoints#request-authorization-from-a-user
[7]: /extend/authorization/oauth2_endpoints/?tab=apikeycreationendpoints#create-an-api-key-on-behalf-of-a-user
[8]: https://tools.ietf.org/html/rfc6749#section-4.1
[9]: /extend/authorization/oauth2_endpoints/?tab=authorizationendpoints#obtain-an-authorization-code
[10]: /extend/authorization/oauth2_endpoints/?tab=tokenendpoints#exchange-authorization-code-for-access-token
