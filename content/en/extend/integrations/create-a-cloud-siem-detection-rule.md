...
- /developers/integrations/create-a-cloud-siem-detection-rule/
further_reading:
...
{{< img src="extend/integrations/detection_rule.png" alt="The Create a New Rule page in Datadog's Detection Rules area" style="width:100%;" >}}
...
{{< img src="extend/integrations/content_tab.png" alt="The Content tab in the Developer Platform" style="width:100%;" >}}
...
{{< img src="extend/integrations/SIEM_detection_rule_top.png" alt="Steps 1-3 of a filled-out detection rule creation form" style="width:90%;" >}}

Setting rule cases and writing the notification message:

{{< img src="extend/integrations/SIEM_detection_rule_bottom.png" alt="Steps 4 and 5 of a filled-out detection rule creation form" style="width:90%;" >}}
...
[3]: https://docs.datadoghq.com/extend/integrations/agent_integration/
