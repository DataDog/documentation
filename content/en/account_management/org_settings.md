...
The **Safety Center** tab contains security alerts, warnings and recommendations to review in your organization. You can also set **Security Contacts** to receive security notifications for your organization by clicking **Configuration**, entering up to 2 email addresses, then clicking the **Save** button.
