...
All API endpoints below have the following host endpoints:

{{< site-region region="us" >}}
* For Datadog US site: `https://api.datadoghq.com/api/`
{{< /site-region >}}
{{< site-region region="eu" >}}
* For Datadog EU site: `https://api.datadoghq.eu/api/`
{{< /site-region >}}
