...
1. Create a [metric monitor][4].
2. Enter `datadog.estimated_usage.apm.ingested_bytes`for the metric query.
3. Define the monitor's evaluation window to `current month (MTD)`. This ensures that the monitor is looking at the month-to-date usage. Read more about cumulative time windows in the [monitors][5] documentation.
...
To effectively reduce your ingested volumes, see this [guide][6] or the [ingestion mechanisms][7] documentation.
...
To reduce the number of indexed spans, check your configuration for retention filters. Read more about retention filters in the [trace retention][8] documentation.
...
[5]: /monitors/configuration/?tab=thresholdalert#cumulative-time-windows
[6]: /tracing/guide/trace_ingestion_volume_control/
[7]: /tracing/trace_pipeline/ingestion_mechanisms/
[8]: /tracing/trace_pipeline/trace_retention/
