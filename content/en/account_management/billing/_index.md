...
Pro and Enterprise plans include 150,000 Retained Spans and 5 custom metrics per billed function. Billing for serverless APM depends on the total number of [Retained Spans][4] exceeding the bundled quantity submitted to the Datadog APM service at the end of the month. There are no billable [APM Hosts][4] when using serverless.
