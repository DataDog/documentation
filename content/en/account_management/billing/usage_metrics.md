...
{{< callout url="#" btn_hidden="true" header="Join the Preview!">}}
  The Estimated Usage `by_tag` Metrics are currently in Preview. To enable this feature, reach out to Customer Success. 
{{< /callout >}}  
...
| USM                   | `datadog.estimated_usage.usm.hosts`, `datadog.estimated_usage.usm.hosts.by_tag` | Unique USM hosts seen in the last hour (excludes hosts that are also APM hosts).  |
...
| Data Streams Monitoring | `datadog.estimated_usage.apm.data_streams_monitoring_hosts`, `datadog.estimated_usage.apm.data_streams_monitoring_hosts.by_tag` | Unique DSM hosts seen in the last hour. |
