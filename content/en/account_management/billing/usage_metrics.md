...
| Incident Management Seats  | `datadog.estimated_usage.incident_management.seats`  | Chosen number of Incident Management seats.  |
| Incident Management Monthly Active Users  | `datadog.estimated_usage.incident_management.monthly_active_users`  | Incident Management unique active users seen from (calendar) month-to-date.  |
