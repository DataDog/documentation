...
| [Individual Resource Restrictions][6] | Filters information in Datadog by Team across Dashboards, Monitors, Service Catalog, and more. See the full [resource list][4]. | Restricts access to specific assets (e.g., dashboards, monitors, or integrations) to members of a specified Team. |
