...
### [Get usage attribution][1]

This API provides monthly usage attribution.

The v2 monthly usage attribution API [Get monthly usage attribution][6] also provides monthly usage attribution and supports querying by combinations of tags.
...
The [Get hourly usage attribution][7]
...
### [Get the list of available monthly custom reports][8]
...
the month for each tag. The [Get monthly usage attribution][6]
API provides this same data.
...
[6]: /api/latest/usage-metering/#get-monthly-usage-attribution
[7]: /api/latest/usage-metering/#get-hourly-usage-attribution
[8]: https://docs.datadoghq.com/api/latest/usage-metering/#get-the-list-of-available-monthly-custom-reports
