...
| <base_url>/api/v1/usage/logs-by-retention         |                  | retention                               | indexed_logs                                                                   | In usage type replace `<retetion>` with one of : 3_day, 7_day, 15_day, 30_day, 45_day, 60_day, 90_day, 180_day, 360_day, custom |
