...
8. Retrieve your `Service Provider Entity ID` and `Assertion Consumer Service URL` from the [Datadog SAML page][2]. The default values are:
    ...
    |                                |                                                                                                                                        |
    |--------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
    | Service Provider Entity ID     | `https://{{< region-param key="dd_subdomain" code="true" >}}.{{< region-param key="dd_site" code="true" >}}/account/saml/metadata.xml` |
    | Assertion Consumer Service URL | `https://{{< region-param key="dd_subdomain" code="true" >}}.{{< region-param key="dd_site" code="true" >}}/account/saml/assertion`    |
