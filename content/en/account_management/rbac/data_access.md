...
* **Supported telemetry**: Only CI Visibility pipelines are supported. Test Optimizations tests are not yet supported.
* **CI Logs**: CI Logs are part of the general Logs product and require a specific dataset.
