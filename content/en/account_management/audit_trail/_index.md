...
{{< img src="account_management/audit_logs/audit_trail_nlq_dark.mp4" alt="Natural language query in Audit Trail showing how to search for audit events using plain English phrases" video=true >}}
