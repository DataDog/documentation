...
7. Next to **Provisioning to App** , select **Edit** to enable the features:
    ...
    - **Deactivate Users**
8. Under **Datadog Attribute Mappings**, you can find the mapping of Okta attributes to Datadog Attributes already pre-configured. You can re-map them if needed, but be sure to map the Okta values to the same set of Datadog values.
