...
| [Trace][7]    | Representation of a request as it flows across a distributed system | A trace can be collected in [any language][8]. Traces are found in the [Traces list for each resources][9] or in the [Trace search directly][10]. Traces always have a [top-level span][11] |
| [Span][12]    | A logical unit of work in the system                                | Spans are associated with a [service][1] and optionally a [resource][4]. Each span consists of a start time, a duration, and optional tags.      |
...
[11]: /tracing/getting_further/top_level_span
[12]: /tracing/visualization/trace/#spans
