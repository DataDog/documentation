...
| `DD_SERVICE_MAPPING`               |             | Define service name mappings to allow renaming services in traces, e.g. `postgres:postgresql,deafultdb:postgresql`. Available in version 0.47+. |
