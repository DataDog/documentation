...
| `dd.trace.methods`                     | `DD_TRACE_METHODS`                     | `null`                            | (Example: `"package.ClassName[method1,method2,...];AnonymousClass$1[call];package.ClassName[*]"`) List of class/interface and methods to trace. Similar to adding `@Trace`, but without changing code. Note: wildcard method support does not accommodate Constructors, Getters, Setters, Synthetic, toString, Equals, HashCode and Finalizer method calls                                                                                       |
