...
1. if the user running the php-fpm user is different from `root` (a common user name is `www-data`) then such user is required to have writing permissions to the core dumps directory;
