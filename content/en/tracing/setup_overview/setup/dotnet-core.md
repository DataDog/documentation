...
| `DD_TRACE_ADONET_EXCLUDED_TYPES`<br/><br/>`AdoNetExcludedTypes` | Sets a list of `AdoNet` types (e.g. `System.Data.SqlClient.SqlCommand`) that will be excluded from automatic instrumentation. |
