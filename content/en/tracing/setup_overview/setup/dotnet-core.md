...
| `DD_TRACE_ADONET_EXCLUDED_TYPES`                    | Sets type names that will be ignored by the `AdoNet` automatic instrumentation. (e.g. : `DD_TRACE_ADONET_EXCLUDED_TYPES=System.Data.SqlClient.SqlCommand`) |
