...
<div class="alert alert-info">This documentation assumes that you are currently using version v1.x of the Go Tracer. If you are already on v2.x of the tracer, please visit <a href="tracing/trace_collection/custom_instrumentation/dd-api-v2">Go v2 Custom Instrumentation using the Datadog API</a> documentation instead.</div>
