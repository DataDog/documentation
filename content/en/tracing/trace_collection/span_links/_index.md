...
**Note***: This section documents minimum support for generating span links with Datadog APM client libraries (via the OpenTelemetry API). Span links generated by the OpenTelemetry SDK are sent to Datadog through [OTLP Ingest][8].
