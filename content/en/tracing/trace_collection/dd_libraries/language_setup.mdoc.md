---
title: Tracing Applications
content_filters:
  - trait_id: prog_lang
    option_group_id: apm_tracing_language_options
    label: Language
aliases:
    - /tracing/java
    ...
    - /tracing/trace_collection/automatic_instrumentation/dd_libraries/php
    - /tracing/dotnet-core
    ...
    - /tracing/trace_collection/automatic_instrumentation/dd_libraries/cpp
