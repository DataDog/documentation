...
For a full list of Datadog’s Python version and framework support (including legacy and maintenance versions), please visit the [Compatibility Requirements][1] page.
