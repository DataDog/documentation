...
This page documents additional use cases of trace context propagation for the Datadog .NET SDK. For a high-level overview of trace context propagation, see [Trace Context Propagation][1].
