...
Starting from version [2.42.0](https://github.com/DataDog/dd-trace-dotnet/releases/tag/v2.42.0), when multiple extractors are specified, this configuration specifies whether context extraction should exit immediately upon detecting the first valid tracecontext, the default value is `false`:
