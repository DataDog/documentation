...
Create {{< tooltip glossary="spans" >}} for your application with minimal manual steps. To automatically instrument your application, you can use either of these options:
