...
In addition to the [general prerequisites](/dynamic_instrumentation/#prerequisites), Node.js applications require:

- Tracing library [`dd-trace-js`](https://github.com/DataDog/dd-trace-js) version 5.48.0 or higher.
