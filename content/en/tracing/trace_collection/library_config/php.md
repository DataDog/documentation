...
**Default**: `0`<br>
Enable the collection of exception messages with exception samples. Please be aware that your exception messages might contain PII (Personal Identifiable Information), which is the reason why this setting is default disabled<br><br>
