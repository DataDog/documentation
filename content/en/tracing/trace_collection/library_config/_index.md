...
The following configuration options are supported across all Datadog SDKs:
...
**Description**: Enables or disables instrumentation for the specified `<INTEGRATION>`.
...
**Not Supported In**: Node.js, Ruby, Python SDKs<br>
