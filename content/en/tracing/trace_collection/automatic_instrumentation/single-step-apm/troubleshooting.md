...
Datadog provides troubleshooting 

### Troubleshoot injection in Datadog

<div class="alert alert-info">This feature is currently in preview for:<br>
- Languages: Python, Java, Node.js, Ruby, PHP, .NET<br>
- Environments: Linux hosts, containers, Kubernetes<br>
- Minimum Agent version: 7.68.2+<br>
To enable it, contact support or ensure the <code>apm-ssi-troubleshooting</code> feature flag is enabled.</div>

Datadog provides a UI-based view to help you identify and troubleshoot SSI issues across your infrastructure. This view shows:
...
This method is especially useful for identifying issues that affect multiple services or hosts, and is a good first stop before inspecting individual logs or configurations.

To access instrumentation insights:
1. In Datadog, navigate to [Fleet Automation][9]
...
The **SDK Installations** section lists processes that failed injection, with a reason and recommended next steps. Here are some common examples:

#### Understand common issues

The SDK Installations section lists processes that failed injection, along with failure reasons and recommended next steps. Here are some common examples:
...
If you're not seeing traces as expected, you can manually verify whether the injection was applied successfully. Follow these steps to confirm that the required components were added to your application container and to gather debug logs for further troubleshooting.
