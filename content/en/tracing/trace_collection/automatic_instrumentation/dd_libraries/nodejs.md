...
Now you should be able to deploy your bundle, which is your application code and most of your dependencies, with the `node_modules/` directory, which contains the native modules and their dependencies.
