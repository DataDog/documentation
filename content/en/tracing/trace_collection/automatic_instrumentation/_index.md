...
{{< tabs >}}
{{% tab "Single Step Instrumentation (in Preview)" %}}

If you install or update a Datadog Agent with the **Enable APM Instrumentation (preview)** option selected, the Agent is installed and configured to enable APM. This allows you to automatically instrument your application, without any additional installation or configuration steps.
