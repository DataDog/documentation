...
| iOS         | `tracingSamplingRate` | [1.11.0][9] _Sampling rate is reported in the Ingestion Control Page since [1.13.0][10]_ |
| Android     | `traceSamplingRate`   | [1.13.0][11] _Sampling rate is reported in the Ingestion Control Page since [1.15.0][12]_ |
| Flutter     | `tracingSamplingRate` | [1.0.0][13] |
| React Native | `tracingSamplingRate` | [1.0.0][14] _Sampling rate is reported in the Ingestion Control Page since [1.2.0][15]_  |

### Synthetic traces
`ingestion_reason:synthetics` and `ingestion_reason:synthetics-browser`

HTTP and browser tests generate traces when the backend services are instrumented. [The APM integration with Synthetic Testing][16] links your synthetic tests with the corresponding backend traces. Navigate from a test run that failed to the root cause of the issue by looking at the trace generated by that test run.
...
|------------|-------------------------------------|---------------------------------|
| Serverless | `lambda` and `xray`                   | Your traces received from the [Serverless applications][17] traced with Datadog Tracing Libraries or the AWS X-Ray integration. |
| Application Security Management     | `appsec`                            | Traces ingested from Datadog tracing libraries and flagged by [ASM][18] as a threat. |
...
[10]: https://github.com/DataDog/dd-sdk-ios/releases/tag/1.13.0
[11]: https://github.com/DataDog/dd-sdk-android/releases/tag/1.13.0
[12]: https://github.com/DataDog/dd-sdk-android/releases/tag/1.15.0
[13]: https://github.com/DataDog/dd-sdk-flutter/releases/tag/datadog_flutter_plugin%2Fv1.0.0
[14]: https://github.com/DataDog/dd-sdk-reactnative/releases/tag/1.0.0
[15]: https://github.com/DataDog/dd-sdk-reactnative/releases/tag/1.2.0
[16]: /synthetics/apm/
[17]: /serverless/distributed_tracing/
[18]: /security/application_security/
