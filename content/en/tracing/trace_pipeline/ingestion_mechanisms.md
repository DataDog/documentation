...
Depending on your setup with OpenTemetry SDKs (using the OpenTelemetry Collector or the Datadog Agent), you have multiple ways of controlling ingestion sampling. Refer to the guide [ingestion sampling with OpenTelemetry][22] for more details about the options available for sampling at the OTel SDK, OTel Collector and Datadog Agent level in various OpenTelemetry setups.
