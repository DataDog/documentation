...
<div class="alert alert-info"><strong>Remotely configured sampling rules are in Beta</strong>. Request access to the feature via this <a href="https://forms.gle/WCG57yTCG27BCBB67">link</a> to be able to dynamically set this configuration from the Datadog UI, without having to redeploy your service. Follow the instructions in this <a href="/tracing/guide/resource_based_sampling">guide</a> to get started.</div>
