...
**Note:** Due to several issues in the .NET Core 2.1 runtime (see GitHub issues [dotnet/runtime/issues/10506][12] and [DataDog/dd-trace-dotnet/issues/302][13]), we strongly recommend .NET Core versions 2.1.12 or higher. For .NET Core 2.2, we recommend version 2.2.6 or higher.
