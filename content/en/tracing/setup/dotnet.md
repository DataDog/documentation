...
---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------- |
`DD_TRACE_ENABLED`                       | Enables or disables the profiler. Valid values are: `true` or `false`                                                                                                                                                                                              | `true`                                         |
`DD_TRACE_AGENT_URL`                     | Sets the URL endpoint where traces are sent. Overrides `DD_AGENT_HOST` and `DD_TRACE_AGENT_PORT` if set.                                                                                                                                                           | `http://<DD_AGENT_HOST>:<DD_TRACE_AGENT_PORT>` |
`DD_AGENT_HOST`                          | Sets the host where traces are sent (the host running the Agent). Can be a hostname or an IP address. Ignored if `DD_TRACE_AGENT_URL` is set.                                                                                                                      | `localhost`                                    |
`DD_TRACE_AGENT_PORT`                    | Sets the port where traces are sent (the port where the Agent is listening for connections). Ignored if `DD_TRACE_AGENT_URL` is set.                                                                                                                               | `8126`                                         |
...
`DD_TRACE_ANALYTICS_ENABLED`             | Shorthand that enables Trace Search and Analytics for web framework integrations. Valid values are: `true` or `false`                                                                                                                                              | `false`                                        |
`DD_<integration>_ANALYTICS_ENABLED`     | Enables or disable Trace Search and Analytics for a specific integration. Valid values are: `true` or `false`                                                                                                                                                      | `false`                                        |
`DD_<integration>_ANALYTICS_SAMPLE_RATE` | Sets the Trace Search and Analytics sampling rate for a specific integration. A floating number between `0` and `1`.                                                                                                                                               | `1.0`                                          |
