...
`DD_<integration>_ANALYTICS_ENABLED`     | `Integrations["<integration>"]`<br/>`.AnalyticsEnabled`    | Enables or disable Trace Search and Analytics for a specific integration. Valid values are: `true` or `false` (default).                                                                                                                                           |
`DD_<integration>_ANALYTICS_SAMPLE_RATE` | `Integrations["<integration>"]`<br/>`.AnalyticsSampleRate` | Sets the Trace Search and Analytics sampling rate for a specific integration. A floating number between `0` and `1` (default).                                                                                                                                     |
