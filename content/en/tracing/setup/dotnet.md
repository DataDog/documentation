...
`DD_TRACE_AGENT_URL`                     | N/A                                                 | Sets the URL endpoint where traces are sent. Overrides `DD_AGENT_HOST` and `DD_TRACE_AGENT_PORT` if set.                                                                                                                                                           | `http://<DD_AGENT_HOST>:<DD_TRACE_AGENT_PORT>` |
