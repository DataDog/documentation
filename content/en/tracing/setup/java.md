...
|`dd.env`                              | `DD_ENV`                              | `none`                            | If DD_ENV or DD_VERSION is used, it will override any env or version tag defined in DD_TAGS.Your application environment (e.g. production, staging, etc.). Available for versions 0.48+.                                                    |
