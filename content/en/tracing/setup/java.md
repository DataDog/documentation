...
| `dd.trace.split-by-tags`               | `DD_TRACE_SPLIT_BY_TAGS`               | `null`               | (Example: `aws.service`) Used to rename spans to spans to be identified with the corresponding service tag                                                                                                             |
