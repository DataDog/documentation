...
| `dd.jmxfetch.enabled`                    | `DD_JMXFETCH_ENABLED`                    | `true`                 | Enable collection of JMX metrics by Java Tracing Agent. Enabled by default since Java tracer v0.29.0.                                                                                                                     |
...
[4]: /tracing/advanced/connect_logs_and_traces/?tab=java
{{% /table %}}
