...
Datadog has a series of pluggable packages which provide out-of-the-box support for instrumenting a series of libraries and frameworks. The list of supported integrations can be found in our [compatibility section](https://docs.datadoghq.com/tracing/compatibility_requirements/go/) (note that packages must be imported).
