...
<div class="alert alert-info">Starting in version 1.18.3, if <a href="/agent/fleet_automation/setup">Agent Remote Configuration</a> is enabled where the service runs, you can set <code>DD_LOGS_INJECTION</code> in the <a href="/tracing/software_catalog">Software Catalog</a> UI.</div>
