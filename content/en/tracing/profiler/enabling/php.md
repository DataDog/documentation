...
Starting in version 0.69.0, both the tracer and profiler can be installed simultaneously using the script `datadog-setup.php`.
...
To begin profiling applications:
 ...
 2. Download the `datadog-setup.php` script from the [GitHub release page][7]. Version 0.69.0 is the first tracer release to include this installer.
