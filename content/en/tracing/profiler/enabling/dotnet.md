...
2. The profiler ships together with the tracer. Install or upgrade to the last beta version if needed, using the [.NET Monitoring MSI installer][3]. Continuous Profiler supports 64-bit Windows, so you need the file like `datadog-dotnet-apm-2.5.1-x64.msi`.
...
[3]: https://github.com/DataDog/dd-trace-dotnet/releases/tag/v2.5.1
