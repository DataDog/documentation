...
2. The profiler ships together with the tracer, starting in version 2.1. Install or upgrade to latest version if needed, using the combined tracer and profiler [.NET Monitoring MSI installer][3], for example `datadog-dotnet-apm-2.1.0-x64-profiler-beta.msi`.
