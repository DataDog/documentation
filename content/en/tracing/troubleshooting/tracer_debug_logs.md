...
To enable debug mode for the Datadog Python Tracer, review the instructions below for the related scenario for the application being traced. Log emitted by the Python Tracer contain the name **[ddtrace]**.
