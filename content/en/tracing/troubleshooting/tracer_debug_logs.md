...
Use Datadog debug settings to diagnose issues or audit trace data. Datadog doesn't recommend enabling debug mode in production systems, because it increases the number of events that are sent to your loggers. Use it sparingly, for debugging purposes only.
