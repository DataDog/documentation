...
<div class="alert alert-warning">If you don’t see the option for your service, there is likely a connection error with the agent and you should default to the manual option of providing debug tracer logs.</div>
