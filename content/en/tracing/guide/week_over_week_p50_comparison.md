...
2. **Search and open a relevant and active service**.
    ...
    The web-store service is used in this example because it’s a stable service that should be double checked that there hasn’t been any issues over the last month.
