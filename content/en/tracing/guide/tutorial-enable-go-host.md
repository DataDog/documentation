...
<div class="alert alert-info">This documentation is for the Go Tracer v1.x. If you are looking for v2.x preview documentation, see the <a href="tutorial-enable-go-host-v2.md">Tutorial - Enabling Tracing for a Go Application on the Same Host as the Datadog Agent</a> documentation.</div>
