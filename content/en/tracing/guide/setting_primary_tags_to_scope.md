...
If `DD_ENV` is exposed to your service's process, the tracer will use it automatically. See [Unified Service Tagging][6] to learn about setting `DD_ENV` and other standard service environment variables.
