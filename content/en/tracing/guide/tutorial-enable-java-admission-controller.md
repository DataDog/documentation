...
2. Open the Datadog UI and see the two services reporting under the [Catalog][11]:
   {{< img src="tracing/guide/tutorials/tutorial-admission-controller-software-catalog.png" alt="Springback and springfront services in the Catalog." style="width:100%;" >}}
