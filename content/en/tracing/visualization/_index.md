...
| [Root span](#root-span) | The first span generated by a request and, as a result, does not have a parent                      |
...
The very first span generated by a request and, as a result, does not have a parent. You can visualize this on the flamegraph by finding the span on the top of the flamegraph that initiates the request.
