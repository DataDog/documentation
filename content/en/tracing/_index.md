...
<strong>Beta: 1-Step APM Instrumentation</strong> - Enable APM when you install the Datadog Agent on your hosts and containers. Your services are automatically instrumented without having to modify the code, quickly getting you up and running with application performance monitoring. For more information, read <a href="/tracing/trace_collection/one-step-apm">1-Step APM Instrumentation</a>.
</div>
