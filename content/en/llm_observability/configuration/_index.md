...
Connect your OpenAI account to LLM Observability with your OpenAI API key. LLM Observability will use the `GPT-4o mini` model for Evaluations.
...
Connect your Anthropic account to LLM Observability with your Anthropic API key. LLM Observability will use the `Haiku` model for Evaluations.
...
Connect your Amazon Bedrock account to LLM Observability with your AWS Account. LLM Observability will use the `Haiku` model for Evaluations.
