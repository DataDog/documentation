...
description: Overview of Datadog Agent Observability, a platform for monitoring, troubleshooting, and improving LLM applications and AI agents.
aliases:
...
Each request fulfilled by your application is represented as a trace on the [**Agent Observability** page][1] in Datadog.

{{< img src="llm_observability/traces.png" alt="A list of prompt-response pair traces on the Agent Observability page" style="width:100%;" >}}
...
{{< img src="llm_observability/dashboard_1.png" alt="The out-of-the-box Agent Observability Operational Insights dashboard in Datadog" style="width:100%;" >}}
