...
You can create and manage custom evaluations from the [Evaluations page][1] in LLM Observability. You can learn more about the [compatibility requirements here][6].
