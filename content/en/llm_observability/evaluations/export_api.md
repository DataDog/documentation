...
| Field | Type | Description |
|-------|------|-------------|
| limit | integer | Maximum number of spans in the response. Default: 10. Maximum configurable limit: 5000. <br>**Note:** Responses are subject to a 50 MB size limit, and large limits (100+) can increase response time. If your spans contain large inputs or outputs, use a lower limit and paginate with `cursor`. |
