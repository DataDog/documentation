...
For more granular control, use **Data Access Control** to restrict code coverage data by repository rather than across your entire organization. This prevents sensitive information in coverage reports from crossing team boundaries. 
