...
1. Navigate to **Monitors** > **New Monitor** and click [**APM**][9].
2. Select **APM Metrics** and define a service or resource's `env` and any other [primary tags][10]. Select a service or resource to monitor and define time interval for the monitor to evaluate the query over. 
...
For more information, see the [APM Monitor documentation][11].

### Create an SLO

You can create an [**SLO**][12] on a per-service basis to ensure you are meeting objectives set by USM metrics and improving availability over time. Datadog recommends [creating an SLO programmatically][13] in order to cover a lot of services. 
...
1. Navigate to **Service Management** > **SLOs** and click [**New SLO**][12].
...
For more information, see the [Service Level Objectives documentation][12].
...
For more information, see the [Dashboards documentation][14].
...
[10]: /metrics/advanced-filtering/
[11]: /monitors/create/types/apm
[12]: https://app.datadoghq.com/slo/new
[13]: /api/latest/service-level-objectives/
[14]: /dashboards
