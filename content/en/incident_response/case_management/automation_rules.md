...
{{< img src="/service_management/case_management/automation_rules/create_case_automation_rule-2.png" alt="Screenshot of the Create Automation Rule dialog in a case management system. The dialog includes steps to set when to evaluate the rule, specify workflow for rule match, name the rule, and set its status." style="width:100%;" >}}
