...
Datadog Case Management integrates with AI tools to support different workflows:
...
## Features
{{< whatsnext desc="Learn more:">}}
    {{< nextlink href="/incident_response/case_management/ai/mcp_server" >}}MCP Server{{< /nextlink >}}
    {{< nextlink href="/incident_response/case_management/ai/custom_agents" >}}Custom Agents{{< /nextlink >}}
{{< /whatsnext >}}
