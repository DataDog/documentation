...
{{< img src="incident_response/incident_management/investigate/declare/from-a-graph.png" alt="Create in incident from a graph" style="width:80%;">}}
...
{{< img src="incident_response/incident_management/investigate/declare/from-slack.png" alt="Create in incident from Slack" style="width:60%;">}}
