...
{{< img src="incident_response/incident_management/incident_ai/message_template_variables.png" alt="New message template with AI variables in it" style="width:80%;" >}}
