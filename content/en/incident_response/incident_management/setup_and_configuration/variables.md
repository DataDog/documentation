...
| `{{incident.slack_channel_id}}` | The channel ID of the incident's Slack channel. |
...
| `{{incident.ms_teams_channel_id}}` | The channel ID of the incident's Microsoft Teams channel. |
