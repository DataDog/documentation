...
- /incident_response/incident_management/integrations/google_chat/
further_reading:
...
4. The **Channel Name Template** you define determines how Datadog names the incident spaces it creates. For the list of available variables, see [Variables available only in channel naming templates][4].
...
[4]: /incident_response/incident_management/setup_and_configuration/variables/#variables-available-only-in-channel-naming-templates
