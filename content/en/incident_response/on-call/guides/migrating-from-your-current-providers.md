...
<div class="alert alert-info">If you're migrating from PagerDuty or OpsGenie, Datadog provides dedicated migration tools that can help you selectively import schedules and escalation policies. Use the <a href="/incident_response/on-call/guides/migrate-your-pagerduty-resources-to-on-call">PagerDuty migration tool</a> or the <a href="/incident_response/on-call/guides/migrate-your-opsgenie-resources-to-on-call">OpsGenie migration tool</a> during setup to reduce manual effort and avoid migrating unused configurations.</div>
