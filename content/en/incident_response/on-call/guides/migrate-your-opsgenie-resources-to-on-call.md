...
{{< img src="service_management/oncall/opsgenie_migration_import_team.png" alt="UI that lists OpsGenie teams and shows a preview of the selected team" style="width:95%;" >}}
...
1. The migration wizards transforms the OpsGenie escalation policy model into Datadog On-Call's escalation policy model.
...
{{< img src="service_management/oncall/opsgenie_migration_review.png" alt="UI for reviewing and editing the migrated escalation policy before saving" style="width:95%;" >}}
