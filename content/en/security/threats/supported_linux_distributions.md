...
Workload Protection Threats supports the following Linux distributions:
...
- For compatibility with a custom Kubernetes network plugin like Cilium or Calico, see the [Troubleshooting Workload Protection Threats][1].
