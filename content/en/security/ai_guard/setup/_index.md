...
When adding [scopes][3] for the {{< ui >}}application key{{< /ui >}}, add the `ai_guard_evaluate` scope. The user creating the application key must have the [AI Guard Evaluate permission](#1-check-prerequisites).
