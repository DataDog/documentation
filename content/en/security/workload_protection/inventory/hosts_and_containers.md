...
2. Click a version label (for example, 7.69.1), and select **{{< ui >}}Filter by agent_version:[number]{{< /ui >}}**. 
...
The **{{< ui >}}Cluster Name{{< /ui >}}** column links hosts to logical infrastructure boundaries like Kubernetes clusters. Filter on a cluster by clicking its name and selecting **{{< ui >}}Filter by cluster_name:[name]{{< /ui >}}**.
