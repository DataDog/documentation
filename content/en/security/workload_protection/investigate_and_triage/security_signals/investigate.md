...
- **Malware IOC**: Groups events that match the same malware indicator from [threat intelligence][5], such as a file hash or domain.
...
[5]: /security/workload_protection/detect_and_monitor/threat_intelligence
