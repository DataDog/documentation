...
<div class="alert alert-info">If you wish to deploy Workload Protection on Amazon EKS configured with the Fargate compute option, we invite you to go to <a href="/security/workload_protection/getting_started/fargate/">the dedicated Fargate deployment page</a>.</div>
