...
<div class="alert alert-info">Workload Protection Automated response is in Preview.</div>

This topic explains how to use the Workload Protection {{< ui >}}Automated response{{< /ui >}} feature to block threats automatically.

Automated response enables you to proactively block and terminate threats identified by the Datadog Agent detection rules.
