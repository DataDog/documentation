...
```json
{
  "api_endpoint": {
    ...
    "path": "/api/v2/bits-ai/incidents/{IncidentID}/summary",
    "resource_name": "GET /api/v2/bits-ai/incidents/{IncidentID}/summary"
  },
  "base_severity": "medium",
  "container_image": {
    "name": "464622532012.dkr.ecr.us-east-1.amazonaws.com/csi-livenessprobe:v2.15.0-dd.202521",
    "registries": [
      "464622532012.dkr.ecr.us-east-1.amazonaws.com"
    ],
    "repo_digests": [
      "sha256:a14e38e3281d72aa59976a96efa60bbedf67451e64e2ddf037144676dda72381"
    ]
  },
  ...
  "finding_id": "AZTOFSk5AACcN-l9MYmaGCFO",
  ...
  "rule": {
    "default_rule_id": "def-000-rtc",
    "id": "TRIVY-CVE-2024-46820",
  ...
  "status": "open",
  "title": "kernel: drm/amdgpu/vcn: remove irq disabling in vcn 5 suspend",
  "workflow": {
    "auto_closed_at": 1738575600859,
    "automations": {
      "rule_id": "10f98989-9c19-41b0-a421-93e265a898ff",
    ...
    "integrations": {
      "cases": {
        "assignee": {
          "id": "Alice",
          "name": "972fc291-1645-4170-891a-14c8fbee6060"
        },
        ...
        "id": "10f98989-9c19-41b0-a421-93e265a898ff",
        "jira_issue": {
          "key": "CSMSEC-103991",
          "status": "To Do",
          "url": "https://datadoghq-sandbox-538.atlassian.net/browse/CSMSEC-103991"
        },
        "key": "CSMINV-66",
        "status": "open",
    ...
    "triage": {
      "assignee": {
        "id": "972fc291-1645-4170-891a-14c8fbee6060",
        "name": "Alice",
...
```json
{
  "base_severity": "medium",
  "cloud_resource": {
    "account": "{\"account\": \"Main production account\", \"account_id\": 464963039276\"}",
    "cloud_provider": "AWS",
    "cloud_provider_url": "https://us-east-1.console.aws.amazon.com/ec2/qweqwe",
    "configuration": {
      "account_id": "464963039276",
      "ami_launch_index": 0,
      "architecture": "x86_64",
      "aws_ami_key": "6ba930f3753d63fa891c16451f01e867",
      "aws_iam_instance_profile_key": "6a2121a651ee4835aacdf17421350dfd",
      "aws_subnet_key": "5c10805010718931bad49d8780eace7b",
      "aws_vpc_key": "78793af35a2c82e12b7384f5f1cf9839",
      "block_device_mappings": [
        {
          ...
          "ebs": {
            ...
            "status": "attached",
            "volume_id": "vol-080f3628382f7d6fa"
          }
        }
      ]
    },
...
```json
{
  ...
  "title": "kernel: drm/amdgpu/vcn: remove irq disabling in vcn 5 suspend",
  "vulnerability": {
    "hash": "270b324d7f23a468c476a38987a785238e5fbe1f63a8bf05c6c5bb1325e67d8f,",
    "stack": {
      "ecosystem": "deb"
    }
  },
...
```json
{
  ...
  "git": {
    "author": {
      ...
      "email": "neo@nebuchadnezzar",
      "name": "Neo"
    },
    "branch": "main",
    "committer": {
      "committed_at": 1738575599859,
      "email": "captain@nebuchadnezzar",
      "name": "Morpheus"
    },
    "default_branch": "main",
    "is_default_branch": false,
    "repository_id": "123456789",
    "repository_url": "https://github.com/ACME/terraform/",
...
{{% collapse-content title="Tags" level="h2" id="tags" %}}
