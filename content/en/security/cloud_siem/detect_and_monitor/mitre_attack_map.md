...
1. Click **Create Custom Rule** if you want to create a custom rule for this technique. See [Detection Rules][4] for more information on creating custom rules. Note in order for the custom rule to surface within active sources the appropriate source tag must be defined in the detection rule.
