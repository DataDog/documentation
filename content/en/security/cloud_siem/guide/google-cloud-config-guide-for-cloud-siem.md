...
1. In the {{< ui >}}Log Types{{< /ui >}} panel, enable {{< ui >}}Admin Read{{< /ui >}}, {{< ui >}}Data Read{{< /ui >}}, and {{< ui >}}Data Write{{< /ui >}}.
1. Click {{< ui >}}Save{{< /ui >}}.
...
1. Navigate to the {{< ui >}}IAM & Admin Console{{< /ui >}} > [Audit Log][4].
...
1. Leave {{< ui >}}Add a default subscription{{< /ui >}} selected.
1. Click {{< ui >}}Create{{< /ui >}}.
...
1. Copy your [Datadog API key][9] and paste it into the {{< ui >}}Secret value{{< /ui >}} section.
...
1. Click {{< ui >}}Next{{< /ui >}}.
1. In the {{< ui >}}Select Sink Service{{< /ui >}} dropdown menu, select {{< ui >}}Cloud Pub/Sub topic{{< /ui >}}.
    **Note**: The Cloud Pub/Sub topic can be located in a different project.
1. In the {{< ui >}}Select a Cloud Pub/Sub topic{{< /ui >}}, select the Pub/Sub created earlier.
1. Click {{< ui >}}Next{{< /ui >}}.
...
1. In the {{< ui >}}Dataflow template{{< /ui >}} dropdown menu, select {{< ui >}}Pub/Sub to Datadog{{< /ui >}}.
1. In the {{< ui >}}Required Parameters{{< /ui >}} section:
   1. In the {{< ui >}}Pub/Sub input subscription{{< /ui >}} dropdown menu, select the default subscription that was created earlier when you created a new [Pub/Sub system](#create-a-google-cloud-publishsubscription-pubsub-system).
   ...
   1. In the {{< ui >}}Output deadletter Pub/Sub topic{{< /ui >}} field, select the [additional topic](#create-an-additional-topic-and-subscription-for-outputdeadlettertopic) you created earlier for receiving messages rejected by the Datadog API.
...
1. If you [created a secret in Secret Manager](#create-a-secret-in-secret-manager) for your Datadog API key value earlier:
   ...
   1. Enter the resource name of the secret in the {{< ui >}}Google Cloud Secret Manager ID{{< /ui >}} field.<br />
      To get the resource name, go to your secret in [Secret Manager][8]. Click on your secret. Click on the three dots under {{< ui >}}Action{{< /ui >}} and select {{< ui >}}Copy resource name{{< /ui >}}.
   1. Enter `SECRET_MANAGER` in the {{< ui >}}Source of the API key passed{{< /ui >}} field.
...
1. If you created a custom worker service account, select it in the {{< ui >}}Service account email{{< /ui >}} dropdown menu.
