...
When Cloud SIEM has been setup, [OOTB detection rules][6] automatically start analyzing your logs and audit events. You can [clone][7] OOTB detection rules and:
...
[7]: /security/detection_rules/#clone-a-rule