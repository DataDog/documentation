...
1. If you chose **Signal** in step 3, to test notifications for this rule, click **Test Notifications**.</br >**Note**: Testing notifications isn't available yet for finding notifications.
