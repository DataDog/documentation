...
| scanner | suspicious | IP addresses | Reputation for scanners | AAP, CWS, and Cloud SIEM |
...
| tor | suspicious | IP addresses  | Corporate policy violations for user activity | AAP, CWS, and Cloud SIEM |
