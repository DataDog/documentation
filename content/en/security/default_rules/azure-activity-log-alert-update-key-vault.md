...
aliases:
- kd9-bgd-5gs
- /security_monitoring/default_rules/kd9-bgd-5gs
- /security_monitoring/default_rules/azure-activity-log-alert-update-key-vault
disable_edit: true
...
title: User has 'Update Key Vault' activity log alert configured
type: security_rules
---
