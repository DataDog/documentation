...
aliases:
- ab7-bv8-6bt
- /security_monitoring/default_rules/ab7-bv8-6bt
- /security_monitoring/default_rules/azure-activity-log-alert-delete-azure-sql-database
disable_edit: true
...
title: User has 'Delete Azure SQL Database' activity log alert configured
type: security_rules
---
