...
aliases:
- 4d4-6d3-df3
- /security_monitoring/default_rules/4d4-6d3-df3
- /security_monitoring/default_rules/azure-activity-log-alert-update-security-policy
disable_edit: true
...
title: User has 'Update Security Policy' activity log alert configured
type: security_rules
---
