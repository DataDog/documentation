...
aliases:
- l3r-4tc-7z1
- /security_monitoring/default_rules/l3r-4tc-7z1
- /security_monitoring/default_rules/azure-activity-log-alert-create-update-virtual-machines
disable_edit: true
...
title: User has 'Create or Update Virtual Machines' activity log alert configured
type: security_rules
---
