...
aliases:
- jl4-3l3-ix2
- /security_monitoring/default_rules/jl4-3l3-ix2
- /security_monitoring/default_rules/azure-activity-log-alert-create-update-storage-account
disable_edit: true
...
title: User has 'Create or Update Storage Accounts' activity log alert configured
type: security_rules
---
