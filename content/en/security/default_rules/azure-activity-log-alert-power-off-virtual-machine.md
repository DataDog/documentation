...
aliases:
- jf0-k3w-az5
- /security_monitoring/default_rules/jf0-k3w-az5
- /security_monitoring/default_rules/azure-activity-log-alert-power-off-virtual-machine
disable_edit: true
...
title: User has 'Power Off Virtual Machine' activity log alert configured
type: security_rules
---
