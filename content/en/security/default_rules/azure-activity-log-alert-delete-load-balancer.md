...
aliases:
- 0pp-84j-ty3
- /security_monitoring/default_rules/0pp-84j-ty3
- /security_monitoring/default_rules/azure-activity-log-alert-delete-load-balancer
disable_edit: true
...
title: User has 'Delete Load Balancer' activity log alert configured
type: security_rules
---
