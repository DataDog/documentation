...
Click the following buttons to filter the detection rules. Security detection rules are available for [App & API Protection][5], [Cloud SIEM][2] (log detection and signal correlation), [CSM Misconfigurations][3] (cloud and infrastructure), [CSM Threats][4], [CSM Identity Risks][6], and [Attack Paths][7].
