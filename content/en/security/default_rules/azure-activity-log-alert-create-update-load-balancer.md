...
aliases:
- 32p-5ty-6t0
- /security_monitoring/default_rules/32p-5ty-6t0
- /security_monitoring/default_rules/azure-activity-log-alert-create-update-load-balancer
disable_edit: true
...
title: User has 'Create or Update Load Balancer' activity log alert configured
type: security_rules
---
