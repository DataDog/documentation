...
1. Find the rule you want to copy one of the following ways:
   - Navigate to [**Security** > **Cloud Security Management** > **Compliance** > **Compliance Rules**][1]. Select a rule you want to copy to open its details page.
...
1. Navigate to [**Security** > **Cloud Security Management** > **Compliance** > **Compliance Rules**][1].
