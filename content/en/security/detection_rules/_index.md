...
To create a custom detection rule, click the {{< ui >}}New Rule{{< /ui >}} button in the upper-right corner of the Detection Rules page. You can also [clone an existing default or custom rule](#clone-a-rule) and use it as a template.
...
1. Click {{< ui >}}Select Rules{{< /ui >}}.
1. Select the rules you want to enable or disable.
1. Click the {{< ui >}}Bulk Actions{{< /ui >}} dropdown menu.
1. Select {{< ui >}}Enable Rules{{< /ui >}} or {{< ui >}}Disable Rules{{< /ui >}}.
...
To edit a rule, click the vertical three-dot menu for the rule and select {{< ui >}}Edit default rule{{< /ui >}} or {{< ui >}}Edit rule{{< /ui >}}, depending on the rule type.

### Clone a rule

To clone a rule, click the vertical three-dot menu for the rule and select {{< ui >}}Clone rule{{< /ui >}}.

Cloning a rule is helpful if you wish to duplicate an existing rule and lightly modify settings to cover other areas of detection. For example, you could duplicate a log detection rule and modify it from {{< ui >}}Threshold{{< /ui >}} to {{< ui >}}Anomaly{{< /ui >}} to add a new dimension to threat detection using the same queries and triggers.

### Delete a rule

To delete a rule, click the vertical three-dot menu for the rule and select {{< ui >}}Delete rule{{< /ui >}}.
...
1. In the rule editor, click {{< ui >}}Version History{{< /ui >}} to see past changes:
   ...
   - Click {{< ui >}}Open Version Comparison{{< /ui >}} to see what changed between versions, then select the two versions you want to compare. Click {{< ui >}}Unified{{< /ui >}} if you want to see the comparison in the same panel.
...
To view the security signals for a rule in the [Signals Explorer][1], click the vertical three-dot menu and select {{< ui >}}View generated signals{{< /ui >}}. This is useful when correlating signals across multiple sources by rule, or when completing an audit of rules.

### Export a rule

To export a copy of a rule, click the rule to open it in the side panel. Click {{< ui >}}Export{{< /ui >}}, then select either {{< ui >}}Export rule to JSON{{< /ui >}} or {{< ui >}}Export rule to Terraform{{< /ui >}}.
...
1. Click the {{< ui >}}Bulk Actions{{< /ui >}} dropdown menu.
1. Select either {{< ui >}}Export to JSON{{< /ui >}} or {{< ui >}}Export to Terraform{{< /ui >}}.
...
[14]: /security/workload_protection/detect_and_monitor/detection_rules#create-a-custom-detection-rule
