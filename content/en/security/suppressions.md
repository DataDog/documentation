...
1. Adsitionally, you can add a log exclusion query to exclude logs from being analyzed. These are based on **log attributes**. (**Note:** this field depicts the same behavior as legacy suppressions) 
