...
To configure the information redacted by ASM, refer to the [data security configuration][10]

## Threat detection methods

Datadog uses multiple pattern sources, including the [OWASP ModSecurity Core Rule Set][11] to detect known threats and vulnerabilities in HTTP requests. When an HTTP request matches one of [the OOTB detection rules][12], a security signal is generated in Datadog.
...
Datadog ASM includes over 100 attack signatures that help protect against [many different kinds of attacks][13], including, but not limited to, the following categories:
...
[10]: /security/application_security/threats/setup_and_configure/#data-security-considerations
[11]: https://owasp.org/www-project-modsecurity-core-rule-set/
[12]: /security/default_rules/#cat-application-security
[13]: https://app.datadoghq.com/security/appsec/event-rules
