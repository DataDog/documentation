...
See the Application Security [Getting Started][10] to validate you you are using the right version of the tracer. These minimum versions are required to start sending telemetry data that includes library information.
...
- Tracer [startup][8] or [debug][11] logs
...
[10]: /security/application_security/getting_started/
[11]: /tracing/troubleshooting/#tracer-debug-logs
