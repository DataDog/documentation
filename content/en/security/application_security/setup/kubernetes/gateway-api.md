...
<div class="alert alert-info">
  The AAP Gateway API integration is built on top of the Datadog Go Tracer. It follows the same release process as the SDK, and its Docker images are tagged with the corresponding tracer version.
</div>

The Gateway API integration uses the [Datadog Go Tracer][6] and inherits all environment variables from the SDK. You can find more information in [Configuring the Go SDK][7] and [AAP Library Configuration][8].
