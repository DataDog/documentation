...
1. **[API Endpoints][23]:** *What APIs exist, and what risk do they expose?*
...
1. **Discover:** Identify what endpoints exist using **[API Endpoints][23]**.
...
[23]: /security/application_security/api_posture/api_inventory/api_endpoints/
