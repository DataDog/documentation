...
1. **Update your Datadog Node.js library package** to at least version 3.10.0 (for NodeJS 14+) or 4.0.0 (for Node 16+) or 6.0.0 (for Node 18+), by running one of these commands:
   ```shell
