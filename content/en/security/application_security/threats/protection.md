...
- [Update your Datadog Agent][1] to at least version 7.41.1.
- [Enable ASM][2].
- [Enable Remote Configuration][3].
...
As In-App WAF rules are toggled between modes, the changes are reflected in near real-time for services with [Remote Configuration enabled][3]. For other services, you can update the policy on the [In-App WAF page][9] and then [define In-App WAF rules][10] for the change in behavior to be applied.
...
[3]: /agent/guide/how_remote_config_works/
