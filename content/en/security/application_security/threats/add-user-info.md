...
| `users.login.success`  | User ID is mandatory, optional metadata can be added | [Credential Stuffing attack][6][Bruteforce attack][12]<br>[Distributed Credential Stuffing][13]               |
