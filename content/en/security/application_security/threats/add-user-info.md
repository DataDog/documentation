...
<div class="alert alert-info">This documentation is for the Go Tracer v1.x. If you are looking for v2.x preview documentation, see the <a href="/security/application_security/threats/add-user-info">User Monitoring and Protection</a> documentation.</div>
