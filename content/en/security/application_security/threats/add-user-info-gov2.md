...
<div class="alert alert-info">[PREVIEW] This documentation is for v2.x preview of the Go Tracer. If you are looking for v1.x documentation, see the <a href="security/application_security/threats/add-user-info">User Monitoring and Protection</a> documentation.</div>
