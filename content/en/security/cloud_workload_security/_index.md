...
Use [Remote Configuration][7] to automatically deploy new and updated rules to the Agent. [Customize the rules][5] by defining how each rule monitors process and file activity, [create custom rules][6], and [set up real-time notifications for new signals](#set-up-real-time-notifications).
