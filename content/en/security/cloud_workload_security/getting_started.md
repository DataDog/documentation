...
[2]: /integrations/kubernetes_audit_logs/
{{% /tab %}}

{{% tab "Kubernetes (DaemonSet)" %}}
1. If you installed the Datadog Agent as a DaemonSet with a manual [manifest][1], then you can add the following lines to activate CWS module:
