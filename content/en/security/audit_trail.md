...
To view audit logs generated by actions taken in Datadog Security, navigate to [**Organization Settings** > **Compliance** > **Audit Trail**][2]. The following product-specific events are available for Datadog Security:
