...
To view audit logs generated by actions taken in Datadog Security, navigate to the [{{< ui >}}Audit Trail{{< /ui >}}][2] page in Datadog. The following product-specific events are available for Datadog Security:
