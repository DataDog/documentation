...
The [datadog-custom-rules-template][5] GitHub repository provides a Git-based workflow for managing custom rules. On every push to `main`, a GitHub Action automatically creates, updates, or deletes rulesets and rules to match what's on disk.
