---
aliases:
- /code_analysis/static_analysis_rules/java-code-style/avoid-dollar-signs
- /continuous_integration/static_analysis/rules/java-code-style/avoid-dollar-signs
- /static_analysis/rules/java-code-style/avoid-dollar-signs
dependencies: []
disable_edit: true
...
meta:
  ...
  severity: Notice
  severity_rank: 3
title: Avoid using dollar signs in variable names
---
