---
aliases:
- /code_analysis/static_analysis_rules/javascript-node-security/detected-jwt-token
- /continuous_integration/static_analysis/rules/javascript-node-security/detected-jwt-token
- /static_analysis/rules/javascript-node-security/detected-jwt-token
dependencies: []
disable_edit: true
