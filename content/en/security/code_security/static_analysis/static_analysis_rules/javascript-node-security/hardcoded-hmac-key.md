---
aliases:
- /code_analysis/static_analysis_rules/javascript-node-security/hardcoded-hmac-key
- /continuous_integration/static_analysis/rules/javascript-node-security/hardcoded-hmac-key
- /static_analysis/rules/javascript-node-security/hardcoded-hmac-key
dependencies: []
disable_edit: true
