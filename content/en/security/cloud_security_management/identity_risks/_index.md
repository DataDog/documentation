...
- Beside {{< ui >}}Group by{{< /ui >}}, group identity risks by {{< ui >}}Identity Risks{{< /ui >}}, {{< ui >}}Resources{{< /ui >}} or {{< ui >}}Teams{{< /ui >}} (or {{< ui >}}None{{< /ui >}} to view identity risks individually), so you can prioritize your remediation efforts accordingly.
...
- Select an identity risk to view up to five affected resources, or click {{< ui >}}View All{{< /ui >}} to view all of them. Select a resource to view additional details in a side panel.
...
For detailed insights and remediation help, click the {{< ui >}}Remediation{{< /ui >}} tab. In the following example, the {{< ui >}}Remediation{{< /ui >}} tab shows the usage of provisioned permissions.
...
In Misconfigurations, Identity Risks, and the Security Inbox, you can click the {{< ui >}}Access Insights{{< /ui >}} tab to see:
...
In the {{< ui >}}What can this resource access?{{< /ui >}} section, you can:
