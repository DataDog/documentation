...
{{< img src="security/csm/remediate_with_ai_coding_agent.png" alt="The Remediate with AI dialog on the Coding agent tab, showing Fix with Cursor and Copy fix prompt options" style="width:100%;" >}}
