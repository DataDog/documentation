...
Static Infrastructure as Code (IaC) scanning integrates with version control systems, such as GitHub, to detect misconfigurations in cloud resources defined by Terraform. The scanning results are displayed in two primary locations: within pull requests during code modifications and on the **Findings** page within Cloud Security Management.
...
{{< img src="security/csm/iac_scanning_explorer2.png" alt="CSM Findings page displaying detected misconfigurations in cloud resources" width="100%">}}
