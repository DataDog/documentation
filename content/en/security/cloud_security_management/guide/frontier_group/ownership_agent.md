...
| 2        | **Ownership preferences**      | Custom tag mappings and rules you define in a [reference table](/security/cloud_security_management/guide/frontier_group/ownership_preferences/). These act as organization-level overrides and are evaluated alongside direct tags. Learn more at [set up ownership preferences]([https://docs.datadoghq.com/security/cloud_security_management/guide/frontier_group/ownership_preferences/#create-an-ownership-preference-file](https://docs.datadoghq.com/security/cloud_security_management/guide/frontier_group/ownership_preferences/#create-an-ownership-preference-file)). |
