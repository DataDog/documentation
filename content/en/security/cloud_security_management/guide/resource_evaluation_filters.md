...
You can use resource tags to create filters that include or exclude resources from being evaluated by Workload Protection. The filters must be specified as a comma-separated list of `key:value` pairs.
...
1. On the [**Workload Protection Setup** page][1], click **Cloud accounts**.
