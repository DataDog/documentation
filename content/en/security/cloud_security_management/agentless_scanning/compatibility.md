...
## Application libraries and languages

The following application languages and package managers are supported for vulnerability scans on containers and Lambda instances:
