...
| query         | Yes      | This is the SQL to execute. It can be a simple statement or a multi-line script. All the rows of the result are going to be evaluated. Use the pipe if you require a multi-line script.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
