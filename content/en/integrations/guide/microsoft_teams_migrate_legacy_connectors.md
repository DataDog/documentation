...
description: "Steps to migrate from legacy Office 365 connectors to the Microsoft Teams integration."
further_reading:
...
3. For each legacy notification connector handle in the [Microsoft Teams Integration Tile][2]:
   ...
   3. Select the team and channel that the legacy connector handle was sending to, and click **Save**. This new handle overrides the existing legacy connector handle.
...
[3]: /integrations/microsoft-teams/#setup
