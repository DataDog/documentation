...
3. Make sure the Virtual machine is running.
    ...
    {{< img src="integrations/guide/azure_vms_appearing_in_the_app_without_metrics/azure_vm_running.png" alt="A graph of the azure.vm.count metric from status:running" >}}
