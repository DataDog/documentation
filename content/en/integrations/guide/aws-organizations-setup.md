...
4. Optionally disables metric collection for the AWS infrastructure. This is useful for Cloud Cost Management (CCM) or Cloud Security Misconfigurations (CSM Misconfigurations) specific use cases.
...
2. **Specify StackSet details**
    ...
    - *Optionally:*  
        a. Enable [Cloud Security Misconfigurations][5] (CSM Misconfigurations) to scan your cloud environment, hosts, and containers for misconfigurations and security risks.  
...
6. *(Optional)* **Integrate the AWS management account**

   The AWS management account does not automatically deploy after this StackSet setup, due to AWS's restrictions on [Service-managed permissions][10].
   Follow the steps in [Datadog-Amazon Cloudformation][9] to integrate the AWS management account.
...
[9]: https://docs.datadoghq.com/integrations/guide/amazon_cloudformation/
