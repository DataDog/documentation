...
{{< whatsnext desc="General guides:" >}}
    ...
    {{< nextlink href="integrations/guide/service-account-impersonation" tag=" google cloud" >}}Set up service account impersonation and automatic project discovery for Google Cloud{{< /nextlink >}}     
{{< /whatsnext >}}
