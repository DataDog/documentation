...
{{< whatsnext desc="General guides:" >}}
    ...
    {{< nextlink href="integrations/guide/application-monitoring-vmware-tanzu" tag=" VMWare Tanzu application monitoring" >}}Datadog Application Monitoring for VMware Tanzu{{< /nextlink >}} 
    {{< nextlink href="integrations/guide/cluster-monitoring-vmware-tanzu" tag=" VMWare Tanzu cluster monitoring" >}}Datadog Cluster Monitoring for VMware Tanzu{{< /nextlink >}} 
{{< /whatsnext >}}
