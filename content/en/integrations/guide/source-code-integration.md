...
Datadog's source code integration allows you to connect your telemetry with your Git repositories hosted in GitHub, GitLab, or Bitbucket. Once you have enabled the [source code integration][1], you can debug stack traces, slow profiles, and other issues by quickly accessing the relevant lines of your source code. 
...
If you have [APM][2] set up already, navigate to [**Integrations** > **Link Source Code**][1] and configure the source code integration for your backend services.
...
If you are a GitHub SaaS user, install Datadog's [GitHub integration][3] to directly inline code snippets from your GitHub repository in your stack traces in [Error Tracking][4]. When specifying permissions on the integration tile, enable Datadog read permissions to **Contents**.

1. Navigate to [**APM** > **Error Tracking**][5].
2. Click on an issue. The **Issue Details** panel appears on the right.
...
To install a GitHub App for your organization, you need to be an organization owner or have admin permissions in a repository. You can also install a GitHub App on your personal GitHub account. For more information, see [GitHub Apps & OAuth Apps][6].
...
[6]: https://docs.github.com/en/developers/apps/getting-started-with-apps/about-apps
