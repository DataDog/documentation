...
Ensure that you have [set][1] an `api_key` and `app_key` for the org that contains the new dashboard in the [`ddev` configuration][2].

Run the following command to [export the dashboard][3]:
...
1. Which widgets best represent your data? Try using a mix of widget types and sizes. Explore visualizations and formatting options until you're confident your dashboard is as clear as it can be. Sometimes a whole dashboard of timeseries is ok, but other times variety can improve things. The most commonly used metric widgets are [timeseries][11], [query values][12], and [tables][13]. For more information on the available widget types, see the [list of supported dashboard widgets][14].
...
1. Try to make the left and right halves of your dashboard symmetrical in high density mode. Users with large monitors will see your dashboard in high density mode by default, so it's important to make sure the group relationships make sense, and the dashboard looks good. You can adjust group heights to achieve this, and move groups between the left and right halves.
    ...
    a. _(perfectly symmetrical)_
       ![Symmetrical example 1][15]

    b. _(close enough)_
       ![Symmetrical example 2][16]

1. [Template variables][17] allow you to dynamically filter one or more widgets in a dashboard. Template variables must be universal and accessible by any user or account using the monitored service. Make sure all relevant graphs are listening to the relevant template variable filters.
...
[1]: ../ddev/cli.md#ddev-config-set
[2]: ../ddev/configuration.md#organization
[3]: ../ddev/cli.md#ddev-meta-dash-export
[4]: ../assets/images/example_full_length.png
[5]: http://app.datadoghq.com/internal/styleguide/logos/logo-gallery?variant=avatar
[6]: ../assets/images/logo_header.png
[7]: http://app.datadoghq.com/internal/styleguide/logos/logo-gallery
[8]: ../assets/images/about_and_overview_groups.png
[9]: ../assets/images/group_titles.png
[10]: ../assets/images/stream_widgets.png
[11]: https://docs.datadoghq.com/dashboards/widgets/timeseries/
[12]: https://docs.datadoghq.com/dashboards/widgets/query_value/
[13]: https://docs.datadoghq.com/dashboards/widgets/table/
[14]: https://docs.datadoghq.com/dashboards/widgets/
[15]: ../assets/images/symmetrical_example_1.png
[16]: ../assets/images/symmetrical_example_2.png
[17]: https://docs.datadoghq.com/dashboards/template_variables/
[18]: ../assets/images/name_repetition.png
[19]: ../assets/images/qa_widths.png
[20]: ../assets/images/header_color_usage.png
[21]: ../assets/images/use_legends.png
[22]: ../assets/images/x_axes_alignment.png
