...
20. Choose which AWS partition your AWS account is scoped to. The partition is either `aws` for commercial regions, `aws-cn` for China, and `aws-us-gov` for GovCloud. Refer to AWS documentation for more information on [AWS partitions][9].
