...
If you're using the US1, EU, or AP1 [Datadog site][1], you can optionally configure Amazon CloudWatch Metric Streams and Amazon Kinesis Data Firehose to get CloudWatch metrics into Datadog faster with a 2-3 minute latency. Visit our [documentation on metric streaming][2] to learn more about this approach.
