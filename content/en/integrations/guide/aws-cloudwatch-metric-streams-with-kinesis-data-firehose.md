...
7. Under **Add additional statistics**, include the AWS percentile metrics to send to Datadog. See the [CloudFormation template][4] for a list of the percentile metrics Datadog supports through polling.
