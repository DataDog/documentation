...
kind: integration
description: ''
short_description: 'Apache APISIX recently released a new plugin: APISIX-Datadog, to provide a deeper integration with Datadog.'
dependencies:
    ['https://github.com/DataDog/documentation/blob/master/content/en/integrations/apisix.md']
categories:
    - log collection
doc_link: /integrations/apisix/
aliases:
    - logs/log_collection/apisix
has_logo: true
integration_title: Apache APISIX
is_public: true
public_title: Datadog-Apache APISIX
further_reading:
    - link: 'logs/'
      tag: 'Documentation'
      text: 'Log Management'
integration_id: "apisix"
---
{{< img src="integrations/apisix/apisix-datadog-cover.png" alt="Apache APISIX recently released a new plugin: APISIX-Datadog, to provide a deeper integration with Datadog." popup="true">}}
...
To learn more about how to install a full-fledged datadog agent, visit [here][2].
...
## Activate APISIX-Datadog plugin
...
## Deactivate APISIX-Datadog plugin
