...
2. Enable process collection and the system probe with the following environment variables in the Agent container if all agents are running in a single container:
