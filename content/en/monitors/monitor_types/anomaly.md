...
* the bounds for the last `15 minutes`, `1 hour`, ... or `custom` to set a value between 15 minutes and 24h
* Recover if the values are within the bounds for at least `15 minutes`, `1 hour`, ... or `custom` to set a value between 15 minutes and 24h
