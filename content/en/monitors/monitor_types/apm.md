...
* over the last `5 minutes`, `15 minutes`, `1 hour`, ... or `custom` to set a value between 1 minute and 48h
...
* the prediction during the past `5 minutes`, `15 minutes`, `1 hour`, ... or `custom` to set a value between 1 minute and 48h
...
* the threshold during the last `5 minutes`, `15 minutes`, `1 hour`, ... or `custom` to set a value between 5 minutes and 24h
* Alert threshold: `<NUMBER>`
* Warning threshold: `<NUMBER>`
