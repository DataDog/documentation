...
You can [mute][3] or [resolve][4] triggered monitors in bulk using the [Triggered Monitors][6] page. This page only shows monitors with a triggered status (Alert, Warn, or No Data).
...
Monitor tags are independent of tags sent by the Agent or integrations. Add up to 32 tags directly to your monitors for filtering on the [manage monitors][1], [triggered monitors][6], or [manage downtime][7] pages. Learn more about monitor tags in [Assigning Tags for the UI][8].

**Note**: Monitor tags are added to the alert event generated by the monitor, up to 25 tags in total on the alert event.
