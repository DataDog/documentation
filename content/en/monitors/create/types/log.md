...
{{< alert type="info" >}}<strong>Note</strong>: There is a default limit of 1000 Log monitors per account. <a href="/help/">Contact Support</a> to lift this limit for your account.{{< /alert >}}
