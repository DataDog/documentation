...
{{< alert type="info" >}}<strong>Note</strong>: There is a default limit of 1000 RUM monitors per account. <a href="/help/">Contact Support</a> to lift this limit for your account.{{< /alert >}}
