...
This option works in a binary fashion. You either get notified for data being missing, or not. The notification occurs when no data was received during a configured time window.
