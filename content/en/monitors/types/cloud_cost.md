...
Cloud Cost monitors use a 48-hour delayed evaluation window, since cost data may not be available until 48 hours after usage, and an evaluation frequency of 30 minutes. For example, a 7-day lookback evaluated on January 15 examines cost data from January 6 to January 13.
