...
**Note:** There must always be exactly one Incident Commander at all times during an incident. If there is only one responder in an incident, that individual will be assigned the Incident Commander role automatically. There can only be at most one Communications Lead in an incident. There is no limit to the number of Responders in an incident.

If you add another individual as a responder, they will be notified through the email they have associated with their Datadog account. Anyone is able to change the role of a responder, but you can only remove an individual from an incident's Responders List if you were the one who originally added them. If there is already an Incident Commander or Communications Lead assigned to an incident, assigning the Incident Commander or Communications Lead roles to other individuals will transfer the roles over to the new individuals. The previous Incident Commander or Communications Lead will revert back to the Responder role.
