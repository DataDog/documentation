...
- **`on_missing_data`** a string declaring the behavior for the monitor when data stops reporting. Default: **defaul**. Other options: **show_no_data**, **show_and_notify_no_data**, **resolve**
