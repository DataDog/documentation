...
Datadog keeps monitor groups available in the UI for 24 hours (48h for service check and host monitors) unless the query is changed. If you do not have *No Data* alert settings enabled and your group for a metric monitor stops reporting data, it will persist on the monitor status page until it ages out, though that group will stop being evaluated after a short absence (specific timing depends on your settings).
