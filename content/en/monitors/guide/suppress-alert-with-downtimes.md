...
Since this guide describes the usage of the API, you need an API key and an application key with admin privileges. These are available in your [Datadog account API key page][2].
