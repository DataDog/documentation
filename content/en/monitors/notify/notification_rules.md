...
1. Click **New Rule**.
1. Add specific tags and values to set the scope for the rule. Notification rules use an AND logic for multiple tags. Both monitor tags and group tags are considered for the matching. For an example of this, see [Routing logic](#routing-logic).
...
- Tags can be either from monitor tags or from the monitor groups
