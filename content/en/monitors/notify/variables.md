...
**Example**: If your monitor message includes a URL to the APM services page filtered to a specific service, use the `service` [tag variable](#attribute-and-tag-variables) and add `{{ urlencode "<variable>"}}` syntax in the URL:
