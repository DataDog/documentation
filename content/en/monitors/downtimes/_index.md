...
To override the default behavior, specify which notifications should be sent at the end of downtimes with the options in the "Notify Your Team" section. For downtimes created via API, the the default behaviour is to exclude is_cancelled option.
