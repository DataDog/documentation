...
Add those parameters at the beginning of the global init script.
...
1. At the bottom of the page, go to the **Spark** tab.
   ...
   In the **Environment variables** textbox, provide the values for the init script parameters. For example, if your Datadog site is {{< region-param key="dd_site" code="true" >}}, paste the following into the box:
   ...
   You can also use Databricks [secret management][4] to store your API key.
