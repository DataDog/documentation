...
1. On the [Experiments][2] page, select your experiment to open its detail page. Hover over the Feature flag label (for example, `new-product-photos`) next to the Status label.
