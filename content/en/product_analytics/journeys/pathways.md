...
{{< img src="/product_analytics/pathways/pathways-overview.png" alt="The default Pathways diagram for an app" style="width:90%;" >}}
...
The example below displays the four steps that users in the United States take after visiting `/dashboards/lists`:

{{< img src="/product_analytics/pathways/customized-pathways.png" alt="A customized Pathways diagram for an app" style="width:90%;" >}}
...
{{< img src="/product_analytics/pathways/wildcard-pathways.png" alt="A Pathways diagram that uses a wildcard to match several routes" style="width:90%;" >}}
...
{{< img src="/product_analytics/pathways/pathways-node-interaction.png" alt="The actions menu of a Pathways diagram node" style="width:90%;" >}}
...
{{< img src="/product_analytics/pathways/pathways-funnel-conversion.png" alt="A Pathway to funnel conversion in process" style="width:90%;" >}}
