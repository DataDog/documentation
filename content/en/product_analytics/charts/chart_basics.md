...
Charts are the primary way to analyze and share insights in Product Analytics. This page introduces the core charting capabilities available across Product Analytics, including:
...
## Share a chart
To add the chart to a dashboard or a notebook, click on **+ Add To** in the upper-right hand corner of the chart. Then, select whether to add it to an existing dashboard or notebook, or to a new one. 
...
{{< img src="product_analytics/chart_basics/pana_chart_basics_templates2.png" alt="New Funnel Chart UI showing the pencil icon for editing the chart name and the save button to save the chart." style="width:80%;" >}}
