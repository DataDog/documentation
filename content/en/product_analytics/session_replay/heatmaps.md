...
You can save the current heatmap state as a screenshot so it's reused the next time anyone in your organization opens that heatmap. To save the current screenshot auto-picked from a recent replay, click **Save** on the current screenshot.
   ...
   {{< img src="real_user_monitoring/session_replay/heatmaps/heatmaps-save-screenshot.png" alt="Click save to save the auto-picked screenshot." style="width:100%;">}}
...
To remove the currently pinned screenshot and revert to an auto-picked one from a recent replay, click **Unpin** on the current screenshot.
