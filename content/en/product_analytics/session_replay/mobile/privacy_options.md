...
<div id="cdoc-selector"><div id="cdoc-filters-menu"><div class="filter-selector-menu" id="cdoc-filters-pill-menu"><div class="cdoc-pills-container"><p 
  ...
  ></a>
  <div class="cdoc__toggleable" data-if="13">
    <div class="code-snippet-wrapper">
      <div
        class="code-filename-wrapper d-flex justify-content-between collapsible"
      >
  ...
  <div class="cdoc__toggleable" data-if="20">
    <p>
  ...
  <div class="cdoc__toggleable" data-if="25">
    <div class="code-snippet-wrapper">
      <div
        class="code-filename-wrapper d-flex justify-content-between collapsible"
      >
  ...
  <div class="cdoc__toggleable" data-if="28">
    <div class="code-snippet-wrapper">
      <div
        class="code-filename-wrapper d-flex justify-content-between collapsible"
      >
  ...
  <div class="cdoc__toggleable" data-if="32">
    <div class="code-snippet-wrapper">
      <div
        class="code-filename-wrapper d-flex justify-content-between collapsible"
      >
  ...
  <div class="cdoc__toggleable" data-if="51">
  ...
  <div class="cdoc__toggleable" data-if="53">
  ...
  <div class="cdoc__toggleable" data-if="57">
    <ul>
      <li>
        User-entered text in:
        <ul>
  ...
  <div class="cdoc__toggleable" data-if="61">
    <ul>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="63">
    <ul>
      <li>Checkbox and Radio Button titles</li>
      <li>Month, day and year labels in the date and time picker</li>
      <li>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="64">
    <ul>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="67">
    <ul>
  ...
  <p>This includes:</p>
  <div class="cdoc__toggleable cdoc__hidden" data-if="68">
  ...
  <div class="cdoc__toggleable" data-if="69">
    <p><strong>Shapes</strong></p>
    <ul>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="70">
    <p><strong>Shapes</strong></p>
    <table>
      <thead>
        <tr>
  ...
  <table>
    <thead>
      <tr>
        ...
        <th>Mask None</th>
        <th>
          <div class="cdoc__toggleable" data-if="72">Mask Large Only</div>
          <div class="cdoc__toggleable cdoc__hidden" data-if="73">
