...
<div id="cdoc-selector"><div id="cdoc-filters-menu"><div class="filter-selector-menu" id="cdoc-filters-pill-menu"><div class="cdoc-pills-container"><p 
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="75">
    <p>
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="80">
    <p>
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="90">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="95">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
