...
- Product Analytics uses the complete, unsampled data captured by the SDK. When paired with RUM without Limits, Product Analytics offers full visibility into user behavior, while RUM applies client-side sampling to support faster issue investigation and reduce noise.
