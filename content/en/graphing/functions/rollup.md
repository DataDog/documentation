...
Appending the `.rollup()` function at the end of a query allows you to perform custom [time aggregation][1]. This function enables you to define the time intervals for your graph and how data points are aggregated within a given time interval.
