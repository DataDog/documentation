...
| The Datadog user does not have sufficient access to view queries by other users. | Run the following query from the superuser to allow the Datadog user to view all rows in pg_stat_activity: `GRANT pg_read_all_stats TO datadog` |
