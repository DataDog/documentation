...
|----------|---------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Go       | [pgx][10]                  | Set `PreferSimpleProtocol` to switch to the simple query protocol on the [ConnConfig][11] or using the [QuerySimpleProtocol][24] flag as the first argument on `Query` or `Exec` calls.                                                                                                                                              |
