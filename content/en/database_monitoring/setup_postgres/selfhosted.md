...
Database Monitoring runs as an integration on top of the base Agent ([see benchmarks][2]). <br/><br/>
...
[2]: /database_monitoring/setup_postgres/#agent-integration-overhead
