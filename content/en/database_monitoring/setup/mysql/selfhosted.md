...
Additionally, create this procedure **in every schema** from which you want to collect explain plans. Replace the `<YOUR_SCHEMA>` with your database schema:
...
[8]: h/agent/guide/agent-commands/#start-stop-and-restart-the-agent
