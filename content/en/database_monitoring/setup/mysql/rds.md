...
To monitor RDS hosts, the Agent should be installed somewhere in your infrastructure and configured to connect to the RDS instance endpoint remotely.

Installing the Datadog Agent also installs the MySQL check which is required for Database Monitoring on MySQL. If you haven't already installed the Agent to run checks, see the [Agent installation instructions][5].
