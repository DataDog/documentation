...
| The query has been executed only once since the agent last restarted. | At this time, query metrics are only emitted after having been executed at least twice over a period of 10 seconds or more. |  
...
| The query has been executed a single time since the agent last restarted. | At this time, query metrics are only emitted after having been executed at least twice over a period of 10 seconds or more. | 
