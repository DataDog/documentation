...
| The query has been executed only once since the agent last restarted. | At this time, query metrics are only emitted after having been executed at least once over two separate 10 second intervals since the agent was restarted. |
...
| The query has been executed a single time since the agent last restarted. | At this time, query metrics are only emitted after having been executed at least once over two separate 10 second intervals since the agent was restarted. |
