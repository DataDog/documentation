...
The following deployment configurations are supported: self-managed, RDS, single-node, multi-tenant. Note these do not include RAC and Exadata or legacy architectures.
