...
Azure allows users to configure managed identity authentication for any resource that can access [Microsoft Entra ID][15]. The Datadog Agent supports both [user and system assigned][10] managed identity authentication to your cloud databases.
