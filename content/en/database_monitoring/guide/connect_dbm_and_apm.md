...
|                                          | [database/sql][4]    | {{< X >}} | {{< X >}} |
|                                          | [sqlx][5]            | {{< X >}} | {{< X >}} |
| **Java** [dd-trace-java][6] >= 1.11.0   |                      |           |           |
|                                          | [jdbc][7]           | {{< X >}} | {{< X >}} |
| **Ruby:** [dd-trace-rb][8] >= 1.8.0      |                      |           |           |
|                                          | [pg][9]              | {{< X >}} |           |
|                                          | [mysql2][10]          |           | {{< X >}} |
| **Python:** [dd-trace-py][11] >= 1.9.0   |                      |           |           |
|                                          | [psycopg2][12]       | {{< X >}} |           |
| **.NET** [dd-trace-dotnet][13] >= 2.26.0 ||                      |           |
|                                          | [Npgsql][14]         | {{< X >}} |           |
|                                          | [MySql.Data][15]     |           | {{< X >}} |
|                                          | [MySqlConnector][16] |           | {{< X >}} |
...
[8]: https://github.com/dataDog/dd-trace-rb
[9]: https://github.com/ged/ruby-pg
[10]: https://github.com/brianmario/mysql2
[11]: https://github.com/DataDog/dd-trace-py
[12]: https://www.psycopg.org/docs/index.html
[13]: https://github.com/DataDog/dd-trace-dotnet
[14]: https://www.nuget.org/packages/npgsql
[15]: https://www.nuget.org/packages/MySql.Data
[16]: https://www.nuget.org/packages/MySqlConnector
[17]: https://github.com/DataDog/dd-trace-php
[18]: https://www.php.net/manual/en/book.pdo.php
[19]: https://www.php.net/manual/en/book.mysqli.php
[20]: https://github.com/DataDog/dd-trace-js
[21]: https://node-postgres.com/
