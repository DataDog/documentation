...
<div class="alert alert-warning">Enabling prepared statements tracing may cause increased connection pinning when using AWS RDS Proxy, which reduces connection pooling efficiency. For more information, see <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-proxy-pinning.html">Avoiding pinning an RDS Proxy</a>.</div>
