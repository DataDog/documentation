...
Use Observability Pipelines' processors to parse, structure, and enrich your logs and metrics (in Preview). When you create a pipeline in the UI, pre-selected processors are added to your processor group based on the selected template. You can add additional processors and delete any existing ones based on your processing needs.
