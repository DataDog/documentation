...
After you select the HTTP Server source in the pipeline UI:

1. Enter the identifier for your HTTP Server address. If you leave it blank, the [default](#secret-defaults) is used.
...
1. Select your authorization strategy. If you selected **Plain**:
    - Enter the identifiers for your HTTP Server username and password. If you leave it blank, the [default](#secret-defaults) is used.
