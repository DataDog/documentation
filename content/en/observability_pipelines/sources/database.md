...
1. Navigate to Log Explorer and check the value found in the latest Worker log to see what the Worker tracked.
1. Check the log in your preferred destination to see what the latest value was actually defined as.
