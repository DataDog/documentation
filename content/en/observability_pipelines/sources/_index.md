...
Select and set up your source when you build a pipeline in the UI. The general steps for setting up a pipeline are:
...
{{< whatsnext desc="These are the available Observability Pipelines sources:" >}}
