...
You can also [send Azure Event Hub logs to Observability Pipelines using the Kafka source](#send-azure-event-hub-logs-to-observability-pipelines-using-the-kafka-source).
