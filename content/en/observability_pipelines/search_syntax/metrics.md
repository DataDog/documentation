...
When you add a processor to a pipeline, you can filter metrics ({{< tooltip text="Preview" glossary="preview" case="title" >}}) to only process a defined subset. This document goes over the following information:
