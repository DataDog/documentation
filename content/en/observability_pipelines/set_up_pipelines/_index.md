...
<div class="alert alert-info">The pipelines and processors outlined in this documentation are specific to on-premises logging environments. To aggregate, process, and route cloud-based logs, see <a href="/logs/log_configuration/pipelines/?tab=source">Log Management Pipelines.</a></div>
