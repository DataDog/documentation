---
title: Generate Metrics for Google Pub/Sub
disable_toc: false
---

## Overview

Send Google Pub/Sub logs to the Observability Pipelines Worker so that you can generate metrics from those logs.
