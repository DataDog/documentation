---
title: Generate Metrics for the Datadog Agent
disable_toc: false
---

## Overview

Configure the Datadog Agent to send logs to the Observability Pipelines Worker so that you can generate metrics from those logs.
...
1. Enter the Datadog Agent address. The Observability Pipelines Worker listens to this address and port, for example `0.0.0.0:<port_number>`, for incoming logs from the Datadog Agent.
