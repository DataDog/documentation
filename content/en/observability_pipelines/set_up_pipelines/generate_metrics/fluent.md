---
title: Generate Metrics for Fluent
disable_toc: false
---

## Overview

Configure Fluentd or Fluent Bit to send logs to the Observability Pipelines Worker so that you can generate metrics from those logs.
