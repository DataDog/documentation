---
title: Generate Metrics for HTTP Client
disable_toc: false
---
...
1. Enter the full path of the HTTP/S endpoint URL, such as `https://127.0.0.8/logs`. The Observability Pipelines Worker collects logs events from this endpoint.
