---
title: Generate Metrics for the Splunk HTTP Event Collector (HEC)
disable_toc: false
---

## Overview

Configure your Splunk HTTP Event Collectors (HEC) to send logs to the Observability Pipelines Worker so that you can generate metrics from those logs.
