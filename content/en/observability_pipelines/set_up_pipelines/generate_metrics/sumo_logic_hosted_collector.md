---
title: Generate Metrics for the Sumo Logic Hosted Collector HTTP Logs Source
disable_toc: false
---

## Overview

Configure your Sumo Logic Hosted Collector HTTP Logs source to send logs to the Observability Pipelines Worker so that you can generate metrics from those logs.
