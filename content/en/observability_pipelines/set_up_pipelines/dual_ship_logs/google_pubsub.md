---
title: Dual Ship Logs for Google Pub/Sub
disable_toc: false
---

## Overview

Configure Google Pub/Sub and set up Observability Pipelines so that the Observability Pipelines Worker aggregates and processes the logs coming from your upstream sources before routing them to various applications.
...
1. [Sending logs to the Observability Pipelines Worker](#send-logs-to-the-observability-pipelines-worker-over-google_pubsub)
