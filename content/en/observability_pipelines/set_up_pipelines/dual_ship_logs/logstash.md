---
title: Dual Ship Logs for Logstash
disable_toc: false
---

## Overview

Configure Logstash and set up Observability Pipelines so that the Observability Pipelines Worker aggregates and processes the logs coming from your upstream sources before routing them to various applications.
