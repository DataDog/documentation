---
title: Split Logs for Google Pub/Sub
disable_toc: false
---

## Overview

Configure Google Pub/Sub to send logs to the Observability Pipelines Worker and then process and route them to different destinations based on your use case.
