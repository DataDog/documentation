---
title: Split Logs for Logstash
disable_toc: false
---

## Overview

Configure Logstash to send logs to the Observability Pipelines Worker and then process and route them to different destinations based on your use case.
