---
title: Log Enrichment for Google Pub/Sub
disable_toc: false
---

## Overview

Configure your Google Pub/Sub to send logs to the Observability Pipelines Worker and enrich and transform your logs before routing them to their destination.
