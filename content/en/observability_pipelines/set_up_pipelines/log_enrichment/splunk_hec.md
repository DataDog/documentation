...
disable_toc: false
aliases:
    - /observability_pipelines/log_enrichment/splunk_hec/
---

## Overview

Configure your Splunk HTTP Event Collectors (HEC) to send logs to the Observability Pipelines Worker and enrich and transform your logs before routing them to their destination.
