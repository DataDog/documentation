---
title: Log Volume Control for Logstash
disable_toc: false
---

## Overview

Set up the Observability Pipelines Worker with the Logstash source so that you only route useful logs to your destinations.
