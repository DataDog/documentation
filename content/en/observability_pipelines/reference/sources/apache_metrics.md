...
# Configuration
<table><thead><tr><td>Param</td><td>Description</td></tr></thead><tbody><tr><td>endpoints</td><td>The list of `mod_status` endpoints to scrape metrics from.</td></tr><tr><td>namespace</td><td>The namespace of the metric.

Disabled if empty.</td></tr><tr><td>proxy</td><td>Proxy configuration.
...
[cidr]: https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing</td></tr><tr><td>scrape_interval_secs</td><td>The interval between scrapes.</td></tr><tr><td>type</td><td>The component type. This is a required field for all components and tells Vector which component to use.</td></tr></tbody></table>
...
[`component_sent_events_total`](/docs/reference/configuration/sources/internal_metrics/#component_sent_events_total) metrics.</td></tr><tr><td>requests_completed_total</td><td>The total number of requests completed by this component.</td></tr><tr><td>events_out_total</td><td>The total number of events emitted by this component.
This metric is deprecated and will be removed in a future version.
...
## Context
By default, the `apache_metrics` source augments events with helpful
context keys.
