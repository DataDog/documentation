...
Can be applied only to FIFO queues.</td></tr><tr><td>queue_url</td><td>The URL of the Amazon SQS queue to which messages are sent.</td></tr><tr><td>region</td><td>The [AWS region][aws_region] of the target service.
