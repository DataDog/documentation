...
[api_key]: https://docs.datadoghq.com/api/?lang=bash#authentication</td></tr><tr><td>endpoint</td><td>The endpoint to send observability data to.

The endpoint must contain an HTTP scheme, and may specify a
hostname or IP address and port.

If set, overrides the `site` option.</td></tr><tr><td>request</td><td>Middleware settings for outbound requests.
...
# Telemetry
<table></tbody><tr><td>component_discarded_events_total</td><td>The number of events dropped by this component.</td></tr><tr><td>component_errors_total</td><td>The total number of errors encountered by this component.</td></tr><tr><td>component_sent_events_total</td><td>The total number of events emitted by this component.</td></tr><tr><td>component_received_events_count</td><td>A histogram of the number of events passed in each internal batch in Vector's internal topology.
