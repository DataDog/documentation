...
[global_acks]: https://vector.dev/docs/reference/configuration/global-options/#acknowledgements</td></tr><tr><td>default_api_key</td><td>The default Datadog [API key][api_key] to use in authentication of HTTP requests.
...
If set, overrides the `site` option.</td></tr><tr><td>region</td><td>The Datadog region to send events to.</td></tr><tr><td>request</td><td>Middleware settings for outbound requests.
