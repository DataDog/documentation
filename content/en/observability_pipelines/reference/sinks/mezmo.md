...
[global_acks]: https://vector.dev/docs/reference/configuration/global-options/#acknowledgements</td></tr><tr><td>api_key</td><td>The Ingestion API key.</td></tr><tr><td>batch</td><td>Event batching behavior.</td></tr><tr><td>batch.max_bytes</td><td>The maximum size of a batch that will be processed by a sink.

This is based on the uncompressed size of the batched events, before they are
serialized / compressed.</td></tr><tr><td>batch.max_events</td><td>The maximum size of a batch before it is flushed.</td></tr><tr><td>batch.timeout_secs</td><td>The maximum age of a batch before it is flushed.</td></tr><tr><td>default_app</td><td>The default app that will be set for events that do not contain a `file` or `app` field.</td></tr><tr><td>default_env</td><td>The default environment that will be set for events that do not contain an `env` field.</td></tr><tr><td>encoding</td><td>Transformations to prepare an event for serialization.</td></tr><tr><td>encoding.except_fields</td><td>List of fields that will be excluded from the encoded event.</td></tr><tr><td>encoding.only_fields</td><td>List of fields that will be included in the encoded event.</td></tr><tr><td>encoding.timestamp_format</td><td>Format used for timestamp fields.</td></tr><tr><td>endpoint</td><td>The HTTP endpoint to send logs to.

Both IP address and hostname are accepted formats.</td></tr><tr><td>hostname</td><td>The hostname that will be attached to each batch of events.</td></tr><tr><td>ip</td><td>The IP address that will be attached to each batch of events.</td></tr><tr><td>mac</td><td>The MAC address that will be attached to each batch of events.</td></tr><tr><td>request</td><td>Middleware settings for outbound requests.
...
[cidr]: https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing</td></tr><tr><td>tags</td><td>The tags that will be attached to each batch of events.</td></tr><tr><td>healthcheck</td><td>Healthcheck configuration.</td></tr><tr><td>healthcheck.enabled</td><td>Whether or not to check the health of the sink when Vector starts up.</td></tr><tr><td>type</td><td>The component type. This is a required field for all components and tells Vector which component to use.</td></tr></tbody></table>
