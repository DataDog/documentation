...
All compression algorithms use the default compression level unless otherwise specified.</td></tr><tr><td>endpoint</td><td>The base URL of the Humio instance.
...
[global_host_key]: https://vector.dev/docs/reference/configuration/global-options/#log_schema.host_key</td></tr><tr><td>host_tag</td><td>Name of the tag in the metric to use for the source host.
...
[global_log_schema_host_key]: https://vector.dev/docs/reference/configuration//global-options#log_schema.host_key</td></tr><tr><td>index</td><td>Optional name of the repository to ingest into.
...
[humio_data_format]: https://docs.humio.com/integrations/data-shippers/hec/#format-of-data</td></tr><tr><td>metric_tag_values</td><td>Controls how metric tag values are encoded.
...
[vector_native_json]: https://github.com/vectordotdev/vector/blob/master/lib/codecs/tests/data/native_encoding/schema.cue</td></tr><tr><td>request</td><td>Middleware settings for outbound requests.
...
Typically the filename the metrics originated from. Maps to `@source` in Humio.</td></tr><tr><td>timezone</td><td>The name of the timezone to apply to timestamp conversions that do not contain an explicit
time zone.
...
[tz_database]: https://en.wikipedia.org/wiki/List_of_tz_database_time_zones</td></tr><tr><td>tls</td><td>TLS configuration.</td></tr><tr><td>tls.alpn_protocols</td><td>Sets the list of supported ALPN protocols.
