...
The following is a list of bootstrap options, their related pipeline environment variables, and whether the bootstrap option or the environment variable has a higher precedence (priority).
