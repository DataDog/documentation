...
Observability Pipelines lets you collect, process, and route logs and metrics (in Preview) within your own infrastructure. A pipeline consists of three core components:

- [Source][1]: Receives data from a tool like the Datadog Agent.
- [Processors][2]: Transform, enrich, or filter data.
- [Destinations][3]: Where data are sent (for example, Datadog, Amazon S3, Splunk, Google Security Operations, and Microsoft Sentinel).
