...
- More than 100 new out-of-the-box rules for the Sensitive Data Scanner processor. These rules redact Personally Identifiable Information (PII) and access key information that focus on GDPR compliance and secrets.
- New [Live Capture][1] configurations that lets you:
