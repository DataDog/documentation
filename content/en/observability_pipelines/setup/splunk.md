...
{{% /tab %}}
{{% tab "Terraform (AWS)" %}}
An NLB is provisioned for you by the Terraform module, and provisioned to point at the instances. Its DNS address is returned to you in the `lb-dns` output in Terraform.
{{% /tab %}}
{{< /tabs >}}
