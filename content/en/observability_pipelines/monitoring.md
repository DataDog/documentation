...
- Enabling [out-of-the-box monitors](#out-of-the-box-monitors) that alerts you if:
    - An Observability Pipelines Worker has high CPU usage, high memory usage, or is dropping data.
    - A component is emitting errors.
    - A defined quota has been reached.
- Creating your own dashboards, notebooks, and monitors with the available [metrics](#metrics).
...
1. Click the **Health** tab to see graphs of:
    - How much each component is being utilized and the total number of events in and out of the component.
...
These metrics are available to track your Observability Pipelines Workers' resource utilization and the amount of data sent through.

To view graphs of these metrics for your Workers:
...
1. Click the export icon for a graph if you want to export it to an [incident][2], [dashboard][3], or [notebook][4].
