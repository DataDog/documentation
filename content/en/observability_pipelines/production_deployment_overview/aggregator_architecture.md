...
Use the Observability Pipelines Worker aggregator for processing most of your data, so that the responsibility is shifted away from your agents. This reduces your dependence on them, making it easier to change agents later on. See [Working with Data][1] for more information on data processing.
...
[1]: /observability_pipelines/working_with_data/
