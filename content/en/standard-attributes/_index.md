...
attributes:
  ...
  - name: network.client.ip
    ...
    product_source: <i class="icon-log" style="font-size:18px;color:#7c3eb9;vertical-align:middle"></i>
    type: string
  ...
  - name: usr.id
    ...
    product_source: <i class="icon-log" style="font-size:18px;color:#7c3eb9;vertical-align:middle"></i> <i class="icon-rum" style="font-size:18px;color:#7c3eb9;vertical-align:middle"></i>
    type: string
    domain: User
  - name: usr.name
  ...
  - name: type
    ...
    product_source: <i class="icon-rum" style="font-size:18px;color:#7c3eb9;vertical-align:middle"></i>
    type: string
    domain: Core RUM
  - name: application.id
  ...
  - name: date
    ...
    product_source: <i class="icon-rum" style="font-size:18px;color:#7c3eb9;vertical-align:middle"></i> {{< img src="/integrations_logos/android-logo.png" alt="Android" style="width:100%;" >}}
    type: integer
    domain: Core
