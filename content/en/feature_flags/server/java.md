...
The examples above pin `dd-openfeature:1.63.0` and the OpenFeature SDK `1.20.1`. See the [Compatibility requirements](#compatibility-requirements) section for the minimum supported versions.
