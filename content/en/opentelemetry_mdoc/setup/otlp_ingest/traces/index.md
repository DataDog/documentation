...
sourceUrl: https://docs.datadoghq.com/opentelemetry/setup/otlp_ingest/traces/index.html
---
...
- The API key belongs to an organization that is not allowed to access the Datadog OTLP traces intake endpoint. **Solution**: To request access, contact your account representative.
