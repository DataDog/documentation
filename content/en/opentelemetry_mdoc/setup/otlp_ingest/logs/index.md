...
sourceUrl: https://docs.datadoghq.com/opentelemetry/setup/otlp_ingest/logs/index.html
---
...
{% alert level="info" %}
Based on your [Datadog site](https://docs.datadoghq.com/getting_started/site/), which is : Replace `${YOUR_ENDPOINT}` with  in the following examples.
{% /alert %}
