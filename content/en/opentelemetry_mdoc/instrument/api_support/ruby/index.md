...
sourceUrl: >-
  https://docs.datadoghq.com/opentelemetry/instrument/api_support/ruby/index.html
---
...
| ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [OpenTelemetry Context propagation](https://opentelemetry.io/docs/instrumentation/ruby/manual/#context-propagation) | [Datadog and W3C Trace Context header formats](https://docs.datadoghq.com/tracing/trace_collection/trace_context_propagation/) are enabled by default.                                           |
...
| `OpenTelemetry.logger`                                                                                              | `OpenTelemetry.logger` is set to the same object as `Datadog.logger`. Configure through [custom logging](https://docs.datadoghq.com/tracing/trace_collection/dd_libraries/ruby/#custom-logging). |
| Trace/span [ID generators](https://opentelemetry.io/docs/reference/specification/trace/sdk/#id-generators)          | ID generation is performed by the tracing library, with support for [128-bit trace IDs](https://docs.datadoghq.com/opentelemetry/guide/otel_api_tracing_interoperability/).                      |
...
Using this block you can:
   ...
   - [Add additional Datadog configuration settings](https://docs.datadoghq.com/tracing/trace_collection/dd_libraries/ruby/#additional-configuration)
   - [Activate or reconfigure Datadog instrumentation](https://docs.datadoghq.com/tracing/trace_collection/dd_libraries/ruby#integration-instrumentation)
