...
sourceUrl: https://docs.datadoghq.com/opentelemetry/instrument/index.html
---
...
{% alert level="info" %}
If you instrument your applications fully with OTel, some Datadog features are not supported. For more information, see the [Feature Compatibility](https://docs.datadoghq.com/opentelemetry/compatibility/) table.
{% /alert %}
...
- [Use the Datadog SDK with OpenTelemetry API](https://docs.datadoghq.com/opentelemetry/instrument/api_support)
- [Configure the Datadog SDK with OpenTelemetry SDK environment variables](https://docs.datadoghq.com/opentelemetry/config/environment_variable_support/)
...
- [Use OpenTelemetry Instrumentation Libraries with the Datadog SDK](https://docs.datadoghq.com/opentelemetry/instrument/instrumentation_libraries/)
