...
sourceUrl: >-
  https://docs.datadoghq.com/opentelemetry/getting_started/datadog_example/index.html
---
...
The Calendar sample application is already partially [instrumented](https://docs.datadoghq.com/tracing/trace_collection/custom_instrumentation/otel_instrumentation/):
...
When the Calendar application runs, the `getDate()` call generates [traces](https://docs.datadoghq.com/tracing/glossary/#trace) and spans.

## Configuring the application{% #configuring-the-application %}

### OTLP Receiver{% #otlp-receiver %}

The Calendar application is already configured to send data from the OpenTelemetry SDK to the [OpenTelemetry Protocol (OTLP) receiver](https://docs.datadoghq.com/opentelemetry/collector_exporter/otlp_receiver/) in the OpenTelemetry Collector.
...
1. Set `exporters.datadog.api.site` to your [Datadog site](https://docs.datadoghq.com/getting_started/site/). Otherwise, it defaults to US1.
...
1. Scroll to the bottom panel and select:
   ...
   {% image
      source="https://datadog-docs.imgix.net/images/getting_started/opentelemetry/infra_and_jvm2.ee035ce972f22cc98ad390910586b971.png?auto=format"
...
{% image
   source="https://datadog-docs.imgix.net/images/getting_started/opentelemetry/logs2.43c742c87041b0969a2624681f040143.png?auto=format"
...
1. Find the **Service** section in the filter menu, and select the `calendar-otel` facet to display all `calendar-otel` traces:
   ...
   {% image
      source="https://datadog-docs.imgix.net/images/getting_started/opentelemetry/traces2.b1f59d9e3f89f11e0a4747c1d26056ba.png?auto=format"
      alt="View Traces for the Calendar application" /%}

1. [Explore your `calendar-otel` traces](https://docs.datadoghq.com/tracing/glossary/#trace).
...
To start, click on a trace to open the trace side panel and find more details about the trace and its spans. For example, the [Flame Graph](https://www.datadoghq.com/knowledge-center/distributed-tracing/flame-graph/) captures how much time was spent in each component of the Calendar execution path:
   ...
   {% image
      source="https://datadog-docs.imgix.net/images/getting_started/opentelemetry/flame_graph2.d5056f017bfdb484c4c45b7360e86541.png?auto=format"
...
1. Notice that you can select **Infrastructure**, **Metrics**, or **Logs** in the bottom panel to correlate your trace with other observability data.
   ...
   {% image
      source="https://datadog-docs.imgix.net/images/getting_started/opentelemetry/trace_logs_correlation.3365e01c45c01ddc449d9e8556c9e7ba.png?auto=format"
...
- [Custom Instrumentation with OpenTelemetry](https://docs.datadoghq.com/tracing/trace_collection/custom_instrumentation/otel_instrumentation)
