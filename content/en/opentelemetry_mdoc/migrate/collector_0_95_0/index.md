...
sourceUrl: https://docs.datadoghq.com/opentelemetry/migrate/collector_0_95_0/index.html
---

# Migrate to OpenTelemetry Collector version 0.95.0+

[OTel Collector Contrib version 0.95.0](https://github.com/open-telemetry/opentelemetry-collector-contrib/releases/tag/v0.95.0) disables Trace Metrics computation in the Datadog Exporter by default.
...
## Migrate to OpenTelemetry Collector version 0.95.0+{% #migrate-to-opentelemetry-collector-version-0950 %}
...
- Consider reaching out to the [Datadog support team](https://docs.datadoghq.com/help/) for guidance and assistance in planning your upgrade strategy.
...
## Vendor-specific Open-Telemetry distributions{% #vendor-specific-open-telemetry-distributions %}
