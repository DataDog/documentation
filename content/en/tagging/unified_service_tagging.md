...
## Overview
Unified service tagging ties Datadog telemetry together through the use of three standard, [reserved tags][1]: `env`, `service`, and `version`.
...
The environment variables `DD_ENV`, `DD_SERVICE`, and `DD_VERSION` form a single point of configuration for all telemetry emitted directly from your service's runtime: Traces, Logs, and Statsd metrics.
