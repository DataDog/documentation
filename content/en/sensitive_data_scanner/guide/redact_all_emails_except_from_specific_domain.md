...
If the email domain you do not want redacted is not an existing attribute, set up a grok processor to identify all logs with the email domain and add it as an attribute.
