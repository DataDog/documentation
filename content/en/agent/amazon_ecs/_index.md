...
While it's possible to run the Agent in `awsvpc` mode, it's not the recommneded setup as it may be difficult to retrieve the ENI IP to reach the Agent for Dogstatsd metrics and APM traces.
