...
-- 
-- At the secondary Datadog site, create a set of API key and App key. You will use these keys in steps 7 to copy dashboards and monitors between Datadog sites.<br> -- For your Agents, Datadog can copy API key signatures to the secondary backup account for you to prevent you from maintaining another set of API keys for your agent.
