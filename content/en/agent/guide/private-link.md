...
10. Once this is created, route traffic from another region to send the data to Datadog via private link. For more information, see [Work With VPC Peering connections][3]. 
