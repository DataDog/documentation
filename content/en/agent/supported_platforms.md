...
The Datadog Agent is supported on a range of widely used operating systems and platforms. If your operating system is not listed below, [a source installation][1] might work for you. Source installations are supported on a best effort basis.
...
|-------|-------------|-----------------|--------------------------|
| 5 | >= 1.12 | 1.3 - 1.8 ||
| 6 | >= 1.12 | >= 1.14 | All versions |
| 7 | >= 1.12 | >= 1.14 | All versions |
...
| [Kubernetes][6] | >= 1.14   | <i class='icon-check-bold'> | <i class='icon-check-bold'> |
