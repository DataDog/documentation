...
- **Configure tracing library settings in the UI**: Change a service's trace sampling rates, Log Injection enablement, and HTTP header tags from within the [Service Catalog][19] UI, without having to restart the service.
