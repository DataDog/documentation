...
To ensure you have access to all Fleet Automation features, upgrade your Agents to version 7.47.0 or later and ensure you've followed the setup instructions below. Datadog recommends upgrading your Agents regularly to make sure you have access to the latest features.
