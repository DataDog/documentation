...
| `DD_DOGSTATSD_TAGS`              | Additional tags to append to all metrics, events, and service checks received by this DogStatsD server, formatted as space-separated key:value pairs, for example: `env:golden group:retrievers`. |
