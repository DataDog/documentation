...
| `DD_LOGS_CONFIG_EXPECTED_TAGS_DURATION` | In some environments, the initial logs from hosts might not include the correct tags. If you're experiencing missing tags in your logs, include this environment variable and set it to `"10m"`.|
