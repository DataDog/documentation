...
**Note:** As a best practice in containerized environments using Autodiscovery, Datadog recommends using unified service tagging when applying Docker labels and Kubernetes pod annotations. To learn how to configure your environment with unified tagging, refer to the dedicated [unified service tagging][28] documentation.
