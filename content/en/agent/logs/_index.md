...
To enable log collection, update the Agent's [main configuration file][2] (`datadog.yaml`) with:
...
For more details on how enforce HTTPS/TCP transport, refer to the [Agent transport documentation][3].
...
If you're using Kubernetes, make sure to [enable log collection in your DaemonSet setup][4]. If you're using Docker, [enable log collection for the containerized Agent][5]. For more information about log collection from containerized environments, refer to the [Container Log Collection][6] documentation. If an integration does not support logs by default, use the custom log collection.
...
| `service`        | Yes      | The name of the service owning the log. If you instrumented your service with [Datadog APM][9], this must be the same service name.                                                                                                                                                                                                                     |
