...
| `service`        | Yes      | The name of the service owning the log. If you instrumented your service with [Datadog APM][9], this must be the same service name. You can inject `service` with the APM tracer or, if you're using Kubernetes or Docker, use labels to set your service in logs. It recommended to use [unified service tagging][10] when configuring `service`.                                                                                                                                                                                                                      |
