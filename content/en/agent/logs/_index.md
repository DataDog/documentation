...
**Note**: As a best practice, Datadog recommends using unified service tagging when assigning tags and environment variables. Unified service tagging ties Datadog telemetry together through the use of three standard tags: `env`, `service`, and `version`. To learn how to configure your environment with unified tagging, refer to the dedicated [unified service tagging][10] documentation.
...
| `service`        | Yes      | The name of the service owning the log. If you instrumented your service with [Datadog APM][11], this must be the same service name.                                                                                                                                                                                                                     |
...
| `tags`           | No       | A list of tags added to each log collected ([learn more about tagging][12]).                                                                                                                                                                                                                                                                             |
