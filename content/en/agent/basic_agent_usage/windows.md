...
| `SITE`                     | String | Set the Datadog intake site, for example: `SITE=datadoghq.eu`.                                                                                                                                                                          |
| `SERVICE`                  | String  | The service name for this application.                             |
| `VERSION`                  | String  | The application’s version e.g. 1.2.3, 6c44da20, 2020.02.13.                   |
| `TAGS`                     | String | Comma-separated list of tags to assign in the configuration file. Example: `TAGS="key_1:val_1,key_2:val_2"`. As a best practice, Datadog recommends using unified service tagging when assigning tags. Refer to the dedicated [unified service tagging][12] documentation.                                                                                                                        |
