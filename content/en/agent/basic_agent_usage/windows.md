...
| `PROXY_PASSWORD`           | String | If using a proxy, sets your proxy password. This variable is required for passing in an authentication password and cannot be renamed. [Learn more about using a proxy with the Datadog Agent][6].                                                                                                                            |
