...
Each of the following configuration options can be added as a property to the command line when installing the Agent on Windows. For additional Agent configuration options, see [more Agent Configuration flags](#agent-configuration-options).  
