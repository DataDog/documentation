...
<div class="alert alert-info">Amazon Linux 2022 installations require the <code>libxcrypt-compat</code> package. To install the package, run:<br/><pre><code>dnf install -y libxcrypt-compat</code></pre>.</div>
