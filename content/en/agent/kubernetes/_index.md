...
* [Helm installation][3] (**recommended**) - [Helm][4] is a package manager for Kubernetes that allows you to easily install the Datadog Agent and enable its various capabilities. Using the Datadog helm-chart is the simplest and fastest way to get started.
* [Container installation][2] -  The Agent runs inside a Pod. This implementation is sufficient for the majority of use cases, but does not monitor the starting phase of your Kubernetes cluster.
