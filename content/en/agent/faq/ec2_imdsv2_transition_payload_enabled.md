...
If your host has already configured the `ec2_prefer_imdsv2` flag to `true`, you will notice no change in its data reporting since IMDSv2 is already enabled.
