...
- Connect your dbt cloud or core project to Datadog using the [dbt integration](). You can also connect your dbt project as part of the next step check configuration.
...
![Add CI/CD Checks](/images/data_observability/cicd/cicd-connection.png)
