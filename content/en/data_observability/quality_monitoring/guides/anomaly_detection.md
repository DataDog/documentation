...
Data Observability monitors use an anomaly detection model tailored to common patterns in data quality metrics such as table freshness and row count. Unlike standard statistical anomaly detection, this model is designed for metrics that have irregular update patterns, sporadic large changes, and business-specific expectations of what is normal.
