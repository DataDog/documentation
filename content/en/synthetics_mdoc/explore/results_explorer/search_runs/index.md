...
breadcrumbs: >-
  ...
  Synthetic Monitoring & Testing Results Explorer > Search Test Runs
sourceUrl: >-
  https://docs.datadoghq.com/synthetics/explore/results_explorer/search_runs/index.html
---
...
After selecting a time frame from the dropdown menu on the top right, you can search for test runs by clicking on the **Test Runs** event type in the [Synthetic Monitoring & Testing Results Explorer](https://app.datadoghq.com/synthetics/explorer/).
...
### Common test run attributes{% #common-test-run-attributes %}
...
## Timings attributes{% #timings-attributes %}
...
### Mobile attributes{% #mobile-attributes %}
...
### Continuous Testing attributes{% #continuous-testing-attributes %}
...
For more information about searching for test runs, see [Search Syntax](https://docs.datadoghq.com/continuous_testing/explorer/search_syntax).
