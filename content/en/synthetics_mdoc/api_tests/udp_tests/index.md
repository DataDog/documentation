...
breadcrumbs: Docs > Synthetic Testing and Monitoring > API Testing > UDP Testing
sourceUrl: https://docs.datadoghq.com/synthetics/api_tests/udp_tests/index.html
---
...
UDP tests can run from both managed and [private locations](https://docs.datadoghq.com/synthetics/private_locations/) depending on your preference for running the test from outside or inside your network. UDP tests can run on a schedule, on-demand, or directly within your [CI/CD pipelines](https://docs.datadoghq.com/synthetics/cicd_integrations).
...
- **Build a test from scratch**:
  ...
  1. Add Environment **Tags** as well as any other tag to your UDP test. You can then use these tags to filter through your Synthetic tests on the [Synthetic Monitoring & Continuous Testing page](https://docs.datadoghq.com/synthetics/search/#search).

  1. Click **Test Host** to try out the request configuration. A response preview is displayed on the right side of your screen.

     {% image
        source="https://datadog-docs.imgix.net/images/synthetics/api_tests/udp_test_config_2.6c8d33b25df282be5c99223a434c2f06.png?auto=format"
        alt="Define UDP request" /%}
...
| string response | `contains`, `does not contain`, `is`, `is not`,`matches`, `does not match` | *String**[Regex](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions)* |
...
{% image
   source="https://datadog-docs.imgix.net/images/synthetics/api_tests/udp_assertions.df970e1401f3a921cfec1b793019ee65.png?auto=format"
   alt="Define assertions for your UDP test to succeed or fail on" /%}
...
Select the **Locations** to run your UDP test from. UDP tests can run from both managed and [private locations](https://docs.datadoghq.com/synthetics/private_locations/) depending on your preference for running the test from outside or inside your network.
...
You can use the [global variables defined on the **Settings** page](https://docs.datadoghq.com/synthetics/settings/#global-variables) in the URL and assertions of your UDP tests.
...
By default, only users with the Datadog Admin and Datadog Standard roles can create, edit, and delete Synthetic UDP tests. To get create, edit, and delete access to Synthetic UDP tests, upgrade your user to one of those two [default roles](https://docs.datadoghq.com/account_management/rbac/).
