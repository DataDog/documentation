...
breadcrumbs: Docs > Synthetic Testing and Monitoring > API Testing > DNS Testing
sourceUrl: https://docs.datadoghq.com/synthetics/api_tests/dns_tests/index.html
---
...
DNS tests can run from both managed and [private locations](https://docs.datadoghq.com/synthetics/private_locations) depending on your preference for running the test from outside or inside your network. DNS tests can run on a schedule, on-demand, or directly within your [CI/CD pipelines](https://docs.datadoghq.com/synthetics/cicd_integrations).
...
- **Build a test from scratch**:
  ...
  1. Add Environment **Tags** as well as any other tag to your DNS test. You can then use these tags to filter through your Synthetic tests on the [Synthetic Monitoring & Continuous Testing page](https://docs.datadoghq.com/synthetics/search/#search).
  ...
  {% image
     source="https://datadog-docs.imgix.net/images/synthetics/api_tests/synthetics_dns_test_domain.fd9b11b1c90a7f48c046683f0f3cce6d.png?auto=format"
     alt="Define DNS query" /%}
...
| every available record | of type A, of type AAAA, of type CNAME, of type MX, of type NS, of type TXT | `is`, `contains`,`matches`, `does not match` | *String**[Regex](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions)* |
| at least one record    | of type A, of type AAAA, of type CNAME, of type MX, of type NS, of type TXT | `is`, `contains`,`matches`, `does not match` | *String**[Regex](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions)* |
...
{% image
   source="https://datadog-docs.imgix.net/images/synthetics/api_tests/assertions_dns.99d791766ec174a706b275ab0b928deb.png?auto=format"
   alt="Define assertions for your DNS test to succeed or fail on" /%}
...
Select the **Locations** to run your DNS test from. DNS tests can run from both managed and [private locations](https://docs.datadoghq.com/synthetics/private_locations) depending on your preference for monitoring a public or private domain.
...
You can use the [global variables defined on the **Settings** page](https://docs.datadoghq.com/synthetics/settings/#global-variables) in the URL, advanced options, and assertions of your DNS tests.
...
By default, only users with the [Datadog Admin and Datadog Standard roles](https://docs.datadoghq.com/account_management/rbac/) can create, edit, and delete Synthetic DNS tests. To get create, edit, and delete access to Synthetic DNS tests, upgrade your user to one of those two [default roles](https://docs.datadoghq.com/account_management/rbac/).
...
- [DNS monitoring with Datadog](https://www.datadoghq.com/blog/monitor-dns-with-datadog/)
- [Get started with API tests](https://docs.datadoghq.com/getting_started/synthetics/api_test)
- [Test DNS resolution of your internal endpoints](https://docs.datadoghq.com/synthetics/private_locations)
