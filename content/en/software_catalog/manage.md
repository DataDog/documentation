...
In comparison, setting the label on a Kubernetes service only affects metric tagging, not other telemetry. Applying [additional container labels][13] is essential for correctly tagging logs and traces, so this approach isn't recommended.
