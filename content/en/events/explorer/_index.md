...
We display event attributes as JSON. You can click on an attribute to add or exclude it from the existing query, or add a column for this attribute. You can normalize enrich event attributes with processing pipelines.
