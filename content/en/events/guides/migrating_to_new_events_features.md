...
<div class="alert alert-warning">
  Use this guide to migrate from the legacy Events Stream to the Events Explorer. If you are looking for legacy events information, see the <a href="/events/stream/">Event Stream documentation</a>.</div>
