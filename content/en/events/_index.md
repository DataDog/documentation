...
The [event explorer][1] is a display of the most recent events generated by your infrastructure and the associated monitors.
...
On the left side, you can use facets to filter your results. Facets are user-defined tags and attributes from your events. You can add custom facets or pre-existing ones, as well as search facets.
{{< /site-region >}}
