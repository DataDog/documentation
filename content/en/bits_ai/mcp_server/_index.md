...
- link: "bits_ai/mcp_server/toolsets"
  tag: "Documentation"
  text: "Datadog MCP Server Toolsets"
- link: "bits_ai/"
  tag: "Documentation"
...
The Datadog MCP Server supports _toolsets_, which allow you to use only the tools you need, saving valuable context window space. See [Toolsets][41] for a full list of available toolsets, their tools, required permissions, and example prompts.
...
For a detailed list of all tools in each toolset, see [Toolsets][41].
...
[41]: /bits_ai/mcp_server/toolsets
