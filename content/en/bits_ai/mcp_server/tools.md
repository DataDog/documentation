...
description: "Reference for available Datadog MCP Server tools, organized by toolset, with example prompts."
algolia:
  tags: ["mcp", "mcp server", "tools"]
  rank: 70
further_reading:
...
This page lists the tools available in the Datadog MCP Server and provides example prompts for using them. Tools are grouped by [toolset][1].
