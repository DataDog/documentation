...
Datadog's [Cursor and VS Code extension](/developers/ide_plugins/vscode/) includes built-in access to the managed Datadog MCP Server. Benefits include:
