...
*Toolset: **core***\
*Required permissions: `ApmRead`, `ApmServiceCatalogRead`, `DashboardsRead`, `EventsRead`, `HostsRead`, `IncidentRead`, `LogsRead`, `MetricsRead`, `MonitorsRead`, `NotebooksRead`, `RumAppsRead`, `TeamsRead`, `TimeseriesQuery`, `UserAccessRead`*\
...
### `apm_search_spans`
*Toolset: **apm***\
*Required permissions: `ApmRead`, `TeamsRead`, `UserAccessRead`*\
...
*Required permissions: `CasesRead`, `ErrorTrackingRead`*\
...
*Toolset: **networks***\
*Required permissions: `BuiltInFeatures`, `NetworkPathConfigRead`*\
...
### `browser_onboarding`
*Toolset: **onboarding***\
*Required permissions: `RumAppsWrite`*\
...
*Toolset: **synthetics***\
*Required permissions: `SyntheticsGlobalVariableRead`, `SyntheticsRead`, `SyntheticsWrite`*\
