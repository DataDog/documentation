...
For the default branches, we provide a metric to track the flaky tests through time. This metric counts all the flaky tests in the default branch for a given moment, every 30 minutes.
