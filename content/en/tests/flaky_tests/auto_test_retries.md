...
<div class="alert alert-info">Failed Test Replay is only supported for Java, JavaScript, and .NET.</div>
...
If you suspect there are any issues with Auto Test Retries, open [**CI/CD Settings**][4], find your repository or service, and toggle Auto Test Retries off.
