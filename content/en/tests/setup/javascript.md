...
### Test failure screenshot upload

Upload the screenshots generated by Cypress to Datadog to better understand test failures. To enable this feature, set the `DD_TEST_FAILURE_SCREENSHOTS_ENABLED=1` environment variable and set [`screenshotOnRunFailure`][12] to `true` in your Cypress configuration.
...
[12]: https://docs.cypress.io/app/references/configuration#Screenshots
{{% /tab %}}
