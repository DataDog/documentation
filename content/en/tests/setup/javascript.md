...
Upload the screenshots generated by Cypress to Datadog to better understand test failures. To enable this feature, set the `DD_TEST_FAILURE_SCREENSHOTS_ENABLED=1` environment variable and set [`screenshotOnRunFailure`][8] to `true` in your Cypress configuration.
