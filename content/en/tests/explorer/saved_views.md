...
To access your saved views, expand {{< ui >}}> Views{{< /ui >}} to the left in the [Test Optimization Explorer][1].
...
Click {{< ui >}}Save{{< /ui >}} to create a custom saved view from the current content in the Test Optimization Explorer.
