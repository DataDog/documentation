...
2. The RUM session might not flush before the wait period expires. Set the `DD_CIVISIBILITY_RUM_FLUSH_WAIT_MILLIS` environment variable to increase the wait period. Specify the duration in milliseconds.
