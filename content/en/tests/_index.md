...
| {{< ci-details title="Distributed traces on integration tests" >}}Tests that make calls to external services instrumented with Datadog show the full distributed trace in their test details.{{< /ci-details >}}                  | {{< X >}} |       {{< X >}}      |       {{< X >}}        |           | {{< X >}}             | {{< X >}} | {{< X >}} |                        |
...
| {{< ci-details title="Early flake detection *" >}}Automatically <a href="/tests/flaky_test_management/early_flake_detection">retry new tests</a> to detect flakiness.{{< /ci-details >}}                                          | {{< X >}} |       {{< X >}}      |       {{< X >}}        |           | {{< X >}}             | {{< X >}} | {{< X >}} |                        |
| {{< ci-details title="Auto test retries *" >}}Automatically <a href="/tests/flaky_test_management/auto_test_retries">retry failed tests</a> up to N times to avoid failing the build due to test flakiness.{{< /ci-details >}}    | {{< X >}} |       {{< X >}}      |       {{< X >}}        |           | {{< X >}}             | {{< X >}} | {{< X >}} |                        |
