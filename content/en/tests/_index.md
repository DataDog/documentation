...
further_reading:
    ...
    - link: "/tests/test_parallelization/"
      tag: "Documentation"
      text: "Learn about Test Parallelization"
...
| {{< ci-details title="Test Parallelization" >}}Capability to <a href="/tests/test_parallelization">split runnable test files across CI nodes or workers</a> after Test Impact Analysis selects the tests to run.{{< /ci-details >}} |           |                      |                        |           | {{< X >}}             |           |           |                        |
