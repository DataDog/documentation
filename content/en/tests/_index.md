...
| {{< ci-details title="Cypress failure screenshots" >}}Automatic upload of a Cypress test's failure screenshot, shown in the Media tab of the test result (Preview).{{< /ci-details >}}                                            |           |                      |  {{< X >}} (Cypress)   |           |                       |           |           |                        |
