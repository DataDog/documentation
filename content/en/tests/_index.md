...
| {{< ci-details title="Selenium integration" >}}Automatically link browser sessions to test cases when testing of RUM-instrumented applications{{< /ci-details >}}                                                | {{< X >}} |       {{< X >}}      |       {{< X >}}        |           |           |           |                        |
