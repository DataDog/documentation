...
| {{< ci-details title="Selenium RUM integration" >}}Automatically link browser sessions to test cases when testing of RUM-instrumented applications{{< /ci-details >}}                                            | {{< X >}} |       {{< X >}}      |       {{< X >}}        |           |           |           |                        |
