...
| <i class="icon-rum" style="font-size:18px;color:#7c3eb9;vertical-align:middle"></i> {{< img src="/images/integrations_logos/android.png" alt="Android" style="width:100%;" >}}   | `date`        | Start of the event in milliseconds from epoch.         | `integer`| Core    | 
| <i class="icon-rum" style="font-size:18px;color:#7c3eb9;vertical-align:middle"></i> {{< img src="/images/integrations_logos/android.png" alt="Android" style="width:100%;" >}}   | `connectivity.status`| Status of device network reachability (`connected`, `not connected`, or `maybe`).  | `string`| Connectivity| 
| <i class="icon-rum" style="font-size:18px;color:#7c3eb9;vertical-align:middle"></i> {{< img src="/images/integrations_logos/android.png" alt="Android" style="width:100%;" >}}   | `connectivity.interfaces`| The list of available network interfaces (for example, `bluetooth`, `cellular`, `ethernet`, or `wifi`).        | `string`| Connectivity| 
| <i class="icon-rum" style="font-size:18px;color:#7c3eb9;vertical-align:middle"></i> {{< img src="/images/integrations_logos/android.png" alt="Android" style="width:100%;" >}}   | `connectivity.cellular.technology`| The type of a radio technology used for cellular connection.         | `string`| Connectivity| 
| <i class="icon-rum" style="font-size:18px;color:#7c3eb9;vertical-align:middle"></i> {{< img src="/images/integrations_logos/android.png" alt="Android" style="width:100%;" >}}   | `connectivity.cellular.carrier_name`| The name of the SIM carrier.             | `string`| Connectivity| 
| <i class="icon-rum" style="font-size:18px;color:#7c3eb9;vertical-align:middle"></i> {{< img src="/images/integrations_logos/android.png" alt="Android" style="width:100%;" >}}   | `view.name`   | Customizable name of the view corresponding to the event.            | `string`| Views   | 
