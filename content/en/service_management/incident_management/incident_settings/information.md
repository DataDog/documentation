...
When timestamp overrides are enabled in an incident type, any user with **Incidents Write** can define timestamp overrides in any incident of that incident type.
