...
5. **Renotify on updates to**: Select the incident properties that will trigger renotifications. A new notification is sent whenever one or more of the selected properties change. **Note**: properties already in your filters (see step 2) are automatically included in the renotification rules.
6. Click **Save**
