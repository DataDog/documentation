...
You can also automatically add [team members][6] to an incident Slack channel when a team is added to the incident.  Only members who have connected their Slack and Datadog accounts by running the “/datadog connect” command in Slack will be added to the channel.
