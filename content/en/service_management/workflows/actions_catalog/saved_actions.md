...
2. Alternatively, if you already have a step added to the Workflow Canvas, click on the step and locate the small button on the top right of the side panel. Select **Configure using a saved action** from the popover that opens.
3. A dialog box appears with the list of available Saved Actions for you to choose from.
4. Once you have made a choice, click on **Use Saved Action** to confirm your selection.
