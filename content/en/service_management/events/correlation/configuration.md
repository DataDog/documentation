...
- **Pattern-based**: you control how the events/alerts are correlated, though the information available within them. Datadog also automatically enriches your pattern based correlation with intelligent alerts powered by ML model.
