...
## This image needs to be updated as it still points to old 'Events' view in UI.
...
{{< img src="service_management/events/explorer/side-panel.mp4" alt="Clicking a row in the Events Explorer opens the event side panel" style="width:100%;" video=true >}}
