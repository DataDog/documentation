...
Ingest, enrich & normalize, and correlate (see public beta) your events from any source into actionable insights. Datadog automatically creates events from various products including monitors, Watchdog, and Error Tracking. You can also track events generated from Agent and installed integrations. Event Management can also ingest events from any sources, including alert events from 3rd parties, change requests, deployments, configuration changes.
