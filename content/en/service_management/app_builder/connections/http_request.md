...
You can use a private HTTP action to interact with services hosted on your private network without opening a port in your firewall. Private actions make use of a private action runner which you install on a host in your network and pair with a Datadog Connection. For more information, see [Private Actions][5].
