...
{{< img src="service_management/app_builder/workflow-trigger-app.mp4" alt="Clicking Trigger Workflow polls Slack then returns a random cat or dog fact" video="true" width="486px">}}
