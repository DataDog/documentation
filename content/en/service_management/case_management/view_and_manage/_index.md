...
On the [Case Management page][1], cases can be sorted by creation date, status, or priority. By default, cases are sorted by creation date. Toggle between **List** and **Board** view to optimize case management by switching between a detailed, functional table and an intuitive, visually engaging Kanban board with drag-and-drop functionality.
