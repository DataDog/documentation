...
| **SLO details side panel History (up to 90 days of historical data)** | Can set custom time windows to view SLO info                                                                                              | Cannot set custom time windows to view SLO info (can view 7, 30, or 90 day history)                                                                                                                     | Can set custom time windows to view SLO info                                         |
| **SLO alerting ([Error Budget][1] or [Burn Rate][2] Alerts)**         | Available for metric-based SLOs                                                                                                       | Available for SLOs based on Metric Monitor types only (not available for Synthetic Monitors or Service Checks)                                                      | Not available for Time Slice SLOs                                                    |
...
| [**SLO Data Source**][5]                                              | Available for this SLO type (up to 15 months of historical data available)                                                                | Not available for Monitor-based SLOs                                                                                                                                     | Not available for Time Slice SLOs                                                |
