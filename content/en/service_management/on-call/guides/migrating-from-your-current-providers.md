...
his phase is also an excellent time to prepare your organization for the transition—encourage all teams who will be impacted to proactively download and set up the [Datadog mobile app](https://docs.datadoghq.com/mobile/) to ensure they can receive critical push notifications without delay.
...
[ ] Datadog On-Call has been trialed with 1–2 teams and validated
