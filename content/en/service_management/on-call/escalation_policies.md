...
1. Select whether Datadog should automatically update the page status to **Resolved** after executing all rules and repeats. *(This only applies if no one acknowledges; once acknowledged, escalation stops and the page won’t auto-resolve.)*
