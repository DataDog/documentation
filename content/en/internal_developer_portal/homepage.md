...
The **Cases** tab <!-- [TO VERIFY] --> lists the Datadog Work Management work items assigned to you, grouped by status: **Open**, **In Progress**, and **Closed**. Each group shows a count.
