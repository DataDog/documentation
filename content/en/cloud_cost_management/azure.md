...
5. Assign these permissions to the app registration same App Registration chosen earlier.
...
In Step 1, choose the Azure Integration corresponding to the App Registration chosen earlier.
