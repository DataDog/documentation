...
5. In the destination tab, select the following details:
    ...
    - Overwrite Data: `Unchecked`
        - **Note:** We do not support the Overwrite Data setting. If the setting was previously `Checked`, please make sure to clean the files in the directory or move them to another one.
