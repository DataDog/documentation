...
<div class="alert alert-warning">The AWS Cost and Usage Reports endpoint is used to validate the above fields against the CUR export in your S3 bucket. This endpoint is not FIPS validated.</div>
{{< /site-region >}}
...
Navigate to [**Cloud Cost** > **Accounts**][18] and click **Add Account** on the AWS account card.
...
Navigate to [**Cloud Cost** > **Accounts**][18] and click **Manage Account** for the management account you want to filter.
