...
**Note**: We use the AWS Cost and Usage Reports endpoint to validate the above fields against the CUR export in your S3 bucket. This endpoint is not FIPS validated.
{{< /site-region >}}
