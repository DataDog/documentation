...
Commitments Explorer provides a detailed, interactive table of all your cloud commitment contracts for the supported products and providers. Browse, search, filter, and sort your commitments by key attributes to track your inventory, monitor expiration dates, and identify opportunities to optimize usage and savings.
...
| Payment Model | Payment option for the commitment (for example, No Upfront, Partial Upfront, All Upfront). | Amazon EC2, Amazon RDS, Amazon ElastiCache|
| Term | Duration of the commitment (for example, 1 Year, 3 Years). | Amazon EC2, Amazon RDS, Amazon ElastiCache|
| Region | AWS or Azure region where the commitment is applied. | Amazon EC2, Amazon RDS, Amazon ElastiCache|
| Instance Type | Type and size of the instance covered by the commitment (for example, `db.r6g.large` for RDS or `m5.large` for EC2). | Amazon EC2, Amazon RDS, Amazon ElastiCache|
| Start Date | Date when the commitment term begins. | Amazon EC2, Amazon RDS, Amazon ElastiCache|
| End Date | Date when the commitment term ends. | Amazon EC2, Amazon RDS, Amazon ElastiCache|
...
| Utilization | Percentage of the commitment used during the selected period. | Amazon EC2, Amazon RDS, Amazon ElastiCache|
