...
- **Dismiss**: Users can go to the recommendation side panel and click "Dismiss" to dismiss a recommendation for a selected time frame and give a reason for the dismissal. Dismissed recommendations appear in the "Dismissed" tab.
