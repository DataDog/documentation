...
- **Datadog Work Management**: Users can go to the recommendation side panel and click {{< ui >}}Create Work Item{{< /ui >}}<!-- [TO VERIFY] --> to generate a work item to manage and take action on recommendations.
