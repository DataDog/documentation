...
multifiltersearch:
  ...
  data:
    ...
    - category: Terminate
      cloud_provider: AWS
      resource_type: EBS
      recommendation_type: Terminate EBS Volume
      recommendation_description: Volume attached to a non-running EC2 instance.
      recommendation_prerequisites: ""
    - category: Terminate
      cloud_provider: AWS
      resource_type: RDS
      recommendation_type: Terminate RDS Instance
    ...
    - category: Terminate
      ...
      recommendation_type: Terminate Elasticache Redis Cluster
    ...
    - category: Terminate
      ...
      recommendation_type: Delete Idle Elastic IP Address
    ...
    - category: Migrate
      cloud_provider: AWS
      resource_type: Autoscaling Group (ASG)
    ...
    - category: Terminate
      ...
      recommendation_type: Terminate Container Registry
    ...
    - category: Migrate
      cloud_provider: AWS
      resource_type: EBS Volume
      recommendation_type: Migrate EBS Volumes from IO1 to GP3
    ...
    - category: Migrate
      ...
      resource_type: EC2
      recommendation_type: Migrate legacy autoscaling group instances to new types
      recommendation_description: Autoscaling Group instances are a legacy EC2 type and can be upgraded.
      recommendation_prerequisites: "[Datadog Agent](/agent/)"
    - category: Downsize
      cloud_provider: AWS
      resource_type: EC2
    ...
    - category: Downsize
      ...
      recommendation_type: Downsize Kubernetes Deployment
