...
**Note**: Persistent volume allocation is only supported in Kubernetes clusters. It's not currently supported for pods that are part of a Kubernetes Deployment.
