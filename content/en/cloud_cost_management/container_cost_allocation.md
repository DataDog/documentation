...
2. (Optional) Enable [AWS Split Cost Allocation][3] for usage-based ECS allocation.
...
[3]: https://docs.aws.amazon.com/cur/latest/userguide/enabling-split-cost-allocation-data.html
