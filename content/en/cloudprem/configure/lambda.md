...
After the <link to prerequisites> iam permissions have been properly set up, to enable Lambda offloading, add a `lambda` section under `config.searcher` in your Helm chart values file:
