...
Before installing CloudPrem on AKS, ensure your Azure environment is properly configured. For detailed Azure configuration instructions, see the [Azure Configuration guide](../configure/azure-config/).
