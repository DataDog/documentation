...
For a complete list of neutral tags and their descriptions, see [Neutral tags][15] in the Tags Reference.
...
Click the three dots menu in the analytics table to pivot to [network path][11] and see the paths between the source and destination specified in CNM.
...
With [enhanced resolution configured][9] for AWS or Azure, CNM filters and groups network traffic using resources collected from these cloud providers. The available tags vary by cloud provider and resource. Datadog automatically applies the tags listed below in addition to any user-defined tags.
