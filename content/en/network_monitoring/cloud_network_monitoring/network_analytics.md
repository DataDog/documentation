...
| `tls_cipher_suite`      | Identifies the TLS cipher suite used (e.g., `tls_ecdhe_rsa_with_aes_128_gcm_sha256`).          |
...
| `gateway_region`        | AWS region of the gateway (e.g., `us-east-1`).                                                |
| `gateway_availability-zone` | Availability Zone hosting the gateway (e.g., `us-east-1a`).                                |
...
| `tgw_attachment_type`   | Type of Transit Gateway attachment (e.g., VPC, VPN, Direct Connect).                          |
