...
SD-WAN
: Software-Defined Wide Area Network. It is mainly used to interconnect remote offices and data centers across different transports (MPLS, Broadband, 5G, and so on).
...
Ping
: Packet Internet or Inter-Network Groper. Ping is a network tool that measures how long it takes for a signal to travel from one device to another over a network and back again.
