...
1. Devices have LLDP (Link Layer Discovery Protocol) and/or CDP (Cisco Discovery Protocol) enabled via SNMP.
3. Datadog Agent version 7.46 or later is installed.
