...
Network Device Monitoring(NDM) gives you visibility into your on-premises and virtual network devices, such as routers, switches, and firewalls. Automatically discover devices on any network, and start collecting metrics like bandwidth utilization, volume of bytes sent, and determine whether devices are up/down.
...
{{< whatsnext desc="This section includes the following topics:">}}
    ...
    {{< nextlink href="network_monitoring/devices/supported_devicess" >}}<u>Supported devices</u>: View supported NDM devices{{< /nextlink >}}
