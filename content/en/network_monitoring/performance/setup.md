...
6. [Optional] If runing on AWS, enable 'standard collection' in your AWS integration for additional visibility in NAT gateways Elastic Load Balancers, Application Load Balancers, and Newtork Load Balancers.
