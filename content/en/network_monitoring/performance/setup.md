...
6. [Optional] Make sure the Azure integration is installed for more visibility into Azure load balancers. This feature is currently not available in the Govcloud region.
