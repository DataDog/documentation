...
- To view integration metrics for a service: in the Network Page, click on a row in the [dependency table](#table). In the opened side panel, click *Integration Metrics*.
