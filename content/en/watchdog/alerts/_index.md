...
When Watchdog detects an irregularity in an APM metric, the pink Watchdog binoculars icon appears next to the impacted service in the [APM Catalog][7].

{{< img src="watchdog/service_list.png" alt="Screenshot of the Catalog, showing 5 services. A pink binoculars icon follows the name of the web-store service." style="width:75%;" >}}
