...
{{< img src="actions/workflows/variables/context-variables5.png" alt="The Context Variables tab" >}}
...
{{< img src="actions/workflows/variables/step-outputs2.png" alt="Datadog suggests existing step outputs as you type." style="width:100%;" >}}
...
{{< img src="actions/workflows/variables/context-variables-tab-source-object-variables2.png" alt="The Source object variables in the Context Variables tab" style="width:60%;">}}
...
{{< img src="actions/workflows/variables/input-parameter3.png" alt="Hover over a counter to see which steps are using the parameter." style="width:60%;">}}
...
If you're looking for an existing input parameter, start typing `{{ Trigger.` to see if it appears as a suggestion. Alternatively, consult the {{< ui >}}Context Variables{{< /ui >}} tab for a list of available parameters.
...
The {{< ui >}}Output Parameters{{< /ui >}} section displays the names of all existing output parameters together with a counter.
...
1. Enter a value for the variable.
   ...
   - To create an object, click the {{< ui >}}Create object{{< /ui >}} <i class="icon-api"></i> button.
   - To create an array, click the {{< ui >}}Create array{{< /ui >}} <span id="icon-array">[ ]</span> button.

If you need to change the value of a custom variable after setting it, you must add an additional {{< ui >}}Set variable{{< /ui >}} step and either reassign the variable or create a new variable.

Here is an example of a workflow that demonstrates the {{< ui >}}Set variable{{< /ui >}} step:

1. In your workflow, start with a {{< ui >}}Set variable{{< /ui >}} step to declare a variable called `intList` and give it the value `[1,2,3,4]`.
...
{{< img src="actions/workflows/variables/set-variable-updated.png" alt="This workflow sets a variable to hold a list of numbers, declares a second variable which filters out the odd numbers in the list using an inline expression, and echoes the value of the second variable." style="width:100%;" >}}
...
Setting a custom variable inside a {{< ui >}}For loop{{< /ui >}} or a {{< ui >}}While loop{{< /ui >}} allows you store data for use outside of the loop. For example, if you're making multiple API requests inside a {{< ui >}}For loop{{< /ui >}}, you can set a custom variable and append the data you need to it on each iteration. Outside of the loop, you can access the custom variable and handle the data you collected.
...
{{< img src="actions/workflows/variables/loop.png" alt="This workflow sets a variable before it is used in a loop." style="width:100%;" >}}
