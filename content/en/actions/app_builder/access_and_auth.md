...
A published app runs using the Datadog user identity of its author, or a service account associated with the app. The author is listed both in the {{< ui >}}All Apps{{< /ui >}} view and in {{< ui >}}App Properties{{< /ui >}}.
...
1. Click {{< ui >}}Manage app identity{{< /ui >}}.
1. Select {{< ui >}}Run as Service Account{{< /ui >}}.
...
1. Click the cog ({{< ui >}}Settings{{< /ui >}}) icon.
1. Select {{< ui >}}Manage app identity{{< /ui >}}.
...
1. Click the cog ({{< ui >}}Settings{{< /ui >}}) icon.
1. Select {{< ui >}}Manage app identity{{< /ui >}}.
1. Click {{< ui >}}Remove service account{{< /ui >}}.
...
By default, only the author of the connection receives {{< ui >}}Editor{{< /ui >}} access. The author can choose to grant access to additional users, roles, or teams.
...
1. Click the {{< ui >}}Connections{{< /ui >}} tab. A list of connections appears.
1. Hover over the connection that you would like to set granular permissions on. {{< ui >}}Edit{{< /ui >}}, {{< ui >}}Permissions{{< /ui >}}, and {{< ui >}}Delete{{< /ui >}} icons appear on the right.
1. Click the padlock ({{< ui >}}Permissions{{< /ui >}}) icon.
1. Select {{< ui >}}Restrict Access{{< /ui >}}.
1. Select a role from the dropdown menu and click {{< ui >}}Add{{< /ui >}}. The role you selected populates into the bottom of the dialog box.
