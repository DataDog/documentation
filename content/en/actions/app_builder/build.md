...
1. From [App Builder][1], click {{< ui >}}New App{{< /ui >}}.
...
1. After Bits AI has generated your app, you can click {{< ui >}}Edit with AI{{< /ui >}} or manually [customize your app][15].
...
1. From [App Builder][1], click {{< ui >}}New App{{< /ui >}}.
1. Click {{< ui >}}Layouts{{< /ui >}} in the onboarding modal.
1. Select a layout. There are three options: 
    - {{< ui >}}Table Manager{{< /ui >}}: List, filter, and sort data from a query.
    - {{< ui >}}Form{{< /ui >}}: Collect inputs and trigger actions (create, update, request, etc.). For more detailed form templates, see [**Forms**][27].
    - {{< ui >}}Custom Chart{{< /ui >}}: Visualize a query by swapping your data into a prebuilt bar chart.
1. Click {{< ui >}}Use Layout{{< /ui >}}.
1. [Customize your app][15].
...
1. From [App Builder][1], click {{< ui >}}New App{{< /ui >}}. 
1. Click {{< ui >}}Start From Scratch{{< /ui >}}, or click the {{< ui >}}X{{< /ui >}} to close the onboarding modal.
1. [Customize your app][15].
...
1. From [App Builder][1], click {{< ui >}}New App{{< /ui >}}. 
1. Click {{< ui >}}App Playground{{< /ui >}}.
1. On the next screen, the app canvas (the right pane) displays information to guide you through App Builder. Click elements like {{< ui >}}Fetching Data{{< /ui >}} to see information and instructions for using that feature. 
...
1. Make edits to your app as required. 
    ...
    1. To add a [UI component](#app-canvas-and-components) to the app canvas, click the {{< ui >}}Add Component{{< /ui >}} <i class="icon-component-wui" style="position:relative; top:4px;"></i> icon to open the {{< ui >}}Components{{< /ui >}} tab. Click the component or drag it onto the canvas.
1. Click the {{< ui >}}View{{< /ui >}} button to see your app from the user's perspective. Use view mode to interact with the app UI and test your queries. When you're done, click {{< ui >}}Edit{{< /ui >}} to return to the app builder.
1. To save your app, click {{< ui >}}Save{{< /ui >}}.
1. When you're ready to publish your app, click {{< ui >}}Publish{{< /ui >}}. Publishing an app makes it available to your dashboards.
...
To delete or duplicate a component, select the component and click the three dot ellipsis (*...*) to display the {{< ui >}}Delete{{< /ui >}} or {{< ui >}}Duplicate{{< /ui >}} options.
...
1. Open the {{< ui >}}App Properties{{< /ui >}} tab in your app.
1. Under {{< ui >}}Tags{{< /ui >}}, use the drop-down to select an existing tag, or enter a new value and click {{< ui >}}Add option: [your text]{{< /ui >}}.
1. Save your app.
...
* To overwrite an existing app with a previous version, select the version, then click {{< ui >}}Restore Version{{< /ui >}} in the upper right.
* To create a new app that is a copy of a version, select the version, then click {{< ui >}}Clone Version{{< /ui >}} in the upper right.
...
To edit an app with JSON, click the settings {{< img src="icons/settings.png" inline="true" style="width:14px;">}} icon and select {{< ui >}}Switch to JSON{{< /ui >}}. The {{< ui >}}Switch to GUI{{< /ui >}} option in the settings menu takes you back to the GUI editor.

### Copy an app

To copy an app layout across organizations or back an app up, click the settings {{< img src="icons/settings.png" inline="true" style="width:14px;">}} icon and select {{< ui >}}Switch to JSON{{< /ui >}}. This shows the JSON code for the entire app. Copy this JSON code and save it in a text editor. You can save intermediate states of your app during development and return to them if necessary.

To copy the app to another organization:
1. Create an app. 
1. Click {{< ui >}}Settings{{< /ui >}} {{< img src="icons/settings.png" inline="true" style="width:14px;">}} and select {{< ui >}}Switch to JSON{{< /ui >}}. 
1. Replace the existing JSON with the JSON that you previously copied. 

The {{< ui >}}Switch to GUI{{< /ui >}} option in the settings menu takes you back to the GUI editor.
...
- {{< ui >}}Action Executions{{< /ui >}}: Track the success and failure of action executions with their associated inputs and outputs.
- {{< ui >}}Errors{{< /ui >}}: View logs for errors, warnings, and info messages.
