...
aliases:
- /workflows/action_catalog
- /service_management/service_management/workflows/action_catalog
- /service_management/workflows/action_catalog
cascade:
...
<div class="alert alert-warning">App Builder and Workflow Automation are not supported for your selected <a href="/getting_started/site">Datadog site</a> ({{< region-param key="dd_site_name" >}}).</div>
{{< /site-region >}}
