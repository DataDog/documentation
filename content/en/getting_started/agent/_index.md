...
In the Datadog UI, go to the Events Managment Page **Service Mgmt > Event Managment**. The Agent sends events to Datadog when an Agent is started or restarted. The following message displays if your Agent successfully installs:
...
6. Go to **Service Mgmt > Event Managment** and find the custom tags displayed with the latest Agent Event.
