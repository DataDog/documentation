...
2. Enable CSM for for your cloud resources and infrastructure:
    ...
    - **CSPM**: [AWS][8], [Azure][9], [GCP][10], [Kubernetes][11], and [Docker][12] instructions.
...
[8]: /security/cspm/setup?tab=aws
[9]: /security/cspm/setup?tab=azure
[10]: /security/cspm/setup?tab=gcp
[11]: /security/cspm/setup?tab=kubernetes
[12]: /security/cspm/setup?tab=docker
