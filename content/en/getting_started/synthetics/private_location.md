...
4. Fill out your private location details. Only `Name` and `API key` fields are mandatory. To set up a private location on a Windows service, tick the **This is a Windows Private Locations** checkbox.
