...
There are three ways to monitor your applications: [API tests][1] to monitor the uptime of your API endpoints, [Multistep API tests][2] to link several HTTP requests, and [Browser tests][3] to test key user journeys. Run all tests from managed locations or from [private locations][4] to monitor internal-facing applications. Synthetic tests can be triggered manually, on a schedule, or directly from your [CI/CD pipelines][5].
