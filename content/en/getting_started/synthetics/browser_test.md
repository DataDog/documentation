...
To troubleshoot a [failed test][10], select a failed test result and review the screenshots leading up to the failed step. You can also review potential [{{< ui >}}Errors & Warnings{{< /ui >}}][11], [{{< ui >}}Resources{{< /ui >}}][12], and [{{< ui >}}Core Web Vitals{{< /ui >}}][13] to diagnose the issue. 
