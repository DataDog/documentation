...
The first metrics appear in Datadog approximately **2 minutes** after setup. After the initial setup, expect a steady-state delay of approximately **7-8 minutes** for new metrics. See [Cloud Metric Delay][412] for details.
