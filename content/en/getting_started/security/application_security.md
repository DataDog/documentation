...
**Identify services vulnerable or exposed to attacks** that would benefit from AAP. On the [**Catalog > Security page**,][1] view and select the services you wish to enable.
...
**Note**: If no vulnerabilities or suspicious requests are reported, ensure your services are using a recent Datadog SDK version. From the [Security Catalog][2], open any service's side panel and look at its **Tracing Configuration**.
