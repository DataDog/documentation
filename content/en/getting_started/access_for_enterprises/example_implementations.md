...
| **Cross-org** | Parent org has Cross-Org Visibility enabled for executive dashboards showing system health across all divisions. Organizational Groups (Preview) for centralizing role templates and access policies across child orgs. |
