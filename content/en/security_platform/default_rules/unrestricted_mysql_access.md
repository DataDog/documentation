...
1. Run `revoke-security-group-ingress` to [remove inbound rules][3] that allow unrestricted access to port 3306.
...
2. Run `authorize-security-group-ingress` to [add new inbound rules][4] that restrict port 3306 access.
