...
security: compliance
source: ec2
title: Inbound Oracle access is restricted
type: security_rules
---
...
1. Run `revoke-security-group-ingress` to [remove inbound rules][3] that allow unrestricted access to port 1521.
...
2. Run `authorize-security-group-ingress` to [add new inbound rules][4] that restrict port 1521 access.
