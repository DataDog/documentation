...
As an administrator or security team member, you can use the [Audit Logs][5] (Public Beta) to see what actions your team is taking against Security Signals within Datadog. As an individual, you can see a stream of your own actions, too.
Signal action history retention is on the set Audit Log [retention][6]. The default retention period for an audit log is seven days. You can set a retention period between three and 90 days.
...
[5]: /account_management/audit_logs/#overview
[6]: /account_management/audit_logs/#retention
