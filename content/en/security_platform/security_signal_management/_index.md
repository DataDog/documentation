...
As an administrator or security team member, you can use [Datadog Audit Trail][5]  to see what actions your team is taking within Security Product. As an individual, you can see a stream of your own actions, too.
Audit Trail Explorer displays all signal actions taken. Navigate to Organization Settings and select Audit Logs Settings under Security.
