...
**Note**: The logs emitted by our `compliance-agent` and `runtime-security-agent` always bypass the security filters. You do not need to write custom filters for them.
