...
If the Security Signal you are reviewing is generated by the Anomaly Detection method, you will see a graph to visualize the anomaly. On the right hand side of the graph you will see a bounding box displaying where the anomaly was detected.
