...
{{< img src="security_platform/security_monitoring/cloud_siem_homepage.png" alt="The Cloud SIEM signals page, filtered to log the detection rule type, showing a bar graph, based on status, of the signals and also a list of signals" >}}
