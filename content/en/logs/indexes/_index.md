...
Multiple indexes also provide the ability to define access rules on the data contained in each index. [More information available in the role base access control documentation][2].
...
1. Go in the [Datadog Log Explorer][3] view 
2. Build a [search query][4] that represents the volume to monitor. 
