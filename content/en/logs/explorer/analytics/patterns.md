...
{{< img src="logs/explorer/group/inspect_values.png" alt="The distribution of values graph showing a bar graph of the values" style="width:90%;" >}}
...
{{< img src="logs/explorer/group/pattern_inspector_panel.png" alt="The pattern panel showing the Pattern Inspector tab" style="width:70%;" >}}
