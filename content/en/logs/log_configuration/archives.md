...
**Note:** Archiving to Azure ChinaCloud and GermanyCloud, and GovCloud is not supported.

**Note:** Archiving to Azure GovCloud is supported in Preview. Contact support to request access.
