...
* Go to your [Azure Portal][1] and [create a storage account][2] to send your archives to. Give your storage account a name, select standard performance or Block blobs premium account type, and select the **hot** or **cool** access tier.
