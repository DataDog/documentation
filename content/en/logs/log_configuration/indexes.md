...
**Note:** The deleted index will no longer accept new incoming logs. The logs in the deleted index are no longer available for querying. Once all logs have aged out according to the applicable retention, the index will no longer show up in the Index page.
