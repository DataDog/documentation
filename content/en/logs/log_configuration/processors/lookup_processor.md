...
* Checks if the source attribute value exists in the mapping table.
  ...
  * Optionally, if it does not find the value in the mapping table, it creates a target attribute with the value of the reference table. You can select a value for a [Reference Table][7] on the {{< ui >}}Reference Table{{< /ui >}} tab.
