...
Datadog log management removes these limitations by decoupling log ingestion from indexing, which makes it possible to cost-effectively collect, process, archive, explore, and monitors all your logs, this is called Logging without Limits*.
