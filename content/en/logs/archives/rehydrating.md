...
7. (Optional) Define the retention period of those rehydrated logs. Choose the `Decide Later` option if you don't know yet how long you are going to need them.
