...
Go to your [Archives page][4] in Datadog and select the **Add a new archive** option at the bottom. Only Datadog users with admin status can complete this and the following step.
...
You can [set a lifecycle configuration on your S3 bucket][6] to automatically transition your log archives to optimal storage classes. 
...
The easiest method to add server side encryption to your S3 log archives is with S3's native server side encryption, [SSE-S3][7]. 
...
Alternatively, Datadog supports server side encryption with a CMK from [AWS KMS][8]. To enable it, take the following steps:
...
[6]: https://docs.aws.amazon.com/AmazonS3/latest/dev/how-to-set-lifecycle-configuration-intro.html
