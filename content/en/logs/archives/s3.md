...
Next, grant Datadog permissions to write log archives to your S3 bucket. You can grant those permissions either from your bucket policy or with role delegation. If you wish to [rehydrate logs from your archive back into Datadog][1], the role delegation setup is required. 
