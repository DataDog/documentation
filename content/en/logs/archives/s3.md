...
Next, grant Datadog permissions to write log archives to your S3 bucket. You can grant those permissions either from your bucket policy or via role delegation. 
...
2. Go to your [Pipelines page in your Datadog application][1], and select the **Add archive** option at the bottom. Only Datadog users with admin status can complete this and the following step.
...
**Use of role delegation for writing log archives is in private beta. Ask support@datadoghq.com if you would like to have it enabled for your account.**
...
4. Select the appopriate AWS Account + Role combination for your S3 bucket. Input your bucket name. Optionally input a prefix directory for all the content of your log archives. Save your archive, and you are finished. 
