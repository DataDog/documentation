...
To unmask sensitive data, navigate to the [Summary page][23], click on a scanning rule, and then click on a log. If you have permission to see masked data, that data has an eye icon next to it. Click the eye icon to see the data. You can also use the [Log Explorer][24] to view your masked log data.
...
[23]: https://app.datadoghq.com/organization-settings/sensitive-data-scanner/summary
