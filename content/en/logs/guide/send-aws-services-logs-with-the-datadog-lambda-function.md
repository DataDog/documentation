...
| [Cloudtrail][12]                   | [Enable AWS Cloudtrail logs][12]                                                                | [Manual][13] log collection. See [AWS Configuration for Cloud SIEM][44] if you are setting up AWS CloudTrail for Cloud SIEM.                                                  |
...
| [SNS][34]                         | SNS does not provide logs. You can process logs and events that are transiting through to the SNS Service. | [Manual][35] log collection.                                                |
...
[44]: /security/cloud_siem/guide/aws-config-guide-for-cloud-siem/
