...
And so on and so forth until the parameter `nextLogId` takes the value `null`. This indicates that you retrieved all Logs associated to your query on your time frame.
