...
{{< whatsnext desc="Log Collection" >}}
    ...
    {{< nextlink href="logs/guide/why-do-my-logs-show-up-with-an-info-status-even-for-warnings-or-errors" >}}Why do my logs show up with an Info status even for Warnings or Errors?{{< /nextlink >}}    
{{< /whatsnext >}}
