...
* The query result displays as a {{< ui >}}List{{< /ui >}} or {{< ui >}}Table{{< /ui >}} (no other visualization types are supported)  
...
To view CSV reports navigate to [Log Explorer][1] and click the {{< ui >}}Reports{{< /ui >}} tab. 
