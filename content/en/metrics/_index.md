...
Add additional layers of aggregation on the results of existing queries in time and space with nested queries in dashboards or through the API. For more information, see the [Dashboard Querying][26] documentation.
