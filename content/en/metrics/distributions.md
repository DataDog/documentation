...
{{< img src="metrics/distributions/enable_percentiles.mp4" alt="A user enabling advanced query functionality by clicking on configure under the advanced section" video=true width=100% >}}
