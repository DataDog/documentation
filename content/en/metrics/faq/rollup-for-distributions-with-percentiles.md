...
Datadog merges the sketch data server-side to represent a rollup interval of a minute (for every minute within the dashboard timeframe of 4 hours). Then calculates a 99th percentile value for each minute interval server-side.
