...
further_reading:
- link: "https://docs.datadoghq.com/metrics/custom_metrics/"
  tag: "Documentation"
  text: "Learn more about Custom Metrics"
- link: "https://docs.datadoghq.com/account_management/billing/custom_metrics/?tab=countrate"
  tag: "Documentation"
  text: "Custom Metrics Billing"
- link: "https://docs.datadoghq.com/metrics/metrics-without-limits/"
  tag: "Documentation"
  text: "Metrics without Limits™"
- link: "https://docs.datadoghq.com/metrics/volume/"
  tag: "Documentation"
...
{{< whatsnext desc="Additional use cases to build monitors for with the estimated usage metrics:" >}}
    ...
    {{< nextlink href="/account_management/billing/custom_metrics/?tab=countrate" >}}Alert on anomalous changes in usage.{{< /nextlink >}}
    {{< nextlink href="/monitors/types/forecast/" >}}How custom metrics are billed{{< /nextlink >}}
{{< /whatsnext >}}
...
With the Metrics Volume Management page you can quickly identify your organization’s largest metrics as well as the metric names spiking in volume (likely culprits of any unexpected overage).
...
You can optimize without fear of losing key visibility provided on any dashboards, notebooks, monitors, SLOS or API workflows. Based on our intelligent query insights across thousands of custom metrics customers, we’ve found that using **Metrics without Limits™ on unqueried metrics can reduce the average customer’s custom metrics volumes by up to 70%**.
...
1. Set up monitors on your custom metrics usage using any of our estimated custom metrics usage metrics.
