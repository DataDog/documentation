...
This setting is automatically created by the [Datadog Azure Automated Log Forwarding][1] service. If it's missing, verify that you have installed the Azure Automated Log Forwarding service correctly.
