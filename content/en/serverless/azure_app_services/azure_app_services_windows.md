...
| Variable | Description | Example |
|----------|-------------|---------|
| `DD_SOURCE` | Identifies the log source for proper processing | `java` |
| `DD_SERVICE` | Your application's service name | `my-web-app` |
| `DD_ENV` | Your application's environment | `production`, `staging`, `development` |
| `DD_LOGS_INJECTION` | Enable trace-log correlation | `true` |
...
1. **Enable trace correlation**: Set `DD_LOGS_INJECTION=true` to correlate logs with traces
2. **Set proper service names**: Use `DD_SERVICE` to ensure logs appear with the correct service name
3. **Configure log sources**: Set `DD_SOURCE=java` for proper log processing
4. **Use structured logging**: Implement structured logging in your application for better log parsing
...
| Variable | Description | Example |
|----------|-------------|---------|
| `DD_SOURCE` | Identifies the log source for proper processing | `nodejs` |
| `DD_SERVICE` | Your application's service name | `my-web-app` |
| `DD_ENV` | Your application's environment | `production`, `staging`, `development` |
| `DD_LOGS_INJECTION` | Enable trace-log correlation | `true` |
...
1. **Enable trace correlation**: Set `DD_LOGS_INJECTION=true` to correlate logs with traces
2. **Set proper service names**: Use `DD_SERVICE` to ensure logs appear with the correct service name
3. **Configure log sources**: Set `DD_SOURCE=nodejs` for proper log processing
4. **Use structured logging**: Implement structured logging in your application for better log parsing

**Note**: Azure resource logs do not include trace ID. Trace ID injection occurs inside your application. Azure resource logs are generated by Azure in the management plane, and therefore do not include the trace ID.
