...
<div class="alert alert-info">To instrument your Azure App Service containers with a sidecar, see <a href="/serverless/azure_app_services/azure_app_services_container">Instrument Azure App Service - Linux Container</a>.</div>
