...
<div class="alert alert-info">To instrument your Azure Container Apps applications with a sidecar, see <a href="/serverless/azure_container_apps">Instrument Azure Container Apps</a>.</div>
...
- `DD_API_KEY`: Datadog API key, used to send data to your Datadog account. It should be configured as an [Azure Secret][7] for privacy and safety issue.
