...
{{< tabs >}}
{{% tab "Datadog UI" %}}
You can instrument your Python AWS Lambda application directly within Datadog. Navigate to the [Serverless > AWS Lambda][2] page and select [{{< ui >}}Instrument Functions{{< /ui >}}][3].
