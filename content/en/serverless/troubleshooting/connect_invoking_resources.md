...
While grouping by service is the default, you can also group your resources by AWS CloudFormation stack name, as well as any other tags you've configured (e.g., team, project, or environment). Additionally, [Saved Views](https://docs.datadoghq.com/logs/explorer/saved_views/) allows you to preserve your preferred way of grouping, so you don't need to manually enter it every time you visit the page. 

## Setup

To instrument your Lambda functions for the first time, follow our [serverless installation instructions][3].
