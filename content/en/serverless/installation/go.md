...
If your Go Lambda functions are still using runtime `go1.x`, consider either [migrating][2] to `provided.al2` or using the [Datadog Forwarder][1] instead of the Datadog Lambda Extension.
...
[2]: https://aws.amazon.com/blogs/compute/migrating-aws-lambda-functions-to-al2/
