---
title: Installing Python Serverless Monitoring
kind: documentation
further_reading:
...
After you have [installed your cloud integration][1], use Python to instrument your application to send metrics, logs, and traces to Datadog. 
