...
<div class="alert alert-info">To ensure that trace merging functions correctly, provide input to the Step Functions Start Execution command. The input can be empty.</div>
