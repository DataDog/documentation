...
description: Instrument .NET applications running as Google Cloud Run functions with Datadog monitoring for traces and metrics.
code_lang: dotnet
...
{{% gcr-env-vars-sidecar language="csharp" function="true" %}}
