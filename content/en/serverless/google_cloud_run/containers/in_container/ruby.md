...
description: Instrument Ruby applications running in Google Cloud Run containers using in-container monitoring for traces and metrics.
code_lang: ruby
...
{{% gcr-env-vars-in-container language="ruby" %}}
