...
<div class="alert alert-info">If you are running multiple containers per Google Cloud Run application, Datadog recommends using the Datadog sidecar: <a href="/serverless/google_cloud/google_cloud_run">Instrument Google Cloud Run</a>.</div>
