...
{{< whatsnext desc="General:" >}}
    ...
    {{< nextlink href="cloudcraft/getting-started/group-by-presets">}}Group By and Presets{{< /nextlink >}}
    ...
    {{< nextlink href="cloudcraft/getting-started/diagram-multiple-cloud-accounts">}}Diagram Multiple Cloud Accounts{{< /nextlink >}}
