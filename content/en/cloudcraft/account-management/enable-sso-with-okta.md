...
2. The details you need to create a new application with Okta can be found in the {{< ui >}}Cloudcraft service provider details{{< /ui >}} section.
...
4. Click {{< ui >}}Application{{< /ui >}}.
5. Click {{< ui >}}Add Application{{< /ui >}}, then click {{< ui >}}Create New App{{< /ui >}}.
6. Select {{< ui >}}SAML 2.0{{< /ui >}} as the sign on method and click {{< ui >}}Create{{< /ui >}}.
...
10. On the {{< ui >}}Name ID format{{< /ui >}} dropdown, select {{< ui >}}EmailAddress{{< /ui >}}.
11. Proceed to the next screen and select {{< ui >}}I'm an Okta customer adding an internal app{{< /ui >}} to answer the question "Are you a customer or partner?".
12. Click {{< ui >}}Finish{{< /ui >}}. Now that the application is set up in Okta, you can assign your users to it and once you're done, navigate to the {{< ui >}}Sign On{{< /ui >}} tab.
...
13. Under the {{< ui >}}View Setup Instructions{{< /ui >}} button, click the blue link to download the file required for upload to Cloudcraft.
...
15. Toggle the {{< ui >}}SAML Single Sign-On is enabled{{< /ui >}} option.
16. If you prefer to have your users access Cloudcraft only via your identity provider, enable the {{< ui >}}Strict mode{{< /ui >}} option.
