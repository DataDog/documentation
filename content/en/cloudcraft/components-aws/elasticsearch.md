...
In [the Cloudcraft API](https://developers.cloudcraft.co/), a Elasticsearch instance is represented in JSON.
...
The Elasticsearch component can be added to [VPCs](https://help.cloudcraft.co/article/118-component-vpc), [security groups](https://help.cloudcraft.co/article/119-component-security-group), and [subnets](https://help.cloudcraft.co/article/120-component-subnet).
