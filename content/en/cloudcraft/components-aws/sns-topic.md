...
{{< img src="cloudcraft/components-aws/sns-topic/component-sns-topic-diagram.png" alt="Screenshot of an isometric Cloudcraft diagram showing interconnected AWS components." responsive="true" style="width:100%;">}}
...
{{< img src="cloudcraft/components-aws/sns-topic/component-sns-topic-toolbar.png" alt="Screenshot of a Cloudcraft interface showing configuration options for the 'SNS Topic' component with pricing information." responsive="true" style="width:100%;">}}
