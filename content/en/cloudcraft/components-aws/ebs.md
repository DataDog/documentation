...
{{< img src="cloudcraft/components-aws/ebs/component-ebs-diagram.png" alt="Screenshot of an isometric Cloudcraft diagram showing the 'EBS' AWS component." responsive="true" style="width:100%;">}}

The **EBS** block component is used to represent elastic block store volumes from your Amazon Web Services architecture with Cloudcraft.
