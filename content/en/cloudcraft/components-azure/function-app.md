---
title: "Component: Function app"
kind: guide
---

{{< img src="cloudcraft/components-azure/function-app/component-function-app-diagram.png" alt="Screenshot of an isometric Cloudcraft diagram showing interconnected Azure functions." responsive="true" style="width:100%;">}}

You can use the **Function App** component to represent and visualize a group of Azure Functions from your Azure environment with Cloudcraft.

## Toolbar

To configure or customize how your function app looks in a diagram, you can use the toolbar that appears when selecting a component inside the application.

### Option

{{< img src="cloudcraft/components-azure/function-app/component-function-app-toolbar.png" alt="creenshot of a Cloudcraft interface showing function app configuration options, including region, VNet, and subnet settings with pricing information." responsive="true" style="width:100%;">}}

For the **Function App** component, the following options are available:
...
The **Function App** component schema representation follows the format above and defines all fields within a diagram for this component.
