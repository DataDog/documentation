---
title: "Component: Database for PostgreSQL"
kind: guide
---

{{< img src="cloudcraft/components-azure/database-for-postgresql/component-database-for-postgresql-diagram.png" alt="Screenshot of an isometric Cloudcraft diagram showing interconnected Azure components." responsive="true" style="width:100%;">}}

You can use the **Database for PostgreSQL** component to represent and visualize PostgreSQL databases from your Azure environment with Cloudcraft.

## Toolbar

To configure or customize how your Database for PostgreSQL looks in a diagram, you can use the toolbar that appears when selecting a component inside the application.

### Option

{{< img src="cloudcraft/components-azure/database-for-postgresql/component-database-for-postgresql-toolbar.png" alt="Screenshot of a Cloudcraft interface showing configuration options for the 'Database for PostgreSQL' component with pricing information." responsive="true" style="width:100%;">}}

For the **Database for PostgreSQL** component, the following options are available:
...
The **Database for PostgreSQL** component schema representation follows the format above and defines all fields within a diagram for this component.
