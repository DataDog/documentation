---
title: "Component: Azure queue"
kind: guide
---

{{< img src="cloudcraft/components-azure/azure-queue/component-azure-queue-diagram.png" alt="Screenshot of an isometric Cloudcraft diagram showing interconnected Azure components." responsive="true" style="width:100%;">}}

You can use the **Azure Queue** component to represent and visualize queue storage from your Azure environment with Cloudcraft.

## Toolbar

To configure or customize how your Azure queue looks in a diagram, you can use the toolbar that appears when selecting a component inside the application.

### Option

{{< img src="cloudcraft/components-azure/azure-queue/component-azure-queue-toolbar.png" alt="Screenshot of a Cloudcraft interface showing configuration options for the 'Azure queue' component with pricing information." responsive="true" style="width:100%;">}}

For the **Azure queue** component, the following options are available:
...
The **Azure queue** component schema representation follows the format above and defines all fields within a diagram for this component.
