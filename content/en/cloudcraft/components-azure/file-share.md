---
title: "Component: File share"
kind: guide
---

{{< img src="cloudcraft/components-azure/file-share/component-file-share-diagram.png" alt="Screenshot of an isometric Cloudcraft diagram showing interconnected Azure components." responsive="true" style="width:100%;">}}

You can use the **File Share** component to represent and visualize file storage services from your Azure environment with Cloudcraft.

## Toolbar

To configure or customize how your File Share looks in a diagram, you can use the toolbar that appears when selecting a component inside the application.

### Option

{{< img src="cloudcraft/components-azure/file-share/component-file-share-toolbar.png" alt="Screenshot of a Cloudcraft interface showing configuration options for the 'File share' component with pricing information." responsive="true" style="width:100%;">}}

For the **File Share** component, the following options are available:
...
The **File Share** component schema representation follows the format above and defines all fields within a diagram for this component.
