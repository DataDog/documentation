...
{{< img src="cloudcraft/components-common/image/component-image.png" alt="Screenshot of a 3D representation of the image component in Cloudcraft" responsive="true" style="width:100%;">}}

The **Image** component is a basic but powerful component available for designing diagrams. Along with **Icon** and **Blocks**, it can be used to represent cloud components not yet available with Cloudcraft, as well as add new icon sets and software stacks.

## Toolbar

The toolbar is displayed when selecting a component. It allows you to replace the current image with a new one, and customize its visual to your liking.
