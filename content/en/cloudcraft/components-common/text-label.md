...
{{< img src="cloudcraft/components-common/text-label/component-text-label.png" alt="Screenshot of a 3D representation of the text label component in Cloudcraft" responsive="true" style="width:100%;">}}
