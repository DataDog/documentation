...
When sending custom feature flag change events, it is **strongly recommended** to include the following fields to ensure accurate filtering, and cross-product correlation within Datadog:
