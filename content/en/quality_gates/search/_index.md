...
{{< img src="quality_gates/rules_list_2.png" alt="PR Gate rules in Datadog displaying the rule name, evaluation, scope, blocking status, last modified date, and the creator avatar" style="width:100%" >}}
...
{{< img src="quality_gates/executions_sidepanel.png" alt="PR Gate rule displaying the rule execution status over time and rule executions" style="width:100%" >}}
