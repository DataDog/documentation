...
{% if equals($agent_version, "5_x_x") %}
### Running Agent v5 on Kubernetes

This isn't a real section, it's here to test the dynamic TOC.
{% /if %}
<!-- kubernetes > Agent version 6 -->
{% if equals($agent_version, "6_x_x") %}
...
<!-- postgres_version 10+ -->
{% if equals($postgres_version, "gte_10_x_x") %}
...
{% if equals($postgres_version, "lte_9_6_x") %}
...
{% if not(equals($agent_version, "5_x_x")) %}
