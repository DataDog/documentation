...
---
<div id="cdoc-selector"><div><div class="cdoc-filter__container"><div class="cdoc-filter__label">Language</div><div class="cdoc-filter__option selected" data-filter-id="prog_lang" data-option-id="python">Python</div><div class="cdoc-filter__option " data-filter-id="prog_lang" data-option-id="go">Go</div><div class="cdoc-filter__option " data-filter-id="prog_lang" data-option-id="javascript">JavaScript</div><div class="cdoc-filter__option " data-filter-id="prog_lang" data-option-id="ruby">Ruby</div><div class="cdoc-filter__option " data-filter-id="prog_lang" data-option-id="java">Java</div></div><div class="cdoc-filter__container"><div class="cdoc-filter__label">Operating system</div><div class="cdoc-filter__option selected" data-filter-id="os" data-option-id="linux">Linux</div><div class="cdoc-filter__option " data-filter-id="os" data-option-id="windows">Windows</div><div class="cdoc-filter__option " data-filter-id="os" data-option-id="mac_os">MacOS</div></div><div class="cdoc-filter__container"><div class="cdoc-filter__label">Database</div><div class="cdoc-filter__option selected" data-filter-id="database" data-option-id="postgres">Postgres</div><div class="cdoc-filter__option " data-filter-id="database" data-option-id="mysql">MySQL</div><div class="cdoc-filter__option " data-filter-id="database" data-option-id="sql_server">SQL Server</div></div><hr /></div></div><div id="cdoc-content" class="customizable"><article>
