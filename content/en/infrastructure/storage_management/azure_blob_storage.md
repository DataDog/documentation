...
8.  After you finish with the above steps, go to **Datadog** -> **Storage Management** > **Azure Blob Storage** > **Enable buckets**. Select the storage accounts you enabled inventory on and click **Confirm**.
