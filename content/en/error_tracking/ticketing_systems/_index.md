...
Datadog Error Tracking integrates with your existing ticketing workflows to streamline issue resolution. Link Error Tracking issues to Jira tickets, Linear issues, or Case Management cases to track and resolve errors within your established processes.

With ticketing system integrations, you can:

- **Create tickets directly from issues**: Open Jira tickets, Linear issues, or Case Management cases from the Error Tracking issue panel to centralize investigation efforts.
