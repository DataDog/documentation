...
If you have not set up the Datadog Android Logs SDK yet, follow the [in-app setup instructions][1] or see the [Android Logs setup documentation][2].
...
If you have not setup the Datadog iOS Logs SDK yet, follow the [in-app setup instructions][1] or see the [iOS Logs setup documentation][2].
