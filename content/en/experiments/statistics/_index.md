---
title: Statistics
description: Statistical methods and metrics for analyzing experiment results.
---

## Overview

Datadog Experiments provides statistical tools for estimating lift, choosing analysis methods, and understanding how experiment results translate to your full user population.
...
{{< whatsnext desc=" " >}}
    ...
    {{< nextlink href="/experiments/statistics/multiple_testing_correction" >}}Multiple Testing Correction: Control the family-wise error rate across multiple metrics and variants{{< /nextlink >}}
