...
{{< img src="real_user_monitoring/explorer/search/rum_explorer_search-2.png" alt="RUM Explorer" style="width:100%;">}}
...
{{< img src="real_user_monitoring/explorer/rum_explorer-3.png" alt="List of facets to the left of the events list" style="width:90%;">}}
...
You can also take taking metadata from a session and turn it into a facet (Virginia, for example) by clicking **+ Add** from the left side panel, then entering or selecting a path to the facet.
