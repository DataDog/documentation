...
- Application ID: Identifies the application available on the {{< ui >}}Application Overview{{< /ui >}} page
...
1. Click {{< ui >}}+ Add Widgets{{< /ui >}} to open the widgets and apps side panel.
2. Select {{< ui >}}Timeseries{{< /ui >}} under {{< ui >}}Graphs{{< /ui >}}.
3. In the {{< ui >}}Graph your data{{< /ui >}} section, select {{< ui >}}Metrics{{< /ui >}} and `datadog.estimated_usage.rum.sessions` from the dropdown menus.
4. In the `from` clause, select the application ID you are interested in tracking. The RUM application ID is available on its {{< ui >}}Application Overview{{< /ui >}} page. 
...
1. Go to your RUM application's {{< ui >}}Application Overview{{< /ui >}} page and copy the application ID.
...
3. Click {{< ui >}}Export to monitor{{< /ui >}}.
