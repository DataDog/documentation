...
<li>Make sure your proxy implementation do not allow a malicious actor to send request to a different server (ex: https://browser-intake-datadoghq.com.malicious.com).</li>  
</ul>
</div>
