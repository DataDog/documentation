...
### Event
The event is generated by the RUM SDK. Find more details about different event types and collected attributes in the [RUM data collected][1] documentation.
...
| View             | [Location][2]                  |
| Action           | [Event][3]                     |
| Resource (XHR)   | [XMLHttpRequest][4] and [PerformanceResourceTiming][5]            |
| Resource (Fetch) | [Request][6], [Response][7], and [PerformanceResourceTiming][5]      |
| Resource (Other) | [PerformanceResourceTiming][5] |
| Error            | [Error][8]                     |
| Long Task        | [PerformanceLongTaskTiming][9] |

More details about the structure of context objects is available in the [Browser SDK repository][10].
...
[5]: https://developer.mozilla.org/en-US/docs/Web/API/PerformanceResourceTiming
...
[9]: https://developer.mozilla.org/en-US/docs/Web/API/PerformanceLongTaskTiming
[10]: https://github.com/DataDog/browser-sdk/blob/main/packages/rum-core/src/domainContext.types.ts
