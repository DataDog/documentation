...
## View RUM usage
The newly tagged sessions are displayed on the [Usage Attribution][3] page. When you review the RUM with Sessions and RUM Sessions columns, you can see the number of sessions by department.
