...
We changed the default behaviour of distributed traces. The SDK will now by default inject trace context into outgoing request only when the trace is sampled in.
