...
kind: documentation
aliases:
- /real_user_monitoring/explorer/search
further_reading:
...
{{< img src="real_user_monitoring/explorer/rum_facet-2.png" alt="List of facets to the left of the events list" style="width:90%;">}}
