...
The RUM Android SDK allows you to get the data you need to Datadog while considering user bandwidth impact. Datadog SDK batches and uploads events as follows:
