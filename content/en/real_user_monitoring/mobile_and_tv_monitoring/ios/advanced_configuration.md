...
- If you use both automatic and manual tracking, you may see duplicate events. This is a known limitation, and the only way to avoid this is to rely on a single instrumentation type.
