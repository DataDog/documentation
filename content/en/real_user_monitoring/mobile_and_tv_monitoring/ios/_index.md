...
{{< whatsnext desc="This section includes the following topics:">}}
  {{< nextlink href="/real_user_monitoring/mobile_and_tv_monitoring/ios/setup">}}<u>Setup</u>: Learn how to setup the iOS SDK, track background events, and send data when devices are offline.{{< /nextlink >}}
