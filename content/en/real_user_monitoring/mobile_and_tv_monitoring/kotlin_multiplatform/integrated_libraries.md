...
2. Add a common dependency on `dd-sdk-kotlin-multiplatform-ktor` if you are using Ktor 2.x, or on `dd-sdk-kotlin-multiplatform-ktor3` if you are using Ktor 3.x:
