...
{{< whatsnext desc="This section includes the following topics:">}}
  {{< nextlink href="/real_user_monitoring/mobile_and_tv_monitoring/kotlin_multiplatform/setup">}}<u>Setup</u>: Learn how to set up the Kotlin Multiplatform SDK, track background events, and send data when devices are offline.{{< /nextlink >}}
