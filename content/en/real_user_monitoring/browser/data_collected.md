...
See a complete list of [Standard Attributes][1] for RUM Browser. Each event type the noted attributes attached by default, so you can use them regardless of the RUM event type being queried.
