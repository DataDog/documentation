...
For Auto-Instrumentation, ensure the [Datadog Agent][2] is installed with APM enabled and that your application is instrumented with the Datadog tracing library.
