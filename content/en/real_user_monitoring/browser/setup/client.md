...
: Required<br/>
**Type**: String<br/>
A [Datadog client token][12].

`site`
: Optional<br/>
**Type**: String<br/>
**Default**: `datadoghq.com`<br/>
[The Datadog site parameter of your organization][13].

`service`
: Optional<br/>
**Type**: String<br/>
The service name for your application. Follows the [tag syntax requirements][14].

`env`
: Optional<br/>
**Type**: String<br/>
The application's environment, for example: prod, pre-prod, and staging. Follows the [tag syntax requirements][14].

`version`
: Optional<br/>
**Type**: String<br/>
The application's version, for example: 1.2.3, 6c44da20, and 2020.02.13. Follows the [tag syntax requirements][14].

`trackingConsent`
: Optional<br/>
**Type**: `"granted"` or `"not-granted"`<br/>
**Default**: `"granted"`<br/>
Set the initial user tracking consent state. See [User Tracking Consent][15].

`trackViewsManually`
: Optional<br/>
**Type**: Boolean<br/>
**Default**: `false` <br/>
Allows you to control RUM views creation. See [override default RUM view names][16].
...
**Type**: Boolean<br/>
**Default**: `true` <br/>
Enables [automatic collection of users actions][17].
...
**Type**: String<br/>
**Default**: `mask` <br/>
See [Session Replay Privacy Options][18].

`enablePrivacyForActionName`
: Optional<br/>
**Type**: Boolean<br/>
**Default**: `false` <br/>
See [Mask Action Names][19].

`actionNameAttribute`
: Optional<br/>
**Type**: String<br/>
Specify your own attribute to be used to [name actions][20].
...
**Type**: Number<br/>
**Default**: `0`<br/>
The percentage of tracked sessions with [Browser RUM & Session Replay pricing][22] features: `100` for all, `0` for none. For more details about `sessionReplaySampleRate`, see the [sampling configuration][21].
...
: Optional<br/>
**Type**: String <br/>
If you are accessing Datadog through a custom subdomain, you can set `subdomain` to include your custom domain in the `getSessionReplayLink()` returned URL. For more details, see [Connect Session Replay To Your Third-Party Tools][24]
...
: Optional<br/>
**Type**: String<br/>
Optional proxy URL, for example: `https://www.proxy.com/path`. For more information, see the full [proxy setup guide][25].

`allowedTracingUrls`
: Optional<br/>
**Type**: List<br/>
A list of request URLs used to inject tracing headers. For more information, see [Connect RUM and Traces][26].

`traceSampleRate`
: Optional<br/>
**Type**: Number<br/>
**Default**: `100`<br/>
The percentage of requests to trace: `100` for all, `0` for none. For more information, see [Connect RUM and Traces][26].

`traceContextInjection`
: Optional<br/>
**Type**: `"all"` or `"sampled"`<br/>
**Default**: `"sampled"`<br/>
If you set a `traceSampleRate`, to ensure backend services' sampling decisions are still applied, configure the `traceContextInjection` initialization parameter to sampled. For more information, see [Connect RUM and Traces][26].
...
: Optional<br/>
**Type**: List<br/>
A list of request origins ignored when computing the page activity. See [How page activity is calculated][27].

`workerUrl`
: Optional<br/>
**Type**: String<br/>
URL pointing to the Datadog Browser SDK Worker JavaScript file. The URL can be relative or absolute, but is required to have the same origin as the web application. See [Content Security Policy guidelines][28] for more information.

`compressIntakeRequests`
: Optional<br/>
**Type**: Boolean<br/>
**Default**: `false`<br/>
Compress requests sent to the Datadog intake to reduce bandwidth usage when sending large amounts of data. The compression is done in a Worker thread. See [Content Security Policy guidelines][28] for more information.

`storeContextsAcrossPages`
: Optional<br/>
**Type**: Boolean<br/>
**Default**: `false`<br/>
Store global context and user context in `localStorage` to preserve them along the user navigation. See [Contexts life cycle][29] for more details and specific limitations.

`allowUntrustedEvents`
: Optional<br/>
**Type**: Boolean<br/>
**Default**: `false`<br/>
Allow capture of [untrusted events][30], for example in automated UI tests.
...
[15]: /real_user_monitoring/browser/advanced_configuration/#user-tracking-consent
[16]: /real_user_monitoring/browser/advanced_configuration/#override-default-rum-view-names
[17]: /real_user_monitoring/browser/tracking_user_actions/
[18]: /real_user_monitoring/session_replay/browser/privacy_options/
[19]: /data_security/real_user_monitoring/#mask-action-names
[20]: /real_user_monitoring/browser/tracking_user_actions/#declare-a-name-for-click-actions
[21]: /real_user_monitoring/guide/sampling-browser-plans/
[22]: https://www.datadoghq.com/pricing/?product=real-user-monitoring--session-replay#products
[23]: /real_user_monitoring/session_replay/browser/#usage
[24]: /real_user_monitoring/guide/connect-session-replay-to-your-third-party-tools
[25]: /real_user_monitoring/guide/proxy-rum-data/
[26]: /real_user_monitoring/correlate_with_other_telemetry/apm/
[27]: /real_user_monitoring/browser/monitoring_page_performance/#how-page-activity-is-calculated
[28]: /integrations/content_security_policy_logs/?tab=firefox#use-csp-with-real-user-monitoring-and-session-replay
[29]: /real_user_monitoring/browser/advanced_configuration/#contexts-life-cycle
[30]: https://developer.mozilla.org/en-US/docs/Web/API/Event/isTrusted
