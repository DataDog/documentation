...
## Setup
Follow the [in-app setup instructions][2] or [the steps on this page][5] to install the SDK and enable Roku Crash Reporting and Error Tracking.
...
[5]: /error_tracking/frontend/mobile/roku/
