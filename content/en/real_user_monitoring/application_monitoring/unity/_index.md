...
aliases:
- /real_user_monitoring/application_monitoring/setup/unity/
- /real_user_monitoring/mobile_and_tv_monitoring/unity
further_reading:
- link: /real_user_monitoring/application_monitoring/unity/troubleshooting
  tag: Documentation
  text: RUM Unity Troubleshooting
- link: https://github.com/DataDog/unity-package
  tag: "Source Code"
  text: Source code for Datadog SDK Unity Package
...
## Start monitoring Unity applications
...
{{< whatsnext desc="This section includes the following topics:">}}
  ...
  {{< nextlink href="/real_user_monitoring/application_monitoring/unity/mobile_vitals">}}<u>Mobile Vitals</u>: View mobile vitals, which help compute insights about your mobile application.{{< /nextlink >}}
