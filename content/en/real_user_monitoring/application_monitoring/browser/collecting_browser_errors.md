...
For security reasons, browsers hide details from errors triggered by cross-origin scripts. When this happens, the {{< ui >}}Error Details{{< /ui >}} tab shows an error with the minimal message "Script error."
