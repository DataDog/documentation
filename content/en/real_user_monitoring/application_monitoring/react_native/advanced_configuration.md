...
The Datadog RUM configuration. See [RUM Configuration][20].

`logsConfiguration`
: Optional<br/>
**Type**: `LogsConfiguration`<br/>
The Datadog Logs configuration. See [Logs Configuration][21].

`traceConfiguration`
: Optional<br/>
**Type**: `TraceConfiguration`<br>
The Datadog Trace configuration. See [Trace Configuration][22].
...
// RUM Event Mappers
config.rumConfiguration.errorEventMapper = (event) => event;
config.rumConfiguration.resourceEventMapper = (event) => event;
config.rumConfiguration.actionEventMapper = (event) => event;

// Log Event Mappers
config.logConfiguration = new LogConfiguration();
config.logConfiguration.logEventMapper = (event) => event;
```
...
const datadogConfiguration = new DatadogProviderConfiguration('<CLIENT_TOKEN>', '<ENVIRONMENT_NAME>');
datadogConfiguration.rumConfiguration = new RumConfiguration('<APPLICATION_ID>');
