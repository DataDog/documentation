...
{{< img src="real_user_monitoring/rum_without_limits/permanent-retention-filters.png" alt="The two permanent retention filters shown at the top of the retention filter list." style="width:90%" >}}

There are two permanent retention filters:

- **Sessions with forced replays**: Retains all sessions for which a replay was force-collected through the [force collection][1] mechanism.
- **Synthetics sessions**: Retains all sessions generated by [Synthetic Monitoring][8]. Synthetic sessions retained by this filter are not billed.
