...
Error Tracking processes errors collected from the RUM SDK for each framework.
...
3. Run the Gradle task to upload your Proguard/R8 mapping file to Datadog to access deobfuscated stack traces. 
