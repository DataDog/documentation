...
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Yes             | dSYM files are available once [App Store Connect][4] completes processing your application's build.                                                                                                                                                                                                    |
...
For more information, see [`fastlane-plugin-datadog`][6].

#### GitHub Action

The [Datadog Upload dSYMs GitHub Action][7] allows you to upload your symbols in your GitHub Action jobs:
...
For more information, see [dSYMs commands][8].
