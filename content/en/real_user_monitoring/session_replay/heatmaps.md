...
1. If the session does not contain the action that leads to the desired snapshot, you can return to the list of replays by clicking **Choose Another Replay**.
