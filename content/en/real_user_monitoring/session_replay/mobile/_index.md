...
{{< whatsnext desc="This section includes the following topics:" >}}
  ...
  {{< nextlink href="/real_user_monitoring/session_replay/app_performance">}}<u>Impact on App Performance</u>: Understand how Mobile Session Replay impacts app performance and resource usage.{{< /nextlink >}}
  {{< nextlink href="/real_user_monitoring/session_replay/troubleshooting">}}<u>Troubleshooting</u>: Resolve common Mobile Session Replay issues and errors.{{< /nextlink >}}
{{< /whatsnext >}}
