...
<div id="cdoc-selector"><div id="cdoc-filters-menu"><div class="filter-selector-menu" id="cdoc-filters-pill-menu"><div class="cdoc-pills-container"><p 
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="124">
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="128">
    <div class="code-snippet-wrapper">
      <div
        class="code-filename-wrapper d-flex justify-content-between collapsible"
      >
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="132">
    <div class="code-snippet-wrapper">
      <div
        class="code-filename-wrapper d-flex justify-content-between collapsible"
      >
  ...
  ></a>
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="137">
    <div class="code-snippet-wrapper">
      <div
        class="code-filename-wrapper d-flex justify-content-between collapsible"
      >
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="144">
    <p>
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="145">
    <a
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="149">
    <div class="code-snippet-wrapper">
      <div
        class="code-filename-wrapper d-flex justify-content-between collapsible"
      >
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="152">
    <div class="code-snippet-wrapper">
      <div
        class="code-filename-wrapper d-flex justify-content-between collapsible"
      >
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="156">
    <div class="code-snippet-wrapper">
      <div
        class="code-filename-wrapper d-flex justify-content-between collapsible"
      >
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="177">
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="181">
    <ul>
      <li>
        User-entered text in:
        <ul>
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="185">
    <ul>
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="189">
    <ul>
  ...
  <div class="cdoc__toggleable" data-description="SDK is Android" data-if="193">
    <p><strong>Shapes</strong></p>
    <ul>
