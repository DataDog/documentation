...
<div id="cdoc-selector"><div id="cdoc-filters-menu"><div class="filter-selector-menu" id="cdoc-filters-pill-menu"><div class="cdoc-pills-container"><p 
  ...
  <div class="cdoc__toggleable" data-if="199">
    <p>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="200">
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="201">
    <p>
      All Session Replay SDK versions can be found in the
      <a
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="202">
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="203">
  ...
  <div class="cdoc__toggleable" data-if="204">
    <p>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="205">
    <p>
      To instrument your consolidated web and native Session Replay views for
      iOS:
    </p>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="206">
    <p>
      To instrument your consolidated web and native Session Replay views for
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="207">
    <p>
      To instrument your consolidated web and native Session Replay views for
      React Native:
    </p>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="208">
    <p>
  ...
  <div class="cdoc__toggleable" data-if="209">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="210">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">AppDelegate.swift</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="211">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="212">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">App.tsx</p>
      </div>
  ...
  <div class="cdoc__toggleable" data-if="213">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-end"></div>
      <div class="code-snippet">
        <div class="code-button-wrapper position-absolute">
  ...
  <div class="cdoc__toggleable" data-if="214">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="215">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">AppDelegate.swift</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="216">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="217">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">App.tsx</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="218">
    <p>
  ...
  <div class="cdoc__toggleable" data-if="219">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="220">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">AppDelegate.swift</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="221">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="222">
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="223">
    <p>
