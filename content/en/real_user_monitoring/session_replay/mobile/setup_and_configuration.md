...
<div id="cdoc-selector"><div id="cdoc-filters-menu"><div class="filter-selector-menu" id="cdoc-filters-pill-menu"><div class="cdoc-pills-container"><p 
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="163">
  ...
  <div class="cdoc__toggleable" data-if="164">
    <p>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="166">
    <p>
      To instrument your consolidated web and native Session Replay views for
  ...
  <div class="cdoc__toggleable" data-if="168">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="169">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">AppDelegate.swift</p>
      </div>
  ...
  <div class="cdoc__toggleable" data-if="172">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="173">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">AppDelegate.swift</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="174">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="175">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">App.tsx</p>
      </div>
  ...
  <div class="cdoc__toggleable" data-if="176">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">Application.kt</p>
      </div>
  ...
  <div class="cdoc__toggleable cdoc__hidden" data-if="177">
    <div class="code-snippet-wrapper">
      <div class="code-filename-wrapper d-flex justify-content-between">
        <p class="code-filename my-0">AppDelegate.swift</p>
      </div>
