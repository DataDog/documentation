...
{{< img src="real_user_monitoring/flutter/react-native-perf-dash-link.png" alt="Access the mobile performance dashboard from the Performance Summary tab" style="width:90%;">}}
