...
Access your RUM dashboards by filtering for `RUM` in the search query of the [**Dashboard List**][2] or from your application summary pages (**Real User Monitoring > Performance Summary** and **Real User Monitoring > Product Analytics > Analytics Summary**).
