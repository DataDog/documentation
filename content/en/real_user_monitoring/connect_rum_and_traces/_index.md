...
{{< alert type="info" >}}End-to-end tracing is available for requests fired after the browser SDK is initialized. End-to-end tracing of the initial HTML document, and early browser requests, is not supported.{{< /alert >}}
