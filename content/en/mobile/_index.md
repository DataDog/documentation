...
**Note**: IdP-initiated login (authentication starting from the SAML identity provider) needs additional configuration on the identity provider side. Please contact [Datadog Support][5] for more information or if you have issues with SAML login.
