...
If your use case is limited to accessing On-Call on mobile and you prefer to restrict access to sensitive telemetry data on mobile devices, reach out to support.
</div>
