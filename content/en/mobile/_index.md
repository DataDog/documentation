...
You can log in using standard authentication, Google authentication, or [SAML][3] - on both US and EU region.
...
**Note**: The mobile app does not support IdP-initiated login (authentication starting from the SAML identity provider) for the moment. Contact [Datadog Support][5] for more information or if you have any issues with SAML authentication.
