...
1. In the mobile app, select your data center region (for example, US1).
...
6. Enter your org's SAML credentials, which upon success will reroute to an authenticated session of the Datadog mobile app.
