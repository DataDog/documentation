...
**Note**: The mobile app currently does not support IdP-initiated login (authentication starting from the SAML identity provider). Please contact [Datadog Support][10] for more information or if you have issues with SAML login.
