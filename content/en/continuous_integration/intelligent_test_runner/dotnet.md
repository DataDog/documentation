...
Prior to setting up Intelligent Test Runner, you must have finished setting up [Test Visibility for .NET][1]. If you are reporting data through the Datadog Agent you need to use v6.40+/v7.40+.
