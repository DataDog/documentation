...
After setting these environment variables, run your tests as you normally do by using [dotnet test][3] or [VSTest.Console.exe][4]:
...
[3]: https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-test
[4]: https://docs.microsoft.com/en-us/visualstudio/test/vstest-console-options
