...
If there are other branches you want to exclude, you can add them in the Intelligent Test Runner settings page. The query bar supports the wildcard character `*` to exclude any branches that match.
