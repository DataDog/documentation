...
Configure the integration on a per project or group basis by going to **Settings > Integrations > Datadog** for each project or group you want to instrument. You can also activate the integration at the GitLab [instance level][9] by going to **Admin > Settings > Integrations > Datadog**, which will be applied to all existing and future projects.
...
**Datadog site**
: Specifies which [Datadog site][10] to send data to. Please note that only `datadoghq.com` is currently supported.<br/>
