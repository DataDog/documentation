...
infrastructure metrics. To see the metrics just click on a job span in the trace view and in the drawer a new tab named **Infrastructure** will
show which contains the host metrics.
