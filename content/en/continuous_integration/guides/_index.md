...
{{< whatsnext desc="Pipeline Visibility Guides:" >}}
    ...
    {{< nextlink href="/continuous_integration/guides/use_ci_jobs_failure_analysis/" >}}Use CI jobs failure analysis to identify the root cause of your failed CI Jobs{{< /nextlink >}}
{{< /whatsnext >}}
