...
{{< whatsnext desc="Pipeline Visibility Guides:" >}}
    ...
    {{< nextlink href="/continuous_integration/guides/identify_highest_impact_jobs_with_critical_path/" >}}Identify CI Jobs on the Critical Path to improve your Pipelines{{< /nextlink >}}
{{< /whatsnext >}}
