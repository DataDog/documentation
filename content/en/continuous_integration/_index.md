...
{{< alert type="info" >}}<p>CI Visibility is in beta. There are no billing implications for tracing pipelines and tests during this period.</p>
{{< /alert >}}
{{< site-region region="us3,gov" >}}
{{< alert type="info" >}}<p>CI Visibility is available only on the US1 and EU1 Datadog sites at this time.</p>{{< /alert >}}
{{< /site-region >}}
