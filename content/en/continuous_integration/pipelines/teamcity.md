...
The integration between [TeamCity][1] and Datadog CI Visibility is provided through a TeamCity [plugin][8].
...
therefore there might be cost implications when the two username styles mentioned above are used.
