...
2. Add the Datadog app registration to your Azure DevOps organization. Navigate to **Organization settings** in your DevOps console, click on **Users** on the left side panel, then click on **Add Users**. If you don't see the button, you may not have the necessary permissions. You should add your app registration as a user with Basic Access Level to each project for which you want to enable log collection. Alternatively, you can click on  **Add to all projects** to configure all projects in bulk.
