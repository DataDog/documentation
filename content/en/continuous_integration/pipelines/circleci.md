...
If you want to enable the hooks for many or all your CircleCI projects, Datadog provides a [script](https://raw.githubusercontent.com/DataDog/ci-visibility-circle-ci/main/service_hooks.py) to help you do it through the Circle CI API.

To run the script, you need:

- A Circle CI personal API token
- To log in to your Circle CI account and follow all the projects for which you want to enable the hooks. You may use the "Follow All" button located at the top of the Projects page.
