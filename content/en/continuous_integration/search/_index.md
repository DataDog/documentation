...
The [Pipelines page][101] shows aggregate stats of your pipelines as well as the status of the latest pipeline execution. For pipelines with Git information, it only shows stats for the default branch of each pipeline over the selected time frame. The _default_ branch is usually named something like `main` or `prod`. Use this page to see all your pipelines and get a quick view of their health.
