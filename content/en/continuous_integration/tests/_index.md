...
In addition to tests, you have visibility over the whole testing phase of your project. On the [Test Runs][4] page, you can filter by test level: session, module, suite and test. Each test level represents a different level of aggregation of tests.
...
#### Module
The definition of module changes slightly per language: for .NET, they represent every test that is run under the same [unit test project][8]; for Swift, it's every test that is run for a given bundle and for JavaScript there are no modules.
...
* [.NET][11] has complete support since version ...
* [Swift][12] has complete support since version ...
