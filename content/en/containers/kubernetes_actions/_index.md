...
After Kubernetes Actions is enabled, actions are available from the [Kubernetes Explorer][6]. You can start an action from the resource's side panel, from the action tray kebab menu, or directly from the Explorer table row.
