...
- Datadog Cluster Agent v7.79.0 or later.
...
1. Ensure you are using Cluster Agent v7.79.0 or later. Add the following to your `datadog-values.yaml` configuration file to enable Remote Configuration and Kubernetes Actions on the Cluster Agent:
