...
| `global.registry` | Image registry to use for all Agent images. When unset, the default registry depends on your Datadog site, cluster type, and `registryMigrationMode`. |
...
| `registry` | Image registry to use for all Agent images. When unset, the default registry depends on `datadog.site`, cluster type, and `registryMigrationMode`. |
