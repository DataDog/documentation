...
For Agent v7.24.0+, use the following environment variable configuration to add all resource labels as tags to all metrics except KSM metrics (kubernetes_state.*), logs, and traces. In this example, the tags' names for pods are prefixed by `<PREFIX>_`:
...
**Important:** Tags do NOT cascade between parent and child resources. For example, annotations on a Deployment are NOT automatically applied to logs from its child Pods. To tag pod logs, you must configure annotations on the Pods themselves.
...
For Agent v7.24.0+, use the following environment variable configuration to add all resource annotations as tags to all metrics except KSM metrics (kubernetes_state.*), logs, and traces. In this example, the tags' names for pods are prefixed by `<PREFIX>_`:
...
For Agent v7.24.0+, use the following environment variable configuration to add all node labels as tags to all metrics except KSM metrics (kubernetes_state.*), logs, and traces. In this example, the tags' names are prefixed by `<PREFIX>_`:
...
For Agent v7.24.0+, use the following environment variable configuration to add all pod labels as tags to pod metrics, logs, and traces. In this example, the tags' names are prefixed by `<PREFIX>_`:
...
For Agent v6.8.0+, use the following environment variable configuration to add all pod labels as tags to all metrics except KSM metrics (kubernetes_state.*), logs, and traces. In this example, the tags names are prefixed by `<PREFIX>_`:
...
For Agent v7.24.0+, use the following environment variable configuration to add all pod annotations as tags to pod/container runtime metrics, logs, and traces. In this example, the tags' names are prefixed by `<PREFIX>_`:
...
For Agent v7.24.0+, use the following environment variable configuration to add all pod annotations as tags to pod metrics, logs, and traces. In this example, the tags' names are prefixed by `<PREFIX>_`:
...
For Agent v7.24.0+, use the following environment variable configuration to add all pod annotations as tags to all metrics except KSM metrics (kubernetes_state.*), logs, and traces. In this example, the tags names are prefixed by `<PREFIX>_`:
...
For Agent v7.24.0+, use the following environment variable configuration to add all namespace labels as tags to all metrics except KSM metrics (kubernetes_state.*), logs, and traces. In this example, the tags' names are prefixed by `<PREFIX>_`:
...
Use the following environment variable configuration to add all namespace labels as tags to all metrics except KSM metrics (kubernetes_state.*), logs, and traces. In this example, the tag names are prefixed by `<PREFIX>_`:
