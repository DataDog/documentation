...
The Datadog Operator chart and Helm chart are progressively migrating from Google Artifact Registry (`gcr.io/datadoghq`) to the Datadog Container Registry (`registry.datadoghq.com`).
