...
In this case, the configuration parameter `datadog.containerIncludeLogs` is ignored, and Autodiscovery log configurations must be applied to the desired target pods or set in an agent configuration file.
