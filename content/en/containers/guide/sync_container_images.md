...
Datadog publishes container images in multiple public container registries.
...
[Crane][1] is a tool made by Google to manage container images and registries and can be used to synchronize images between different container registries.
For more information about Crane, see the [Crane documentation][2].
...
```shell
AGENT_VERSION=<REPLACE_BY_AGENT_IMAGE_TAG>
OPERATOR_VERSION=<REPLACE_BY_OPERATOR_IMAGE_TAG>
REGISTRY=<REPLACE_BY_REGISTRY_URL>
