...
If you do not want to autoscale with the `DatadogMetric` you can still create your HPAs with the native format. The Cluster Agent converts the HPA format into a Datadog metric query.
