...
<div class="alert alert-info">The Datadog Helm chart uses the Datadog Container Registry (<code>registry.datadoghq.com</code>) by default. As of Datadog Operator chart version 2.19.0, the Operator chart also uses the Datadog Container Registry by default.</div>
