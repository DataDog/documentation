...
*   **`resource`** - _Required._ The resource you are tracing. The resource must not be longer than 5000 characters.
*   **`service`** - _Required._ The service you are tracing. The service must not be longer than 100 characters.
