...
2. As seen below, filter for Datadog and click on the tile.
        {{< img src="integrations/opsgenie/opsgenie-int-index.png" responsive="true" >}}
3. Enter your Datadog API key from the [Integrations > APIs page](https://app.datadoghq.com/account/settings#api) in the dedicated field. The key looks like this:
        {{< img src="integrations/opsgenie/where-is-dd-key.png" responsive="true" >}}
...
7. Copy the red key and the name. You will use this in Datadog.
        {{< img src="integrations/opsgenie/opsgenie-add-api-key.png" responsive="true" >}}
...
{{< img src="integrations/opsgenie/datadog-add-opsgenie-key.png" responsive="true" >}}
...
{{< img src="integrations/opsgenie/og_metric_alert.png" responsive="true" >}}
...
{{< img src="integrations/opsgenie/dd_ack_og_alert.png" responsive="true" >}}
...
{{< img src="integrations/opsgenie/og_create_alert_dd_updated.png" responsive="true" >}}
...
{{< img src="integrations/opsgenie/og_closed_dd_updated.png" responsive="true" >}} -->
