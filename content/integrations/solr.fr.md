...
- search
ddtype: check
doc_link: https://docs.datadoghq.com/integrations/solr/
...
short_description: Monitor request rate, handler errors, cache misses and evictions,
  and more.
support: core
supported_os:
- linux
...
[Run the Agent's `status` subcommand](https://docs.datadoghq.com/agent/faq/agent-status-and-information/) and look for `solr` under the Checks section:
