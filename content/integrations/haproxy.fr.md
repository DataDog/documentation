...
- log collection
ddtype: check
description: The HAProxy integration helps to collect performance and avaialbility
  metrics from HAProxy instances.
display_name: haproxy
doc_link: https://docs.datadoghq.com/integrations/haproxy/
...
short_description: Monitor key metrics for requests, responses, errors, bytes served,
  and more.
support: core
supported_os:
- linux
