---
display_name: Amazon Web Service EKS
doc_link: https://docs.datadoghq.com/integrations/amazon_eks/
git_integration_title: amazon_eks
has_logo: true
integration_title: AWS-EKS
is_public: true
kind: integration
name: amazon_eks
public_title: Datadog-AWS EKS Integration
categories:
- aws
- containers
- orchestration
...
{{< img src="integrations/amazon_eks/eks_screenboard.png" alt="EKS Screenboard" responsive="true" popup="true">}}
