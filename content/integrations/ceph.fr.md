...
- os & system
ddtype: check
doc_link: https://docs.datadoghq.com/integrations/ceph/
...
short_description: Collect per-pool performance metrics and monitor overall cluster
  status.
support: core
supported_os:
- linux
...
[Run the Agent's `status` subcommand](https://docs.datadoghq.com/agent/faq/agent-status-and-information/) and look for `ceph` under the Checks section:
