---
aliases: []
description: Track redis performance, memory use, blocked clients, evicted keys, and
  more.
git_integration_title: redisdb
integration_title: ''
kind: integration
newhlevel: true
title: Datadog-RedisDB Integration
---
...
: /var/run/redis/redis.sock # if your redis uses a socket instead of TCP
: myredispassword                   # if your redis requires auth
```
