...
instances:
 ...
 change the top-level namespace for metrics, e.g. my_go_app.memstats.alloc
 ...
 you don't want it named my_go_app.my_func_counter
: my_go_app.preferred_counter_name
