...
name: zendesk
public_title: Datadog-Zendesk Integration
short_description: Track new versus solved tickets; auto-generate tickets from Datadog
  monitors.
version: '1.0'
---
...
### Service Checks
The Zendesk integration does not include any service check at this time.
