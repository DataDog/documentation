...
3. Under properties, copy the Directory ID Value
    ...
    {{< img src="integrations/azure/Azure_tenant_name.png" alt="Azure tenant name" responsive="true" >}}

4. Paste the ID under "Tenant Name/ID" in the form on the Azure setup tile

    {{< img src="integrations/azure/tenant_name_form.png" alt="tenant name form" responsive="true" >}}
...
4. Press "Create"
    ...
    {{< img src="integrations/azure/Azure_create_ad.png" alt="azure create ad" responsive="true" >}}
...
6. Copy the "Application ID" and paste the value into "Client ID" in the form on the Azure setup tile
    ...
    {{< img src="integrations/azure/Azure_client_id.png" alt="azure client id" responsive="true" >}}

    {{< img src="integrations/azure/client_id_form.png" alt="client id form" responsive="true" >}}
...
10. When the Secret Key is shown, copy and paste it in "Client Secret" in the form on the Azure setup tile
    ...
    {{< img src="integrations/azure/Azure_client_secret.png" alt="azure client secret" responsive="true">}}

    {{< img src="integrations/azure/client_secret_form.png" alt="client secret" responsive="true">}}
...
1. Navigate to “Subscriptions” on the left hand menu
    ...
    {{< img src="integrations/azure/subscriptions_icon.png" style="width:50%;" alt="subscriptions icon" responsive="true">}}

2. Click on the subscription you would like to monitor
3. Click on "Access control (IAM)" in the lefthand menu

    {{< img src="integrations/azure/access_control_button.png" style="width:50%;" alt="access control button" responsive="true">}}

4. Click "Add"

    {{< img src="integrations/azure/add_user_button.png" style="width:50%;" alt="add user button" responsive="true">}}

5. Select “Reader” as a role

    {{< img src="integrations/azure/reader_icon.png" style="width:50%;" alt="reader icon" responsive="true">}}
...
{{< img src="integrations/azure/azure_vm_screenboard.png" alt="azure vm screenboard" responsive="true">}}
...
{{< img src="integrations/azure/filter_form.png" alt="filter_form" responsive="true">}}
...
{{< img src="integrations/azure/azure_tenant_url.png" alt="azure tenant url" responsive="true">}}
...
4. Click Save to save your changes
    ...
    {{< img src="integrations/azure/azure_enable_diagnostics.png" alt="azure enable diagnostics" responsive="true">}}
