...
* Get metrics for other services: Application Gateway, App Service (Web & Mobile), Server Farm, Batch Service, Event Hub, IOT Hub, Logic App, Redis Cache, SQL Database, SQL Elastic Pool, and Virtual Machine Scale Set
