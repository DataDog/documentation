...
- network
ddtype: check
doc_link: https://docs.datadoghq.com/integrations/ntp/
...
[Run the Agent's `status` subcommand](https://docs.datadoghq.com/agent/faq/agent-status-and-information/) and look for `ntp` under the Checks section:
