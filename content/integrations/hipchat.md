...
**NOTICE** : 
If you are using a hipchat API V1 token, if your chat name contains special characters such as commas or brackets, they'll be escaped when sending notifications with the @ handle. You shouldn't have to worry about that, the autocomplete box automatically takes care of escaping chat names.

If you are using a hipchat API V2 token, your chat should only have lower case alphanumerical characters and the special characters '-' and '_'.
