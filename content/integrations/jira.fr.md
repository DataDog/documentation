...
{{< img src="integrations/jira/JiraInstallation9.png" alt="settings" responsive="true" popup="true" style="width:75%;" >}}
...
2. Go to settings (Gear icon) –> Applications
    ...
    {{< img src="integrations/jira/JiraInstallation2.png" style="width:50%;" alt="settings" responsive="true" popup="true">}}

3. Under "Integrations" in left menu, Select Application Links

    {{< img src="integrations/jira/JiraInstallation3.png" style="width:25%;" alt="settings" responsive="true" popup="true">}}

4. Enter `https://app.datadoghq.com/` as the URL to link –> press "Create new link"

    {{< img src="integrations/jira/JiraInstallation4.png" style="width:75%;" alt="settings" responsive="true" popup="true">}}
...
8. Press Continue
    ...
    {{< img src="integrations/jira/JiraInstallation5.png" style="width:40%;" alt="settings" responsive="true" popup="true">}}

9. Copy and Paste the Consumer Key, Consumer Name, and Public Key from the Jira tile

10. Press Continue

    {{< img src="integrations/jira/JiraInstallation6.png" style="width:40%;" alt="settings" responsive="true" popup="true">}}
...
13. Press Install
    ...
    {{< img src="integrations/jira/JiraInstallation7.png" style="width:50%;" alt="settings" responsive="true" popup="true">}}
...
{{< img src="integrations/jira/JiraInstallation8.png" alt="settings" responsive="true" popup="true">}}
