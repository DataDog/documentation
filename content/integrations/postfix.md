...
instances:
 one instance for each postfix service you want to track
...
instances:
 config_directory option only applies when `postqueue: true`.
 config_directory is the location of the Postfix configuration directory
 main.cf lives.
