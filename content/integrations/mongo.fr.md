...
- log collection
ddtype: check
doc_link: https://docs.datadoghq.com/integrations/mongo/
...
[Run the Agent's `status` subcommand](https://docs.datadoghq.com/agent/faq/agent-status-and-information/) and look for `mongo` under the Checks section:
