...
kind: integration
newhlevel: true
title: Datadog-HTTP Check Integration
---
...
: false      # default is true, so set false to check SSL validation
: /path/to/ca/file         # e.g. /etc/ssl/certs/ca-certificates.crt
: true # default is true
: 28                   # default 14
: 14                  # default 7
: 3                         # in seconds. Default is 1.
