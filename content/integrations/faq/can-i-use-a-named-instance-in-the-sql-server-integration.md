...
The SQL Server Browser service is required to use named instances and this service is disabled by default. We highly recommend the approval of a sys admin before enabling [this service][2].aspx).
...
[2]: https://technet.microsoft.com/en-us/library/ms165734(v=sql.90
