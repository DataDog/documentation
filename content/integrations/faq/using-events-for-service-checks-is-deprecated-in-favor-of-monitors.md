...
If this warning is a distraction for you or your team you may get rid of it by enabling the “skip_event” attribute in the source YAML file. [Here is an example](https://github.com/DataDog/integrations-core/blob/master/http_check/conf.yaml.example#L110-L114) using the HTTP_check: