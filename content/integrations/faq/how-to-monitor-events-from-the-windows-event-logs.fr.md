---
title: Comment monitorer des événements issus du Windows Event Logs ?
kind: faq
---
...
Pour ce faire, ouvrez le gestionnaire d'Agents Datadog et, dans le volet de gauche, accédez à la section Windows Event Log.

Ici définit les filtres qui correspondent aux événements entrants:
```yaml
# init_config:
# 
# instances:
