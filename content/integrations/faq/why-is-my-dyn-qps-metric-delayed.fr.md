...
Utilisez [l'intégration Dyn de Datadog][1] pour visualiser et monitorer le nombre de requêtes DNS effectuées par seconde et le nombre de changements de zone.
