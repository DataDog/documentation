---
title: Troubleshooting et Deep Dive for Kafka
kind: faq
---
...
# - host: remotehost
    ...
    # newTag: test
```
Si vous exécutez Producers et Consumers à partir d'autres languages, ce n'est pas une option, et vous devez utiliser un autre moyen pour envoyer ces métriques à partir de votre code, par exemple via dogstatsd.
