...
Pour vérifier que vous avez accès à JMX, testez en utilisant JConsole ou équivalent . Si vous ne parvenez pas à vous connecter à l'aide de JConsole [cet article][1], vous sera peut-être plus utile. En outre, si les métriques listées dans votre YAML ne sont pas 1:1 avec celles listées dans JConsole, vous devrez le corriger.
