...
Assurez-vous de [redémarrer votre agent](/agent/faq/agent-commands/#start-stop-restart-the-agent) après avoir mis à jour la configuration, et vous devriez voir plus de métriques provenant de cette configuration.