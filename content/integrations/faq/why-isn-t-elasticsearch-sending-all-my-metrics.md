...
If you've configured the Elasticsearch integration but feel you are not being sent all the available metrics, it may be because your cluster is hosted externally. If this is the case, you will need to change your elastic.yaml configuration file to include `is_external: true`. This parameter defaults to false for customers pointing to localhost.
