...
Si ce n'est pas le cas, modifiez vos autorisations pour l'URL de statut afin d'autoriser l'accès à partir de l'host. Vous pouvez lire [cet article][1] pour plus d'informations.

Si vous avez encore des problèmes, [contactez-nous][2] avec [un flare][3].
