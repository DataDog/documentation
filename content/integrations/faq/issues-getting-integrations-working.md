...
2. Is the integration showing up in the [info command](/agent/faq/agent-status-and-information)?
    * No, it’s not.
        ...
        3. If you moved or changed the file, [restart the Agent](/agent/faq/agent-commands/#start-stop-restart-the-agent) and then rerun the info command to see if it is now showing up.
    * Yes, it’s there.
