---
title: Comment récupérer les métriques WMI
kind: faq
---

## Qu'est-ce que WMI?

Dans le monde de Windows, les métriques des systèmes d'exploitation et des applications sont exposées à l'aide de Windows Management Instrumentation. L'Agent Datadog pour Windows est livré avec une intégration WMI prête à l'emploi, ce qui vous permet de monitorer les informations qui vous intéressent.
