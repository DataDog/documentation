---
title: Les métriques Producer et Consumer n'apparaissent pas dans mon application Datadog.
kind: faq
---

Par défaut, nous collectons uniquement des métriques basées sur les broker.
