...
**ヒント**: <kbd>Cmd</kbd>/<kbd>Ctrl</kbd> + <kbd>K</kbd> を押すと、Datadog 全体からダッシュボードやモニターなどのページやエンティティを検索できます。
