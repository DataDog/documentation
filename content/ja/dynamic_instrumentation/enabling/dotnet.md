...
3. [.NET Framework][2] または [.NET Core][3] の手順に従って、.NET トレーシングライブラリをインストールまたはバージョン 2.22 にアップグレードします。

   **注**: ダイナミックインスツルメンテーションは、バージョン 2.23.0 以降の `dd-trace-dotnet` ライブラリで利用可能です。
