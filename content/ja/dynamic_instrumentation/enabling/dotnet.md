...
3. [.NET Framework][2] または [.NET Core][3] の手順に従って、.NET トレーシングライブラリのバージョン 2.32 をインストールするか、アップグレードします。

   **注**: ダイナミックインスツルメンテーションは、バージョン 2.32.0 以降の `dd-trace-dotnet` ライブラリで利用可能です。
