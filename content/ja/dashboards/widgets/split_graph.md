...
スプリットグラフエディタは、[**Edit Graph**](#edit-graph) と [**Split Graph**](#edit-split) の 2 つのセクションから構成されています。ウィジェットのタイトルを追加するには、エディタ上部のテキスト入力を更新します。
...
{{< img src="dashboards/widgets/split_graph/split_graph_tab.png" alt="スプリットグラフタブには、スプリットグラフの構成オプションが表示されます" style="width:100%;" >}}
