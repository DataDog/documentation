...
このウィジェットは、**ダッシュボード API** とともに使用できます。詳しくは、[ダッシュボード API][10] ドキュメントをご参照ください。

時系列ウィジェットの[ウィジェット JSON スキーマ定義][11]は次のとおりです。
...
[10]: /ja/api/v1/dashboards/
[11]: /ja/dashboards/graphing_json/widget_json/