...
先ずは、["Datadogが提供するサービスの概要"][4]を一読することをお勧めします。このドキュメントでは、Datadog内で利用できる各種監視機能の概要を素早く把握することができます。
...
Datadogサイト内のメッセージを入力するスペースで、[@support-datadog][5]に続きお問い合わせに関するメッセージを記述することで、サポートチームに問い合わせ依頼を送信することができます。更に、[email][6]、[IRC][7]、ZenDeskの[お問い合わせ][8]ページらでも、問い合わせることができます。
