...
| メトリクス      | 同じサービスのすべてのプロファイルからのプロファイリングメトリクス                                                                              |
...
| プロファイルタイプ | 定義 |
| ------------ | ---------- |
| 割り当て   | 各関数によって割り当てられたヒープメモリの量を示します。これには、後で解放された割り当ても含まれます。 |
| Wall         | 各関数が使用した経過時間を表示します。経過時間には、コードが CPU で実行されている時間、I/O を待機している時間、および関数の実行中に発生するその他の時間が含まれます。 |
