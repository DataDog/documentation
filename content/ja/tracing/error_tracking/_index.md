...
**Backend Services** のエラー追跡のために APM をセットアップすると、問題リストにカードが入力されます。また、未解決の問題、無視されている問題、すべての問題を表示したり、量や年齢で問題をソートしたり、バックエンドサービスにあるすべてのカスタムおよびデフォルトのファセットで問題をフィルターしたりすることができます。
