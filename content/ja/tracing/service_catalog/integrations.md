...
PagerDuty メタデータをサービスに追加することで、サービスカタログに、誰がオンコールしているか、そのサービスに対してアクティブな PagerDuty インシデントがあるかなどの情報を表示したり、リンクしたりすることができます。オンコールを 1 つしか表示できないため、Datadog はエスカレーションレベルによって最初のユーザーを選択し、次にメールによってアルファベット順に選択します。
