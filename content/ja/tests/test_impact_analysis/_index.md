...
Datadog ライブラリを Test Impact Analysis 用に設定したら、[Test Service Settings][5] ページから構成します。Test Impact Analysis を有効にするには、`Intelligent Test Runner Activation Write` 権限が必要です。
