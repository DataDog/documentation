...
- link: /security/cloud_security_management/identity_risks/
  tag: ドキュメント
  text: CSM Identity Risks でアイデンティティの状況を把握する
- link: /security/cloud_security_management/vulnerabilities/
  tag: ドキュメント
  text: CSM Vulnerabilities について
...
| **Improbable**      | Low     | 小        | Medium   | 中       |
| **Possible**        | Low     | Medium     | High     | 大         |
| **Probable**        | Medium  | High       | 大     | Critical     |
| **Highly Probable** | Medium  | High       | Critical | クリティカル     |
