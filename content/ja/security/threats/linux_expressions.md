...
## Linux Agent の属性とヘルパー
このドキュメントでは、[Datadog の Security Language (SECL)][1] における Linux の属性とヘルパーについて説明します。
...
| `network_flow_monitor` | ネットワーク | ネットワーク モニター イベントが送信されました | 7.63 |
| `open` | ファイル | ファイルが開かれた | 7.27 |
| `packet` | ネットワーク | 生のネットワーク パケットがキャプチャされました | 7.60 |
...
| `sysctl` | カーネル | sysctl パラメーターの読み取りまたは変更が行われました | 7.65 |
...
### コマンドライン引数
*args_flags* と *args_options* は、コマンドライン引数に基づく CSM 脅威ルールの記述を容易にするためのヘルパーです。
...
* `exec.args_options in [ r"s=.*\\" ]` を使用すると、`sudoedit` が `-s` 引数と末尾に `\` が付いたコマンドで起動されたことを検知できます。
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
| [`container.created_at`](#container-created_at-doc) | コンテナ作成時のタイムスタンプ |
| [`container.id`](#container-id-doc) | コンテナの ID |
| [`container.runtime`](#container-runtime-doc) | コンテナを管理するランタイム |
| [`container.tags`](#container-tags-doc) | コンテナのタグ |
| [`event.async`](#event-async-doc) | syscall が非同期の場合、true |
| [`event.hostname`](#event-hostname-doc) | イベントに関連付けられたホスト名 |
| [`event.origin`](#event-origin-doc) | イベントの発生元 |
| [`event.os`](#event-os-doc) | イベントが発生したオペレーティングシステム |
| [`event.service`](#event-service-doc) | イベントに関連付けられたサービス |
...
| [`process.ancestors.auid`](#common-credentials-auid-doc) | プロセスのログイン UID |
...
| [`process.ancestors.cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`process.ancestors.cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`process.ancestors.cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`process.ancestors.cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`process.ancestors.cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
...
| [`process.ancestors.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`process.ancestors.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`process.ancestors.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`process.ancestors.interpreter.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`process.ancestors.interpreter.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`process.ancestors.interpreter.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`process.ancestors.interpreter.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`process.ancestors.interpreter.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`process.ancestors.is_exec`](#common-process-is_exec-doc) | プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します |
...
| [`process.ancestors.user_session.k8s_groups`](#common-usersessioncontext-k8s_groups-doc) | プロセスを実行したユーザーの Kubernetes グループ |
| [`process.ancestors.user_session.k8s_uid`](#common-usersessioncontext-k8s_uid-doc) | プロセスを実行したユーザーの Kubernetes UID |
| [`process.ancestors.user_session.k8s_username`](#common-usersessioncontext-k8s_username-doc) | プロセスを実行したユーザーの Kubernetes ユーザー名 |
...
| [`process.auid`](#common-credentials-auid-doc) | プロセスのログイン UID |
...
| [`process.cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`process.cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`process.cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`process.cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`process.cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
...
| [`process.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`process.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`process.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`process.interpreter.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`process.interpreter.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`process.interpreter.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`process.interpreter.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`process.interpreter.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`process.is_exec`](#common-process-is_exec-doc) | プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します |
...
| [`process.parent.auid`](#common-credentials-auid-doc) | プロセスのログイン UID |
...
| [`process.parent.cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`process.parent.cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`process.parent.cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`process.parent.cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`process.parent.cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
...
| [`process.parent.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`process.parent.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`process.parent.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`process.parent.interpreter.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`process.parent.interpreter.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`process.parent.interpreter.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`process.parent.interpreter.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`process.parent.interpreter.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`process.parent.is_exec`](#common-process-is_exec-doc) | プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します |
...
| [`process.parent.user_session.k8s_groups`](#common-usersessioncontext-k8s_groups-doc) | プロセスを実行したユーザーの Kubernetes グループ |
| [`process.parent.user_session.k8s_uid`](#common-usersessioncontext-k8s_uid-doc) | プロセスを実行したユーザーの Kubernetes UID |
| [`process.parent.user_session.k8s_username`](#common-usersessioncontext-k8s_username-doc) | プロセスを実行したユーザーの Kubernetes ユーザー名 |
...
| [`process.user_session.k8s_groups`](#common-usersessioncontext-k8s_groups-doc) | プロセスを実行したユーザーの Kubernetes グループ |
| [`process.user_session.k8s_uid`](#common-usersessioncontext-k8s_uid-doc) | プロセスを実行したユーザーの Kubernetes UID |
| [`process.user_session.k8s_username`](#common-usersessioncontext-k8s_username-doc) | プロセスを実行したユーザーの Kubernetes ユーザー名 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`accept.addr.family`](#accept-addr-family-doc) | アドレスファミリー |
| [`accept.addr.hostname`](#accept-addr-hostname-doc) | アドレスのホスト名 (利用可能な場合) |
| [`accept.addr.ip`](#common-ipportcontext-ip-doc) | IP アドレス |
| [`accept.addr.is_public`](#common-ipportcontext-is_public-doc) | IP アドレスがパブリック ネットワークに属するかどうか |
| [`accept.addr.port`](#common-ipportcontext-port-doc) | ポート番号 |
| [`accept.retval`](#common-syscallevent-retval-doc) | syscall の戻り値 |
...
| [`bind.addr.is_public`](#common-ipportcontext-is_public-doc) | IP アドレスがパブリック ネットワークに属するかどうか |
| [`bind.addr.port`](#common-ipportcontext-port-doc) | ポート番号 |
| [`bind.protocol`](#bind-protocol-doc) | ソケット プロトコル |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`chdir.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`chdir.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`chdir.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`chdir.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`chdir.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`chdir.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`chdir.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`chdir.syscall.path`](#chdir-syscall-path-doc) | このシステムコールのパス引数 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`chmod.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`chmod.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`chmod.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`chmod.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`chmod.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`chmod.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`chmod.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`chmod.syscall.mode`](#chmod-syscall-mode-doc) | このシステムコールのモード引数 |
| [`chmod.syscall.path`](#chmod-syscall-path-doc) | このシステムコールのパス引数 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`chown.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`chown.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`chown.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`chown.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`chown.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`chown.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`chown.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`chown.syscall.gid`](#chown-syscall-gid-doc) | このシステムコールの GID 引数 |
| [`chown.syscall.path`](#chown-syscall-path-doc) | このシステムコールのパス引数 |
| [`chown.syscall.uid`](#chown-syscall-uid-doc) | このシステムコールの UID 引数 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`connect.addr.family`](#connect-addr-family-doc) | アドレスファミリー |
| [`connect.addr.hostname`](#connect-addr-hostname-doc) | アドレスのホスト名 (利用可能な場合) |
| [`connect.addr.ip`](#common-ipportcontext-ip-doc) | IP アドレス |
| [`connect.addr.is_public`](#common-ipportcontext-is_public-doc) | IP アドレスがパブリック ネットワークに属するかどうか |
| [`connect.addr.port`](#common-ipportcontext-port-doc) | ポート番号 |
| [`connect.protocol`](#connect-protocol-doc) | ソケット プロトコル |
| [`connect.retval`](#common-syscallevent-retval-doc) | syscall の戻り値 |
...
| [`dns.question.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`network.destination.is_public`](#common-ipportcontext-is_public-doc) | IP アドレスがパブリック ネットワークに属するかどうか |
| [`network.destination.port`](#common-ipportcontext-port-doc) | ポート番号 |
| [`network.device.ifname`](#common-networkdevicecontext-ifname-doc) | インターフェイスの ifname |
| [`network.l3_protocol`](#common-networkcontext-l3_protocol-doc) | ネットワークパケットの L3 プロトコル |
| [`network.l4_protocol`](#common-networkcontext-l4_protocol-doc) | ネットワークパケットの L4 プロトコル |
| [`network.network_direction`](#common-networkcontext-network_direction-doc) | ネットワーク パケットの通信方向 |
| [`network.size`](#common-networkcontext-size-doc) | ネットワークパケットのバイト単位のサイズ |
| [`network.source.ip`](#common-ipportcontext-ip-doc) | IP アドレス |
| [`network.source.is_public`](#common-ipportcontext-is_public-doc) | IP アドレスがパブリック ネットワークに属するかどうか |
| [`network.source.port`](#common-ipportcontext-port-doc) | ポート番号 |

### イベント `exec`

プロセスが実行されました (fork syscall ではトリガーされません)
...
| [`exec.auid`](#common-credentials-auid-doc) | プロセスのログイン UID |
...
| [`exec.cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`exec.cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`exec.cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`exec.cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`exec.cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
...
| [`exec.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`exec.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`exec.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`exec.interpreter.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`exec.interpreter.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`exec.interpreter.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`exec.interpreter.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`exec.interpreter.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`exec.is_exec`](#common-process-is_exec-doc) | プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します |
...
| [`exec.syscall.path`](#exec-syscall-path-doc) | このシステムコールのパス引数 |
...
| [`exec.user_session.k8s_groups`](#common-usersessioncontext-k8s_groups-doc) | プロセスを実行したユーザーの Kubernetes グループ |
| [`exec.user_session.k8s_uid`](#common-usersessioncontext-k8s_uid-doc) | プロセスを実行したユーザーの Kubernetes UID |
| [`exec.user_session.k8s_username`](#common-usersessioncontext-k8s_username-doc) | プロセスを実行したユーザーの Kubernetes ユーザー名 |
...
| [`exit.auid`](#common-credentials-auid-doc) | プロセスのログイン UID |
...
| [`exit.cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`exit.cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`exit.cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`exit.cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`exit.cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
...
| [`exit.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`exit.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`exit.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`exit.interpreter.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`exit.interpreter.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`exit.interpreter.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`exit.interpreter.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`exit.interpreter.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`exit.is_exec`](#common-process-is_exec-doc) | プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します |
...
| [`exit.user_session.k8s_groups`](#common-usersessioncontext-k8s_groups-doc) | プロセスを実行したユーザーの Kubernetes グループ |
| [`exit.user_session.k8s_uid`](#common-usersessioncontext-k8s_uid-doc) | プロセスを実行したユーザーの Kubernetes UID |
| [`exit.user_session.k8s_username`](#common-usersessioncontext-k8s_username-doc) | プロセスを実行したユーザーの Kubernetes ユーザー名 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`imds.aws.is_imds_v2`](#imds-aws-is_imds_v2-doc) | IMDS イベントが IMDSv1 か IMDSv2 のどちらに準拠しているかを示すブール値 |
| [`imds.aws.security_credentials.type`](#imds-aws-security_credentials-type-doc) | セキュリティクレデンシャルの種類 |
| [`imds.cloud_provider`](#imds-cloud_provider-doc) | IMDS イベントの対象となるクラウドプロバイダ |
| [`imds.host`](#imds-host-doc) | HTTP プロトコルのホスト |
| [`imds.server`](#imds-server-doc) | レスポンスのサーバヘッダー |
| [`imds.type`](#imds-type-doc) | IMDS イベントの種類 |
| [`imds.url`](#imds-url-doc) | クエリされた IMDS URL |
| [`imds.user_agent`](#imds-user_agent-doc) | HTTP クライアントのユーザーエージェント |
| [`network.destination.ip`](#common-ipportcontext-ip-doc) | IP アドレス |
| [`network.destination.is_public`](#common-ipportcontext-is_public-doc) | IP アドレスがパブリック ネットワークに属するかどうか |
| [`network.destination.port`](#common-ipportcontext-port-doc) | ポート番号 |
| [`network.device.ifname`](#common-networkdevicecontext-ifname-doc) | インターフェイスの ifname |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`link.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
| [`link.file.destination.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`link.file.destination.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`link.file.destination.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`link.file.destination.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`link.file.destination.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`link.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`link.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`link.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`link.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`link.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`link.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`link.syscall.destination.path`](#link-syscall-destination-path-doc) | このシステムコールの宛先パス引数 |
| [`link.syscall.path`](#link-syscall-path-doc) | このシステムコールのパス引数 |
...
| [`load_module.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`load_module.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`load_module.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`load_module.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`load_module.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`mkdir.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`mkdir.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`mkdir.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`mkdir.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`mkdir.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`mkdir.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`mkdir.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`mkdir.syscall.mode`](#mkdir-syscall-mode-doc) | 新しいディレクトリのモード |
| [`mkdir.syscall.path`](#mkdir-syscall-path-doc) | このシステムコールのパス引数 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`mmap.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`mmap.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`mmap.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`mmap.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`mmap.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`mmap.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`mmap.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`mount.root.path`](#mount-root-path-doc) | マウントのルートパス |
| [`mount.source.path`](#mount-source-path-doc) | バインドマウントのソースパス |
| [`mount.syscall.fs_type`](#mount-syscall-fs_type-doc) | このシステムコールのファイルシステムタイプ引数 |
| [`mount.syscall.mountpoint.path`](#mount-syscall-mountpoint-path-doc) | マウントポイントパス引数 |
| [`mount.syscall.source.path`](#mount-syscall-source-path-doc) | ソースパス引数 |
...
### `network_flow_monitor` イベント

ネットワーク モニター イベントが送信されました

| プロパティ | 定義 |
| -------- | ------------- |
| [`network_flow_monitor.device.ifname`](#common-networkdevicecontext-ifname-doc) | インターフェイスの ifname |
| [`network_flow_monitor.flows.destination.ip`](#common-ipportcontext-ip-doc) | IP アドレス |
| [`network_flow_monitor.flows.destination.is_public`](#common-ipportcontext-is_public-doc) | IP アドレスがパブリック ネットワークに属するかどうか |
| [`network_flow_monitor.flows.destination.port`](#common-ipportcontext-port-doc) | ポート番号 |
| [`network_flow_monitor.flows.egress.data_size`](#common-networkstats-data_size-doc) | 送受信されたデータ量 |
| [`network_flow_monitor.flows.egress.packet_count`](#common-networkstats-packet_count-doc) | 送受信されたネットワーク パケット数 |
| [`network_flow_monitor.flows.ingress.data_size`](#common-networkstats-data_size-doc) | 送受信されたデータ量 |
| [`network_flow_monitor.flows.ingress.packet_count`](#common-networkstats-packet_count-doc) | 送受信されたネットワーク パケット数 |
| [`network_flow_monitor.flows.l3_protocol`](#network_flow_monitor-flows-l3_protocol-doc) | ネットワークパケットの L3 プロトコル |
| [`network_flow_monitor.flows.l4_protocol`](#network_flow_monitor-flows-l4_protocol-doc) | ネットワークパケットの L4 プロトコル |
| [`network_flow_monitor.flows.length`](#common-string-length-doc) | 対応する要素の長さ |
| [`network_flow_monitor.flows.source.ip`](#common-ipportcontext-ip-doc) | IP アドレス |
| [`network_flow_monitor.flows.source.is_public`](#common-ipportcontext-is_public-doc) | IP アドレスがパブリック ネットワークに属するかどうか |
| [`network_flow_monitor.flows.source.port`](#common-ipportcontext-port-doc) | ポート番号 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`open.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`open.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`open.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`open.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`open.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`open.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`open.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`open.syscall.flags`](#open-syscall-flags-doc) | このシステムコールのフラグ引数 |
| [`open.syscall.mode`](#open-syscall-mode-doc) | このシステムコールのモード引数 |
| [`open.syscall.path`](#open-syscall-path-doc) | このシステムコールのパス引数 |

### `packet` イベント

生のネットワーク パケットがキャプチャされました

| プロパティ | 定義 |
| -------- | ------------- |
| [`packet.destination.ip`](#common-ipportcontext-ip-doc) | IP アドレス |
| [`packet.destination.is_public`](#common-ipportcontext-is_public-doc) | IP アドレスがパブリック ネットワークに属するかどうか |
| [`packet.destination.port`](#common-ipportcontext-port-doc) | ポート番号 |
| [`packet.device.ifname`](#common-networkdevicecontext-ifname-doc) | インターフェイスの ifname |
| [`packet.filter`](#packet-filter-doc) | pcap フィルター式 |
| [`packet.l3_protocol`](#common-networkcontext-l3_protocol-doc) | ネットワークパケットの L3 プロトコル |
| [`packet.l4_protocol`](#common-networkcontext-l4_protocol-doc) | ネットワークパケットの L4 プロトコル |
| [`packet.network_direction`](#common-networkcontext-network_direction-doc) | ネットワーク パケットの通信方向 |
| [`packet.size`](#common-networkcontext-size-doc) | ネットワークパケットのバイト単位のサイズ |
| [`packet.source.ip`](#common-ipportcontext-ip-doc) | IP アドレス |
| [`packet.source.is_public`](#common-ipportcontext-is_public-doc) | IP アドレスがパブリック ネットワークに属するかどうか |
| [`packet.source.port`](#common-ipportcontext-port-doc) | ポート番号 |
| [`packet.tls.version`](#packet-tls-version-doc) | TLS バージョン |
...
| [`ptrace.tracee.ancestors.auid`](#common-credentials-auid-doc) | プロセスのログイン UID |
...
| [`ptrace.tracee.ancestors.cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`ptrace.tracee.ancestors.cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`ptrace.tracee.ancestors.cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`ptrace.tracee.ancestors.cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`ptrace.tracee.ancestors.cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
...
| [`ptrace.tracee.ancestors.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`ptrace.tracee.ancestors.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`ptrace.tracee.ancestors.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`ptrace.tracee.ancestors.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.ancestors.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.ancestors.interpreter.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`ptrace.tracee.ancestors.interpreter.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`ptrace.tracee.ancestors.interpreter.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`ptrace.tracee.ancestors.interpreter.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.ancestors.interpreter.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.ancestors.is_exec`](#common-process-is_exec-doc) | プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します |
...
| [`ptrace.tracee.ancestors.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.ancestors.user_session.k8s_groups`](#common-usersessioncontext-k8s_groups-doc) | プロセスを実行したユーザーの Kubernetes グループ |
| [`ptrace.tracee.ancestors.user_session.k8s_uid`](#common-usersessioncontext-k8s_uid-doc) | プロセスを実行したユーザーの Kubernetes UID |
| [`ptrace.tracee.ancestors.user_session.k8s_username`](#common-usersessioncontext-k8s_username-doc) | プロセスを実行したユーザーの Kubernetes ユーザー名 |
...
| [`ptrace.tracee.auid`](#common-credentials-auid-doc) | プロセスのログイン UID |
...
| [`ptrace.tracee.cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`ptrace.tracee.cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`ptrace.tracee.cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`ptrace.tracee.cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`ptrace.tracee.cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
...
| [`ptrace.tracee.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`ptrace.tracee.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`ptrace.tracee.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`ptrace.tracee.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.interpreter.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`ptrace.tracee.interpreter.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`ptrace.tracee.interpreter.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`ptrace.tracee.interpreter.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.interpreter.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.is_exec`](#common-process-is_exec-doc) | プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します |
...
| [`ptrace.tracee.parent.auid`](#common-credentials-auid-doc) | プロセスのログイン UID |
...
| [`ptrace.tracee.parent.cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`ptrace.tracee.parent.cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`ptrace.tracee.parent.cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`ptrace.tracee.parent.cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`ptrace.tracee.parent.cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
...
| [`ptrace.tracee.parent.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`ptrace.tracee.parent.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`ptrace.tracee.parent.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`ptrace.tracee.parent.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.parent.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.parent.interpreter.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`ptrace.tracee.parent.interpreter.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`ptrace.tracee.parent.interpreter.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`ptrace.tracee.parent.interpreter.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.parent.interpreter.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`ptrace.tracee.parent.is_exec`](#common-process-is_exec-doc) | プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します |
...
| [`ptrace.tracee.parent.user_session.k8s_groups`](#common-usersessioncontext-k8s_groups-doc) | プロセスを実行したユーザーの Kubernetes グループ |
| [`ptrace.tracee.parent.user_session.k8s_uid`](#common-usersessioncontext-k8s_uid-doc) | プロセスを実行したユーザーの Kubernetes UID |
| [`ptrace.tracee.parent.user_session.k8s_username`](#common-usersessioncontext-k8s_username-doc) | プロセスを実行したユーザーの Kubernetes ユーザー名 |
...
| [`ptrace.tracee.user_session.k8s_groups`](#common-usersessioncontext-k8s_groups-doc) | プロセスを実行したユーザーの Kubernetes グループ |
| [`ptrace.tracee.user_session.k8s_uid`](#common-usersessioncontext-k8s_uid-doc) | プロセスを実行したユーザーの Kubernetes UID |
| [`ptrace.tracee.user_session.k8s_username`](#common-usersessioncontext-k8s_username-doc) | プロセスを実行したユーザーの Kubernetes ユーザー名 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`removexattr.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`removexattr.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`removexattr.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`removexattr.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`removexattr.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`rename.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
| [`rename.file.destination.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`rename.file.destination.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`rename.file.destination.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`rename.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`rename.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`rename.syscall.destination.path`](#rename-syscall-destination-path-doc) | このシステムコールの宛先パス引数 |
| [`rename.syscall.path`](#rename-syscall-path-doc) | このシステムコールのパス引数 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`rmdir.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`rmdir.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`rmdir.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`rmdir.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`rmdir.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`rmdir.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`rmdir.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`rmdir.syscall.path`](#rmdir-syscall-path-doc) | このシステムコールのパス引数 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`setxattr.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`setxattr.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`setxattr.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`setxattr.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`setxattr.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`setxattr.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`setxattr.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.ancestors.auid`](#common-credentials-auid-doc) | プロセスのログイン UID |
...
| [`signal.target.ancestors.cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`signal.target.ancestors.cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`signal.target.ancestors.cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`signal.target.ancestors.cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`signal.target.ancestors.cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
...
| [`signal.target.ancestors.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`signal.target.ancestors.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`signal.target.ancestors.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`signal.target.ancestors.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.ancestors.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.ancestors.interpreter.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`signal.target.ancestors.interpreter.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`signal.target.ancestors.interpreter.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`signal.target.ancestors.interpreter.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.ancestors.interpreter.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.ancestors.is_exec`](#common-process-is_exec-doc) | プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します |
...
| [`signal.target.ancestors.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.ancestors.user_session.k8s_groups`](#common-usersessioncontext-k8s_groups-doc) | プロセスを実行したユーザーの Kubernetes グループ |
| [`signal.target.ancestors.user_session.k8s_uid`](#common-usersessioncontext-k8s_uid-doc) | プロセスを実行したユーザーの Kubernetes UID |
| [`signal.target.ancestors.user_session.k8s_username`](#common-usersessioncontext-k8s_username-doc) | プロセスを実行したユーザーの Kubernetes ユーザー名 |
...
| [`signal.target.auid`](#common-credentials-auid-doc) | プロセスのログイン UID |
...
| [`signal.target.cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`signal.target.cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`signal.target.cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`signal.target.cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`signal.target.cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
...
| [`signal.target.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`signal.target.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`signal.target.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`signal.target.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.interpreter.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`signal.target.interpreter.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`signal.target.interpreter.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`signal.target.interpreter.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.interpreter.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.is_exec`](#common-process-is_exec-doc) | プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します |
...
| [`signal.target.parent.auid`](#common-credentials-auid-doc) | プロセスのログイン UID |
...
| [`signal.target.parent.cgroup.file.inode`](#common-pathkey-inode-doc) | ファイルの Inode |
| [`signal.target.parent.cgroup.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`signal.target.parent.cgroup.id`](#common-cgroupcontext-id-doc) | cgroup の ID |
| [`signal.target.parent.cgroup.manager`](#common-cgroupcontext-manager-doc) | [実験的] cgroup のライフサイクル マネージャー |
| [`signal.target.parent.cgroup.version`](#common-cgroupcontext-version-doc) | [実験的] cgroup API のバージョン |
...
| [`signal.target.parent.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`signal.target.parent.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`signal.target.parent.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`signal.target.parent.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.parent.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.parent.interpreter.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`signal.target.parent.interpreter.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`signal.target.parent.interpreter.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
...
| [`signal.target.parent.interpreter.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.parent.interpreter.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`signal.target.parent.is_exec`](#common-process-is_exec-doc) | プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します |
...
| [`signal.target.parent.user_session.k8s_groups`](#common-usersessioncontext-k8s_groups-doc) | プロセスを実行したユーザーの Kubernetes グループ |
| [`signal.target.parent.user_session.k8s_uid`](#common-usersessioncontext-k8s_uid-doc) | プロセスを実行したユーザーの Kubernetes UID |
| [`signal.target.parent.user_session.k8s_username`](#common-usersessioncontext-k8s_username-doc) | プロセスを実行したユーザーの Kubernetes ユーザー名 |
...
| [`signal.target.user_session.k8s_groups`](#common-usersessioncontext-k8s_groups-doc) | プロセスを実行したユーザーの Kubernetes グループ |
| [`signal.target.user_session.k8s_uid`](#common-usersessioncontext-k8s_uid-doc) | プロセスを実行したユーザーの Kubernetes UID |
| [`signal.target.user_session.k8s_username`](#common-usersessioncontext-k8s_username-doc) | プロセスを実行したユーザーの Kubernetes ユーザー名 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`splice.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`splice.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`splice.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`splice.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`splice.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`splice.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`splice.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
sysctl パラメーターの読み取りまたは変更が行われました

| プロパティ | 定義 |
| -------- | ------------- |
| [`sysctl.action`](#sysctl-action-doc) | システム制御パラメーターに対して行われた操作 |
| [`sysctl.file_position`](#sysctl-file_position-doc) | その操作が行われた sysctl 制御パラメーター ファイル内の位置 |
| [`sysctl.name`](#sysctl-name-doc) | システム制御パラメーター名 |
| [`sysctl.name_truncated`](#sysctl-name_truncated-doc) | name フィールドが切り詰められていることを示します |
| [`sysctl.old_value`](#sysctl-old_value-doc) | システム制御パラメーターの以前の値 |
| [`sysctl.old_value_truncated`](#sysctl-old_value_truncated-doc) | old_value フィールドが切り詰められていることを示します |
| [`sysctl.value`](#sysctl-value-doc) | アクションの種類に応じたシステム制御パラメーターの新しい値または現在値 |
| [`sysctl.value_truncated`](#sysctl-value_truncated-doc) | value フィールドが切り詰められていることを示します |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`unlink.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`unlink.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`unlink.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`unlink.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`unlink.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`unlink.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`unlink.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`unlink.syscall.dirfd`](#unlink-syscall-dirfd-doc) | このシステムコールのディレクトリファイルディスクリプタ引数 |
| [`unlink.syscall.flags`](#unlink-syscall-flags-doc) | このシステムコールのフラグ引数 |
| [`unlink.syscall.path`](#unlink-syscall-path-doc) | このシステムコールのパス引数 |
...
| プロパティ | 定義 |
| -------- | ------------- |
| [`utimes.file.change_time`](#common-filefields-change_time-doc) | ファイルの変更時刻 (ctime) |
...
| [`utimes.file.hashes`](#common-fileevent-hashes-doc) | [実験的機能] このファイルに対して計算された暗号学的ハッシュのリスト |
...
| [`utimes.file.modification_time`](#common-filefields-modification_time-doc) | ファイルの更新時刻 (mtime) |
| [`utimes.file.mount_id`](#common-pathkey-mount_id-doc) | ファイルのマウント ID |
| [`utimes.file.name`](#common-fileevent-name-doc) | ファイルのベース名 |
| [`utimes.file.name.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`utimes.file.path.length`](#common-string-length-doc) | 対応する要素の長さ |
...
| [`utimes.syscall.path`](#utimes-syscall-path-doc) | このシステムコールのパス引数 |
...
`*.args_flags` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.args_options` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.args_truncated` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.argv0` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.cap_effective` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.cap_permitted` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.change_time` で使用できるプレフィックスは 39 種類あります:
...
`*.container.id` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.created_at` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.data_size` で使用できるプレフィックスは 2 種類あります:
...
`*.egroup` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.envs_truncated` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.euser` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.file.destination.name` で使用できるプレフィックスは 2 種類あります:
...
`*.file.destination.namespace` で使用できるプレフィックスは 2 種類あります:
`removexattr` `setxattr`
...
`*.filesystem` で使用できるプレフィックスは 39 種類あります:
`chdir.file` `chmod.file` `chown.file` `exec.file` `exec.interpreter.file` `exit.file` `exit.interpreter.file` `link.file` `link.file.destination` `load_module.file` `mkdir.file` `mmap.file` `open.file` `process.ancestors.file` `process.ancestors.interpreter.file` `process.file` `process.interpreter.file` `process.parent.file` `process.parent.interpreter.file` `ptrace.tracee.ancestors.file` `ptrace.tracee.ancestors.interpreter.file` `ptrace.tracee.file` `ptrace.tracee.interpreter.file` `ptrace.tracee.parent.file` `ptrace.tracee.parent.interpreter.file` `removexattr.file` `rename.file` `rename.file.destination` `rmdir.file` `setxattr.file` `signal.target.ancestors.file` `signal.target.ancestors.interpreter.file` `signal.target.file` `signal.target.interpreter.file` `signal.target.parent.file` `signal.target.parent.interpreter.file` `splice.file` `unlink.file` `utimes.file`
...
`*.fsgid` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.fsgroup` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.fsuid` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.fsuser` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.group` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.group` で使用できるプレフィックスは 39 種類あります:
`chdir.file` `chmod.file` `chown.file` `exec.file` `exec.interpreter.file` `exit.file` `exit.interpreter.file` `link.file` `link.file.destination` `load_module.file` `mkdir.file` `mmap.file` `open.file` `process.ancestors.file` `process.ancestors.interpreter.file` `process.file` `process.interpreter.file` `process.parent.file` `process.parent.interpreter.file` `ptrace.tracee.ancestors.file` `ptrace.tracee.ancestors.interpreter.file` `ptrace.tracee.file` `ptrace.tracee.interpreter.file` `ptrace.tracee.parent.file` `ptrace.tracee.parent.interpreter.file` `removexattr.file` `rename.file` `rename.file.destination` `rmdir.file` `setxattr.file` `signal.target.ancestors.file` `signal.target.ancestors.interpreter.file` `signal.target.file` `signal.target.interpreter.file` `signal.target.parent.file` `signal.target.parent.interpreter.file` `splice.file` `unlink.file` `utimes.file`
...
`*.hashes` で使用できるプレフィックスは 39 種類あります:
`chdir.file` `chmod.file` `chown.file` `exec.file` `exec.interpreter.file` `exit.file` `exit.interpreter.file` `link.file` `link.file.destination` `load_module.file` `mkdir.file` `mmap.file` `open.file` `process.ancestors.file` `process.ancestors.interpreter.file` `process.file` `process.interpreter.file` `process.parent.file` `process.parent.interpreter.file` `ptrace.tracee.ancestors.file` `ptrace.tracee.ancestors.interpreter.file` `ptrace.tracee.file` `ptrace.tracee.interpreter.file` `ptrace.tracee.parent.file` `ptrace.tracee.parent.interpreter.file` `removexattr.file` `rename.file` `rename.file.destination` `rmdir.file` `setxattr.file` `signal.target.ancestors.file` `signal.target.ancestors.interpreter.file` `signal.target.file` `signal.target.interpreter.file` `signal.target.parent.file` `signal.target.parent.interpreter.file` `splice.file` `unlink.file` `utimes.file`
...
`*.ifname` で使用できるプレフィックスは 3 種類あります:
...
`*.in_upper_layer` で使用できるプレフィックスは 39 種類あります:
`chdir.file` `chmod.file` `chown.file` `exec.file` `exec.interpreter.file` `exit.file` `exit.interpreter.file` `link.file` `link.file.destination` `load_module.file` `mkdir.file` `mmap.file` `open.file` `process.ancestors.file` `process.ancestors.interpreter.file` `process.file` `process.interpreter.file` `process.parent.file` `process.parent.interpreter.file` `ptrace.tracee.ancestors.file` `ptrace.tracee.ancestors.interpreter.file` `ptrace.tracee.file` `ptrace.tracee.interpreter.file` `ptrace.tracee.parent.file` `ptrace.tracee.parent.interpreter.file` `removexattr.file` `rename.file` `rename.file.destination` `rmdir.file` `setxattr.file` `signal.target.ancestors.file` `signal.target.ancestors.interpreter.file` `signal.target.file` `signal.target.interpreter.file` `signal.target.parent.file` `signal.target.parent.interpreter.file` `splice.file` `unlink.file` `utimes.file`
...
`*.inode` で使用できるプレフィックスは 51 種類あります:
...
定義: プロセス エントリーが新しいバイナリーの実行に由来するかどうかを示します

`*.is_exec` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.is_kworker` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
定義: IP アドレスがパブリック ネットワークに属するかどうか

`*.is_public` で使用できるプレフィックスは 9 種類あります:
`accept.addr` `bind.addr` `connect.addr` `network.destination` `network.source` `network_flow_monitor.flows.destination` `network_flow_monitor.flows.source` `packet.destination` `packet.source`
...
`*.is_thread` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
`*.k8s_groups` で使用できるプレフィックスは 11 種類あります:
...
`*.k8s_uid` で使用できるプレフィックスは 11 種類あります:
`exec.user_session` `exit.user_session` `process.ancestors.user_session` `process.parent.user_session` `process.user_session` `ptrace.tracee.ancestors.user_session` `ptrace.tracee.parent.user_session` `ptrace.tracee.user_session` `signal.target.ancestors.user_session` `signal.target.parent.user_session` `signal.target.user_session`
...
`*.k8s_username` で使用できるプレフィックスは 11 種類あります:
`exec.user_session` `exit.user_session` `process.ancestors.user_session` `process.parent.user_session` `process.user_session` `ptrace.tracee.ancestors.user_session` `ptrace.tracee.parent.user_session` `ptrace.tracee.user_session` `signal.target.ancestors.user_session` `signal.target.parent.user_session` `signal.target.user_session`
...
`*.l3_protocol` で使用できるプレフィックスは 2 種類あります:
`network` `packet`
...
`*.l4_protocol` で使用できるプレフィックスは 2 種類あります:
`network` `packet`
...
`*.length` で使用できるプレフィックスは 83 種類あります:
...
定義: [実験的] cgroup のライフサイクル マネージャー

`*.manager` で使用できるプレフィックスは 12 種類あります:
`cgroup` `exec.cgroup` `exit.cgroup` `process.ancestors.cgroup` `process.cgroup` `process.parent.cgroup` `ptrace.tracee.ancestors.cgroup` `ptrace.tracee.cgroup` `ptrace.tracee.parent.cgroup` `signal.target.ancestors.cgroup` `signal.target.cgroup` `signal.target.parent.cgroup`
...
`*.modification_time` で使用できるプレフィックスは 39 種類あります:
`chdir.file` `chmod.file` `chown.file` `exec.file` `exec.interpreter.file` `exit.file` `exit.interpreter.file` `link.file` `link.file.destination` `load_module.file` `mkdir.file` `mmap.file` `open.file` `process.ancestors.file` `process.ancestors.interpreter.file` `process.file` `process.interpreter.file` `process.parent.file` `process.parent.interpreter.file` `ptrace.tracee.ancestors.file` `ptrace.tracee.ancestors.interpreter.file` `ptrace.tracee.file` `ptrace.tracee.interpreter.file` `ptrace.tracee.parent.file` `ptrace.tracee.parent.interpreter.file` `removexattr.file` `rename.file` `rename.file.destination` `rmdir.file` `setxattr.file` `signal.target.ancestors.file` `signal.target.ancestors.interpreter.file` `signal.target.file` `signal.target.interpreter.file` `signal.target.parent.file` `signal.target.parent.interpreter.file` `splice.file` `unlink.file` `utimes.file`
...
`*.mount_id` で使用できるプレフィックスは 51 種類あります:
`cgroup.file` `chdir.file` `chmod.file` `chown.file` `exec.cgroup.file` `exec.file` `exec.interpreter.file` `exit.cgroup.file` `exit.file` `exit.interpreter.file` `link.file` `link.file.destination` `load_module.file` `mkdir.file` `mmap.file` `open.file` `process.ancestors.cgroup.file` `process.ancestors.file` `process.ancestors.interpreter.file` `process.cgroup.file` `process.file` `process.interpreter.file` `process.parent.cgroup.file` `process.parent.file` `process.parent.interpreter.file` `ptrace.tracee.ancestors.cgroup.file` `ptrace.tracee.ancestors.file` `ptrace.tracee.ancestors.interpreter.file` `ptrace.tracee.cgroup.file` `ptrace.tracee.file` `ptrace.tracee.interpreter.file` `ptrace.tracee.parent.cgroup.file` `ptrace.tracee.parent.file` `ptrace.tracee.parent.interpreter.file` `removexattr.file` `rename.file` `rename.file.destination` `rmdir.file` `setxattr.file` `signal.target.ancestors.cgroup.file` `signal.target.ancestors.file` `signal.target.ancestors.interpreter.file` `signal.target.cgroup.file` `signal.target.file` `signal.target.interpreter.file` `signal.target.parent.cgroup.file` `signal.target.parent.file` `signal.target.parent.interpreter.file` `splice.file` `unlink.file` `utimes.file`
...
`*.network_direction` で使用できるプレフィックスは 2 種類あります:
`network` `packet`

定数: [ネットワーク方向](#network-directions)
...
`*.package.name` で使用できるプレフィックスは 39 種類あります:
`chdir.file` `chmod.file` `chown.file` `exec.file` `exec.interpreter.file` `exit.file` `exit.interpreter.file` `link.file` `link.file.destination` `load_module.file` `mkdir.file` `mmap.file` `open.file` `process.ancestors.file` `process.ancestors.interpreter.file` `process.file` `process.interpreter.file` `process.parent.file` `process.parent.interpreter.file` `ptrace.tracee.ancestors.file` `ptrace.tracee.ancestors.interpreter.file` `ptrace.tracee.file` `ptrace.tracee.interpreter.file` `ptrace.tracee.parent.file` `ptrace.tracee.parent.interpreter.file` `removexattr.file` `rename.file` `rename.file.destination` `rmdir.file` `setxattr.file` `signal.target.ancestors.file` `signal.target.ancestors.interpreter.file` `signal.target.file` `signal.target.interpreter.file` `signal.target.parent.file` `signal.target.parent.interpreter.file` `splice.file` `unlink.file` `utimes.file`
...
`*.package.source_version` で使用できるプレフィックスは 39 種類あります:
`chdir.file` `chmod.file` `chown.file` `exec.file` `exec.interpreter.file` `exit.file` `exit.interpreter.file` `link.file` `link.file.destination` `load_module.file` `mkdir.file` `mmap.file` `open.file` `process.ancestors.file` `process.ancestors.interpreter.file` `process.file` `process.interpreter.file` `process.parent.file` `process.parent.interpreter.file` `ptrace.tracee.ancestors.file` `ptrace.tracee.ancestors.interpreter.file` `ptrace.tracee.file` `ptrace.tracee.interpreter.file` `ptrace.tracee.parent.file` `ptrace.tracee.parent.interpreter.file` `removexattr.file` `rename.file` `rename.file.destination` `rmdir.file` `setxattr.file` `signal.target.ancestors.file` `signal.target.ancestors.interpreter.file` `signal.target.file` `signal.target.interpreter.file` `signal.target.parent.file` `signal.target.parent.interpreter.file` `splice.file` `unlink.file` `utimes.file`
...
`*.package.version` で使用できるプレフィックスは 39 種類あります:
`chdir.file` `chmod.file` `chown.file` `exec.file` `exec.interpreter.file` `exit.file` `exit.interpreter.file` `link.file` `link.file.destination` `load_module.file` `mkdir.file` `mmap.file` `open.file` `process.ancestors.file` `process.ancestors.interpreter.file` `process.file` `process.interpreter.file` `process.parent.file` `process.parent.interpreter.file` `ptrace.tracee.ancestors.file` `ptrace.tracee.ancestors.interpreter.file` `ptrace.tracee.file` `ptrace.tracee.interpreter.file` `ptrace.tracee.parent.file` `ptrace.tracee.parent.interpreter.file` `removexattr.file` `rename.file` `rename.file.destination` `rmdir.file` `setxattr.file` `signal.target.ancestors.file` `signal.target.ancestors.interpreter.file` `signal.target.file` `signal.target.interpreter.file` `signal.target.parent.file` `signal.target.parent.interpreter.file` `splice.file` `unlink.file` `utimes.file`
...
定義: 送受信されたネットワーク パケット数

`*.packet_count` で使用できるプレフィックスは 2 種類あります:
`network_flow_monitor.flows.egress` `network_flow_monitor.flows.ingress`
...
`*.retval` で使用できるプレフィックスは 24 種類あります:
...
`*.rights` で使用できるプレフィックスは 39 種類あります:
`chdir.file` `chmod.file` `chown.file` `exec.file` `exec.interpreter.file` `exit.file` `exit.interpreter.file` `link.file` `link.file.destination` `load_module.file` `mkdir.file` `mmap.file` `open.file` `process.ancestors.file` `process.ancestors.interpreter.file` `process.file` `process.interpreter.file` `process.parent.file` `process.parent.interpreter.file` `ptrace.tracee.ancestors.file` `ptrace.tracee.ancestors.interpreter.file` `ptrace.tracee.file` `ptrace.tracee.interpreter.file` `ptrace.tracee.parent.file` `ptrace.tracee.parent.interpreter.file` `removexattr.file` `rename.file` `rename.file.destination` `rmdir.file` `setxattr.file` `signal.target.ancestors.file` `signal.target.ancestors.interpreter.file` `signal.target.file` `signal.target.interpreter.file` `signal.target.parent.file` `signal.target.parent.interpreter.file` `splice.file` `unlink.file` `utimes.file`
...
`*.tty_name` で使用できるプレフィックスは 11 種類あります:
`exec` `exit` `process` `process.ancestors` `process.parent` `ptrace.tracee` `ptrace.tracee.ancestors` `ptrace.tracee.parent` `signal.target` `signal.target.ancestors` `signal.target.parent`
...
定義: [実験的] cgroup API のバージョン

`*.version` で使用できるプレフィックスは 12 種類あります:
`cgroup` `exec.cgroup` `exit.cgroup` `process.ancestors.cgroup` `process.cgroup` `process.parent.cgroup` `ptrace.tracee.ancestors.cgroup` `ptrace.tracee.cgroup` `ptrace.tracee.parent.cgroup` `signal.target.ancestors.cgroup` `signal.target.cgroup` `signal.target.parent.cgroup`
...
定義: システム制御パラメーターに対して行われた操作


定数: [SysCtl アクション](#sysctl-actions)
...
定義: その操作が行われた sysctl 制御パラメーター ファイル内の位置
...
定義: name フィールドが切り詰められていることを示します
...
定義: old_value フィールドが切り詰められていることを示します
...
定義: アクションの種類に応じたシステム制御パラメーターの新しい値または現在値
...
定義: value フィールドが切り詰められていることを示します
...
SysCtl アクションは sysctl イベントで利用できるアクションです
