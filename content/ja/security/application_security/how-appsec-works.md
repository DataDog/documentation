...
<div class="alert alert-info">Application Vulnerability Management の脆弱性検出はベータ版です。</a></div>
...
<div class="alert alert-info">脆弱性検出による Application Vulnerability Management はベータ版です。</a></div>
