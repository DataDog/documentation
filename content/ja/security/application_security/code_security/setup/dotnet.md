...
title: .NET 向け Code Security を有効化する
...
2. Code Security を有効にするのに必要な最小バージョン以上に Datadog Tracing Library をアップデートしてください。詳細は [Library Compatibility][4] ページを参照してください。
...
[2]: /ja/security/application_security/code_security/setup/compatibility/dotnet/
[3]: /ja/agent/versions/upgrade_between_agent_minor_versions/
[4]: /ja/security/application_security/code_security/setup/compatibility/