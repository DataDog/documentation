...
| オープンソースの脆弱性検出  | 1.1.4 | 2.16.0 |Node.js 12+ の場合は 2.23.0、Node.js 14+ の場合は 3.10.0 | 1.5.0 | 非対応| 非対応| 非対応|
| カスタムコードの脆弱性検出   |1.15.0| 非公開ベータ版 | NodeJS 12+ の場合は 2.32.0、NodeJS 14+ の場合は 3.19.1 | 非公開ベータ版 | 非対応<br/>| 非対応| 非対応|
