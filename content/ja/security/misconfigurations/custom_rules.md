...
自分の環境に適用されているルールを拡張してセキュリティポスチャを評価するために、コンプライアンスルールを複製してその複製を編集したり、独自のルールをゼロから作成したりすることができます。
カスタムルールで利用可能なリソースタイプの一覧は、[クラウドリソーススキーマ][8]を参照してください。
...
1. 次のいずれかの方法でコピーしたいルールを探します。
   - [**Security** > **Configuration** > **Cloud Security Management** > **Compliance Rules**][1] に移動します。コピーしたいルールを選択し、その詳細ページを開きます。
   - [**Security** > **Cloud Security Management** > **Explorer** > **Misconfigurations**][2] に移動します。誤構成を選択してその詳細を開き、**Rule** メニューから **Edit Rule** を選択します。
...
1. [**Security** > **Configuration** > **Cloud Security Management** > **Compliance Rules**][1] に移動します。
...
[5]: /ja/security/misconfigurations/compliance_rules#set-notification-targets-for-compliance-rules
