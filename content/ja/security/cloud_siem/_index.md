...
{{< img src="security/security_monitoring/cloud_siem_homepage.png" alt="Cloud SIEM のホームページには、重要なシグナル、疑わしいアクター、影響を受けるリソース、脅威インテル、シグナルの傾向などのウィジェットを備えた Security Overview セクションが表示されています" >}}
...
{{< img src="security/security_monitoring/new_detection_rule.png" alt="ログ検出ルールを選択し、検出ルールをしきい値に設定した新規検出ルールページ" style="width:65%;" >}}

## 詳細はこちら

{{< whatsnext >}}
  {{< nextlink href="/getting_started/cloud_siem/">}}設定と構成{{< /nextlink >}}
