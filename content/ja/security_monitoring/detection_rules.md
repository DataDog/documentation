...
{{< img src="security/security_monitoring/detection_rules/define_search_query.png" alt="検索クエリを定義" >}}
...
{{< img src="security/security_monitoring/detection_rules/define_rule_case.png" alt="ルールケースを設定" >}}
...
{{< img src="security/security_monitoring/detection_rules/gbv2.png" alt="ルールケースを設定" >}}
...
{{< img src="security/security_monitoring/detection_rules/rules_table2.png" alt="検出ルールテーブル"  >}}
