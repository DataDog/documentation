...
{{< img src="security/security_monitoring/guide/monitor-authentication-logs-for-security-threats/credential-stuffing-attack-signal.png" alt="セキュリティシグナルエクスプローラーに表示されたクレデンシャルスタッフィング攻撃のサイン">}}
...
{{< img src="security/security_monitoring/guide/monitor-authentication-logs-for-security-threats/investigation-dashboard-example.gif" alt="IP 調査ダッシュボードで、トリガーされたセキュリティシグナルを分析">}}
