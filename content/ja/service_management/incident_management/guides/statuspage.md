...
{{< img src="incident_response/incident_management/guide/statuspage/add_update_statuspage_form.png" alt="Select a Statuspage、Incident name、Incident statusなどの必須フィールドを持つ、Statuspage インシデントを追加または更新するためのフォーム" style="width:70%;" >}}

## ステータスの更新

Statuspage がインシデントに追加された後は、インシデントが解決するまで Statuspage を更新し続けることができます。

{{< img src="incident_response/incident_management/guide/statuspage/update_status_modal.png" alt="リンクされている statuspage インシデントと Statuspage インシデントの更新オプションがハイライト表示されているインシデントの例" style="width:80%;" >}}
