...
{{< img src="incident_response/on-call/schedule_override.png" alt="スケジュールを編集するとき、シフトが選択される。ダイアログが表示され、Override ボタンがある。" style="width:100%;" >}}
