...
1. デフォルトのエスカレーションポリシーを追加します。
   {{< img src="incident_response/on-call/escalation_policy_blank.png" alt="新しいエスカレーションポリシーのセットアップ画面。3 つの提案されたスケジュールを通知する。" style="width:80%;" >}}
...
1. 前のステップで作成したスケジュールを定義する
   {{< img src="incident_response/on-call/schedule_blank.png" alt="新しいスケジュールのセットアップ画面。" style="width:80%;" >}}
