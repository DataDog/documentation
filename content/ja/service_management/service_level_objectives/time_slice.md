...
グループが存在する場合、アップタイムは個々のグループごとに計算されます。ただし、全体的なアップタイムは異なります。既存のモニター SLO 機能と一致させるため、タイムスライス SLO は同じ全体的なアップタイムの定義を使用します。**すべての**グループにアップタイムがある場合、全体的なアップタイムとみなされます。逆に、**いずれかの**グループにダウンタイムがある場合は、全体的なダウンタイムと見なされます。全体的なアップタイムは、常に個々のグループのアップタイムよりも少なくなります。
