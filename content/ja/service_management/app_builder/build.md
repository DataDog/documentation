...
{{< img src="actions/app_builder/app-builder-my-apps.png" alt="App Builder ページで 'My apps' のみが表示されるようにフィルターした状態" style="width:100%;" >}}
...
1. アプリ名と説明を変更するには、アプリ名をクリックします。
1. アプリ キャンバスに [UI コンポーネント](#app-canvas-and-components) を追加するには、プラス アイコン ({{< img src="actions/app_builder/components-icon.png" inline="true" width="30px">}}) をクリックして **Components** タブを開き、コンポーネントをクリックするか、キャンバス上にドラッグします。
...
アプリ キャンバスは、ユーザーが操作するグラフィカルなインターフェースを表します。コンポーネントをドラッグ アンド ドロップして、キャンバス上で移動できます。利用可能なコンポーネントをすべて表示するには、プラス アイコン ({{< img src="actions/app_builder/components-icon.png" inline="true" width="30px">}}) をクリックして **Components** タブを開きます。
...
{{< img src="actions/app_builder/app-list-star.png" alt="4 つのアプリがあり、どれもスターが付いていないアプリ リスト" style="width:40%;" >}}

ページを更新すると、スター付きのアプリが、アプリのリストの先頭のセクションに表示されます:

{{< img src="actions/app_builder/app-list-with-favorited-app.png" alt="4 つのアプリがあるアプリ リスト。1 つがスター付きでリストの先頭に固定されている" style="width:40%;" >}}

## アプリのバージョン履歴を表示する

App Builder は、アプリの保存済みの各バージョンを記録として保持します。

アプリのバージョン履歴を表示するには、アプリの左側メニューでバージョン履歴アイコン {{< img src="actions/app_builder/version-history-icon.png" inline="true">}} をクリックします。

UI は、保存済みまたは公開済みのアプリのバージョンを最大 50 件まで表示し、さらにそのバージョンを保存または公開したユーザーのアイコンも表示します:

{{< img src="actions/app_builder/version-history-example.png" alt="App Builder のバージョン履歴一覧の例。2 件の項目 (現在のバージョンと前のバージョン)" style="width:70%;" >}}
