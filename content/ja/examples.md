...
このセクションでは、Datadogが提供している各機能の設定例を紹介しています。
設定例には、スクリーンショット、コード、出力結果、およびデータ等が含まれています。
ここに紹介しているサンプル以外で、是非掲載してほしい設定項目がある場合は、[support@datadoghq.com][1]宛てにご要望ください。
...
[1]: mailto:support@datadoghq.com
