...
- link: /product_analytics/analytics_explorer
  tag: ドキュメント
  text: Analytics Explorer で Product Analytics のデータを可視化する
...
<div class="alert alert-info">Session Replay は SDK バージョン 3.6.0 以降でサポートされます。</div>
