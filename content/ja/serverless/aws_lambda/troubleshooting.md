...
<div class="alert alert-info">Datadog Lambda 拡張機能はデフォルトで ログ コレクションを有効にします。Forwarder から拡張機能へ移行する場合は、ログ サブスクリプションを削除してください。削除しないと、重複したログが表示されることがあります。</div>
...
<div class="alert alert-info">Serverless Flare の詳細については、<a href="https://docs.datadoghq.com/serverless/libraries_integrations/cli/#troubleshooting-lambda-instrumentation">コマンドドキュメント</a>をお読みください。</div>
{{% /tab %}}
{{% tab "Manually" %}}
