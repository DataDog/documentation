...
<div class="alert alert-warning">分散型トレーシングでサーバーレスアプリケーションを完全にインスツルメントするには、Java Lambda 関数が Java 8 Corretto (<code>java8.al2</code>)、Java 11 (<code>java11</code>) または Java 17 (<code>java17</code>) ランタイム (1024 MB 以上のメモリ) を使用している必要があります。</div>
