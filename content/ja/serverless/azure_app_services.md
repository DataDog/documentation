...
{{< alert >}}Function Apps または追加のランタイム用の非公開ベータ版が利用可能になったときに通知を受け取るには、<a href="https://forms.gle/n4nQcxEyLqDBMCDA7">こちらでサインアップ</a>してください。{{< /alert >}}
...
7. {{< alert >}}[必須] <u>Stop</u> をクリックしてアプリケーションを停止します。{{< /alert >}}
