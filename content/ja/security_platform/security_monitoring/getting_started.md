...
* [ログの取り込み](#ingest-logs)
* [検出ルールのレビュー](#review-detection-rules)
* [セキュリティシグナルについて](#explore-security-signals)
...
{{< img src="security_platform/security_monitoring/getting_started/ingest_logs_overview.png" alt="ログの取り込み" >}}
