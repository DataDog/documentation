...
- [Datadog の AWS インテグレーションを設定する](##set-up-aws-integration-using-cloudformation)
- [AWS CloudTrail のログを有効にする](#enable-aws-cloudtrail-logs)
- [AWS CloudTrail のログを Datadog に送信する](#send-aws-cloudtrail-logs-to-datadog)
- [Cloud SIEM でセキュリティシグナルのトリアージを行う](#use-cloud-siem-to-triage-security-signals)
...
[10]: https://docs.datadoghq.com/ja/security_platform/explorer/
[11]: https://app.datadoghq.com/dash/integration/30459/aws-cloudtrail
[12]: https://docs.datadoghq.com/ja/security_platform/default_rules/#cat-cloud-siem
[13]: https://docs.datadoghq.com/ja/security_platform/detection_rules/
