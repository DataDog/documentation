...
| [Runtime Metrics][23] | {{< X >}} | {{< X >}}<br>(Java、.NET、Goのみ) | {{< X >}}<br>(Java、.NET、Goのみ) | {{< X >}}<br>(Java、.NET、Goのみ) |
| [Span Links][25] | {{< X >}} | {{< X >}} | {{< X >}} | {{< X >}} |
| [Trace Metrics][26] | {{< X >}} | {{< X >}} | {{< X >}} | {{< X >}}<br>({{< tooltip text="Sampled" tooltip="Datadogに到達するスパンから計算されます; 設定したOTel側のサンプリングを反映します。" >}}) |
...
| [Data Streams Monitoring][15] (DSM) | {{< X >}} | | {{< tooltip text="N/A" tooltip="OTelはDSM機能を提供していません。" >}} | {{< tooltip text="N/A" tooltip="OTelはDSM機能を提供していません。" >}} |
