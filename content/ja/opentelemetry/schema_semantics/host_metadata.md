...
| Semantic convention                         | タイプ               | In-app field |
|---------------------------------------------|--------------------|--------------|
| [*Various host-identifying attributes*][10] | Resource attribute | ホスト名     |
...
| `host.cpu.family`           | Resource attribute | ファミリー             |
| `host.cpu.model.id`         | Resource attribute | モデル              |
