...
- **Initial Load**: 読み込み時間は、次の_どちらか長い方_になります。
  ...
  - `navigationStart` とページで初めてアクティビティがなくなる時間との差。詳しくは、[ページアクティビティの計算方法](#ページアクティビティの計算方法)をご覧ください。

- **SPA Route Change**: ロード時間は、URL が変わってから、ページで初めてアクティビティがなくなる時間との差に相当します。詳しくは、[ページアクティビティの計算方法](#ページアクティビティの計算方法)をご覧ください。
