...
{{< whatsnext desc="ブラウザ RUM" >}}
    ...
    {{< nextlink href="real_user_monitoring/guide/browser-sdk-upgrade" >}}ブラウザ SDK の V3 へのアップグレード{{< /nextlink >}}

{{< /whatsnext >}}

{{< whatsnext desc="セッションリプレイ:" >}}
    {{< nextlink href="real_user_monitoring/guide/session-replay-getting-started/" >}}セッションリプレイの利用開始{{< /nextlink >}}
