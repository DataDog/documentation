...
| Resource   | 30 日   | リソースとは、Roku チャンネルのファーストパーティホスト、API、サードパーティプロバイダーへのネットワークリクエストのことです。ユーザーセッション中に生成されるすべてのリクエストは、一意の `resource.id` と共にビューにアタッチされます。                                                                                                                                                                                                                        |
...
[2]: /ja/real_user_monitoring/roku/advanced_configuration/#enrich-user-sessions
[4]: /ja/getting_started/tagging/unified_service_tagging/
[5]: /ja/real_user_monitoring/roku/advanced_configuration/#identifying-your-users
