...
- /ja/real_user_monitoring/mobile_and_tv_monitoring/data_collected/roku
further_reading:
...
| `resource.ssl.duration`        | 数値（ns）    | Time spent for the TLS handshake. If the last request is not over HTTPS, this attribute does not appear (connectEnd - secureConnectionStart). |
...
| `error.issue_id` | 文字列 | The unique identifier for the error issue.                                        |
...
[2]: /ja/real_user_monitoring/mobile_and_tv_monitoring/roku/advanced_configuration/#enrich-user-sessions
[4]: /ja/getting_started/tagging/unified_service_tagging/
[5]: /ja/real_user_monitoring/mobile_and_tv_monitoring/roku/advanced_configuration/#identifying-your-users
