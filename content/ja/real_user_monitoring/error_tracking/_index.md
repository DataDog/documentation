...
**Web and Mobile Apps** のエラー追跡のために RUM をセットアップすると、問題リストにカードが入力されます。また、未解決の問題、無視されている問題、すべての問題を表示したり、量や年齢で問題をソートしたり、Web およびモバイルアプリケーションにあるすべてのカスタムおよびデフォルトのファセットで問題をフィルターしたりすることができます。

{{< img src="real_user_monitoring/error_tracking/page.png" alt="RUM のエラー追跡エクスプローラーは、Web およびモバイルアプリケーションのクラッシュレポートから問題を表示します" style="width:100%;" >}}
