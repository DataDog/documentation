...
<!--- {{< img src="mobile/quick_actions.png" alt="ダッシュボードページ">}}  --->

<!--- Datadog アプリアイコンを長押しして、トップダッシュボードのクイックアクションシートを表示させます。iOS ではプリセット済みの「Frequently Viewed By Me」ダッシュボードのトップ 5 が表示されます。Android ではモバイルで良く閲覧するダッシュボードのトップ 5 が表示されます。  --->
