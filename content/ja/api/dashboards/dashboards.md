...
この新しいエンドポイントは、Screenboard API と Timeboard API を統合し、すべてのダッシュボードを 1 つの形式で管理できるようにします。古いエンドポイントに関するドキュメントは、以下を参照してください。
    <ul>
        <li><a href="https://docs.datadoghq.com/dashboards/guide/timeboard-api-doc"> Timeboard API ガイド</a></li>
        <li><a href="https://docs.datadoghq.com/dashboards/guide/screenboard-api-doc/"> Screenboard API ガイド</a></li>
    </ul>
</div>
