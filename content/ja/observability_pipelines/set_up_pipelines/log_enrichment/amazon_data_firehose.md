---
disable_toc: false
title: Amazon Data Firehose のログの強化
---

## 概要

Observability Pipelines Worker を使用して、Amazon Data Firehose のログを強化・変換してから、送信先にルーティングします。
...
1. [Observability Pipelines Worker にログを送信する](#send-logs-to-the-observability-pipelines-worker-over-amazon_data_firehose)
...
1. **Log Enrichment** テンプレートを選択して新しいパイプラインを作成します。
1. **Amazon Data Firehose** ソースを選択します。
...
1. Amazon Data Firehose アドレスを入力します。Observability Pipelines Worker はこのアドレスとポートで Amazon Data Firehose からの受信ログを待ち受けます。
...
## Amazon Data Firehose を介して Observability Pipelines Worker にログを送信します。
