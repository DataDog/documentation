---
aliases:
- /ja/observability_pipelines/sensitive_data_redaction/fluent/
disable_toc: false
title: Fluent の機密データのマスキング
---
...
1. Fluent ソケットアドレスとポートを入力します。Observability Pipelines Worker はこのアドレスで受信ログメッセージを待ち受けます。
