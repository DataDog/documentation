...
{{< img src="observability_pipelines/production_deployment_overview/as_an_agent.png" alt="複数のサービスと観測可能性パイプラインワーカーを含むノードを示す図で、サービスがワーカーにデータを送信し、ワーカーがデータを送信している" style="width:30%;" >}}
...
{{< img src="observability_pipelines/production_deployment_overview/from_other_agents.png" alt="複数のサービス、他の Agent、観測可能性パイプラインワーカーを含むノードを示す図で、サービスと Agent がワーカーにデータを送信し、ワーカーがデータを送信している" style="width:35%;" >}}
...
{{< img src="observability_pipelines/production_deployment_overview/agent.png" alt="2 つの別々のノードを示す図で、それぞれがサービス、他の Agent、他のノードデータ、および観測可能性パイプラインワーカーを含み、ノードと Agent データはワーカーに送られ、その後シンクに送られる" style="width:70%;" >}}
...
{{< img src="observability_pipelines/production_deployment_overview/unified.png" alt="複数のサービスを含むノードと別の Agent を示す図。どちらもノード内のワーカーにデータを送信し、ワーカーはデータをロードバランサーに送信する。ロードバランサーは次にデータをアグリゲーターに送り、アグリゲーターは複数のワーカーをコンテナ化する" style="width:70%;" >}}
