...
title: (レガシー) Observability Pipelines Worker のセットアップ
...
- [Datadog アーカイブセットアップガイド][3]: Datadog Agent からデータを受信し、Datadog および S3 へルーティングするためのすぐに使えるパイプラインを備えたワーカーをインストールします。
...
1. [Observability Pipelines][6] に移動します。
...
{{% /tab %}}
{{% tab "AWS EKS" %}}
1. AWS EKS 用の [Helm チャートの values ファイル][1]をダウンロードします。サンプル構成で使用されているソース、トランスフォーム、シンクの詳細については、[構成][2]を参照してください。
...
{{% /tab %}}
{{% tab "Azure AKS" %}}
1. Azure AKS 用の [Helm チャートの values ファイル][1]をダウンロードします。サンプル構成で使用されているソース、トランスフォーム、シンクの詳細については、[構成][2]を参照してください。
...
{{% /tab %}}
{{% tab "Google GKE" %}}
1. Google GKE 用の [Helm チャートの values ファイル][1]をダウンロードします。サンプル構成で使用されているソース、トランスフォーム、シンクの詳細については、[構成][2]を参照してください。
