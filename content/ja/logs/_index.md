...
{ {< learning-center-callout header="イネーブルメントウェビナーセッションに参加" hide_image="true" btn_title="サインアップ" btn_url="https: / /www.datadoghq.com/technical-enablement/sessions / ? tags.topics-0=Logs">}
...
{ { < img src="logs/lwl_marketecture_20231030.png" alt="ログを1か所にまとめる" >}}
...
{ { < img src= " / logs/connect.png" alt="ログをメトリックまたはトレースと関連付ける" style="width:80% ; ">}}
...
{ {< learning-center-callout header="ラーニングセンターのログ管理入門を試す" btn_title="今すぐ登録" btn_url="https: / /learn.datadoghq.com/courses/intro-to-log-management">}}
