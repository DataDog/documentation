...
* 保存期間や [1 日の割り当て](#set-daily-quota)を複数使用して、バジェットをより細かく管理したい場合。
...
**注**: インデックスの 1 日の割り当ては、UTC 時間の 2:00pm (CET 時間の 4:00pm、EDT 時間の 10:00am、PDT 時間の 7:00am) に自動的にリセットされます。
