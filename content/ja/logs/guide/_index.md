...
{{< whatsnext desc="Logging Without Limits™" >}}
    ...
    {{< nextlink href="logs/guide/logs-monitors-on-volumes" >}}ログの使用状況の監視{{< /nextlink >}}
{{< /whatsnext >}}
...
{{< whatsnext desc="ログ収集" >}}
    ...
    {{< nextlink href="logs/guide/setting-file-permissions-for-rotating-logs" >}}ログをローテーションするためのファイルアクセス許可の設定 (Linux){{< /nextlink >}}
{{< /whatsnext >}}
...
{{< whatsnext desc="機密データ管理" >}}
    {{< nextlink href="logs/guide/logs-rbac" >}}Logs RBAC の設定方法{{< /nextlink >}}
