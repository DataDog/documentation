...
<div class="alert alert-info">本ドキュメントで説明するソリューションは、クラウドベースのログ環境向けに設計されています。オンプレミスのログからメトリクスを生成するには、<a href="https://docs.datadoghq.com/observability_pipelines/set_up_pipelines/generate_metrics/">Observability Pipelines</a> ドキュメントを参照してください。</div>
