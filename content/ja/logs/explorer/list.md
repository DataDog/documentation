...
{{< img src="logs/explorer/list/list_walkthrough.gif" alt="表示テーブルの構成"  style="width:80%;">}}
...
{{< img src="logs/explorer/list/table_controls.gif" alt="表示テーブルの構成"  style="width:80%;">}}

ログテーブルの構成は、トラブルシューティングのコンテキストの他の要素と一緒に[保存ビュー][4]に保存されます。

## ビューのエクスポート

{{< img src="logs/explorer/list/list_share.png" alt="表示テーブルの構成"  style="width:80%;">}}
