...
<div class="alert alert-warning">リファレンステーブルはベータ版です。1,000,000 行を超えるリファレンステーブルは、ログのフィルタリングには使用できません。リファレンステーブルの作成および管理方法の詳細については、<a href="https://docs.datadoghq.com/integrations/guide/reference-tables/">リファレンステーブルによるカスタムメタデータの追加</a>を参照してください。</div>
