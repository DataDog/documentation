...
- /ja/continuous_testing/explorer/
...
{{% /tab %}}
{{% tab "テスト実行" %}}
{{< img src="continuous_testing/explorer/explorer_test_runs_2.png" alt="Synthetic Monitoring & Testing Results Explorer でテスト実行の検索と管理を行います" style="width:100%;">}}
{{% /tab %}}
{{< /tabs >}}
...
Results Explorer から [テスト実行を CSV にエクスポート][9] して、デバッグ、レポート作成、外部システムとの連携に活用できます。

また、Results Explorer の設定を [保存ビュー][10] として保存しておくと、今後の調査で素早く呼び出せます。
...
[9]: /ja/synthetics/explore/results_explorer/export/
[10]: /ja/continuous_testing/explorer/saved_views/