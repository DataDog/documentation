...
[Synthetic テストと APM トレース間のインテグレーション][16]を利用すれば、フロントエンド、ネットワーク、バックエンドリクエスト全体の障害の根本的な原因を見つけることができます。
...
## Synthetic Monitoring & Testing Results エクスプローラーを使用する {#use-the-synthetic-monitoring-testing-results-explorer}
