...
title: Jenkins
kind: documentation
description: CI/CD パイプラインで Synthetic テストを実行するために、Jenkins インスタンスを構成します。
further_reading:
...
{{< img src="synthetics/cicd_integrations/jenkins/nodejs-installation.png" alt="Jenkins の NodeJS インストール" style="width:80%;">}}
...
[4]: /ja/synthetics/cicd_integrations/configuration#configure-tests
[5]: /ja/continuous_integration/setup_pipelines/jenkins/