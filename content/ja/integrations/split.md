...
short_description: エンジニアリングチームと製品チームに実験プラットフォームを提供
support: contrib
supported_os:
  - linux
  - mac_os
 ...
 * API キー <span class="hidden-api-key">${api_key}</span> を作成します。

**Split で**

 * **Admin Settings** に移動し、**Integrations** をクリックして、Marketplace に移動します。Datadog 横の Add をクリックします。<br/>
...
[5]: https://docs.datadoghq.com/ja/graphing/event_stream
