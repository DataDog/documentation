...
tile:
  ...
  - caption: Komodor's main service view and full workload visibility
    ...
    media_type: image
  - caption: Correlate between several services and piece together the chain of events
      on a single timeline
    image_url: images/Komodor_screen_02.png
    media_type: image
  - caption: Easily compare changes in the Kubernetes manifest and config changes
      through Komodor
  ...
  - caption: Deep dive into Pod status and logs without a single kubectl command
    ...
    media_type: image
  - caption: Connect Datadog alerts, Kubernetes events, and availability issues in
      one simple view
