...
### Log collection
 ...
 8. Create a pan.firewall.d/conf.yaml file at the root of the [Agent's configuration directory][4] with the below content.
...
The metrics collected for this integration are determined by the relevant configured profiles on the [network vendors][6] page. 
...
- [Log types and fields][7]
- [Logs Collection documentation][8]
