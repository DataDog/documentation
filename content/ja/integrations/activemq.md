...
short_description: Collect metrics for brokers and queues, producers and consumers,
  and more.
supported_os:
- linux
- windows
...
tile:
  ...
  description: Collect metrics for brokers and queues, producers and consumers, and
    more.
  media: []
