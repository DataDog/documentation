...
- prometheus モード (デフォルト) は、Kubernetes バージョン 1.7.6 以降と互換性があります。
- cAdvisor モード (`cadvisor_port` オプションを設定すると有効) は、バージョン 1.3 以降と互換性があります。一貫したタグ付けと絞り込みを行うには、Agent バージョン 6.2 以降が必要です。
