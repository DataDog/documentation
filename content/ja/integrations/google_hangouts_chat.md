...
チームのコラボレーションを促進するために、Google Hangouts Chat を Datadog に接続して、以下のことができます。
...
| コマンド                            | 説明                                                                                                                                                                                                                                                  |
| ----                               | ---                                                                                                                                                                                                                                                          |
| `@Datadog install`                 | インストールワークフローを開始します。注: 複数の Datadog アカウントに属している場合は、インストールワークフロー時に自動的に「アカウント選択ページ」に移動します。                                                                                            |
...
2. Datadog アカウント内で、[Google Hangout Chat インテグレーションタイル][4]を使用してルームを削除できます。
...
[3]: https://docs.datadoghq.com/ja/developers/faq/what-do-notifications-do-in-datadog
