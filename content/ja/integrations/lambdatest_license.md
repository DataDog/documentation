...
- billing_type: flat_fee
  ...
  short_description: Monthly fee for using LambdaTest
  unit_price: 19
public_title: LambdaTest
short_description: Smart automation testing platform to reduce test execution time
  by 10X
supported_os:
- macos
- windows
tile:
  ...
  description: Smart automation testing platform to reduce test execution time by
    10X
  media:
  - caption: App Testing
