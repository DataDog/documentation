...
{{< whatsnext desc="一般ガイド:" >}}
    ...
    {{< nextlink href="integrations/guide/collect-sql-server-custom-metrics" tag="SQL Server" >}}SQL Server のカスタムメトリクスを収集する{{< /nextlink >}}
    {{< nextlink href="integrations/guide/freshservice-tickets-using-webhooks" tag="Webhooks" >}}Webhook を使用した Freshservice チケット{{< /nextlink >}}
    ...
    {{< nextlink href="integrations/guide/collecting-composite-type-jmx-attributes" tag="jmx" >}}複合条件型 JMX 属性の収集{{< /nextlink >}}
    {{< nextlink href="integrations/guide/jmx_integrations/" >}}Jmxfetch を使用しているインテグレーションは？{{< /nextlink >}} 
{{< /whatsnext >}}
...
{{< whatsnext desc="AWS ガイド:" >}}
    ...
    {{< nextlink href="integrations/guide/aws-cloudwatch-metric-streams-with-kinesis-data-firehose" tag="AWS" >}}AWS CloudWatch Metric Stream と Kinesis Data Firehose{{< /nextlink >}}
