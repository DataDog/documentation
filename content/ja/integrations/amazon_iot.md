...
"name": "amazon_iot"
"public_title": "Datadog-AWS IoT Core Integration"
"short_description": "Track key AWS IoT Core metrics."
"version": "1.0"
---
...
1. In the [AWS integration page][2], ensure that `IoT` is enabled under the `Metric Collection` tab.
2. Install the [Datadog - AWS IoT Core integration][3].
...
**Note**: If you log to a S3 bucket, make sure that `amazon_iot` is set as _Target prefix_.
