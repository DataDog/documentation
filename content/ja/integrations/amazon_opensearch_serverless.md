...
short_description: Amazon OpenSearch Serverless is a search configuration which automatically
...
tile:
  ...
  description: Amazon OpenSearch Serverless is a search configuration which automatically
    adjusts to handle versatile workloads.
  media: []
