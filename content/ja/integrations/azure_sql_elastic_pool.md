...
* SQL エラスティックプールのパフォーマンスを視覚化できます。
* SQL エラスティックプールのパフォーマンスをアプリケーションと関連付けることができます。
