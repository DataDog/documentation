...
name: tomcat
public_title: Tomcat
short_description: Track requests per second, bytes served, cache hits, servlet metrics,
  and more.
supported_os:
- linux
- windows
...
tile:
  ...
  description: Track requests per second, bytes served, cache hits, servlet metrics,
    and more.
  media: []
