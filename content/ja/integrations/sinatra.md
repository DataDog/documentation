...
* Sinatra アプリケーションログの収集を開始するには、[Agent の構成ディレクトリ][7]のルートにある `sinatra.d/conf.yaml` ファイルに次の構成ブロックを追加します。
...
[7]: /ja/agent/guide/agent-configuration-files/?tab=agentv6#agent-configuration-directory
[8]: /ja/agent/guide/agent-commands/?tab=agentv6#restart-the-agent