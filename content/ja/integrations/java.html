...
java.lang)</li> <li><code>bean</code> or <code>bean_name</code>: The full bean
name (e.g. java.lang:type=Compilation)</li> <li><code>attribute</code>: A list
...
cache. You could use the <code>type: Caches</code> filter: <br /> <br /> <%=snippet_code_block "jmx-cassandra-cache.yaml" %>
