...
ddtype: クローラー
dependencies: []
description: Pusher から Datadog にメトリクスを取得し、アプリエンゲージメントを表示および監視
...
short_description: Pusher から Datadog にメトリクスを取得し、アプリエンゲージメントを表示および監視
version: '1.0'
---
## 概要
...
4. Datadog ダッシュボードに戻り、デフォルトの Pusher ダッシュボードビューにメトリクスの表示が開始されることを確認します。
