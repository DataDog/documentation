...
ddtype: クローラー
dependencies: []
description: Azure SQL Database のキーメトリクスを追跡
...
short_description: Azure SQL Database のキーメトリクスを追跡
version: '1.0'
---
## 概要
...
* SQL データベースのパフォーマンスを視覚化できます。
* SQL データベースのパフォーマンスをアプリケーションと関連付けることができます。
