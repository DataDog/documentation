...
name: nginx
public_title: Nginx
short_description: Monitor connection and request metrics. Get more metrics with NGINX
  Plus.
supported_os:
- linux
- windows
...
tile:
  ...
  description: Monitor connection and request metrics. Get more metrics with NGINX
    Plus.
  media: []
