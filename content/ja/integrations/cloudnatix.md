...
short_description: CloudNatix による自動化された容量、コスト、運用の最適化を提供します。
supported_os:
- linux
- windows
- macos
tile:
  ...
  description: CloudNatix による自動化された容量、コスト、運用の最適化を提供します。
  media:
  - caption: CloudNatix の Datadog ダッシュボードは、クラスターの支出、使用状況、コストの最適化に関する洞察を提供します。
    image_url: images/cloudnatix-dashboard.png
    media_type: image
  - caption: ワークロードごとの削減可能見込額の視覚化
...
- [CloudNatix と Datadog でインフラを最適化する][8]
