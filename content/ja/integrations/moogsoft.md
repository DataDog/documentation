...
"terms":
  ...
  "legal_email": subscriptions@moogsoft.com
---
...
{{< img src="marketplace/moogsoft/images/moogsoft.correlation.png" alt="Moogsoft の相関関係" >}}

{{< img src="marketplace/moogsoft/images/moogsoft.dashboard.png" alt="Moogsoft のダッシュボード" >}}
...
### Moogsoft 可観測性クラウドデータフロー

{{< img src="marketplace/moogsoft/images/moogsoft.main.jpg" alt="Moogsoft の相関関係" >}}

{{< img src="marketplace/moogsoft/images/moogsoft.flow.png" alt="Moogsoft メイン" >}}

## サポート
Moogsoft サポート ([https://support.moogsoft.com][1]) までお問い合わせください。

---
このアプリケーションは Marketplace から入手でき、Datadog テクノロジーパートナーによってサポートされています。このアプリケーションを購入するには、[こちらをクリック][2]してください。
