...
カスタムチェックモニターには、Agent に含まれる [400 以上のインテグレーション][1]のいずれかによってレポートされないサービスチェックが含まれます。カスタムサービスチェックは、[カスタム Agent チェック][2]、[DogStatsD][3]、または [API][4] を使用して Datadog に送信できます。
