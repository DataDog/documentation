...
{{< img src="/monitors/monitor_types/watchdog/watchdog-monitor-apm2.png" alt="APM 上の Watchdog モニターの構成" style="width:80%;">}}
...
{{< img src="/monitors/monitor_types/watchdog/watchdog-monitor-infra.png" alt="インフラストラクチャー上の Watchdog モニターの構成" style="width:80%;">}}
...
{{< img src="/monitors/monitor_types/watchdog/log_anomaly_monitor-2.png" alt="Watchdog モニターの編集画面では、アラートカテゴリーがログ、アラートタイプがログ異常、環境が本番、サービスが広告サーバー、モニターのタイトルが本番広告サーバーで異常検出となっています" style="width:55%;">}}
