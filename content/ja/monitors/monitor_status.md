...
ステータスページでモニターを直接ミュートします。**Scope** フィールドを使用して、ダウンタイムを絞り込みます。複数のスコープまたはモニターを同時にミュートする方法の詳細については、[ダウンタイム][2]を参照してください。
...
| Delete | 現在のモニターを削除します。削除の確認を求められます。                                                                                                                                      |
...
メトリクスの動きをさらに調査するには、[ダッシュボード][6]または[ノートブック][7]を使用します。

## イベント

モニターから生成されたイベント（アラート、警告、回復など）は、**Status & History** セクションの上の時間セレクターに基づいてこのセクションに表示されます。イベントは[イベントストリーム][8]にも表示されます。
