...
{{< img src="/monitors/downtimes/downtime_recurring_rrule.png" alt="RRULEで定期的なダウンタイムをスケジュールするためのフィールド" style="width:90%;">}}
...
デフォルトの動作をオーバーライドするには、"Notify Your Team" セクションのオプションを使用して、ダウンタイムの終了時に送信する通知を指定します。
