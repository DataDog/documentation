...
{{< img src="monitors/service_level_objectives/error-rate-definition.jpeg" alt="エラー率の定義">}}
...
{{< img src="monitors/service_level_objectives/error-budget-definition.jpeg" alt="エラーバジェットの定義">}}
...
{{< img src="monitors/service_level_objectives/observed-error-rate-example.jpeg" alt="観測されたエラーレートの例">}}
...
{{< img src="monitors/service_level_objectives/burn-rate-alert-formula.jpeg" alt="バーンレートアラート式">}}

## 最大バーンレート値

上述したように、この式を使って、長いウィンドウと短いウィンドウの両方で観測されたバーンレートを評価することができます。

{{< img src="monitors/service_level_objectives/observed-error-rate.jpeg" alt="観測されたエラー率">}}

これまでに観測されたエラー率の最大値は 1 です (例えば、ある時間帯に全体の 100% が不良動作であった場合)。つまり、バーンレートアラートで使用できるバーンレートの最大値が存在することになります。

{{< img src="monitors/service_level_objectives/max-burn-rate.jpeg" alt="最大バーンレート">}}
...
{{< img src="monitors/service_level_objectives/time-to-depletion.jpeg" alt="枯渇までの時間計算式">}}
...
{{< img src="monitors/service_level_objectives/burn-rate-approach-2.jpeg" alt="バーンレートアプローチ # 2 計算式">}}

例えば、7 日間の SLO の場合、1 時間を長いウィンドウとして、理論上のエラーバジェット消費量が 10% の場合にアラートを発するには、次のようなバーンレートを選択する必要があります。

{{< img src="monitors/service_level_objectives/burn-rate-approach-2-example.jpeg" alt="バーンレートアプローチ # 2 計算式例">}}
