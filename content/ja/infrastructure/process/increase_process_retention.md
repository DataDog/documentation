...
<div class="alert alert-danger">プロセスベースのメトリクスは<a href="/metrics/custom_metrics/">カスタムメトリクス</a>と見なされ、それに応じて請求されます。請求への影響を避けるために、<code>command</code> や <code>user</code> などの無制限または非常に高いカーディナリティタグによるグループ化は避けてください。</div>
