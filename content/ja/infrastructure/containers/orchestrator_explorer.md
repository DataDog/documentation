...
_Resource Utilization ページについては、[Resource Utilization][13] を参照してください_。
...
{{< img src="infrastructure/livecontainers/orch_ex_resource_utilization_sorted_column.png" alt="コンテナリソース使用率のソートされた列" style="width:50%;">}}
