...
<div class="alert alert-warning">この機能は限定的に提供されています。アクセスのリクエストおよび組織が機能の適用基準を満たしていることの確認については、アカウント 担当者または <a href="https://docs.datadoghq.com/help/">カスタマー サポート</a> にお問い合わせください。</div>
