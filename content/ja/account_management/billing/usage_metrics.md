...
| APM インデックス化スパン             | `datadog.estimated_usage.apm.indexed_spans` | Total number of spans indexed by tag-based retention filters. |
...
| カスタムイベント                   | `datadog.estimated_usage.events.custom_events` | Volume of custom events submitted. |
