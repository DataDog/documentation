...
* Datadog は、お客様が Datadog データベースモニタリングで監視しているデータベースのユニークホスト数を 1 時間ごとに記録します。
  * Datadog の最高水準プラン (HWMP) では、月末にこの 1 時間ごとの測定結果が最高から最低まで順序付けられ、そのうち 8 番目に高い測定値に基づいて課金されます。
  * 月単位/時間単位混合プラン (MHP) では、月単位の最低契約量に対して課金され、ホスト数がその契約量を超えた時間については、時間単位の料金が課金されます。
* Datadog は、任意の時点で追跡されている構成された[正規化クエリ][9]の総数に基づいて課金します。
...
アカウントの 1 時間ごとの料金または請求については、[セールス][7]または[カスタマーサクセス][8]マネージャーにお問い合わせください。

[1]: https://www.datadoghq.com/pricing
[2]: /ja/metrics/custom_metrics/
[3]: /ja/tracing/trace_retention/#retention-filters
[4]: /ja/tracing/trace_ingestion/
[5]: /ja/tracing/trace_retention/
[6]: /ja/help/
[7]: mailto:sales@datadoghq.com
[8]: mailto:success@datadoghq.com
[9]: /ja/database_monitoring/data_collected/#normalized-queries