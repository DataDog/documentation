...
|--------------------|-----------------------------------|--------------------------------------------------|
| データベースホスト      | すべてのデータベースホストには、月に 200 の正規化されたクエリが含まれています。 | お客様がデータベースモニタリングで同時に監視しているデータベースホスト数を 1 時間に一度記録します。最高水準プラン (HWMP) では、月末にこの 1 時間ごとの測定結果が最高から最低まで順序付けられ、そのうち 8 番目に高い測定値に基づき課金されます。 |
