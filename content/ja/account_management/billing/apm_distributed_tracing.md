...
| Indexed Spans | 3,000 万件 | 5 つの APM ホストに 500 万件の Indexed span が含まれるため、残りの 2,500 万件に対し 1.70 ドル / 100 万件 | 25 × 1.70 ドル    | 42.50 ドル                |
...
サービス 1 はコンテナ 1 で、サービス 2 はコンテナ 2 で稼働するが、どちらも 1 つのホストで動作し、App Analytics で 2,000 件の Indexed span を送信。

| 対象ユニット  | 数量   | 料金                                                                                          | 計算式      | 小計             |
|----------------|------------|------------------------------------------------------------------------------------------------|--------------|----------------------|
| APM ホスト      | 1          | 31 ドル / ホスト                                                                                   | 1 × 31 ドル      | 31 ドル                  |
| Indexed Spans | 2,000 万件 | 1 つの APM ホストに 100 万件の Indexed span が含まれるため、残りの 1,900 万件に対し 1.70 ドル / 100 万件 | 19 × 1.70 ドル   | 32.30 ドル               |
...
| Indexed Spans    | 2,000 万件 | Indexed span  100 万件あたり 1.70 ドル | 20 × 1.70 ドル | 34 ドル               |
