...
| [Fargate][4]       | 1 件の同時タスクあたり 2 ドル / 月           | 65,000 のIndexed Span を価格に含む。                                        | お客様が Datadog APM サービスで監視しているタスクのインスタンス数を 5 分間隔で記録します。月末にこの間隔に基づく測定値を集計し、アプリケーションが実行されて監視された合計時間数に基づいて課金されます。[詳しくはこちら][4]              |
...
| インデックス化されたスパン | 2,000 万件 | 5 つの APM ホストに 500 万件の Indexed Span が含まれます。20のFargateタスクに130万含まれています。残りの 1,370万件のIndexed Spanに対し1.70 ドル / 100 万件 | 13.7 × 1.70 ドル          | 23.29 ドル                |
...
| インデックス化されたスパン    | 1,000 万 | 各ラムダ関数には150,000個のIndexed Spanが含まれています。追加のIndexed Span 100万個あたり1.70ドル | 7 × 1.70 ドル | 11.90 ドル               |
