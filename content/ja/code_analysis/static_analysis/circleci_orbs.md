...
CircleCI ワークフローで [Datadog Static Analysis][1] ジョブを実行します。
...
[CircleCI Project Settings ページ][2]で以下の環境変数を設定してください。

| 名前         | 説明                                                                                                                | 必須 |
|--------------|----------------------------------------------------------------------------------------------------------------------------|----------|
| `DD_API_KEY` | Datadog API キー。このキーは [Datadog 組織][3]によって作成され、シークレットとして保存する必要があります。              | はい     |
| `DD_APP_KEY` | Datadog アプリケーションキー。このキーは [Datadog 組織][4]によって作成され、シークレットとして保存する必要があります。      | はい     |
