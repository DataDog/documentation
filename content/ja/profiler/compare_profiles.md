...
{{< img src="profiler/compare_time_period.mp4" alt="比較ビューを開いて、プロファイルをタイムフレームの集計と比較します。" video="true">}}
...
{{< img src="profiler/compare_version.mp4" alt="2 つのバージョンの比較ビューを開きます。" video="true">}}
