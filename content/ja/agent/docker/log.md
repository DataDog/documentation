...
`-e DD_LOGS_CONFIG_DOCKER_CONTAINER_USE_FILE=true`            
: ファイルからの Docker コンテナログ収集を有効化するログコンフィギュレーションを追加します。Datadog Agent 7.27.0/6.27.0 以降で利用可能です。詳しくは[詳細セクション](#docker-container-log-collection-from-file)を参照してください。
