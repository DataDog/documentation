...
Synthetic Worker > v0.1.6 の API テスト結果: `intake.synthetics.`{{< region-param key="dd_site" code="true" >}}<br>
Synthetic Worker > v0.2.0 のブラウザテスト結果: `intake-v2.synthetics.`{{< region-param key="dd_site" code="true" >}}<br>
Synthetic Worker < v0.1.5 の API テスト結果: `api.`{{< region-param key="dd_site" code="true" >}}
