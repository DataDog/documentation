...
{{< img src="guides/saml/saml_configure.png" responsive="true" >}}
...
1.  Upload the IdP Metadata from your SAML Identity provider by clicking the "Choose File" button.
    ...
    {{< img src="guides/saml/saml_choose_file.png" responsive="true" >}}
...
{{< img src="guides/saml/saml_enable.png" responsive="true" >}}
...
{{< img src="guides/saml/saml_enabled.png" responsive="true" >}}
...
Normally users must be invited to Datadog, even for organizations with SAML enabled. 
If a user that has not been invited to Datadog logs in via an Org's IdP, the SAML assertion will be validated, but they will be redirected to a SAML Error page.
...
{{< img src="guides/saml/saml_jit_default.png" responsive="true" >}}
