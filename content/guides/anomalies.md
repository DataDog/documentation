...
{{ partial "img.html" (dict "root" . "src/anomalies" "dashboard_graph.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "initial_editor.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "function_menu.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "final_editor.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "monitor_options.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "alg_comparison_1.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "alg_comparison_2.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "alg_comparison_3.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "alg_comparison_scale.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "alg_comparison_new_metric.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "spaghetti.png") }}

You can, however, add multiple series in a single graph one at a time. The gray envelope will only show up on mouseover.

{{ partial "img.html" (dict "root" . "src/anomalies" "anomaly_multilines.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "anomalous_history.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "no_effect.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "disappearing_day.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "disappearing_half_hour.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "raw_profile_updates.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "rollup_profile_updates.png") }}
...
{{ partial "img.html" (dict "root" . "src/anomalies" "ewma_profile_updates.png") }}