...
Now, click on the + icon (Add functions and modifiers) on the right side of the metrics line. In the popup box, choose "Algorithms" then one of the four outlier algorithms:
...
### DBSCAN/ScaledDBSCAN vs. MAD/ScaledMAD
