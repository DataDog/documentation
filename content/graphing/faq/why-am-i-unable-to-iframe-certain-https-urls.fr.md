---
title: Pourquoi suis-je incapable d'iFrame certain URL?
kind: faq
---

Le problème concerne probablement les en-têtes définis sur la page URL, en particulier `X-Frame-Options`:
...
En utilisant `https://ozcruising.fogbugz.com/login` comme exemple:
