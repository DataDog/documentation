---
title: De fausses pointes apparaissent parfois sur mon graphique de sum
kind: faq
---

Nous avons identifié un scénario spécifique dans lequel des pics inattendus (souvent le double de la valeur normale attendue) sont affichés sur un graphique.

L'équipe d'ingénieurs de Datadog a travaillé sur une solution qui ne fonctionne que sur des comptes spécifiques et réduit fortement la présence de ces artefacts. Nous travaillons à améliorer cette solution et espérons la généraliser bientôt.
