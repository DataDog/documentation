...
Tras la cancelación, podrás seguir accediendo a los diagramas que creaste, pero perderás el acceso a algunas funciones:

- Los planos de _cuadrícula infinita_ pasan al modo de sólo lectura.
- La función _Live_ ya no estará disponible.
- AWS y los recursos de Azure ya no se actualizan.
- El [menú Bits][1] ya no funciona.

<div class="alert alert-info">Si cancelas dentro del periodo de garantía de devolución de 30 días y prefieres un reembolso, <a href="https://app.cloudcraft.co/support" rel="help" title="Cloudcraft support">ponte en contacto con el equipo de asistencia de Cloudcraft</a>.
</div>

1. Ve a **User** > **Subscription Settings** (Usuario > Configuración de la suscripción).
2. Haz clic en **Cancel subscription** (Cancelar suscripción).
3. Si lo deseas, puedes dejarnos comentarios sobre lo que Cloudcraft puede hacer para adaptarse mejor a tus necesidades en el futuro.
4. Selecciona **Cancel my account** (Cancelar mi cuenta).

Si no ves la opción **Cancel subscription** (Cancelar suscripción), es posible que hayas comprado tu suscripción a través del equipo de ventas de Datadog o a través de AWS Marketplace.
