---
aliases:
- /es/mobile_testing/mobile_app_tests
- /es/mobile_app_testing/mobile_app_tests
description: Aprende cómo empezar a monitorizar flujos (flows) de negocios clave utilizando
  tests de aplicaciones móviles.
further_reading:
- link: /synthetics/mobile_app_testing/settings
  tag: Documentación
  text: Más información sobre la configuración de los tests móviles
- link: /synthetics/browser_tests
  tag: Documentación
  text: Más información sobre cómo crear tests de navegador Synthetic
...
title: Tests de aplicaciones móviles
---
...
Los tests de aplicaciones móviles pueden ejecutarse de forma programada, bajo demanda o directamente dentro de tus [pipelines CI/CD][1].

Puedes crear tests de aplicaciones móviles en Datadog accediendo a [**Experiencia digital** > **Nuevo test**][12] y seleccionando **Test de aplicaciones móviles**.

{{< img src="mobile_app_testing/new_test.png" alt="Crear un test para móviles en Synthetic" style="width:50%;">}}
