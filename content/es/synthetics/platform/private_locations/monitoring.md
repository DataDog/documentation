...
Al hacer clic en una localización privada, aparece un panel que contiene información del **Estado** y los **Metadatos**. La tabla de la pestaña **Estado** muestra todos los workers que generan informes y la versión de imagen que están ejecutando. Esto de da una idea de cuántos workers necesitas extraer para la nueva versión de imagen.

En **Monitores** puedes ver avisos de estado, como `ALERT`, cuando algo no funciona como debería en una de tus localizaciones privadas. Por ejemplo, si la localización privada deja de enviar datos, significa que tiene un menor aprovisionamiento o que un worker está ejecutando una versión de imagen obsoleta.
...
|-------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Las [Localizaciones privadas Synthetic] {{location_id.name}} han dejado de enviar informes**              | Este monitor activa una alerta `NO DATA` cuando la métrica [`synthetics.pl.worker.running`][1] deja de informar datos de una de tus localizaciones privadas. Esto indica que los workers de tu localización privada pueden haber sido eliminados o haber dejado de funcionar.                                                                                                                                                                                                                                                                                  |
