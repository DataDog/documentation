...
| `INVALID_CA`                         | Un certificado de CA no es válido porque no es una CA o sus extensiones no se corresponden con el objetivo previsto.                                                     |
| `INVALID_PURPOSE`                    | El certificado proporcionado no puede utilizarse para los fines previstos.                                                                                               |
