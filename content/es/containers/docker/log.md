...
{{< tabs >}}
{{% tab "Instalación del contenedor" %}}
...
{{% /tab %}}
{{% tab "Agent de host con creación de logs personalizada" %}}
...
{{% /tab %}}
{{% tab "Logs de múltiples líneas Java" %}}
