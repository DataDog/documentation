...
| `DD_TAGS`            | Etiquetas (tags) de host separadas por espacios. Por ejemplo: `simple-tag-0 tag-key-1:tag-value-1`.                                                                                                                                                                                                                                                                 |
| `DD_SITE`            | Lugar de destino para tus métricas, trazas (traces) y logs. Tu `DD_SITE` es {{< region-param key="dd_site" code="true">}}. Por defecto es `datadoghq.com`.                                                                                                                                                                                               |
