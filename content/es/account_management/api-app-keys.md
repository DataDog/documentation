...
<div class="alert alert-danger">Asegúrese de almacenar de manera segura su clave de aplicación inmediatamente después de su creación, ya que el secreto de la clave no se puede recuperar más tarde.</div>
{{< /site-region >}}

<div class="alert alert-info">Si su organización tiene habilitado el modo de Lectura Única (OTR), asegúrese de almacenar de manera segura su clave de aplicación inmediatamente después de su creación, ya que el secreto de la clave no se puede recuperar más tarde.</div>
