...
* Un **tramo ingerido** es una solicitud individual realizada a un servicio individual de tu stack. Datadog te factura en función del número total de gigabytes de tramos ingeridos en APM de Datadog.
