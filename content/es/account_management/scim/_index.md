...
- link: /account_management/scim/azure/
  tag: Documentación
  text: Configurar SCIM con Azure Active Directory
- link: account_management/scim/okta
  tag: Documentación
  text: Configurar SCIM con Okta
kind: documentación
title: Suministro de usuarios con SCIM
---

## Información general

El sistema de administración de identidades entre dominios, o SCIM, es un estándar abierto que permite automatizar el suministro de usuarios. Con SCIM, puedes suministrar y quitar automáticamente usuarios en tu organización Datadog, de manera sincronizada con el proveedor de identidad (IdP) de tu organización.
...
Datadog admite el uso de SCIM con los proveedores de identidad Azure Active Directory (Azure AD) y Okta. Para Configurar SCIM, consulta la documentación de tu proveedor de identidad (IdP):
- [Azure AD][2]
- [Okta][3]
...
Datadog recomienda encarecidamente utilizar la clave de aplicación de una cuenta de servicio al configurar SCIM, para evitar cualquier interrupción en el acceso. Para obtener más información, consulta el [uso de cuentas de servicio con SCIM][4].

Al utilizar SAML y SCIM conjuntamente, Datadog recomienda encarecidamente deshabilitar el suministro justo-a-tiempo (JIT) de SAML, para evitar discrepancias en el acceso. Gestiona el suministro de usuarios únicamente a través de SCIM.

## Uso de una cuenta de servicio con SCIM

Para activar SCIM, debes utilizar una [clave de aplicación][5] para proteger la conexión entre tu proveedor de identidad y su cuenta de Datadog. Un usuario específico o una cuenta de servicio controla cada clave de aplicación.

Si utilizas una clave de aplicación vinculada a un usuario para habilitar SCIM y ese usuario abandona tu organización, su cuenta de Datadog se vacía. La clave de aplicación específica de ese usuario se revoca y puedes romper permanentemente tu integración SCIM, lo que impide a los usuarios de tu organización acceder a Datadog.
