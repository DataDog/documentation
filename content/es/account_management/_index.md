...
cascade:
  algolia:
    rank: 70
description: Administra tu cuenta y organización de Datadog
further_reading:
...
## Configuraciones personales {#personal-settings}

Las páginas de configuraciones personales en Datadog te permiten controlar cómo apareces ante otros en tu organización, cambiar o dejar organizaciones, y gestionar tus preferencias de notificación.
...
Puedes gestionar tu zona horaria, formato de hora, preferencia de accesibilidad visual y suscripciones de correo electrónico desde la pestaña [Preferencias][3] dentro de la {{< ui >}}Personal Settings{{< /ui >}} página.
...
Si no estás seguro de si un resumen de correo electrónico es relevante para ti, puedes ver un ejemplo haciendo clic en el enlace {{< ui >}}Example{{< /ui >}} junto a cada suscripción de correo electrónico. También puedes usar el botón {{< ui >}}Unsubscribe From All{{< /ui >}} para darte de baja de todas las suscripciones de correo electrónico.
{{% /site-region %}}
...
Elige si las horas se muestran en formato de 12 horas o de 24 horas en Datadog (por ejemplo, "2:30 pm" o "14:30"). Las cuentas nuevas tienen como formato predeterminado el de 12 horas. Los gráficos y ciertos datos tabulares se muestran en formato de 24 horas en todo momento.
...
Para unirte a una organización existente, debes ser invitado por un administrador. Después de que seas invitado, se te envía un correo electrónico con el asunto "Has sido invitado a unirte a \<Nombre de la Organización>". Haz clic en el botón {{< ui >}}Join Account{{< /ui >}} en el correo electrónico.

Si eres administrador de la organización, consulta la documentación adicional para:
...
Cuando pasas el cursor sobre una aplicación, la opción para habilitar o deshabilitarla aparece a la derecha de la lista de aplicaciones.
...
4. Haz clic {{< ui >}}Submit{{< /ui >}} para completar el proceso de verificación.
...
Cerrar sesión en todas las sesiones web activas te cierra sesión en todas las sesiones actuales en todos los dispositivos, incluyendo el que estás usando.


Para cerrar sesión en todas las sesiones activas:
1. Ve a {{< ui >}}Personal Settings{{< /ui >}}.
2. Haz clic {{< ui >}}Log Out of All Web Sessions{{< /ui >}}.
3. Confirma la acción.

Después de confirmar, se cierra la sesión en todos los dispositivos y necesitarás iniciar sesión nuevamente.

## Apariencia {#appearance}

Ve Datadog en modo oscuro al pasar el cursor sobre tu avatar en la barra lateral, o presionando `Ctrl+Opt+D` / `Ctrl+Alt+D`.

Para adaptarte a la configuración de apariencia de tu computadora, selecciona la opción {{< ui >}}System{{< /ui >}}. Esto hace que la apariencia de Datadog coincida automáticamente con el tema que hayas establecido a nivel de sistema operativo.

## Conectando a GitHub {#connecting-to-github}

Si instalaste la [integración de GitHub][9] para crear eventos en Datadog, vincula tu cuenta personal de GitHub a tu cuenta de usuario de Datadog. Al vincular tus cuentas, cualquier comentario que publiques en eventos de GitHub en Datadog se publicará automáticamente en el issue o en el pull request correspondiente en GitHub.
