...
{{< img src="metrics/guide/smooth_line.mp4" alt=Vídeo "Suavizar un gráfico de líneas"="true" width="90%" >}}

Cuando se muestran barras, el intervalo de rollup es más obvio:

{{< img src="métricas/guide/smoothing.mp4" alt=Vídeo "Suavizar un gráfico de barras"="true" width="90%" >}}
