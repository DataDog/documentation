---
description: Configura opciones de privacidad para Mobile Session Replay.
further_reading:
...
- link: /product_analytics/session_replay/mobile/app_performance
  tag: Documentación
  text: Cómo afecta Mobile Session Replay al rendimiento de las aplicaciones
- link: /product_analytics/session_replay/mobile/setup_and_configuration
  tag: Documentación
  text: Configuración de Mobile Session Replay
- link: /product_analytics/session_replay/mobile/troubleshooting
  tag: Documentación
  text: Solución de problemas de Mobile Session Replay
- link: /product_analytics/session_replay
  tag: Documentación
  text: Session Replay
title: Opciones de privacidad de Mobile Session Replay
---
