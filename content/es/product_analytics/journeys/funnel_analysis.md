...
- link: /product_analytics/analytics_explorer/
  tag: Documentación
  text: Explorador de análisis
title: Análisis de embudo
---

{{< callout url="http://datadoghq.com/private-beta/product-analytics" header="false" >}}
Todas las funciones de Product Analytics tienen disponibilidad limitada. Para solicitar acceso, rellena el formulario.
{{< /callout >}}
...
Para crear un embudo, ve a [**Digital Experience > Product Analytics > Journeys** (Experiencia digital > Product Analytics > Recorridos)][1] y haz clic en **Funnel** (Embudo).

{{< img src="product_analytics/journeys/funnel_analysis/funnels-overview.png" alt="Ir a la pestaña Análisis del embudo, en Product Analytics" style="width:100%;" >}}

En esta página, elige tu vista o acción inicial y haz clic en el icono más para crear pasos adicionales. También puedes utilizar la función de arrastrar y soltar para organizar los pasos.

{{< img src="product_analytics/journeys/funnel_analysis/funnels-start-view-action.mp4" alt="Filtrar el mapa de búsqueda con una consulta" video=true >}}
...
{{< img src="product_analytics/journeys/funnel_analysis/funnels-build-next-steps.png" alt="El editor de pasos del embudo carga automáticamente las vistas y acciones más frecuentes que tus usuarios suelen ver y realizar a continuación" style="width:50%;" >}}
...
- Los **filtros globales** se aplican a todo el embudo.
  ...
  {{< img src="product_analytics/journeys/funnel_analysis/funnels-global-filters.png" alt="Uso de atributos para filtrar información globalmente al crear tu embudo" style="width:50%;" >}}
...
- El **filtrado de un paso** proporciona información sobre cómo cambia el paso en función de una restricción concreta de ese paso. Por ejemplo, es posible que quieras ver cómo un dispositivo, sistema operativo, geolocalización o usuario específico afecta a la conversión entre pasos.
    ...
    {{< img src="product_analytics/journeys/funnel_analysis/funnels-step-filters.png" alt="Uso de atributos para filtrar información entre pasos al crear tu embudo" style="width:50%;" >}}
...
{{< img src="product_analytics/journeys/funnel_analysis/funnels-across-steps.png" alt="Mide atributos en todos los pasos o en pasos específicos." style="width:60%;" >}}
...
{{< img src="product_analytics/journeys/funnel_analysis/funnel-timeseries.mp4" alt="Hacer clic en el desplegable de visualización para seleccionar una vista diferente" video=true >}}
...
{{< img src="product_analytics/journeys/funnel_analysis/funnels-timeseries.png" alt="Visualiza los datos de conversión como series temporales." style="width:80%;" >}}

### Valor de consulta

Los valores de consulta muestran el valor actual de la métrica de uso dada.

{{< img src="product_analytics/journeys/funnel_analysis/funnels-query-value.png" alt="Visualiza los datos de conversión como valores de consulta." style="width:80%;" >}}

### Lista principal

Visualiza los principales valores de una faceta en función de la medida elegida.

{{< img src="product_analytics/journeys/funnel_analysis/funnels-top-list.png" alt="Visualiza los datos de conversión como una lista de elementos principales" style="width:80%;" >}}
...
- Comparte la visualización completa en notebooks y dashboards:
  ...
  {{< img src="product_analytics/journeys/funnel_analysis/funnels-share-visualization.png" alt="Compartir la visualización completa haciendo clic en Export (Exportar)" style="width:90%;" >}}

- Comparte widgets individuales desde un dashboard:

  {{< img src="product_analytics/journeys/funnel_analysis/funnels-share.png" alt="Compartir un widget haciendo clic en el icono Export (Exportar), en la parte superior derecha del widget" style="width:90%;" >}}
...
[3]: /es/real_user_monitoring/browser/data_collected/#session-metrics
