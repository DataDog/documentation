---
aliases:
- /es/tracing/dynamic_instrumentation/enabling/ruby/
code_lang: ruby
code_lang_weight: 30
further_reading:
- link: contenedores
...
3. Instala o actualiza la biblioteca de rastreo de Ruby a la versión 2.9.0 o posterior, siguiendo las [instrucciones pertinentes][2].
