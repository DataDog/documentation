...
- link: https://app.datadoghq.com/release-notes?category=Watchdog
  ...
  text: ¡Échales un vistazo a las últimas versiones de Watchdog de Datadog! (Se requiere
...
- link: https://www.datadoghq.com/blog/datadog-watchdog-automated-root-cause-analysis/
  tag: Blog
  text: Análisis automatizado de causas raíz con el RCA de Watchdog
...
- link: https://www.datadoghq.com/blog/ai-powered-metrics-monitoring/
  ...
  text: Detección de anomalías, correlaciones predictivas - Uso de la monitorización
    de métricas asistidas por IA
title: Datadog WatchdogTM
---
## Información general

Watchdog es el motor de inteligencia artificial de Datadog que te proporciona alertas automatizadas, información y análisis de las causas raíz a partir de datos observables en toda la plataforma Datadog. Watchdog supervisa continuamente tu infraestructura y llama tu atención sobre las señales más importantes, ayudándote a detectar, solucionar y resolver problemas. 
...
{{< whatsnext desc="">}}
 {{< nextlink href="/watchdog/alerts">}}<u>Alertas de Watchdog</u>: Cómo ver e interpretar las alertas de Watchdog: Qué información proporciona cada alerta, qué cubren las alertas y dónde encontrar las alertas de Watchdog en Datadog.{{< /nextlink >}}
...
Para ayudar con la investigación, Watchdog muestra informaciones basadas en el contexto en todos los exploradores, busca las causas raíz y determina el impacto en el usuario.
...
{{< whatsnext desc="">}}
  ...
  {{< nextlink href="/watchdog/rca">}}<u>Análisis de causas raíz</u>: Cómo el análisis de las causas raíz (RCA) de Watchdog encuentra la causas originales de una anomalía y cómo utilizar la información proporcionada.{{< /nextlink >}}
