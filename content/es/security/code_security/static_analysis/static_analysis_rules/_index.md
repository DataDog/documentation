...
cascade:
  banner:
    ...
    title: <span>Integraciones fluidas.</span> Prueba la Seguridad de Código de Datadog
  modal:
    bottom_boxes:
...
rulesets:
  ...
  swift-code-style:
    description: 'Las reglas de Code Security permiten escribir reglas de Swift que
  ...
  typescript-browser-security:
    description: 'Reglas enfocadas en encontrar problemas de seguridad en tus aplicaciones
      ...
      '
    title: Reglas de seguridad para las aplicaciones web de TypeScript
  typescript-code-style:
    description: 'Reglas consideradas mejores prácticas para bases de código modernas
      ...
      ser opinativas respecto a la aplicación de patrones de código más simples.

      '
    title: Patrones de código opinativos en TypeScript
  ...
  typescript-node-security:
    description: 'Reglas para identificar posibles puntos críticos de seguridad en
      Node. Esto puede incluir falsos positivos que requieren una evaluación adicional.
...
<div class="alert alert-warning">
    Code Security no está disponible para el {{< region-param key="dd_site_name" >}} el sitio.
</div>
{{% /site-region %}}

## Descripción general {#overview}

El análisis de código estático de Datadog proporciona reglas listas para usar que ayudan a detectar vulnerabilidades de seguridad, errores y problemas de mantenibilidad en tu base de código. Para más información, consulta la [documentación de configuración][1].
