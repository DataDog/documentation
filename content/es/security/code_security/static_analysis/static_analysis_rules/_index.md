...
cascade:
  banner:
    ...
    title: <span>Integraciones sin interrupciones.</span> Prueba Datadog Code Security
  modal:
    bottom_boxes:
...
rulesets:
  apex-code-style:
    description: 'Reglas de Datadog Code Security para escribir reglas de Apex que
      sigan estándares de codificación establecidos.

      '
    title: Reglas para hacer cumplir el estilo de código de Apex y las mejores prácticas.
  apex-security:
  ...
  bash-code-quality:
    description: 'Reglas para hacer cumplir la calidad del código para scripts de
      Bash.
  ...
  go-security:
    description: 'Detecta problemas de seguridad comunes (como inyección SQL, XSS
      ...
      '
    title: Asegúrate de que tu código Go sea seguro y protegido
  java-best-practices:
  ...
  python-inclusive:
    description: 'Reglas para Python para evitar un lenguaje inapropiado en el código
      ...
      '
    title: Revisa el código Python en busca de problemas de redacción.
  python-pandas:
  ...
  swift-code-style:
    description: 'Reglas de seguridad del código para escribir reglas de Swift que
      ...
      '
    title: Reglas para hacer cumplir el estilo de código y las mejores prácticas de
      Swift.
  swift-security:
    description: 'Reglas enfocadas en encontrar problemas de seguridad en tu código
      en Swift.
  ...
  typescript-code-style:
    description: 'Reglas consideradas como mejores prácticas para bases de código
      ...
      suelen tener criterios definidos sobre la imposición de patrones de código más
      simples.

      '
    title: Patrones de código con una fuerte orientación en TypeScript.
  ...
  typescript-node-security:
    description: 'Reglas para identificar posibles puntos críticos de seguridad en
      Node. Esto puede incluir falsos positivos que requieran un análisis adicional.
