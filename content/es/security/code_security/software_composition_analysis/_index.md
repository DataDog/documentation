...
---
## Información general
Software Composition Analysis (SCA) detecta bibliotecas de código abierto, tanto en tus repositorios como en tus servicios en ejecución, y te proporciona una visibilidad de extremo a extremo de las vulnerabilidades de biblioteca y la gestión de licencias desde el desarrollo hasta la producción.
...
- Identificación de paquetes maliciosos, fin de vida útil de bibliotecas y riesgos en bibliotecas basada en las normas OpenSSF
...
Los pasos recomendados para corregir las vulnerabilidades detectadas se pueden encontrar en el panel lateral de cada vulnerabilidad en SCA. Se proporcionan pasos para actualizar la biblioteca a la versión más segura (no vulnerable), así como a la versión más cercana.
...
El [inventario][8] de bibliotecas te ayuda a entender la lista de bibliotecas y sus versiones, que se utilizan en tu base de código y se ejecutan en servicios desplegados. Para cada versión de biblioteca, puedes evaluar la frecuencia con la que se utiliza, el riesgo de su licencia y entender el estado cada biblioteca (por ejemplo, si ha llegado al fin de su vida útil, si no recibe mantenimiento, etc.).


### Contexto de vulnerabilidad de bibliotecas en APM
...
- Estado de esta versión de biblioteca basada en su desglose de la puntuación OpenSSF
