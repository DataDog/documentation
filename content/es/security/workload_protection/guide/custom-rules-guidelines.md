---
aliases:
- /es/security/cloud_security_management/guide/custom-rules-guidelines
further_reading:
...
En algún momento, puede que desees escribir tus propias [reglas personalizadas de Workload Protection Agent ][1]. Cuando escribas tus propias reglas, hay algunas estrategias que puedes utilizar para optimizar la eficiencia.
...
Workload Protection utiliza el concepto de aprobadores y descartadores para filtrar eventos que no debería activar ninguna regla en una política. Los aprobadores y descartadores permiten o deniegan eventos solo a nivel de políticas. No actúan sobre reglas individuales.
