...
- link: /security/default_rules/?category=cat-csm-threats#all
  tag: Documentación
  text: Explorar las reglas de detección de Workload Protection
- link: /security/workload_protection/workload_security_rules
  tag: Documentación
  text: Aprenda a gestionar las reglas de detección de Workload Protection
...
<!-- {{< img src="security/csm/agent_events_explorer_details.png" alt="Descripción de tu imagen" style="width:100%;" >}} -->
...
[11]: /es/security/workload_protection/security_signals
...
[18]: /es/security/workload_protection/guide/active-protection