---
aliases:
- /es/security/threats/backend_windows
description: Documentación del esquema JSON del evento backend de protección de cargas
  de trabajo de Windows
disable_edit: true
title: Formatos de eventos de protección de cargas de trabajo de Windows
---
...
Los eventos de amenazas de protección de cargas de trabajo de Windows tienen el siguiente esquema JSON:
