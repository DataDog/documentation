...
- link: /security/default_rules/?category=cat-application-security#cat-application-security
  tag: Documentación
  text: Explorar las reglas predefinidas de detección de amenazas de la AAP
- link: /security/application_security/policies/custom_rules/
  tag: Documentación
  text: Configurar reglas personalizadas de detección de amenazas de la AAP
- link: /security/application_security/how-it-works/threat-intelligence/
  tag: Documentación
  text: Inteligencia sobre amenazas de la AAP
title: Investigar las señales de seguridad
---

## Información general

Las señales de seguridad de AAP se crean cuando Datadog detecta una amenaza basada en una regla de detección. Mira, busca, filtra e investiga las señales de seguridad en el [Explorer de señales][2] o configura [Reglas de notificación][8] para enviar señales a herramientas de terceros.

<!-- {{< img src="security/application_security/threats/security_signals/appsec-threat-signals.png" alt="Información general sobre investigación de amenazas en el explorador de señales con el panel lateral de detalles">}} -->
...
**Nota**: Para modificar las señales de seguridad, debes tener el permiso `security_monitoring_signals_write`. Consulta [Control de acceso basado en roles][9] para obtener más información sobre los roles predeterminados de Datadog y los permisos de control de acceso granular basados en roles disponibles para la protección de aplicaciones y API.
...
3. Revisa los **Siguientes pasos** y actúa:
    ...
    -  Haz clic en **Bloqueo automático de atacantes** (basado en reglas de [detección][10]). Esta configuración requiere el permiso **Proteger escritura** de Protección de aplicaciones y API.
