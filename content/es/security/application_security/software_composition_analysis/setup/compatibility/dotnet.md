...
Para consultar la lista de plataformas y sistemas operativos compatibles, consulta [Compatibilidad con .NET Framework][2] y [Compatibilidad con .NET/.NET Core][1].
