...
| Función de protección de las aplicaciones y las API                   | Versión mínima de rastreador PHP |
| -------------------------------- |----------------------------|
...
| Seguimiento automático de los eventos de actividades de usuarios | 0.89.0                     |
