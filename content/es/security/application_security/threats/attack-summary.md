...
{{< img src="security/application_security/threats/appsec-threat-overview-page-top.png" alt="Captura de pantalla de la página de Resumen de ataques de ASM"  >}}

El **Resumen de ataques** de ASM proporciona una visión rápida de la situación de tu aplicación y API. Destaca las tendencias, la exposición del servicio, el tráfico de ataques y el impacto en la lógica de negocio. Puedes pasar de widgets a sus trazas (traces) relacionadas.
