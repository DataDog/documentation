...
- link: https://www.datadoghq.com/blog/secure-serverless-applications-with-datadog-asm/
  tag: Blog
  text: Aplicaciones serverless seguras con ASM de Datadog
title: Habilitación de la detección de amenazas de ASM con las bibliotecas de rastreo
  de Datadog
type: multi-code-lang
---

Selecciona el lenguaje de la aplicación para obtener información sobre cómo habilitar la detección de amenazas de ASM para tu lenguaje y los tipos de infraestructura.
