...
Las siguientes funciones de seguridad de aplicaciones son compatibles con la biblioteca Java para la versión de rastreador especificada:
...
La versión mínima de rastreador para contar con todas las funciones de seguridad de aplicaciones compatibles para Java es v1.31.0.
...
### Tipos de despliegues compatibles
...
## Compatibilidad de lenguajes y marcos
...
- Si la **Seguridad del código** no es compatible con tu marco, aún así detectará las vulnerabilidades Cifrado débil, Hashing débil, Cookie insegura, Cookie sin marca HttpOnly y Cookie sin marca SameSite.



| Marco                  | Versiones   | ¿Es compatible la detección de amenazas? | ¿Es compatible la protección contra amenazas? |¿Seguridad del código? |
| ----------------------- | ---------- | --------------- | ---------------------------------------------- | ---------------------------------------------- |
...
### Compatibilidad con marcos en la red
...
- Si tu marco no aparece como compatible más abajo, la **Seguridad del código** no detectará vulnerabilidades de inyección SQL, pero sí detectará el resto de tipos de vulnerabilidades presentadas [aquí][3].
