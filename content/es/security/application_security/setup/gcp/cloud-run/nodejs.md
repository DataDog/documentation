...
title: Habilitar App and API Protection para funciones de Google Cloud Run en Node.js
---
...
2. Copia el rastreador Datadog Node.js en tu imagen Docker.
...
4. Cambia el punto de entrada para contener tu aplicación en el proceso de `serverless-init` de Datadog.
   **Nota**: Si ya tienes un punto de entrada definido en tu archivo Docker, consulta la [configuración alternativa](#alt-node).
