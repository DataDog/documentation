...
- link: https://www.datadoghq.com/blog/datacenter-monitoring-dashboards/
  tag: Blog
  text: Monitorización de centros de datos y dispositivos de red con Datadog
- link: https://www.datadoghq.com/blog/network-device-monitoring/
  tag: Blog
  text: Presentación de Network Device Monitoring
...
La sección [perfiles de proveedor](#vendor-profiles) a continuación enumera los dispositivos de monitorización de red que Datadog admite con perfiles predefinidos. Datadog también puede monitorizar dispositivos no incluidos en esta lista usando un [perfil genérico](#generic-profile), que recopila métricas básicas si es aplicable para esos dispositivos.

### Perfil genérico

El [perfil genérico][114] recopila métricas para todos los dispositivos no admitidos por un perfil de proveedor. Las métricas incluyen TCP, UDP, IP y métricas de interfaz como la utilización del ancho de banda y el volumen enviado/recibido.

### Perfiles de proveedores

Los siguientes proveedores de dispositivos son compatibles con perfiles específicos.
Si un proveedor o tipo de dispositivo es compatible, pero el modelo específico no lo es, puedes:
* Crea nuevos [perfiles][2] para empezar la monitorización de nuevos modelos de dispositivos.

* Ponte en contacto con el [servicio de asistencia de Datadog][1] para solicitar asistencia para tu modelo específico.

  **Nota**: Puedes seguir utilizando NDM, ya que Datadog recopila métricas de referencia genéricas de todos los dispositivos. Si hay métricas no compatibles de un proveedor MIB, puedes enviar una solicitud de asistencia a Datadog con los siguientes detalles: <br></br>

  Ejecuta un `snmpwalk` desde el dispositivo solicitado y envía la siguiente salida:
...
* Amplía tus perfiles para que admitan otros valores `sysobjectid`.
  ...
  Por ejemplo, si deseas monitorizar otro tipo de Cisco CSR, puedes modificar el perfil ISR directamente para mencionar otro `sysobjectid` de esta manera:

  ```
  snmpwalk -v 2c -c [community string] [ip address] 1.3.6.1.2.1.1.2
  ```

  **Nota**: Si no conoces el `sysobjectid` de tu dispositivo, ejecuta un `snmpwalk` en un host que pueda llegar a tu dispositivo. Utiliza el resultado para mencionar el perfil a coincidir.
<br></br>

| Proveedor                                                                                                                                                                                                               | Archivos de configuración |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| ----------- |
...
[1]: /es/network_monitoring/devices/troubleshooting#what-do-i-do-if-datadog-supports-a-vendor-or-device-type-but-my-specific-model-isnt-supported
...
[10]: https://docs.datadoghq.com/es/integrations/snmp_arista/
...
[13]: https://docs.datadoghq.com/es/integrations/snmp_aruba/
...
[22]: https://docs.datadoghq.com/es/integrations/crest_data_systems_barracuda_waf/
...
[27]: https://docs.datadoghq.com/es/integrations/snmp_chatsworth_products/#overview
...
[32]: https://docs.datadoghq.com/es/integrations/snmp_cisco/
[33]: https://docs.datadoghq.com/es/integrations/cisco_aci/?tab=host
[34]: https://docs.datadoghq.com/es/integrations/crest_data_systems_cisco_asa/
[35]: https://docs.datadoghq.com/es/integrations/crest_data_systems_cisco_ise/
...
[57]: https://docs.datadoghq.com/es/integrations/snmp_dell/
...
[67]: https://docs.datadoghq.com/es/integrations/snmp_f5/
...
[70]: https://docs.datadoghq.com/es/integrations/snmp_fortinet/
...
[74]: https://docs.datadoghq.com/es/integrations/snmp_hewlett_packard_enterprise/
...
[82]: https://docs.datadoghq.com/es/integrations/rapdev_infoblox/
...
[84]: https://docs.datadoghq.com/es/integrations/snmp_juniper/
...
[91]: https://docs.datadoghq.com/es/integrations/meraki/
...
[102]: https://docs.datadoghq.com/es/integrations/pan_firewall/
...
[106]: https://docs.datadoghq.com/es/integrations/crest_data_systems_pfsense/
