...
rulesets:
  ...
  python-pandas:
    ...
    description: "Un conjunto de reglas para verificar que el código de pandas se\
      \ use de forma adecuada.\n\n - Garantiza que las declaraciones `import` sigan\
      \ las pautas de codificación.\n - Evita códigos y métodos obsoletos.\n - Evita\
      \ el código ineficiente siempre que sea posible.\n"
  python-security:
    ...
    description: "Reglas centradas en encontrar problemas de seguridad y vulnerabilidad\
      \ en tu código de Python, incluidos aquellos que se encuentran en OWASP10 y\
  ...
  ruby-code-style:
    ...
    description: 'Reglas de análisis de código para escribir reglas de Ruby que sigan
  ...
  modal:
    ...
    top_box:
      ...
      - Crea un static-analysis.datadog.yml con el contenido anterior en la raíz de
        tu repositorio
      - Usa nuestros complementos de IDE gratuitos o añade escaneos de Code Analysis
        a tus pipelines de CI
      - Recibe comentarios sobre tu código
      footer: Para obtener más información, lee la <a href="/code_analysis">documentación
        de Code Analysis</a>
    bottom_boxes:
    ...
    footer:
      text: Usa Datadog Code Analysis para detectar problemas de código en cada paso
