...
- link: https://www.datadoghq.com/blog/soar/
  tag: Blog
  text: Automatizar la protección de identidades, la contención de las amenazas y
    la inteligencia sobre amenazas con los flujos de trabajo SOAR de Datadog
...
- link: https://learn.datadoghq.com/courses/automated-workflows
  ...
  text: Solucionar problemas con Workflow Automation
...
<br>¿Tienes preguntas o comentarios? Únete al canal **#workflows** en [Datadog Community Slack][4].
