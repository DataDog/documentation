...
Infraestructura DevSecOps Pro incluye [Contenedores][1], [Serverless][2] y [CSM Pro][3]. También incluye más de {{< translate key="integration_count" >}} [integraciones listas para usar][4].
...
Infraestructura DevSecOps Enterprise incluye [Containers][1], [Serverless][2], [Live Processes][3], y [CSM Enterprise][4]. También incluye más de {{< translate key="integration_count" >}} [integraciones listas para usar][5].
