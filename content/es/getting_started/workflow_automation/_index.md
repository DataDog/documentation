...
- link: /security/cloud_security_management/workflows/
  tag: Documentación
  text: Automatizar flujos de trabajo de seguridad
title: Empezando con la automatización de flujos de trabajo
---
...
1. En la página **[Workflow Automation][5]** (Automatización del flujo de trabajo), haz clic en **New Workflow** (Nuevo flujo de trabajo).
1. Introduce un nombre y una descripción para el flujo de trabajo. El flujo de trabajo del ejemplo utiliza el nombre y la descripción siguientes:<br>
   Nombre: `Create a Jira Ticket`.<br>
...
1. Introduce el **proyecto** y el **tipo de incidencia** para la incidencia de Jira creada por el flujo de trabajo.
...
1. Para obtener una notificación de Slack más útil, utiliza variables de salida del paso. Las variables de salida del paso te permiten transferir datos del paso de Jira al paso de Slack dentro de tu flujo de trabajo. Utiliza el siguiente texto de mensaje para incluir la clave de incidencia de Jira, el nombre del monitor y la incidencia de Jira en el mensaje de Slack:
...
1. Para probar la acción, haz clic en **Test** (Probar) en la pestaña **Configure** (Configurar). Al probar una acción, se crea un mensaje de Slack real.
...
1. En la sección **Configure notifications & automations** (Configurar notificaciones y automatizaciones), haz clic en **Add Workflow** (Añadir flujo de trabajo).
1. Utiliza el nombre de mención del flujo de trabajo (`@workflow-Create-Jira-Ticket`) para buscar tu flujo de trabajo y selecciónalo en el menú desplegable.
...
* Explora la lista de todas las acciones de flujos de trabajo disponibles en el [catálogo de acciones][8]. 
* Crea un flujo de trabajo a partir de un [plano][9].
* Utiliza la [acción HTTP][10] para enviar una solicitud a cualquier endpoint.
...
[8]: /es/actions/actions_catalog/
[9]: /es/workflows/build
[10]: /es/service_management/workflows/actions/#http
[11]: /es/service_management/workflows/actions/#data-transformation