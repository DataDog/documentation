...
El Agente de Datadog es un software que se ejecuta en tus servidores. Recopila eventos y métricas de los hosts y los envía a Datadog, donde puedes analizar tus datos de monitorización y rendimiento. 

El Agente puede ejecutarse en:
- Servidores locales (Windows, macOS) 
...
2. Ten a mano tu [clave API de Datadog][16].
...
Para brindarle visibilidad completa de su infraestructura, el Agente de Datadog informa métricas sobre su propia salud y configuración, así como métricas recopiladas de sus servidores y servicios a través de sus verificaciones predeterminadas.

### Métricas del Agente {#agent-metrics}

El Agente informa las siguientes métricas a Datadog sobre sí mismo. Estas métricas proporcionan información sobre qué servidores o contenedores tienen el Agente en ejecución, cuándo se inició cada Agente y la versión de Python que está utilizando.
...
| Descriptor de archivo | [Sistema][4]  | Todos excepto Mac     |
...
Estas verificaciones se pueden utilizar en Datadog para visualizar el estado del Agente a través de monitores y tableros de un vistazo. Consulta [Descripción general de las verificaciones de servicio][21] para aprender más.
...
- **Detección de Integrations**: 
    - **Host**: [Integrations][9] se identifican a través del archivo de configuración del Agente.
    - **Contenedor**: Las Integrations se identifican automáticamente utilizando la función de Autodiscovery de Datadog. Consulta [Autodiscovery básico del Agente][11] para aprender más.
...
Ve a [Comandos del Agente][33] para [Iniciar][34], [Detener][35] o [Reiniciar][26] tu Agente.

## Solución de problemas {#troubleshooting}

Para obtener ayuda con la solución de problemas del Agente:

- Ve [Solución de problemas del Agente][36]
- Ve los [Archivos de Registro del Agente][37]
...
{{< nextlink href="/getting_started/application" >}}Aprende sobre la Datadog UI{{< /nextlink >}}
{{< nextlink href="/getting_started/logs" >}}Aprende cómo recopilar Logs a través del Agente{{< /nextlink >}}
