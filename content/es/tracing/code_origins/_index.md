...
description: Más información sobre cómo utilizar Code Origins para entender dónde
...
title: Code Origins para tramos (spans)
---

{{< beta-callout url="#" btn_hidden="true" >}}
Code Origins está actualmente en Vista previa. Para unirte a la vista previa, sigue las siguientes instrucciones para activar la función en tus servicios compatibles. 

Para enviar preguntas, comentarios o solicitudes relacionadas con Code Origins, <a href="https://docs.google.com/forms/d/e/1FAIpQLScyeRsF2GJjYdf9bUyeDjt8_9id-gvqiBU1SHR3ioDGe5eF3g/viewform?usp=header">rellena este formulario</a> con tus datos. 
{{< /beta-callout >}}

## Información general

Code Origins detecta las localizaciones exactas en tu código base donde se crean tramos APM. Cuando se activa en un servicio compatible, añade automáticamente la ruta del archivo, el número de la línea y el nombre de la función a cada [tramo de entrada de servicios][12], lo que facilita:
...
{{< img src="tracing/code_origins/code_origin_details_spotlight.png" alt="Detalles de Code Origins" style="width:100%;">}}
...
1. Busca "tramos de entrada de servicios" desde tus servicios habilitados para Code Origins.

    {{< img src="tracing/code_origins/code_origin_service_entry_spans_filter.png" alt="Code Origins - Buscar tramos de entrada de servicios" style="width:100%;">}}

1. Haz clic en un tramo para ver los detalles.
1. En el panel lateral de detalles de la traza, busca la sección "Code Origins".

    {{< img src="tracing/code_origins/code_origin_details_spotlight.png" alt="Detalles de Code Origins en el Explorador de trazas" style="width:100%;">}}

1. De la sección Code Origins:
    - Inicia una sesión de [Live Debugger][11] en el servicio en ejecución haciendo clic en "Start Debug Session" (Empezar la sesión de depuración), para capturar logs en la localización del método de Code Origins. O bien, selecciona un punto de interrupción en el gutter de la vista previa del código, para capturar logs en la línea de código seleccionada.

        {{< img src="tracing/code_origins/code_origin_start_debug_session.png" alt="Code Origins - Iniciar sesión de Live Debugger" style="width:100%;">}}  

     - Haz clic en las variables del código fuente para añadirlas como atributos a tramos futuros con [Dynamic Instrumentation][5].

        {{< img src="tracing/code_origins/code_origin_add_span_tag_spotlight.png" alt="Code Origins - Añadir etiquetas de tramo con Dynamic Instrumentation" style="width:100%;">}} 
...
2. Visualiza las métricas RED (Solicitudes, Errores y Duración) como anotaciones en línea de tus métodos de endpoint.
    ...
    {{< img src="tracing/code_origins/code_origin_ide_details.png" alt="Detalles de Code Origins en IDE" style="width:100%;">}}

## Solucionar problemas

### Falta sección Code Origins

- Verifica que Code Origins está [habilitado](#enable-code-origins) en la configuración de tu biblioteca de rastreo.
...
- En la mayoría de los servicios, los datos de Code Origins se capturan sólo para [tramos de entrada de servicios][12]. Puedes filtrar por "tramos de entrada de servicios" en el [Explorador de trazas APM][1].

    {{< img src="tracing/code_origins/code_origin_service_entry_spans_filter.png" alt="Code Origins - Buscar tramos de entrada de servicios" style="width:100%;">}}

- Para buscar todos los tramos que incluyan Code Origins, utiliza la consulta `@_dd.code_origin.type:*` en el [Explorador de trazas APM][1].
...
- Code Origins está diseñado para referenciar únicamente códigos de usuario, pero en algunos casos pueden colarse referencias a códigos de terceros. Puedes informar de estos casos al [servicio de asistencia de Datadog][13] y ayudar a mejorar estas referencias.
