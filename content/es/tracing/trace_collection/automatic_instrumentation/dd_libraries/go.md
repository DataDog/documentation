...
El rastreador Go requiere Go `v1.21 o superiores` y el Datadog Agent `v6.20.0 o superiores`. Para ver la lista completa de versiones de Go y de compatibilidad de marcos de trabajo de Datadog (incluidas las versiones heredadas y de mantenimiento), consulta la página de [requisitos de compatibilidad][1].
