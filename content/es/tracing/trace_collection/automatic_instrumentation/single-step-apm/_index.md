...
- `DD_APM_INSTRUMENTATION_LIBRARIES="java:1,python:3"`: instala sólo las bibliotecas de Datadog APM para Java y Python fijadas a las versiones principales 1 y 3 respectivamente.
