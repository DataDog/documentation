...
Utiliza la API de Datadog para crear, modificar o eliminar trazas de manera programática para enviar a Datadog. Esto es útil para trazar código interno que no es capturado por la instrumentación automática, eliminar tramos no deseados de las trazas y proporcionar una visibilidad y contexto más profundos sobre los tramos, incluyendo la adición de etiquetas de tramo.
