...
integration_title: Balanceador de carga de aplicaciones Google Cloud
integration_version: ''
is_public: true
manifest_version: 2.0.0
name: google_cloud_application_load_balancer
public_title: Balanceador de carga de aplicaciones Google Cloud
short_description: Protege tus balanceadores de carga de aplicaciones Google Cloud
  con Datadog App & API Protection.
supported_os:
- linux
- windows
- macos
tile:
  ...
  description: Protege tus balanceadores de carga de aplicaciones Google Cloud con
    Datadog App & API Protection.
  media:
  - caption: Datadog App & API Protection ofrece la seguridad de una defensa en profundidad
      mediante la monitorización tanto del balanceador de carga de aplicaciones Google
      Cloud como de los servicios backend, detectando y alertando sobre exploits y
      ataques reales.
  ...
  - caption: Datadog App & API Protection proporciona visibilidad a nivel de borde
      ...
      maliciosas en el balanceador de carga de aplicaciones Google Cloud antes de
      que puedan llegar a tus servicios backend.
  ...
  title: Balanceador de carga de aplicaciones Google Cloud
---
...
Datadog App and API Protection amplía la visibilidad y la mitigación de amenazas en línea a tus balanceadores de carga de aplicaciones Google Cloud mediante [extensiones de servicio de Google Cloud][1].
...
[2]: https://docs.datadoghq.com/es/security/application_security/setup/gcp/service-extensions/?source=gcp-alb-tile-setup
