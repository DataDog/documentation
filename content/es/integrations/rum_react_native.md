...
short_description: Monitorizar aplicaciones React Native y generar métricas utilizando
  Datadog RUM
supported_os:
- android
- ios
tile:
  ...
  description: Monitorizar aplicaciones React Native y generar métricas utilizando
    Datadog RUM
  media: []
...
Con la [integración React Native][1] en Datadog, puedes dedicar menos tiempo a resolver problemas y más a lanzar nuevas funciones:
...
Monitoriza el estado de extremo a extremo de tu aplicación React Native:
...
Para empezar a recopilar eventos de Real User Monitoring de tu aplicación, consulta [Monitorización de React Native][2].

### Recopilar trazas

Tu aplicación React Native envía automáticamente trazas a Datadog.

### Recopilar logs

Para empezar a reenviar logs de tu aplicación React Native a Datadog, consulta [Recopilación de logs de React Native][3].

## Datos recopilados

### Métricas

La integración React Native no incluye métricas. Para generar métricas personalizadas desde tu aplicación RUM, consulta [Generar métricas][4].

### Eventos 

Para obtener más información sobre eventos y atributos, consulta [Monitorización de RUM React Native][5].

### Checks de servicios

La integración React Native no incluye checks de servicios.
...
- [React Native Monitorización][5]

[1]: https://app.datadoghq.com/integrations/rum-react-native
[2]: https://docs.datadoghq.com/es/real_user_monitoring/reactnative/#setup
...
[5]: https://docs.datadoghq.com/es/real_user_monitoring/reactnative/
