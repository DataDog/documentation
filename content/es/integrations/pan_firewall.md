...
### Recopilación de logs
 ...
 1. [Instala el Datadog Agent ][1] en una máquina accesible por el cortafuegos y que pueda conectarse a Internet.
 2. En Pan OS, selecciona Dispositivo >> Perfiles de servidor >> Syslog, añade un nombre para el perfil del servidor. Sigue los [pasos de configuración][2] del reenvío de logs de Syslog. Los mismos pasos se enumeran a continuación.
 3. Haz clic en Añadir y proporciona los siguientes datos del servidor:
    * Nombre del servidor
    * Dirección IP de la máquina con Datadog Agent
    * Transporte como TCP
    * Puerto como 10518 y formato como BSD
 4. Copia y configura el el formato de log personalizado para el tipo de log requerido. Los formatos siguientes son correspondencias de los formatos enumerados en [los documentos de descripciones de campos d Syslog de Palo Alto Networks][3].
 ...
 6. Haz clic en la pestaña Objetos para abrir la pantalla del perfil de reenvío de logs.
 7. Crear el perfil de reenvío de logs proporcionando el nombre, el tipo de log y el perfil syslog
 8. Crea un archivo pan.firewall.d/conf.yaml en la raíz del [directorio de configuración del Agent][4] con el siguiente contenido.
     ...
     - type: tcp
       ...
       source: "pan.firewall"
     ```
 9. [Reinicia el Agent][5].

## Datos recopilados

### Métricas

Las métricas recopiladas para esta integración están determinados por los perfiles de configurados pertinentes en la página de [vendedores de red][6]. 
...
- [Tipos y campos de logs][7]
- [Documentación de la recopilación de logs][8]
...
[8]: https://docs.datadoghq.com/es/logs/log_collection/?tab=tailexistingfiles#getting-started-with-the-agent
