...
- link: https://docs.datadoghq.com/logs/guide/send-aws-services-logs-with-the-datadog-kinesis-firehose-destination/
  tag: Guía
  text: Enviar logs de servicios de AWS con el destino Datadog Amazon Data Firehose
...
14. De manera opcional, adjunta la <a href="https://console.aws.amazon.com/iam/home#policies/arn:aws:iam::aws:policy/SecurityAudit" target="_blank">política SecurityAudit de AWS</a> al rol para usar [Cloud Security Management Misconfigurations][5].
...
[5]: /es/security/cloud_security_management/misconfigurations/
