...
{{< whatsnext desc="Envía tus eventos personalizados a Datadog:">}}
    ...
    {{< nextlink href="/events/guides/agent/" >}}Check personalizado del Agent{{< /nextlink >}}
    {{< nextlink href="/events/guides/email/" >}}Correo electrónico{{< /nextlink >}}
    {{< nextlink href="/events/guides/dogstatsd/" >}}DogStatsD{{< /nextlink >}}
    {{< nextlink href="/integrations/guide/events-from-sns-emails/" >}}Correo electrónico de Amazon SNS{{< /nextlink >}}
    {{< nextlink href="/logs/guide/sending-events-and-logs-to-datadog-with-amazon-eventbridge-api-destinations/#configuration" >}}Destinos de API de Amazon EventBridge{{< /nextlink >}}
{{< /whatsnext >}}