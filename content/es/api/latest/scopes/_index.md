...
<div class="alert alert-danger">Esta página enumera únicamente los contextos de autorización que pueden asignarse a los clientes OAuth. Para ver la lista completa de permisos asignables para claves de aplicación delimitadas, consulta <a href="/account_management/rbac/permissions/#permissions-list">Permisos para roles Datadog</a>.
