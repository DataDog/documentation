---
disable_toc: false
title: Dividir logs para Google Pub/Sub
---

## Información general

Configura Google Pub/Sub para enviar logs al worker de Observability Pipelines y luego procesar y enrutarlos a diferentes destinos en función de tu caso de uso.
