---
aliases:
- /es/observability_pipelines/split_logs/http_client/
disable_toc: false
title: Dividir logs del cliente HTTP
---

## Información general

Utiliza el worker de Observability Pipelines para procesar y enrutar logs de tu servidor HTTP a diferentes destinos en función de tu caso de uso.
...
1. Selecciona la plantilla **Dividir logs** para crear un nuevo pipeline.
1. Seleccione **Cliente HTTP** como fuente.
...
{{% collapse-content title="Mapa de biblioteca" level="h5" expanded=false id="library_mapping" %}}

{{% observability_pipelines/processors/remap_ocsf_library_mapping %}}

{{% /collapse-content %}}

{{% collapse-content title="Mapas personalizados" level="h5" expanded=false id="custom_mapping" %}}
