---
disable_toc: false
title: Control del volumen de logs para Amazon S3
---

## Información general

Utiliza el worker de Observability Pipelines para dirigir únicamente logs de Amazon S3 útiles a sus destinos.
