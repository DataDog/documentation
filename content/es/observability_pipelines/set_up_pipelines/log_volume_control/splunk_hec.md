---
aliases:
- /es/observability_pipelines/log_volume_control/splunk_hec/
disable_toc: false
title: Control del volumen de logs para Splunk HTTP Event Collector (HEC)
---

## Información general

Configura el worker de Observability Pipelines con el origen Splunk HTTP Event Collector (HEC) para que sólo enrute logs útiles a tus destinos.
...
1. Introduce la dirección Splunk HEC. Esta es la dirección y el puerto a los que tus aplicaciones están enviando sus datos de registro. El worker de Observability Pipelines escucha esta dirección para los logs entrantes.
