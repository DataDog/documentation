---
aliases:
- /es/observability_pipelines/log_volume_control/fluent/
disable_toc: false
title: Control del volumen de logs para Fluent
---

## Información general

Configura el worker de Observability Pipelines con la fuente Fluentd o Fluent Bit para que solo enrutes logs útiles a tus destinos.
