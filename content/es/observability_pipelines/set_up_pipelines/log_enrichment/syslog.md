---
aliases:
- /es/observability_pipelines/log_enrichment/syslog/
disable_toc: false
title: Enriquecimiento de logs para Syslog
---

## Información general

Configura Rsyslog o Syslog-ng para enviar logs al worker de Observability Pipelines y enriquecer y transformar tus logs antes de enrutarlos a su destino.
