---
aliases:
- /es/observability_pipelines/log_enrichment/fluent/
disable_toc: false
title: Enriquecimiento de logs para Fluent
---

## Información general

Configura Fluentd o Fluent Bit para enviar logs al worker de Observability Pipelines y enriquecer y transformar tus logs antes de enrutarlos a su destino.
