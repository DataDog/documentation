---
aliases:
- /es/observability_pipelines/log_enrichment/datadog_agent/
disable_toc: false
title: Enriquecimiento de logs para el Datadog Agent
---

## Información general

Configura tu Datadog Agent para enviar logs al worker de Observability Pipelines y enriquecer y transformar tus logs antes de enrutarlos a su destino.
