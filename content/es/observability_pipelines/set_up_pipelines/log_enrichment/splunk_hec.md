---
aliases:
- /es/observability_pipelines/log_enrichment/splunk_hec/
disable_toc: false
title: Enriquecimiento de logs para Splunk HTTP Event Collector (HEC)
---

## Información general

Configura Splunk HTTP Event Collector (HEC) para enviar logs al worker de Observability Pipelines y así enriquecer y transformar tus logs antes de enrutarlos a su destino.
