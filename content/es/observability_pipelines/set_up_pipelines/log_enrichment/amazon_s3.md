...
<<<<<<< HEAD:content/en/observability_pipelines/set_up_pipelines/log_enrichment/amazon_s3.md
{{% /tab %}} -->
{{% tab "Google SecOps" %}}
=======
{{% /tab %}} 
{{% tab "Chronicle" %}}
>>>>>>> master:content/es/observability_pipelines/set_up_pipelines/log_enrichment/amazon_s3.md
