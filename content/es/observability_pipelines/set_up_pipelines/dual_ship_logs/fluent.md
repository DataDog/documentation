---
aliases:
- /es/observability_pipelines/dual_ship_logs/fluent/
disable_toc: false
title: Envío doble de logs para Fluent
---

## Información general

Configura Fluentd o Fluent Bit y Observability Pipelines para que el worker de Observability Pipelines agregue y procese los logs provenientes de tus fuentes previas antes de enrutarlos a varias aplicaciones.
