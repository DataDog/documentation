---
aliases:
- /es/observability_pipelines/dual_ship_logs/splunk_tcp/
disable_toc: false
title: Envío doble de logs para Splunk Heavy o Universal Forwarders (TCP)
---

## Información general

Configura tu Splunk Heavy o Universal Forwarders para enviar logs al worker de Observability Pipelines para procesar y enrutarlos a destinos descendentes.
