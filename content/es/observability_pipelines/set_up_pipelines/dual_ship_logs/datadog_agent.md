...
1. Introduce la dirección de escucha, que es la dirección y el puerto en los que el worker de Observability Pipelines escucha los logs entrantes del Datadog Agent. Por ejemplo, `0.0.0.0:<port_number>`.
