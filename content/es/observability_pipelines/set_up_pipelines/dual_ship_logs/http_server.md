---
disable_toc: false
title: Envío doble de logs para el servidor HTTP
---

## Información general

Usa el worker de Observability Pipelines para agregar y procesar los logs de tu cliente HTTP antes de enrutarlos a varias aplicaciones.
