---
aliases:
- /es/observability_pipelines/dual_ship_logs/syslog/
disable_toc: false
title: Envío doble de logs para Syslog
---

## Información general

Configura Rsyslog o Syslog-ng y establece Observability Pipelines para que el worker de Observability Pipelines agregue y procese los logs procedentes de tus orígenes ascendentes antes de enrutarlos a varias aplicaciones, incluido Splunk.
