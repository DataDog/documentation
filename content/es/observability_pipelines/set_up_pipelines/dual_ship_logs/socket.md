...
{{% /tab %}}
<<<<<<< HEAD:content/en/observability_pipelines/set_up_pipelines/dual_ship_logs/http_client.md
...
=======
{{% tab "Chronicle" %}}
>>>>>>> master:content/es/observability_pipelines/set_up_pipelines/dual_ship_logs/socket.md
