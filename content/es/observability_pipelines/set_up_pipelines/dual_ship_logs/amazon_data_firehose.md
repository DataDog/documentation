---
disable_toc: false
title: Dual Ship Logs para Amazon Data Firehose
---

## Información general

Utiliza el worker de Observability Pipelines para agregar y procesar tus logs de Amazon Data Firehose antes de enviarlos a varias aplicaciones.
...
<<<<<<< HEAD:content/en/observability_pipelines/set_up_pipelines/dual_ship_logs/amazon_data_firehose.md
{{% /tab %}} -->
{{% tab "Google SecOps" %}}
=======
{{% /tab %}} 
{{% tab "Chronicle" %}}
>>>>>>> master:content/es/observability_pipelines/set_up_pipelines/dual_ship_logs/amazon_data_firehose.md
