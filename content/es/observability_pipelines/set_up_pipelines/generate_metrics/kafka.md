---
disable_toc: false
title: Generar métricas para Kafka
---

## Información general

Utiliza el worker de Observability Pipelines para generar métricas para tus logs a partir de tus temas de Kafka.
...
1. [Envío de logs al worker de Observability Pipelines](#send-logs-to-the-observability-pipelines-worker-over-kafka)
