---
aliases:
- /es/observability_pipelines/sensitive_data_redaction/sumo_logic_hosted_collector/
disable_toc: false
title: Redacción de datos confidenciales para la fuente de logs HTTP del recopilador
  alojado de Sumo Logic
---
...
Observability Pipelines es compatible con la fuente de logs HTTP del recopilador de Sumo Logic.
...
1. [Envío de logs al worker de Observability Pipelines a través de la fuente HTTP de Sumo Logic](#send-logs-to-the-observability-pipelines-worker-over-sumo-logic-http-source)
...
1. Selecciona **Sumo Logic** como fuente.
...
1. Ingresa la dirección de Sumo Logic. Esta es la dirección y el puerto a los que tus aplicaciones envían sus datos de registro. El worker de Observability Pipelines escucha esta dirección en busca de logs entrantes.
