---
aliases:
- /es/observability_pipelines/sensitive_data_redaction/fluent/
disable_toc: false
title: Redacción de datos confidenciales para Fluent
---
...
1. Selecciona la plantilla **Sensitive Data Redactions** (Redacciones de datos confidenciales) para crear un pipeline nuevo.
