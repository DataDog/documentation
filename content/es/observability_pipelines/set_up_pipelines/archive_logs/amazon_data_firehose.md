...
<<<<<<< HEAD:content/en/observability_pipelines/set_up_pipelines/archive_logs/amazon_data_firehose.md
{{% /tab %}} -->
{{% tab "Google SecOps" %}}
=======
{{% /tab %}} 
{{% tab "Chronicle" %}}
>>>>>>> master:content/es/observability_pipelines/set_up_pipelines/archive_logs/amazon_data_firehose.md
