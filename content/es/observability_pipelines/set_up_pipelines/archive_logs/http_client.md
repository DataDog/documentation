---
aliases:
- /es/observability_pipelines/archive_logs/http_client/
disable_toc: false
title: Logs de archivo para el cliente HTTP
---

## Información general

Utiliza el worker de Observability Pipelines para formatear tus logs de servidor HTTP en un formato rehidratable por Datadog antes de dirigirlos a archivos de logs de Datadog.
