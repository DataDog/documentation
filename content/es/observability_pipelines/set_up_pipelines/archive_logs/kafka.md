---
disable_toc: false
title: Archive Logs para Kafka
---

## Información general

Utiliza el worker de Observability Pipelines para formatear tus logs de temas de Kafka en un formato rehidratable por Datadog antes de dirigirlos a Datadog Log Archives.
...
1. Selecciona la plantilla **Archive Logs** para crear un nuevo pipeline.
1. Selecciona la fuente **Kafka**.
...
{{% /tab %}}
{{% tab "Procesador de etiquetas (tags)" %}}
...
1. Introduce el host y el puerto de los servidores de arranque de Kafka que los clientes deben utilizar para conectarse al clúster Kafka y detectar todos los demás hosts del clúster. Deben introducirse en el formato `host:port`, como `10.14.22.123:9092`. Si hay más de un servidor, utilice comas para separarlos.

    Si has activado SASL, introduce el nombre de usuario y la contraseña de Kafka SASL.
