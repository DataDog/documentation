...
El destino Azure Storage está disponible para la plantilla [Logs de archivos][1]. Utiliza este destino para enviar tus logs en formato rehidratable en Datadog a un bucket de Azure Storage para archivarlo. Debes configurar [logs de archivos de Datadog][2], si aún no lo has hecho y, a continuación, debes configurar el destino en la interfaz de usuario del pipeline.
