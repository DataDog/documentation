...
- description: 'Una duración de cualquier tipo en **nanosegundos**: tiempo de respuesta
    HTTP, tiempo de consulta de base de datos, latencia, etc. Utiliza [Remap](/logs/log_configuration/processors/#remapper)
    para reasignar cualquier duración dentro de los registros a este atributo, ya
    que Datadog lo muestra y lo utiliza como medida predeterminada para la búsqueda
    de trazas.'
  domain: Performance
  name: duration
  product_source:
...
- description: El nombre de la aplicación Datadog.
  ...
  - ios
  type: string
- description: El tipo de dispositivo según lo reportado por el dispositivo (System
    User-Agent).
  ...
  - roku
  type: string
- description: La marca del dispositivo según lo reportado por el dispositivo (System
    User-Agent).
  domain: Device (Android, iOS, Roku)
  name: device.brand
  product_source:
  ...
  - roku
  type: string
- description: El modelo del dispositivo según lo reportado por el dispositivo (System
    User-Agent).
  domain: Device (Android, iOS, Roku)
  name: device.model
  product_source:
  ...
  - roku
  type: string
- description: El nombre del dispositivo según lo reportado por el dispositivo (System
    User-Agent).
  domain: Device (Android, iOS, Roku)
  name: device.name
  product_source:
...
- description: El tipo de dispositivo reportado por el dispositivo (encabezado HTTP
  ...
  - browser
  type: string
- description: La marca del dispositivo según lo reportado por el dispositivo (encabezado
    HTTP User-Agent).
  domain: Device (Browser)
  name: device.brand
  product_source:
...
- description: Indica si la sesión está actualmente activa. La sesión termina después
  ...
  - browser
  type: boolean
- description: El tipo de sesión, `user` o `synthetics`. Las sesiones de [Pruebas
...
- description: El tipo de proveedor del recurso (por ejemplo, `primera parte`, `cdn`,
  ...
  - browser
  type: string
- description: Los clics muertos detectados por el RUM Browser SDK.
  ...
  - browser
  type: string
- description: Los clics de rabia detectados por el RUM Browser SDK.
  domain: Frustration signals (Browser events)
  ...
  - browser
  type: string
- description: Los clics de error detectados por el RUM Browser SDK.
  domain: Frustration signals (Browser events)
