...
{{< img src="incident_response/incident_management/guide/jira/incident_jira_settings.png" alt="Configuración de la integración de Jira en la que se muestra la configuración de la cuenta, las reglas de creación condicionales y las propiedades de Jira con variables de plantillas" style="width:80%;" >}}
...
{{< img src="incident_response/incident_management/guide/jira/incident_jira_mappings.png" alt="Asignaciones de estado y gravedad de Jira en las que se muestran estados de incident (incidente) asignados a estados de Jira y niveles de gravedad asignados a propiedades de Jira" style="width:80%;" >}}
