...
- Lotes CI y ejecuciones de tests
- Consultas de búsqueda (como ejecuciones de tests fallidas con códigos de estado de error HTTP, ejecuciones de tests fallidas en CI por su estado de bloqueo, ejecuciones de tests que requirieron reintentos, ID de tests para agregar a tu pipeline CI).
- Intervalo de tiempo en directo (como la última hora o la última semana)
- Visualizaciones (como series temporales, lista de los principales, tabla o lista)
...
{{< img src="continuous_testing/saved_view.png" alt="Vistas guardadas en el Explorador de Monitorización Synthetic y resultados de tests" width="100%" >}}
