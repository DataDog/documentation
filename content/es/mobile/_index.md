...
1. Primero, inicia sesión en la [página del perfil de tu cuenta de Datadog][4] a través de un navegador y haz clic en el botón **Link mobile device** (Vincular dispositivo móvil) de la organización en la que desees iniciar sesión. Acto seguido, se te mostrará un código QR.
...
- Dependiendo del SLO que elijas, es posible que aparezca la etiqueta “Timeframe” (Intervalo de tiempo). Pulsa “Choose” (Elegir), junto a la etiqueta “Timeframe”, para seleccionar el intervalo de tiempo del SLO.
