...
| [Biblioteca Lambda][4]       | La biblioteca Lambda de Datadog recopila datos (como las métricas de Lambda mejoradas y las trazas [traces]) del tiempo de ejecución de tu función de Lambda. Luego, la biblioteca Lambda envía estos datos a logs (para que los recopile el [Forwarder][5]) o a la [Extensión de Lambda][6]. La biblioteca Lambda de Datadog suele agruparse junto con la biblioteca de rastreo de Datadog en una [Capa de Lambda][7] para facilitar su instalación.                          |
