...
- Instalación de la librería Datadog Lambda en tus funciones Lambda como una capa Lambda.
...
| `addLayers`                   | Si deseas instalar la librería de Datadog Lambda como una capa. Por defecto es `true`. Configúralo en `false` cuando planees empaquetar la librería Datadog Lambda al paquete de despliegue de tus funciones por tu cuenta para poder instalar una versión específica de la librería Datadog Lambda ([Python][8] o [Node.js][9]).                                                                                                                   |
...
| `coldStartTraceSkipLibs`      | Omite opcionalmente la creación de tramos de inicio en frío para un lista separada por comas de librerías. Es útil para limitar la profundidad u omitir bibliotecas conocidas. El valor por defecto depende del tiempo de ejecución.                                                                                                                                                                                                                                                                |
