...
Ejecuta `datadog-ci lambda instrument` para aplicar la instrumentación de Datadog a una función de Lambda. Este comando añade la librería Lambda de Datadog o la Datadog Lambda Extension como capas de Lambda a las funciones de Lambda instrumentadas y modifica sus configuraciones.
...
| `--layer-version`              | `-v`      | La versión de la capa de la librería Lambda de Datadog que se va a aplicar. Esto varía entre los tiempos de ejecución. Para ver la última versión de la capa, consulta las notas de versión del repositorio datadog-lambda-layer de [JS][2] o [Python][3].                                                                                                                                                 |         |
...
| `--log-level`                  |           | Configura `debug` para ver una salida adicional de la librería Lambda de Datadog o la extensión de Lambda con fines de resolución de problemas.                                                                                                                                                                                                                 |         |
