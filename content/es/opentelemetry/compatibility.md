...
Para habilitar la funcionalidad completa de RUM, necesita [inyectar encabezados compatibles][2] para correlacionar RUM y trazas.

### Monitoreo de Redes en la Nube (CNM) {#cloud-network-monitoring-cnm}

El monitoreo a nivel de span o a nivel de punto final **no** es compatible.
...
Para lenguajes no compatibles en configuraciones de OpenTelemetry, [configure el etiquetado de telemetría][5] para vincular datos a un commit específico.
