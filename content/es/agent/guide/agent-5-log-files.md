...
disable_toc: false
private: true
title: Archivos de log del Agent 5
---
...
**Nota**: En los sistemas Windows Server 2008, Vista y sistemas posteriores, los logs del Agent se encuentran en `C:\ProgramData\Datadog\logs`. `ProgramData` es una carpeta oculta.
...
[3]: /es/agent/guide/agent-5-configuration-files#agent-main-configuration-file