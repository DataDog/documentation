---
aliases:
- /es/agent/versions/upgrade_to_agent_v7/
- /es/agent/upgrade/
further_reading:
- link: /agent/guide/python-3/
  tag: Documentación
  text: Migra tus checks personalizados de Python 2 a Python 3
title: Actualización al Datadog Agent 7
---

<div class="alert alert-info">
Agent 7 solo admite checks personalizados de Python 3. <a href="/agent/guide/python-3">Comprueba si los checks personalizados son compatibles con Python 3</a> antes de actualizar al Agent 7.
</div>
...
4. Cuando termines la instalación, tendrás la opción de iniciar el Datadog Agent Manager.
...
Ejecuta el comando de instalación del Agent con la variable de entorno `DD_UPGRADE="true"` para actualizar tu Agent de la versión 5 a la versión 7. El instalador del Agent v7 puede convertir automáticamente las configuraciones de v5 durante la actualización:
...
Ejecuta el comando de instalación del Agent con la variable de entorno `DD_AGENT_MAJOR_VERSION=7` y `DD_UPGRADE="true"` para actualizar tu Agent de la versión 5 a la versión 7. El instalador del Agent v7 puede convertir automáticamente las configuraciones de v5 durante la actualización:
