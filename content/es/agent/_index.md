...
El Agente v7 está disponible. <a href="/agent/versions/upgrade_to_agent_v7">Actualice a la versión más reciente</a> para beneficiarse de toda la nueva funcionalidad.
</div>
...
{{< whatsnext desc="Esta sección incluye los siguientes temas:">}}
  ...
  {{< nextlink href="/agent/iot">}}<u>IoT</u>: Instalar y configurar el Agente de IoT de Datadog, una versión del Agente de Datadog optimizada para el seguimiento de dispositivos IoT y aplicaciones embebidas.{{< /nextlink >}}
  ...
  {{< nextlink href="/getting_started/observability_pipelines">}}<u>Configurar Pipelines de Observabilidad y Datadog</u>: Despliegue el Observability Pipelines Worker como un agregador para recopilar, transformar y dirigir todos sus registros y métricas a cualquier destino.{{< /nextlink >}}
{{< /whatsnext >}}
