...
<div class="alert alert-danger"><strong>Nota</strong>: El script de instalación del Agent crea el archivo de socket con los permisos correctos, y <code>use_dogstatsd: true</code> y <code>dogstatsd_socket: "/var/run/datadog/dsd.socket"</code> se establecen por defecto. </div>
