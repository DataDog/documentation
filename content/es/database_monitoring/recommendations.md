...
| **Índice faltante**       | El plan de ejecución de la consulta realiza escaneos secuenciales costosos. Cuando se detecta, Datadog recomienda utilizar un índice para agilizar la consulta.                | <i class='icon-check-bold'> |                             |                             | <i class='icon-check-bold'> | <i class='icon-check-bold'> |
