...
Agent Observability se integra con [Sensitive Data Scanner][3], que ayuda a evitar la filtración de datos identificando y redactando cualquier información confidencial (como datos personales, detalles financieros o información de propiedad) que pueda estar presente en cualquier paso de tu aplicación de LLM.
