...
| **Functionality for SLO with Groups** (Funcionalidad para grupos con SLO)                                               | SLO calculado en base a todos los grupos<br><br>Puedes ver todos los grupos en el panel lateral del SLO y en el widget de resumen SLO                                                                                                                  | Admitido para SLOs con un monitor de una sola alerta múltiple<br><br>**Option 1:** (Opción 1:) SLO calculado basado en todos los grupos (puedes ver todos los grupos en el panel lateral SLO y en el widget de resumen SLO)<br>**Option 2:** (Opción 2:) SLO calculado basado en hasta 20 grupos seleccionados (puedes ver todos los grupos seleccionados en el panel lateral SLO y en el widget de resumen SLO)                                                                                                                                | SLO calculado basado en todos los grupos<br><br>Puedes ver todos los grupos en el panel lateral SLO y en el widget de resumen SLO.                                                           |
...
| **SLO widgets ([List widget][10] or [Summary widget][9])** (Widgets SLO [widget de lista][10] o [widget de resumen][9])                                                  | Puedes ver hasta 15 meses de datos históricos con el widget de resumen SLO                                                                                                           | Puedes ver hasta 3 meses de datos históricos con el widget de resumen SLO                                                                                                                           | Puedes ver hasta 15 meses de datos históricos con el widget de resumen SLO                                                         |
