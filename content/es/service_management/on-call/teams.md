...
1. Añade una política de escalada por defecto.
   {{< img src="incident_response/on-call/escalation_policy_blank.png" alt="Vista de configuración de una nueva política de escalada. Notifica tres cronogramas propuestos." style="width:80%;" >}}
...
1. Define los cronogramas creados en el paso anterior. 
   {{< img src="incident_response/on-call/schedule_blank.png" alt="Vista de configuración de un nuevo cronograma." style="width:80%;" >}}
