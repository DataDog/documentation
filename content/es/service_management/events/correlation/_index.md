...
{{< whatsnext desc="Comienza con:">}}
    ...
    {{< nextlink href="/service_management/events/correlation/triage_and_notify/" >}}<u>Clasificación y notificación</u>: consulta, clasifica y recibe notificaciones o tickets sobre las correlaciones que se han creado para ti{{< /nextlink >}}
