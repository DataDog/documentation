...
Los checks de Datadog informan del estado de cada ejecución. La [página Resumen de checks][1] muestra tus checks informados en el último día. Los estados potenciales son:
...
{{< img src="monitors/check_summary/check_search.png" alt="Detalles del check" style="width:100%;">}}
