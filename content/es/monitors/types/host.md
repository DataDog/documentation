...
<div class="alert alert-danger">Los Agents AIX no informan del check de servicio <code>Datadog.Agent.up</code>. Puedes utilizar la métrica <code>datadog.agent.running</code> para monitorizar el tiempo de actividad de un Agent AIX. La métrica emite un valor de <code>1</code> si el Agent está informando a Datadog.</div>
