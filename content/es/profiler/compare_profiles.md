...
{{< img src="profiler/compare_time_frames.mp4" alt="Abrir la vista de comparación para comparar un perfil con una agregación para un periodo de tiempo." video="true">}}
...
{{< img src="profiler/comparison_legend.png" alt="Leyenda de la comparación de perfiles." >}}
...
{{< img src="profiler/compare_hover.png" alt="Pasa el ratón por encima de un método del perfil para ver la comparación de métricas" >}}
...
{{< img src="profiler/compare_recent_versions.mp4" alt="Abrir la vista de comparación para ver dos versiones diferentes." video="true">}}
