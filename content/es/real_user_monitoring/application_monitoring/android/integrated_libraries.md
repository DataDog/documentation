...
- /es/real_user_monitoring/mobile_and_tv_monitoring/android/integrated_libraries
...
Siguiendo la [documentación de la API generada][5] de SQLiteOpenHelper, solo tienes que proporcionar la implementación de
...
Si utilizas Kotlin Coroutines, consulta la [biblioteca dedicada con extensiones para Apollo][11] de Datadog y la [configuración de red avanzada de Android][12].
...
[12]: /es/real_user_monitoring/application_monitoring/android/advanced_configuration?tab=kotlin#apollo-instrumentation