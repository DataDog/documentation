---
aliases:
- /es/real_user_monitoring/browser/setup/server
beta: true
code_lang: servidor
code_lang_weight: 2
description: Inyecta automáticamente el SDK de RUM Browser en las respuestas HTML
  a través de la configuración del servidor web o proxy para una configuración de
  supervisión perfecta.
further_reading:
...
La autoinstrumentación de RUM requiere Datadog Agent versión 7.34+.
...
[1]: /es/real_user_monitoring/application_monitoring/browser/advanced_configuration/