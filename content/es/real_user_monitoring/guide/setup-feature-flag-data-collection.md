...
Las banderas de características aparecen en el contexto de tus sesiones, vistas y errores de RUM como una lista.
...
#### Sesiones
Filtrando tus **Sesiones** con el atributo `@feature_flags.{flag_name}`, puedes encontrar todas las sesiones en el marco de tiempo dado donde se evaluó tu bandera de características.
...
#### Vistas
Filtrando tus **Vistas** con el atributo `@feature_flags.{flag_name}`, puedes encontrar las vistas específicas en el marco de tiempo dado donde se evaluó tu bandera de características.
...
#### Errores
Filtrando tus **Errores** con el atributo `@feature_flags.{flag_name}`, puedes encontrar todos los errores en el marco de tiempo dado que ocurrieron en la vista donde se evaluó tu bandera de características.
...
Al realizar tus investigaciones, también puedes limitar tus datos a los `View Name` que son relevantes para tu bandera de características.
