...
title: Envía los datos RUM del navegador a través de un proxy
---
...
### Construye la URL de recepción de Datadog {% #build-the-datadog-intake-url %}
...
El SDK del navegador RUM agrega un parámetro de consulta `ddforward` a todas las solicitudes a tu proxy. Este parámetro de consulta contiene la ruta de la URL y los parámetros que todos los datos deben ser reenviados a.
...
**Nota:**
- Algunos bloqueadores de privacidad ya apuntan a los patrones de URL de entrada [URL patterns][2], por lo que es posible que debas tenerlo en cuenta al construir tu URL de proxy.
...
**Para evitar vulnerabilidades de seguridad, debes actualizar al SDK del navegador `4.34.0` o posterior.**
{% /if %}
