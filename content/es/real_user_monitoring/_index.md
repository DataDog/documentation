...
La *RUM* de Datadog te brinda visibilidad de extremo a extremo sobre la actividad y experiencia en tiempo real de usuarios individuales. RUM resuelve cuatro tipos de casos de uso para la monitorización de aplicaciones web y móviles:
...
Una sesión RUM puede durar hasta 4 horas y expira después de 15 minutos de inactividad. Si el usuario interactúa con la aplicación después de cualquiera de los límites, se inicia automáticamente una nueva sesión.
...
Si un evento supera cualquiera de las limitaciones técnicas mencionadas anteriormente, es rechazado por el sistema de ingesta de Datadog.
...
| Función                               | Navegador | Android | iOS |   Flutter   | React Native | Roku | KMP | Unity |  Notas |
| ------------------------------------- | --------|---------|---------|---------|--------------|------|-----|-------|--------|
...
| Seguimiento de Feature Flags y seguimiento de lanzamientos | {{< X >}} | {{< X >}}  | {{< X >}}  | {{< X >}} | {{< X >}} |  | {{< X >}} | {{< X >}} |  |
| Error Tracking y mapa del código fuente | {{< X >}} | {{< X >}}  | {{< X >}} | {{< X >}} | {{< X >}} | {{< X >}} | {{< X >}} | {{< X >}} | Solo parcialmente compatible con **React Native**. |
| Rastrear fallos, simbolización y desofuscación | {{< X >}} | {{< X >}}  | {{< X >}}  | {{< X >}} | {{< X >}} | {{< X >}}  | {{< X >}} | {{< X >}} |  |
| Detener sesiones (Monitoreo de Kioscos) | {{< X >}} | {{< X >}}  | {{< X >}}  | {{< X >}} | {{< X >}} |  | {{< X >}} | {{< X >}}  |  |
| Seguimiento de eventos en WebViews |  | {{< X >}}  | {{< X >}}  | {{< X >}} | {{< X >}} |  | {{< X >}} |  |  |
...
| Reproducción de sesión | {{< X >}} | {{< X >}} | {{< X >}} | {{< X >}} | {{< X >}} |  | {{< X >}} |  | **Flutter** Reproducción de sesión está en vista previa. |
...
| Resumen de rendimiento de navegador | Resumen de rendimiento móvil |
|---------|---------|
...
La página de [Resumen de Monitoreo de Rendimiento RUM][1] proporciona información relevante y procesable para aplicaciones web y móviles. Usted tiene una experiencia personalizada para cada plataforma que le ayuda a:

- **Enfocarse en puntos de datos clave** por plataforma, como la latencia de la interfaz de usuario para web o los fallos móviles
- **Monitorear la salud de la aplicación** a través de KPIs familiares, como Core Web Vitals para aplicaciones web o tasa de bloqueos para iOS, para evaluar la confiabilidad de la aplicación
- **Profundizar en investigaciones directamente** desde widgets interactivos sin salir de la página

Para **aplicaciones web**, use la barra de búsqueda para filtrar datos, identificar páginas lentas y seguir la interfaz de usuario hasta la página de [RUM Optimization Inspect][17].
...
{{< img src="real_user_monitoring/rum-out-of-the-box-dashboard.png" alt="Tableros RUM" >}}

### Explorador RUM y visualizaciones {#rum-explorer-and-visualizations}

Visualiza las sesiones de usuario en segmentos, como verificar cuándo la latencia impacta a tus clientes premium, con [visualizaciones][3]. Explora datos, guarda vistas y crea [monitors] en tus búsquedas personalizadas.
...
Visualiza tus [trazas de backend, registros y métricas de infraestructura][5] hasta la línea exacta de código que impacta el rendimiento de tu aplicación, correspondiente a las experiencias de usuario y problemas reportados.
...
Recibe alertas automáticas sobre valores anómalos y grupos de errores, tiempos de espera y fallos para reducir significativamente tu MTTR con [Seguimiento de Errores][6].

{{< img src="real_user_monitoring/error_tracking/errors_rum.mp4" alt="Seguimiento de errores RUM" video=true >}}
...
Recopila información de tus aplicaciones web nativas y explora vistas híbridas con Seguimiento de Vistas Web para [iOS y tvOS][10] o [Android y Android TV][11].
...
Accede a los registros activados, errores e información de rendimiento al solucionar problemas de la aplicación utilizando [Herramientas de desarrollo del navegador][14].
...
1. El cuadro de diálogo se actualiza para mostrar que los miembros de su organización tienen acceso de **Visualizador** por defecto.
