...
| Medición | Tipo de SLO |  Widget de series temporales  | Widgets escalares |
| -----  | ----- | ----- | ----- |
| Eventos apropiados | Basados en métricas | Recuento de eventos apropiados. | Suma de eventos apropiados en todos los grupos. |
| Eventos inapropiados | Basados en métricas | Recuento de eventos inapropiados. | Suma de eventos inapropiados en todos los grupos. |
| Minutos apropiados | Intervalo de tiempo | Recuento de minutos apropiados. | Suma de minutos apropiados en todos los grupos. |
| Minutos inapropiados | Intervalo de tiempo | Recuento de minutos inapropiados. | Suma de los minutos inapropiados de todos los grupos. |
| Estado de SLO | Basado en métricas o intervalos de tiempo | Para cada bucket de tiempo, el estado de un SLO se calcula como la relación entre el número de eventos/minutos buenos y el total de eventos/minutos. | Relación entre el número de eventos/minutos buenos y el total de eventos/minutos. |
...
| Burn rate | Basado en métricas o intervalos de tiempo | Para cada bucket de tiempo, el burn rate muestra la tasa de error observada, dividida por la tasa de error ideal. | Burn rate durante el periodo de tiempo del widget. |
