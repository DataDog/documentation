...
## Ver versiones
Desde un dashboard individual, haz clic en **Configure** (Configurar), en la parte superior derecha de la página, y selecciona **Version History** (Historial de versiones). Si no hay ediciones dentro del periodo de conservación, se desactiva el historial de versiones.
...
**Nota**: Hasta que no decidas restaurar a una versión, si haces clic en otra versión para previsualizarla no se guardará ningún cambio, ni se alterará lo que ven los demás usuarios.

## Restaurar a una versión
Existen dos formas de restaurar tu dashboard a una versión anterior.

{{< img src="/dashboards/guide/version_history/dashboard_version_history_options.png" alt="Panel lateral del Historial de versiones que muestra versiones pasadas del dashboard y maneras de restaurarlas." style="width:100%;" >}}

- En el panel lateral del historial de versiones, después de elegir la versión a la que quieres restaurar, haz clic en el menú con los tres puntos situado a la derecha del perfil de un usuario y selecciona **Restore this version** (Restaurar a esta versión).
- Cuando se abre el panel lateral del historial de versiones, aparece un botón en la parte superior de la página para **Restore this version** (Restaurar a esta versión).
