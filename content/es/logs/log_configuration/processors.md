...
Utiliza el [punto final de la API de Datadog Log Pipeline][1] con la siguiente carga útil JSON de Reasignador:
...
2. Utiliza el procesador remapeador de trazas para definir un atributo de registro como su ID de traza asociado.

{{< tabs >}}
{{% tab "INTERFAZ DE USUARIO" %}}

Define el procesador remapeador de trazas en la página [**Pipelines**][1]. Ingresa la ruta del atributo ID de traza en el cuadro del procesador de la siguiente manera:
