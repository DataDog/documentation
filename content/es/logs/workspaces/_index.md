...
{{< callout url="https://www.datadoghq.com/private-beta/log-workspaces/" header="Accede a la Vista previa." >}}
...
1. Haz clic en **More** (Más), junto a *Descargar como CSV*, y seleccione **Abrir en espacio de trabajo**.
...
1. Haz clic en el botón de descarga para exportar los datos como CSV.
...
1. Haz clic en el icono + (más) para añadir una función **Filtrar**, **Analizar** o **Agregar**.
