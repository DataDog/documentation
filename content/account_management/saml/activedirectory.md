...
{{< img src="account_management/saml/1ef6IBS.png" alt="1ef6IBS" responsive="true" popup="true" style="width:60%;">}}

Click the button on the right for Add a Relying Party Trust.

{{< img src="account_management/saml/O85HjIi.png" alt="O85HjIi" responsive="true" popup="true" style="width:60%;">}}
...
{{< img src="account_management/saml/KWe4h6W.png" alt="KWe4h6W" responsive="true" popup="true" style="width:60%;">}}
...
{{< img src="account_management/saml/UAjeUVL.png" alt="UAjeUVL" responsive="true" popup="true" style="width:60%;">}}

Click Browse to select the downloaded metadata file then Next.

{{< img src="account_management/saml/LWZCPG6.png" alt="LWZCPG6" responsive="true" popup="true" style="width:60%;">}}

Provide a display name for the Trust, "Datadog" or something similar is recommended and click Next.

{{< img src="account_management/saml/IQDM19N.png" alt="IQDM19N" responsive="true" popup="true" style="width:60%;">}}

Multi-factor Authentication is not supported at this time. Leave the selection default and click Next.

{{< img src="account_management/saml/AhM25jW.png" alt="AhM25jW" responsive="true" popup="true" style="width:60%;">}}
...
{{< img src="account_management/saml/Rd13Ofm.png" alt="Rd13Ofm" responsive="true" popup="true" style="width:60%;">}}

Review the trust to ensure the appropriate endpoint is configured and click Next.

{{< img src="account_management/saml/xex71aV.png" alt="xex71aV" responsive="true" popup="true" style="width:60%;">}}
...
{{< img src="account_management/saml/5NkUanW.png" alt="5NkUanW" responsive="true" popup="true" style="width:60%;">}}

We recommend two Claim Rules for brokering the SAML assertions. They can be added by first clicking the Add Rule button.

{{< img src="account_management/saml/QkNaDCD.png" alt="QkNaDCD" responsive="true" popup="true" style="width:60%;">}}
...
{{< img src="account_management/saml/cogaUQT.png" alt="cogaUQT" responsive="true" popup="true" style="width:60%;">}}
...
{{< img src="account_management/saml/JS5FNbR.png" alt="JS5FNbR" responsive="true" popup="true" style="width:60%;">}}

Input the configuration as shown below and click **Finish**.

{{< img src="account_management/saml/OT9i0K5.png" alt="OT9i0K5" responsive="true" popup="true" style="width:60%;">}}

Save the new claim rules by clicking OK.

{{< img src="account_management/saml/CeCyDmc.png" alt="CeCyDmc" responsive="true" popup="true" style="width:60%;">}}
...
{{< img src="account_management/saml/KJxaVYe.png" alt="KJxaVYe" responsive="true" popup="true" style="width:60%;">}}
...
{{< img src="account_management/saml/6TsPUla.png" alt="6TsPUla" responsive="true" popup="true" style="width:60%;">}}
...
{{< img src="account_management/saml/0R81SaK.png" alt="0R81SaK" responsive="true" popup="true" style="width:60%;">}}
