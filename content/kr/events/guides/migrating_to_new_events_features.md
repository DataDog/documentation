---
aliases:
- /kr/events/guides/migrating_from_stream_to_explorer
further_reading:
...
{{< img src="events/events-analytics.png" alt="이벤트 분석" stype="width:40%;" >}}
...
{{< img src="events/graph-events.png" alt="이벤트 분석" stype="width:40%;" >}}
...
{{< img src="events/guides/events-migration-monitor-new.png" alt="모니터 쿼리 구문에 대한 새 UI" style="width:100%;" >}}
...
| `source`  | 통합 이름 또는 이벤트가 시작된 기술에 해당합니다. 통합 이름과 일치하면 Datadog은 해당 파서 및 패싯을 자동으로 설치합니다(예: `nginx`, `postgresql` 등). |
| `status`  | 이벤트의 수준 또는 심각도에 해당합니다.      |
...
[1]: /kr/events/explorer
[2]: /kr/events/explorer/#event-analytics
[3]: /kr/events/#generate-custom-metrics-from-events
[4]: https://app.datadoghq.com/dash/integration/30532/monitor-notifications-overview
[5]: /kr/events/guides/new_events_sources/
[6]: /kr/help/
[7]: /kr/api/latest/monitors/#create-a-monitor