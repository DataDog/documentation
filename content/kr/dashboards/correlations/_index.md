...
* 상관관계는 메트릭에 대한 관심 영역(비정상적인 동작)을 자동으로 감지하려고 *시도*합니다.
* 관심 영역이 자동으로 선택되지 않거나 조정이 필요한 경우 [edit search](#edit) 옵션에서 수동으로 관심 영역을 지정할 수 있습니다.
* Datadog은 관심 영역과 일치하는 시간에 비정상적인 동작을 나타내는 다른 지표를 검색합니다.

{{< img src="dashboards/correlations/dashboard_search1.png" alt="대시보드 검색" style="width:80%;">}}

{{< img src="dashboards/correlations/dashboard_search2.png" alt="대시보드 검색" style="width:80%;">}}
...
**Edit Search** 버튼을 클릭하거나, 그래프를 클릭하여 기본 검색 파라미터를 맞춤 설정할 수 있습니다.
...
{{< img src="dashboards/correlations/edit_search.png" alt="검색 편집" style="width:80%;">}}
...
{{< img src="dashboards/correlations/detail_view.png" alt="상세 보기" style="width:90%;">}}
