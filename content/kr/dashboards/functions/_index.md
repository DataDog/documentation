...
aliases:
- /kr/examples/
- /kr/examples/aws-metrics/
- /kr/examples/month_before/
- /kr/examples/graphing-functions/
- /kr/examples/day_before/
- /kr/examples/json-editing/
- /kr/examples/nginx-metrics/
- /kr/examples/dashboards/
- /kr/examples/hour_before/
- /kr/examples/os-metrics/
- /kr/examples/week_before/
- /kr/examples/cassandra-metrics/
- /kr/graphing/miscellaneous/functions
- /kr/graphing/miscellaneous/
- /kr/getting_started/from_the_query_to_the_graph
- /kr/graphing/miscellaneous/from_the_query_to_the_graph
- /kr/graphing/functions/
kind: 설명서
title: 함수
---
...
[1]: /kr/metrics/#time-aggregation
[2]: /kr/metrics/#space-aggregation