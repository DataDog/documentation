---
aliases:
- /kr/agent/faq/agent-check-directory-structure
- /kr/agent/faq/install-core-extra
- /kr/logs/faq/can-the-datadog-agent-be-used-to-send-only-logs
- /kr/agent/faq/the-datadog-agent-for-logs-or-traces-only
