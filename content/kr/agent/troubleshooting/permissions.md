---
aliases:
- /kr/agent/faq/how-to-solve-permission-denied-errors
- /kr/agent/faq/why-don-t-i-see-the-system-processes-open-file-descriptors-metric
- /kr/agent/faq/cannot-open-an-http-server-socket-error-reported-errno-eacces-13
further_reading:
...
[1]: /kr/agent/guide/upgrade-to-agent-v6/
[2]: https://github.com/DataDog/dd-agent
[3]: /kr/agent/guide/agent-commands/?tab=agentv5#stop-the-agent
...
[1]: /kr/agent/guide/agent-commands/
[2]: /kr/agent/guide/agent-log-files/
[3]: /kr/agent/faq/error-restarting-agent-already-listening-on-a-configured-port/
[4]: /kr/agent/faq/network/
[5]: /kr/agent/guide/agent-commands/#start-the-agent
[6]: /kr/help/
[7]: /kr/integrations/process/