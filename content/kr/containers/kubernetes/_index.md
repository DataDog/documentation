---
aliases:
- /kr/guides/basic_agent_usage/kubernetes
- /kr/agent/basic_agent_usage/kubernetes
- /kr/tracing/kubernetes/
- /kr/tracing/setup/kubernetes
- /kr/integrations/faq/using-rbac-permission-with-your-kubernetes-integration
- /kr/integrations/faq/can-i-install-the-agent-on-my-Kubernetes-master-node-s/
- /kr/integrations/faq/docker-ecs-kubernetes-events/
- /kr/integrations/faq/container-integration-event/
- /kr/integrations/faq/why-is-the-kubernetes-check-failing-with-a-connecttimeout-error-to-port-10250/
- /kr/agent/kubernetes/
further_reading:
...
[1]: /kr/agent/faq/kubernetes-legacy/
