...
Note: This video uses v6 of the Datadog agent. If you want to use the older agent, refer to [the video for Agent v5](/videos/tipsandtricks-docker-autodiscovery-labels/). 
