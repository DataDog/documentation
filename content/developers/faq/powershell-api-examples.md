...
2. Set up your parameters according to description in [here](http://docs.datadoghq.com/api/#hosts), shell tab
```
$host_name = "test.host"
...
3. Set up parameters according to description in [here](http://docs.datadoghq.com/api/#metrics), shell tab
```
$http_method = "POST"
