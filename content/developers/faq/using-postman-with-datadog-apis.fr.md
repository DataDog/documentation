---
title: Utilisation de Postman avec les APIs Datadog
kind: faq
---

## Aperçu

L'API Datadog facilite l'entrée et la sortie des données dans Datadog. L'API Datadog utilise des URL orientées ressources, des codes d'état pour indiquer le succès ou l'échec des demandes et renvoie un objet JSON à partir de toutes les demandes.
...
Pour importer la collection Datadog dans Postman:
