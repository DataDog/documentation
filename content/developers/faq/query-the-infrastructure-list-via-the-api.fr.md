---
title: Requêter la liste d'infrastructure avec l'API
kind: faq
---
...
Cet endpoint prend les paramètres requis suivants:

* **api_key**: string. Votre clé d'API Datadog
* **application_key**: string. Your Datadog Application key

Par défaut, cet endpoint interroge toutes les données présente dans votre infrastructure list, ce qui peut conduire à une très grande réponse. Utilisez l'un des paramètres facultatifs suivants pour filtrer le contenu que vous recevez:
