...
1. With your Datadog agent directly (Learn more on how [to write an Agent Checks](/developers/agent_checks) && [Aggregator source](https://github.com/DataDog/dd-agent/blob/master/aggregator.py))
