...
First off, ensure you've properly installed the [Agent][3] on your machine. If you run into any issues during the setup, [contact Datadog support team][4].
...
Now let's define the check method. The main part of the check makes
