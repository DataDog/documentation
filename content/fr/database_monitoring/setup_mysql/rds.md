...
kind: documentation
description: "Installez et configurez la surveillance de bases de données pour MySQL avec une gestion sur Amazon\_RDS."
further_reading:
...
Si vous avez respecté les instructions d'installation et de configuration des intégrations et de l'Agent, mais que vous rencontrez un problème, consultez la section [Dépannage de la surveillance de bases de données][9].
