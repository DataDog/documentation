...
description: Exécutez des tests Synthetic à la demande ou à des intervalles prédéfinis
...
{{< whatsnext desc="Avec Synthetics et les pipelines de CI/CD, vous pouvez exécuter des tests Synthetic sur la plateforme CI de votre choix :" >}}
...
Le [package `@datadog/datadog-ci`][1] vous permet d'exécuter des tests Synthetics directement dans votre pipeline de CI/CD.

Pour utiliser le [package NPM `@datadog/datadog-ci`][2], consultez la section relative à la [configuration][3].
...
[3]: /fr/synthetics/cicd_integrations/configuration
[4]: /fr/api/latest/synthetics/#trigger-tests-from-cicd-pipelines
[5]: /fr/api/latest/synthetics/#get-details-of-batch
[6]: /fr/synthetics/cicd_integrations/configuration#configure-tests