...
- link: https://datadoghq.com/blog/
  tag: Blog
  text: '''En savoir plus sur les dernières solutions et fonctionnalités Datadog,
    les intégrations, et plus encore'''
...
De plus, des centaines de [intégrations][1] vous permettent de superposer les fonctionnalités de Datadog sur les technologies que vous utilisez déjà. Par exemple, l'[intégration AWS][2] collecte des journaux, des événements et des métriques de plus de 90 services AWS.
