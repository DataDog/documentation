...
<table>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li>Ingestez <a href="/logs/">logs</a>, <a href="/metrics/">métriques</a>, <a href="/events/">événements</a> et <a href="/tracing/glossary/#trace">traces réseau</a> avec un contrôle granulaire sur le traitement, l'agrégation et <a href="/monitors/">l'alerte.</a></li>
...
### Approfondissez un domaine de produit {#dive-deeper-into-a-product-area}
...
{{< nextlink href="/getting_started/devsecops" >}}<u>Bundles DevSecOps d’Infrastructure</u>: Commencez avec les bundles DevSecOps d’Infrastructure.{{< /nextlink >}}
...
{{< nextlink href="/getting_started/learning_center" >}}<u>Centre d'apprentissage</u>: Suivez un parcours d'apprentissage, suivez un cours ou un laboratoire autonome, et explorez le programme de certification Datadog.{{< /nextlink >}}
{{< /whatsnext >}}
...
{{< nextlink href="/getting_started/profiler" >}}<u>Profileur</u>: Utilisez le Profileur Continu pour identifier et résoudre les problèmes de performance dans votre code.{{< /nextlink >}}
{{< nextlink href="/getting_started/database_monitoring" >}}<u>Surveillance de la Base de Données</u>: Consultez la santé et la performance des bases de données, et résolvez rapidement tout problème qui survient.{{< /nextlink >}}
...
{{< nextlink href="/getting_started/application_security" >}}<u>Protection des Applications et des API</u>: Découvrez les meilleures pratiques pour rendre votre équipe opérationnelle avec AAP.{{< /nextlink >}}
{{< nextlink href="/getting_started/cloud_security_management" >}}<u>Sécurité Cloud</u>: Découvrez les meilleures pratiques pour rendre votre équipe opérationnelle avec la Sécurité Cloud.{{< /nextlink >}}
...
{{< nextlink href="/getting_started/logs" >}}<u>Journaux</u>: Envoyez vos premiers journaux et utilisez le traitement des journaux pour les enrichir.{{< /nextlink >}}
...
{{< nextlink href="/getting_started/feature_flags" >}}<u>Drapeaux de Fonctionnalités</u>: Gérez la livraison des fonctionnalités et personnalisez les expériences utilisateur, avec une observabilité intégrée.{{< /nextlink >}}
