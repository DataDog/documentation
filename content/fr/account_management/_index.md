...
<div class="alert alert-danger">Les résumés d'e-mails ne sont pas disponibles dans le site sélectionné ({{< region-param key="dd_site_name" >}}).</div>
{{< /site-region >}}
...
Pour rejoindre une organisation existante, vous devez être invité par un administrateur. Après avoir été invité, vous recevez un e-mail avec l'objet : "Vous avez été invité à rejoindre \<Nom de l'Organisation>". Cliquez sur le bouton {{< ui >}}Join Account{{< /ui >}} dans l’e-mail.
