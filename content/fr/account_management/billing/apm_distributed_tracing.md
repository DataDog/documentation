...
|---------------------|---------------------------------------------|-------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Host d'APM][3]      | 31 $ par [host d'APM][3] sous-jacent par mois | 1 million de spans analysées supplémentaires incluses par mois avec chaque host d'APM.   | Le nombre de [hosts d'APM][4] que vous surveillez en même temps dans le service APM de Datadog est mesuré toutes les heures. Avec une formule basée sur la limite supérieure, ces mesures horaires sont ordonnées de la plus élevée à la plus faible à la fin du mois, et le prix facturé par Datadog est calculé en fonction de la huitième mesure la plus élevée. [En savoir plus.][4] |
| [Fargate][3]       | 2 $ par tâche et par mois            | Aucune span analysée incluse dans le prix.                                        | Le nombre d'instances de tâches que vous surveillez dans le service APM de Datadog est mesuré toutes les cinq minutes. Datadog agrège ces mesures à la fin du mois et calcule le prix facturé en fonction du nombre total d'heures pendant lesquelles vos applications s'exécutaient et étaient surveillées. [En savoir plus.][3]               |
| [Span analysée][4] | 1,70 $ par million de spans analysées par mois  | Prix facturé lorsque le nombre de spans analysées dépasse le quota autorisé pour chaque host d'APM | Une span analysée est une requête individuelle effectuée auprès d'un service de votre pile. Le prix facturé par Datadog est calculé en fonction du nombre total de spans analysées envoyées au service APM de Datadog à la fin du mois. [En savoir plus.][4]                                                                                           |
