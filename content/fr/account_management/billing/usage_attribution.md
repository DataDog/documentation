...
Pour commencer à recevoir des données quotidiennes, un administrateur doit créer un rapport avec l'interface utilisateur. 
...
* Les rapports mensuels comportent l'ensemble de tags le plus récent. Si vous modifiez les tags à la moitié du mois, les pourcentages d'utilisation risquent de ne pas correspondre. 
...
| public_id   | heure                  | équipe      | service               | num_custom_timeseries           |
|-------------|-----------------------|-----------|-----------------------|---------------------------------|
