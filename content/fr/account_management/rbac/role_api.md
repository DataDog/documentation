...
```sh
curl -X GET "https://app.datadoghq.com/api/v1/role?api_key=${CLÉ_API}&application_key=${CLÉ_APP}"
...
Méthode : GET  
Endpoint : `api/v1/role/$UUID_RÔLE`  
Charge utile requise : aucune charge utile  
Exemple :

```sh
curl -X GET "https://app.datadoghq.com/api/v1/role/${UUIDRÔLE}?api_key=${CLÉ_API}&application_key=${CLÉ_APP}"
...
```sh
curl -X POST -H "Content-type: application/json" -d "{\"name\":\"${NOMRÔLE}\"}" "https://app.datadoghq.com/api/v1/role?api_key=${CLÉ_API}&application_key=${CLÉ_APP}"
```
...
```sh
curl -X PUT -H "Content-type: application/json" -d "{\"name\":\"${NOMRÔLE}\"}" "https://app.datadoghq.com/api/v1/role/${UUIDRÔLE}?api_key=${CLÉ_API}&application_key=${CLÉ_APP}"
```
...
```sh
curl -X DELETE "https://app.datadoghq.com/api/v1/role/${UUIDRÔLE}?api_key=${CLÉ_API}&application_key=${CLÉ_APP}"
```

### Récupérer les autorisations

Description : renvoie une liste de toutes les autorisations, y compris le nom, la description et l'uuid.  
Méthode : GET  
...
```sh
curl -X GET "https://app.datadoghq.com/api/v1/permission?api_key=${CLÉ_API}&application_key=${CLÉ_APP}"
...
Méthode : POST  
Endpoint : `api/v1/role/$UUID_RÔLE/permission/$UUID_AUTORISATION`  
Charge utile requise : vide (`{}`)  
Exemple :

```sh
curl -X POST -H "Content-type: application/json" -d "{}" "https://app.datadoghq.com/api/v1/role/${UUIDRÔLE}/permission/${AUTORISATION}?api_key=${CLÉ_API}&application_key=${CLÉ_APP}"
```
...
```sh
curl -X DELETE -H "Content-type: application/json" -d "{}" "https://app.datadoghq.com/api/v1/role/${UUIDRÔLE}/permission/${AUTORISATION}?api_key=${CLÉ_API}&application_key=${CLÉ_APP}"
```
...
Méthode : POST  
Endpoint : `api/v1/role/$RUUID_RÔLE/user/$HANDLE_UTILISATEUR`  
Charge utile requise : vide (`{}`)  
Exemple :

```sh
curl -X POST -H "Content-type: application/json" -d "{}" "https://app.datadoghq.com/api/v1/role/${UUIDRÔLE}/user/${UTILISATEUR}?api_key=${CLÉ_API}&application_key=${CLÉ_APP}"
```
...
Méthode : DELETE  
Endpoint : `api/v1/role/$UUID_RÔLE/user/$HANDLE_UTILISATEUR`  
Charge utile requise : vide (`{}`)  
Exemple :

```sh
curl -X DELETE -H "Content-type: application/json" -d "{}" "https://app.datadoghq.com/api/v1/role/${UUIDRÔLE}/user/${UTILISATEUR}?api_key=${CLÉ_API}&application_key=${CLÉ_APP}"
```
...
|------------------------------|--------------------------------------|----------------------------------------------|
| admin                        | 984a2bd4-d3b4-11e8-a1ff-a7f660d43029 | Autorisations de lecture/écriture sur l'ensemble du compte Datadog  |
...
|             nom             |                 uuid                 |                 description                  |
|------------------------------|--------------------------------------|----------------------------------------------|
| admin                        | f1624684-d87d-11e8-acac-efb4dbffab1c | Autorisations de lecture/écriture sur l'ensemble du compte Datadog  |
