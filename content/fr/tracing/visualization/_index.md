...
Les métriques de trace sont utiles pour la surveillance. Les monitors de l'APM peuvent être configurés sur la page [Nouveaux Monitors][14], [Service][5] ou [Ressource][6]. Un ensemble de monitors suggérés est disponible sur la page [Service][5] ou [Ressources][6].
...
Pour commencer à tagger des spans dans votre application, consultez cette [procédure pas à pas][17].

Une fois qu'un tag a été ajouté à une span, recherchez et interrogez le tag dans Analyse et recherche de traces en cliquant sur le tag pour l'ajouter en tant que [facette][18]. Une fois effectué, la valeur de ce tag est stockée pour toutes les nouvelles traces et peut être utilisée dans la barre de recherche, le panneau de facettes et la requête du graphique de traces.
...
[7]: /fr/tracing/advanced/manual_instrumentation
[8]: /fr/tracing/advanced/opentracing
[9]: /fr/tracing/advanced/connect_logs_and_traces
[10]: /fr/tracing/advanced/adding_metadata_to_spans
[11]: /fr/tracing/advanced/runtime_metrics
[12]: /fr/tracing/app_analytics
[13]: https://app.datadoghq.com/metric/summary
[14]: https://app.datadoghq.com/monitors#/create
[15]: /fr/tracing/app_analytics/#automatic-configuration
[16]: /fr/tracing/app_analytics/#configure-additional-services-optional
[17]: /fr/tracing/advanced/adding_metadata_to_spans
[18]: /fr/tracing/advanced/search/#facets
