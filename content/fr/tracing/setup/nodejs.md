...
|------------------|----------|-----------------|--------------------------------------------|
| [connect][10]    | `>=2`    | Complète |                                            |
| [express][11]    | `>=4`    | Complète | Prend en charge Sails, Loopback et [plus encore][12]   |
| [fastify][13]    | `>=1`    | Complète |                                            |
| [graphql][14]    | `>=0.10` | Complète | Prend en charge Apollo Server et express-graphql |
| [hapi][15]       | `>=2`    | Complète |                                            |
| [koa][16]        | `>=2`    | Complète |                                            |
| [paperplane][17] | `>=2.3`  | Complète | Non pris en charge en [mode sans serveur][18]     |
| [restify][19]    | `>=3`    | Complète |                                            |
...
| Module                 | Versions | Type de prise en charge    | Remarques                                            |
|------------------------|----------|-----------------|--------------------------------------------------|
| [cassandra-driver][24] | `>=3`    | Complète |                                                  |
| [elasticsearch][25]    | `>=10`   | Complète | Prend en charge `@elastic/elasticsearch` versions `>=5` |
| [ioredis][26]          | `>=2`    | Complète |                                                  |
| [knex][27]             | `>=0.8`  | Complète | Cette intégration est uniquement pour la propagation en contexte |
| [memcached][28]        | `>=2.2`  | Complète |                                                  |
| [mongodb-core][29]     | `>=2`    | Complète | Prend en charge Mongoose                                |
| [mysql][30]            | `>=2`    | Complète |                                                  |
| [mysql2][31]           | `>=1`    | Complète |                                                  |
| [pg][32]               | `>=4`    | Complète | Prend en charge `pg-native` si utilisé avec `pg`         |
| [redis][33]            | `>=0.12` | Complète |                                                  |
| [tedious][34]          | `>=1`    | Complète | Pilote SQL Server pour `mssql` et `sequelize`    |

#### Compatibilité des workers

| Module             | Versions | Type de prise en charge    | Remarques                                                  |
|--------------------|----------|-----------------|--------------------------------------------------------|
| [amqp10][35]       | `>=3`    | Complète | Prend en charge les agents AMQP 1.0 (p. ex. ActiveMQ, Apache Qpid) |
| [amqplib][36]      | `>=0.5`  | Complète | Prend en charge les agents AMQP 0.9 (p. ex. RabbitMQ, Apache Qpid) |
| [generic-pool][37] | `>=2`    | Complète |                                                        |
...
|------------------|-----------|-----------------|
| [bluebird][40]   | `>=2`     | Complète |
| [promise][41]    | `>=7`     | Complète |
| [promise-js][42] | `>=0.0.3` | Complète |
| [q][43]          | `>=1`     | Complète |
| [when][44]       | `>=3`     | Complète |
...
| Module        | Versions | Type de prise en charge    |
|---------------|----------|-----------------|
| [bunyan][45]  | `>=1`    | Complète |
| [pino][46]    | `>=2`    | Complète |
| [winston][47] | `>=1`    | Complète |
