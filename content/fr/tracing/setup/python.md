...
| `DATADOG_ENV`                      | `null`      | Définit l'environnement d'une application, par ex. `prod`, `pre-prod` ou `staging`. Découvrez [comment configurer votre environnement][6].                                                                                                                                                   |
...
[9]: /fr/tracing/connect_logs_and_traces/python
