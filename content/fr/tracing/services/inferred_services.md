...
description: Découvrez automatiquement les dépendances des services comme les bases
  de données et les files d'attente grâce à l'analyse des requêtes sortantes.
further_reading:
