...
**Remarque** : l'activation de l'intégration AWS X-Ray augmente le nombre de spans analysées utilisées, ce qui peut avoir une incidence sur votre facturation.
