...
```
[1]: https://docs.datadoghq.com/fr/tracing/guide/add_span_md_and_graph_it
{{% /tab %}}
{{% tab "Python" %}}
...
[4]: https://docs.datadoghq.com/fr/tracing/guide/add_span_md_and_graph_it