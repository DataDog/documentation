...
Pour définir votre score Apdex, vous devez être l'administrateur de votre compte Datadog. Commencez par définir un seuil de temps (**T**) afin de déterminer les réponses satisfaisantes et les réponses non satisfaisantes pour votre application ou service. Un seuil vous permet de définir trois catégories :
...
Pour visualiser le score Apdex de votre application ou service, procédez comme suit :

1. Sur le dashboard de votre service, sélectionnez Apdex à la place de la latence :

   {{< img src="tracing/faq/apdex_selection.png" alt="Sélection Apdex" >}}

2. Cliquez sur l'icône en forme de crayon en haut à gauche de votre widget pour configurer votre Apdex :
