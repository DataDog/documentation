...
| `max_traces_per_second` | `DD_MAX_TRACES_PER_SECOND` | Le nombre maximum de traces à échantillonner par seconde. Définissez ce paramètre sur `0` pour désactiver la limite (*non conseillé*). Valeur par défaut : `10`.                              |
