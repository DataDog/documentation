...
```
Le service s'affiche ensuite sur votre page des services APM dans Datadog.
...
{{< img src="tracing/guide/setting_up_APM_with_cpp/traces_ui.png" alt="IU des traces de l'APM" responsive="true" >}}
