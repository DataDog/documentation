...
Utilisez l'API Datadog pour créer, modifier ou supprimer des traces à envoyer à Datadog de manière programmatique. Cela est utile pour tracer le code interne non capturé par l'instrumentation automatique, supprimer les spans indésirables des traces et fournir une visibilité plus approfondie et un contexte plus approfondi aux spans, y compris l'ajout de balises de span.
