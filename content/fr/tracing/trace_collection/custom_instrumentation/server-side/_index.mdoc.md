...
Utilisez l'API Datadog pour créer, modifier ou supprimer des traces à envoyer à Datadog de manière programmatique. Ceci est utile pour tracer le code interne qui n'est pas capturé par l'instrumentation automatique, supprimer les spans indésirables des traces et offrir une visibilité plus approfondie ainsi qu'un contexte plus complet sur les spans, y compris l'ajout de balises de span.
