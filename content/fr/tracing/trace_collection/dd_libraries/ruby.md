...
| `tracing.trace_id_128_bit_generation_enabled` | `DD_TRACE_128_BIT_TRACEID_GENERATION_ENABLED` | `true` | Définissez cette option sur `true` pour générer un ID de trace de 128 bits ou sur `false` pour générer un ID de trace de 64 bits.  |
