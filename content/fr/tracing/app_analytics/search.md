...
Si vous sélectionnez l'option **Traces**, les spans analysées affichées dans le flux de traces sont associées à un échantillon de trace. Si vous sélectionnez l'option **Retained Spans**, le flux de traces affiche uniquement les spans analysées.
