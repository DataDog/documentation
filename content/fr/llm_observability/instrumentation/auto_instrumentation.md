...
- Chat Completions du routeur (y compris les appels en streaming) :
...
Pour des instructions de configuration et un exemple complet, voir [Instrumentation OpenTelemetry — Utilisation des Agents Strands][4].
...
{{< tabs >}}
{{% tab "Python" %}}
Utilisez le [paramétrage SDK en code][1] et spécifiez `integrations_enabled=False`.

**Exemple** : Paramétrage SDK en code qui désactive toutes les intégrations LLM
...
{{% tab "Node.js" %}}
Utilisez le [paramétrage SDK en code][1] et spécifiez `plugins: false`.
...
### N'activer que des intégrations LLM spécifiques

{{< tabs >}}
{{% tab "Python" %}}
1. Utilisez le [paramétrage SDK en code][1] et désactivez toutes les intégrations avec `integrations_enabled=False`.
2. Activez manuellement certaines intégrations avec `ddtrace.patch()`.

**Exemple** : Paramétrage SDK en code qui n'active que l'intégration LangChain
...
{{% tab "Node.js" %}}
1. Utilisez le [paramétrage SDK en code][1] et désactivez toutes les intégrations avec `plugins: false`.
...
: Une chaîne de noms d'intégrations séparés par des virgules qui sont automatiquement désactivées lorsque le traceur est initialisé.<br>
