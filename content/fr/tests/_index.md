...
| {{< ci-details title="Détection en amont des irrégularités *" >}}Relancez automatiquement des nouveaux tests pour détecter les irrégularités.{{< /ci-details >}}                                                                                          | {{< X >}} |       {{< X >}}      |       {{< X >}}        |           |           |           |                        |
| {{< ci-details title="Nouvelles tentative automatiques de tests *" >}}Relancez automatiquement des tests échoués jusqu'à N fois, afin d'éviter d'échouer le build en raison d'irrégularités du test.{{< /ci-details >}}                                                |           |       {{< X >}}      |       {{< X >}}        |           |           |           |                        |
