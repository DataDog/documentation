...
Vous pouvez également surveiller le taux de réussite et les SLI (indicateurs de niveau de service) basés sur des événements. Par exemple: `99 % du temps, la latence est inférieure à 200 ms` :

