...
{{< img src="graphing/widgets/monitor_summary/monitor-summary-overview.png" alt="résumé des monitors" >}}

## Implémentation

{{< img src="graphing/widgets/monitor_summary/monitor-summary-setup.png" alt="configuration du widget résumé des monitors"  style="width:80%;">}}
...
1. Sélectionnez l'un des trois types de résumé : `Monitor`, `Group` ou `Combined`.
    ...
    {{< img src="graphing/widgets/monitor_summary/monitor_summary_type.png" alt="type de résumé Monitor"  style="width:80%;">}}
    ...
    {{< img src="graphing/widgets/monitor_summary/group_summary_type.png" alt="type de résumé Group"  style="width:80%;">}}
    ...
    {{< img src="graphing/widgets/monitor_summary/combined_summary_type.png" alt="type de résumé combined"  style="width:80%;">}}
...
{{< img src="graphing/widgets/monitor_summary/display-preferences.png" alt="préférences d'affichage"  style="width:80%;">}}
...
{{< img src="graphing/widgets/monitor_summary/monitor-summary.png" alt="préférences d'affichage"  style="width:80%;">}}

#### Titre

Affichez un titre personnalisé pour votre widget en cochant la case `Show a title` :

{{< img src="graphing/widgets/monitor_summary/widget_title.png" alt="titre du widget"  style="width:80%;">}}
