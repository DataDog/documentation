...
"https://api.datadoghq.com/api/v1/dashboard/lists/manual/${id_liste}/dashboards?api_key=${clé_api}&application_key=${clé_app}"
```
...
*   **`dashboards`** [*obligatoire*] :
    Une liste des dashboards à supprimer de la liste.
    Les définitions de dashboard respectent le format suivant :
    *   **`type`** [*obligatoire*] :
        Le type du dashboard.
        Le type doit être correspondre à l'une des valeurs suivantes :
