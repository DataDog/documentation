...
**Remarque** : les noms des fonctions Lambda doivent respecter la [convention de tagging de Datadog][2]. Cela lie parfaitement toutes les traces, les logs et les métriques de votre fonction.
