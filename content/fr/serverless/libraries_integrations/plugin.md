...
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `site`                        | Définit le site Datadog auquel envoyer les données, tel que `datadoghq.com` (par défaut), `datadoghq.eu`, `us3.datadoghq.com`, `us5.datadoghq.com` ou `ddog-gov.com`. Ce paramètre est obligatoire lorsque vous recueillez des données de télémétrie avec l'extension Lambda Datadog. |
