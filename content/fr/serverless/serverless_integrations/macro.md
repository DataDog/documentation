...
| `isGovCloud`            | Spécifie si votre fonction est exécutée dans GovCloud. Valeur par défaut : false. Lorsque ce paramètre est défini sur true, la couche Lambda GovCloud est associée à vos fonctions.                                                                                                                                                                                                                    |
