...
Une fois votre intégration validée (fonctionnalités, conformité du framework et qualité générale du code), elle est ajoutée au référentiel GitHub. Elle fait alors officiellement partie de l'écosystème Datadog. Félicitations !

### Quelles sont vos responsabilités ?

En tant qu'auteur du code, vous êtes alors responsable du maintien de l'intégration. Vous êtes chargé de mettre à jour le code et d'assurer le bon fonctionnement de l'intégration. Aucun engagement de temps spécifique n'est imposé ; vous devez toutefois vous occuper du code pendant quelque temps. Vous ne serez pas seul, car Datadog fait tout son possible pour allouer des ressources au maintien des intégrations supplémentaires.
...
[2]: https://docs.datadoghq.com/fr/developers/integrations/new_check_howto/
