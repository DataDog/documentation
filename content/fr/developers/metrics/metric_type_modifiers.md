...
* `RATE` : variation de la valeur normalisée au fil du temps (généralement _toutes les secondes_).
...
[1]: /fr/graphing/faq/interpolation-the-fill-modifier-explained
{{% /tab %}}
{{% tab "RATE" %}}
...
[2]: /fr/graphing/metrics/introduction/#time-aggregation
[3]: /fr/graphing/faq/why-does-zooming-out-a-timeframe-also-smooth-out-my-graphs
