...
{{< img src="developers/metrics/metric_types/count_metric.png" alt="Métrique count" responsive="true">}}
...
{{< img src="developers/metrics/metric_types/rate_metric.png" alt="Métrique rate" responsive="true">}}
...
| `<NOM_MÉTRIQUE>.95percentile` | Renvoie la valeur correspondant au 95e centile de ces `X` valeurs durant l'intervalle de transmission.                                                                                  | GAUGE               |
| `<NOM_MÉTRIQUE>.max`          | Renvoie la valeur maximale de ces `X` valeurs envoyées durant l'intervalle de transmission.                                                                           | GAUGE               |
...
| [Check de l'Agent][12] | `self.count(...)`                    | COUNT           | COUNT               |
| [Check de l'Agent][13] | `self.increment(...)`                | COUNT           | RATE                |
| [Check de l'Agent][13] | `self.decrement(...)`                | COUNT           | RATE                |
| [Check de l'Agent][14] | `self.monotonic_count(...)`          | COUNT           | COUNT               |
| [Check de l'Agent][15] | `self.gauge(...)`                    | GAUGE           | GAUGE               |
| [Check de l'Agent][16] | `self.histogram(...)`                | HISTOGRAM       | GAUGE, RATE         |
| [Check de l'Agent][17] | `self.rate(...)`                     | RATE            | GAUGE               |
| [Check de l'Agent][18] | `self.set(...)`                      | SET             | GAUGE               |

[1]: /fr/developers/metrics/metric_type_modifiers
...
[6]: /fr/api/?lang=python#post-timeseries-points
[7]: /fr/developers/metrics/dogstatsd_metrics_submission/#gauge
[8]: /fr/developers/metrics/dogstatsd_metrics_submission/#distribution
[9]: /fr/developers/metrics/dogstatsd_metrics_submission/#count
[10]: /fr/developers/metrics/dogstatsd_metrics_submission/#set
[11]: /fr/developers/metrics/dogstatsd_metrics_submission/#histogram
[12]: /fr/developers/metrics/agent_metrics_submission/?tab=count#count
[13]: /fr/developers/metrics/agent_metrics_submission/?tab=count#increment-decrement
[14]: /fr/developers/metrics/agent_metrics_submission/?tab=count#monotonic-count
[15]: /fr/developers/metrics/agent_metrics_submission/?tab=gauge
[16]: /fr/developers/metrics/agent_metrics_submission/?tab=histogram
[17]: /fr/developers/metrics/agent_metrics_submission/?tab=rate
