...
### Fonctionnalités et support de la plateforme {#capabilities-and-platform-support}
...
| Fonction                               | Navigateur | Android | iOS |   Flutter   | React Native | Roku | KMP | Unity |  Remarques |
| ------------------------------------- | --------|---------|---------|---------|--------------|------|-----|-------|--------|
...
| Suivi des fonctionnalités et suivi des versions | {{< X >}} | {{< X >}}  | {{< X >}}  | {{< X >}} | {{< X >}} |  | {{< X >}} | {{< X >}} |  |
...
| Session Replay | {{< X >}} | {{< X >}} | {{< X >}} | {{< X >}} | {{< X >}} |  | {{< X >}} |  | **Flutter** Session Replay est en aperçu. |
...
La page de [surveillance des performances RUM][1] fournit des informations pertinentes et exploitables pour les applications web et mobiles. Vous avez une expérience personnalisée pour chaque plateforme qui vous aide à :
...
- **Surveillez la santé de l'application** à travers des indicateurs clés de performance familiers, tels que les Core Web Vitals pour les applications web ou le taux de blocage pour iOS, afin d'évaluer la fiabilité de l'application
