...
{{< whatsnext desc="RUM général :" >}}
    ...
    {{< nextlink href="real_user_monitoring/guide/alerting-with-rum" >}}Créer des alertes avec des données RUM{{< /nextlink >}}
    ...
    {{< nextlink href="/real_user_monitoring/guide/remotely-configure-rum-using-launchdarkly" >}}Configuration de RUM à distance à l'aide de LaunchDarkly{{< /nextlink >}}
...
{{< whatsnext desc="RUM Browser :" >}}
    ...
    {{< nextlink href="real_user_monitoring/guide/identify-bots-in-the-ui" >}}Identifier des bots dans le RUM Explorer{{< /nextlink >}}
    {{< nextlink href="real_user_monitoring/guide/upload-javascript-source-maps" >}}Importer des source maps JavaScript{{< /nextlink >}}
    {{< nextlink href="real_user_monitoring/guide/sampling-browser-plans" >}}Contrôle le volume des sessions en configurant l'échantillonnage pour RUM Browser et RUM Browser et Session Replay{{< /nextlink >}}
    ...
    {{< nextlink href="/real_user_monitoring/guide/define-services-and-track-ui-components-in-your-browser-application/" >}}Définir des services et suivre des composants d'IU dans votre application Browser{{< /nextlink >}}
