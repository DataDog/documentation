...
5. Choisissez d'afficher les *X* valeurs les plus **élevées** ou **faibles** en fonction de la [mesure][1] sélectionnée.
...
{{< img src="real_user_monitoring/explorer/analytics/graph_selector.png" alt="Sélecteur de graphique RUM Analytics" style="width:50%;">}}
...
{{< img src="real_user_monitoring/explorer/analytics/rum_timeserie_example.png" alt="exemple de série temporelle RUM" style="width:90%;">}}
...
{{< img src="real_user_monitoring/explorer/analytics/top_list_rum.png" alt="exemple de top list RUM" style="width:90%;">}}
...
{{< img src="real_user_monitoring/explorer/analytics/view_events.png" alt="afficher les événements" style="width:30%;" >}}
