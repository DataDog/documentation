...
{{< img src="real_user_monitoring/explorer/visualize/rum_explorer_lists.mp4" alt="Listes dans le RUM Explorer" video="true" style="width:70%;" >}}
...
{{< img src="real_user_monitoring/explorer/visualize/top_list.png" alt="Graphique à barres d'une top list dans le RUM Explorer" style="width:80%;" >}}
...
Visualisez les valeurs les plus élevées pour une à trois [facettes][5] en fonction de la [mesure][3] de votre choix (la première mesure sélectionnée dans la liste), et affichez la valeur d'autres mesures dans le tableau. Vous pouvez modifier la requête de recherche ou étudier les événements RUM correspondant à l'une des dimensions.
...
{{< img src="real_user_monitoring/explorer/visualize/nested_table.png" alt="Tableau imbriqué dans le RUM Explorer" style="width:90%;">}}
...
{{< img src="real_user_monitoring/explorer/visualize/distribution.png" alt="Graphique de distribution dans le RUM Explorer" style="width:90%;">}}
...
{{< img src="real_user_monitoring/explorer/visualize/geomap.png" alt="Carte géographique dans le RUM Explorer" style="width:90%;">}}
...
{{< img src="real_user_monitoring/explorer/visualize/related_events.png" alt="Lien vers les événements associés qui s'affiche après un clic sur le graphique" width="80%" >}}
