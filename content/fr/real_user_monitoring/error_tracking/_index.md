...
Après avoir configuré [RUM][2] pour le suivi des erreurs des **applications Web et mobiles**, les problèmes détectés commencent à apparaître sous forme de cartes. Accédez à [**UX Monitoring** > **Error Tracking**][3] pour consulter les problèmes en cours, les problèmes ignorés ou tous les problèmes, les trier par volume ou par ancienneté, et les filtrer en fonction de n'importe quelle facette par défaut ou personnalisée sur vos applications Web et mobiles.
