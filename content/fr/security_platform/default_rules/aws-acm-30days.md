...
aliases:
  - /fr/mpg-nle-oki
  - /fr/security_monitoring/default_rules/mpg-nle-oki
  - /fr/security_monitoring/default_rules/aws-acm-30days
cloud: aws
disable_edit: true
...
security: conformité
source: acm
title: "Certificat ACM expirant dans plus de 30\_jours"
type: security_rules
---
## Description

Renouvelez votre certificat SSL/TLS géré par AWS Certificat Manager, car il vous reste 30 jours pour le renouveler.
...
ACM renouvelle automatiquement les certificats (si vous utilisez la validation DNS) ou envoie une notification par e-mail lorsque la date d'expiration approche. Consultez la page [Renouvellement géré des certificats ACM][1] pour en savoir plus.
