...
Les logs Google Cloud HTTP Loadbalancer sont recueillis avec Stackdriver et envoyés à un Cloud Pub/Sub via un redirecteur Push HTTP. Si vous ne l'avez pas déjà fait, configurez le [Cloud Pub/Sub par le biais d'un redirecteur Push HTTP][4].
