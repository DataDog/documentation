...
name: amazon_route53
public_title: "Intégration Datadog/AWS Route\_53"
...
Si vous ne l'avez pas déjà fait, configurez d'abord [l'Intégration Amazon Web Services](https://docs.datadoghq.com/integrations/amazon_web_services/).
...
**Remarque** : pour obtenir les métriques Amazon Route 53 à l'aide de CloudWatch, vous devez choisir la région Est des États-Unis (Virginie du Nord). Les métriques Amazon Route 53 ne sont pas disponibles si vous sélectionnez une autre région. Cliquez [ici][6] pour en savoir plus.
