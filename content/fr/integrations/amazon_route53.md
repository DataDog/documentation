...
**Remarque** : pour obtenir les métriques Amazon Route 53 à l'aide de CloudWatch, vous devez choisir la région Est des États-Unis (Virginie du Nord). Les métriques Amazon Route 53 ne sont pas disponibles si vous sélectionnez une autre région. Cliquez [ici][7] pour en savoir plus.
