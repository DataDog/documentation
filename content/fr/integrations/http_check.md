...
| `tags`                           | La liste des tags arbitraires qui seront associés au check. Pour en savoir plus sur les tags, consultez notre [guide sur les tags][7] et notre article de blog, [La puissance des métriques taguées][8] (en anglais).                                                                   |
