...
|---------------------------------|--------------------------------------------------------------------------------------|
| [App Service][1]                | Un service de déploiement et de mise à l'échelle d'applications Web, mobiles, API et de logique métier |
| [Batch Service][2]              | Un planificateur et processeur de tâches gérés                                                 |
| [Event Hubs][3]                  | Un service géré de flux de données à grande échelle                                              |
| [IOT Hub][4]                   | Connexion, surveillance et gestion de milliards de ressources IoT                                  |
| [Logic App][5]                 | Conception de solutions d'intégration puissantes                                                 |
| [Redis Cache][6]               | Cache de données géré                                                                   |
| [Stockage][7]                   | Stockage de tables, de files d'attente, de fichiers et de blobs                                                 |
| [SQL Database][8]              | Base de données relationnelle fortement évolutive dans le cloud                                     |
| [SQL Database Elastic Pool][9] | Gestion des performances de plusieurs bases de données                                         |
| [Machine virtuelle][10]           | Service de gestion de machines virtuelles                                                   |
| [Virtual Machine Scale Set][11] | Déploiement, gestion et mise à l'échelle automatique d'un ensemble de machines virtuelles identiques                                 |
...
Afin d'intégrer Datadog à Azure à l'aide de l'interface de ligne de commande Azure, assurez-vous que [celle-ci est bien installée][12].
...
2. Cliquez sur **Créer**, saisissez votre [clé d'API Datadog][4] et cliquez sur **OK**.

Pour effectuer l'installation de l'Agent en fonction du système d'exploitation ou de l'outil CICD, consultez les [instructions d'installation de l'Agent Datadog][5] au sein de l'application.
...
Accédez au [dashboard par défaut des machines virtuelles Azure][6] pour visualiser les données de votre infrastructure, qui s'ajoutent automatiquement au dashboard.
...
1. Créez un [Azure Event Hub][7] depuis le [portail Azure][8], l’[interface de ligne de commande Azure][9] ou [Powershell][10].
...
3. [Configurez vos services Azure pour transférer leurs logs au Event Hub][11].

#### Créer une fonction Azure

Si vous n'avez jamais utilisé de fonction Azure, consultez la section [Créer votre première fonction à l'aide du portail Azure][12].
...
7. Créez un fichier `index.js` et ajoutez le [code de la fonction Datadog/Azure][13] (remplacez `<DATADOG_API_KEY>` par votre [clé d'API Datadog][4]).
...
10. Vérifiez que vos logs sont présents dans le [Log Explorer de Datadog][14] pour confirmer que la fonction est bien configurée.
...
* [Redis Cache][20]
* [SQL Database][21]
* [SQL Database Elastic Pool][22]
* [Machine virtuelle][23]
* [Virtual Machine Scale Set][24]

### Événements
L'intégration Azure envoie tous vos événements Azure à votre [flux d'événements][25] Datadog.
...
Besoin d'aide ? Contactez [l'assistance Datadog][26].
...
{{< get-dependencies >}}
[1]: https://docs.datadoghq.com/fr/integrations/azure_app_services
[2]: https://docs.datadoghq.com/fr/integrations/azure_batch
[3]: https://docs.datadoghq.com/fr/integrations/azure_event_hub
[4]: https://docs.datadoghq.com/fr/integrations/azure_iot_hub
[5]: https://docs.datadoghq.com/fr/integrations/azure_logic_app
[6]: https://docs.datadoghq.com/fr/integrations/azure_redis_cache
[7]: https://docs.datadoghq.com/fr/integrations/azure_storage
[8]: https://docs.datadoghq.com/fr/integrations/azure_sql_database
[9]: https://docs.datadoghq.com/fr/integrations/azure_sql_elastic_pool
[10]: https://docs.datadoghq.com/fr/integrations/azure_vm
[11]: https://docs.datadoghq.com/fr/integrations/azure_vm_scale_set
[12]: https://azure.microsoft.com/en-us/documentation/articles/xplat-cli-install
[13]: https://docs.datadoghq.com/fr/integrations/azure_app_services
[14]: https://docs.datadoghq.com/fr/integrations/azure_app_services
[15]: https://docs.datadoghq.com/fr/integrations/azure_batch
[16]: https://docs.datadoghq.com/fr/integrations/azure_event_hub
[17]: https://docs.datadoghq.com/fr/integrations/azure_iot_hub
[18]: https://docs.datadoghq.com/fr/integrations/azure_logic_app
[19]: https://docs.datadoghq.com/fr/integrations/azure_redis_cache
[20]: https://docs.datadoghq.com/fr/integrations/azure_storage
[21]: https://docs.datadoghq.com/fr/integrations/azure_sql_database
[22]: https://docs.datadoghq.com/fr/integrations/azure_sql_elastic_pool
[23]: https://docs.datadoghq.com/fr/integrations/azure_vm
[24]: https://docs.datadoghq.com/fr/integrations/azure_vm_scale_set
[25]: https://azure.microsoft.com/en-us/documentation/articles/xplat-cli-install
[26]: https://app.datadoghq.com/account/settings#integrations/azure
[27]: https://app.datadoghq.com/account/settings#integrations/azure
[28]: https://portal.azure.com
[29]: https://docs.datadoghq.com/fr/integrations/faq/azure-troubleshooting/#enable-diagnostics
[30]: https://app.datadoghq.com/account/settings#api
[31]: https://app.datadoghq.com/account/settings#agent
[32]: https://app.datadoghq.com/screen/integration/azure_vm
[33]: https://azure.microsoft.com/en-us/services/event-hubs
[34]: https://docs.microsoft.com/en-gb/azure/event-hubs/event-hubs-create
[35]: https://docs.microsoft.com/en-us/azure/event-hubs/event-hubs-quickstart-cli
[36]: https://docs.microsoft.com/en-us/azure/event-hubs/event-hubs-quickstart-powershell
[37]: https://docs.microsoft.com/en-us/azure/monitoring-and-diagnostics/monitor-stream-monitoring-data-event-hubs
[38]: https://docs.microsoft.com/en-us/azure/azure-functions/functions-create-first-azure-function
[39]: https://github.com/DataDog/datadog-serverless-functions/blob/master/azure/activity_logs_monitoring/index.js
