...
1. Modifiez le fichier `storm.d/conf.yaml` dans le dossier `conf.d/` à la racine du [répertoire de configuration de votre Agent][7] pour commencer à recueillir vos [métriques](#metriques) Storm. Consultez le [fichier d'exemple storm.d/conf.yaml][8] pour découvrir toutes les options de configuration disponibles.
