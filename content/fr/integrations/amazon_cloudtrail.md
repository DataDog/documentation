...
Une fois terminé, les logs s'affichent dans votre [Log Explorer sur Datadog][9].
...
Vous devez d'abord configurer le [carré Amazon Web Services][11], puis le carré CloudTrail.
