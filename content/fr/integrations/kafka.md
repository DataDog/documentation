...
- [Dépannage et analyse approfondie pour Kafka][13]
- [Échec de la récupération du stub RMIServer par l'Agent][14]
- [Les métriques relatives aux producteurs et consommateurs n'apparaissent pas dans mon application Datadog][15]

## Pour aller plus loin

- [Surveillance des métriques de performance Kafka][16]
- [Collecte des métriques de performance Kafka][17]
- [Surveillance de Kafka avec Datadog][18]
...
1. Modifiez le fichier `kafka_consumer.d/conf.yaml` dans le dossier `conf.d/` à la racine du [répertoire de configuration de votre Agent][6]. Consultez le [fichier d'exemple kafka_consumer.d/conf.yaml][20] pour découvrir toutes les options de configuration disponibles.
...
[Lancez la sous-commande status de l'Agent][12] et cherchez `kafka_consumer` dans la section Checks.
...
[13]: https://docs.datadoghq.com/fr/integrations/faq/troubleshooting-and-deep-dive-for-kafka/
[14]: https://docs.datadoghq.com/fr/integrations/faq/agent-failed-to-retrieve-rmierver-stub/
[15]: https://docs.datadoghq.com/fr/integrations/faq/producer-and-consumer-metrics-don-t-appear-in-my-datadog-application/
[16]: https://www.datadoghq.com/blog/monitoring-kafka-performance-metrics
[17]: https://www.datadoghq.com/blog/collecting-kafka-performance-metrics
[18]: https://www.datadoghq.com/blog/monitor-kafka-with-datadog
[19]: https://raw.githubusercontent.com/DataDog/integrations-core/master/kafka_consumer/images/kafka_dashboard.png
[20]: https://github.com/DataDog/integrations-core/blob/master/kafka_consumer/datadog_checks/kafka_consumer/data/conf.yaml.example