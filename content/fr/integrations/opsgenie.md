...
#### Créer une intégration Datadog dans OpsGenie
  ...
  {{< img src="integrations/opsgenie/opsgenie-int-index.png" alt="Index des intégrations OpsGenie" responsive="true" popup="true">}}
  ...
  {{< img src="integrations/opsgenie/opsgenie-add-api-key.png" alt="Ajouter la clé d'API dans OpsGenie" responsive="true" popup="true">}}
...
#### Afficher les intégrations créées avec OpsGenie dans Datadog
  ...
  {{< img src="integrations/opsgenie/datadog-add-opsgenie-key.png" alt="Ajouter une clé OpsGenie dans Datadog" responsive="true" popup="true">}}
