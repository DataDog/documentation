...
#### Créer une intégration Datadog dans OpsGenie
  ...
  {{< img src="integrations/opsgenie/opsgenie-int-index.png" alt="Index des intégrations OpsGenie"  >}}
  ...
  {{< img src="integrations/opsgenie/opsgenie-add-api-key.png" alt="Ajouter la clé d'API dans OpsGenie"  >}}
  8. Pour ajouter d'autres intégrations Datadog sur OpsGenie, accédez à la page des [intégrations OpsGenie][3] et répétez les étapes ci-dessus.

#### Afficher les intégrations créées avec OpsGenie dans Datadog

  1. Dans Datadog, sélectionnez le carré OpsGenie depuis la [page Integrations de votre compte][4].
  ...
  {{< img src="integrations/opsgenie/datadog-add-opsgenie-key.png" alt="Ajouter une clé OpsGenie dans Datadog"  >}}
...
{{< img src="integrations/opsgenie/dd_ack_og_alert.png" alt="Confirmer la réception d'une alerte OpsGenie depuis Datadog"  >}}
...
{{< img src="integrations/opsgenie/og_create_alert_dd_updated.png" alt="Créer une alerte OG et mettre à jour DD"  >}}
