...
2.  Saisissez le nom d'utilisateur et le mot de passe de votre compte Pingdom.
    Si vous possédez un compte d'équipe, vous pouvez utiliser vos propres identifiants et spécifier le compte à partir duquel vous souhaitez effectuer des vérifications.
