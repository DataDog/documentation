...
**Remarque** : si vous envoyez vos logs vers un compartiment S3, assurez-vous que `amazon_sagemaker` est défini en tant que _Target prefix_.
...
[4]: https://docs.datadoghq.com/fr/integrations/amazon_web_services/?tab=automaticcloudformation#log-collection
