...
[Lancez la sous-commande status de l'Agent][8] et cherchez `php_apcu` dans la section Checks.
...
[10]: https://github.com/DataDog/integrations-extras/blob/master/php_apcu/assets/service_checks.json
