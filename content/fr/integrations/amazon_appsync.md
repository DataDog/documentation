...
ConfigurezAWS AppSync de façon à ce que ses logs soient envoyés vers un compartiment S3 ou vers CloudWatch.
...
2. Une fois la fonction Lambda installée, ajoutez manuellement un déclencheur sur le compartiment S3 ou sur le groupe de logs CloudWatch qui contient vos logsAWS AppSync dans la console AWS :
