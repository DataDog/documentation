...
1. Modifiez le fichier `riak.d/conf.yaml` dans le dossier `conf.d/` à la racine du [répertoire de configuration de votre Agent][4].
    Consultez le [fichier d'exemple riak.yaml][5] pour découvrir toutes les options de configuration disponibles.
