...
<li>Une fois votre profil Datadog configuré, vous devrez l'assigner à un groupe de contacts depuis Alerting>Contacts. Pour assigner le profil, utilisez le champ Push Notifications dans le groupe de contacts.</li>
</ul>
