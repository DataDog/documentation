...
ddtype: crawler
dependencies: []
description: 'Observez et discutez des cas nouveaux, ouverts, en attente et résolus dans votre flux d''événements. stream.'
...
short_description: 'Observez et discutez des cas nouveaux, ouverts, en attente et résolus dans votre flux d''événements. event stream.'
version: '1.0'
---
## Présentation
...
{{< img src="integrations/desk/desk_config.png" alt="configuration desk"  >}}
