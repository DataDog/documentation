...
Configurez Amazon Elastic Transcoder de façon à ce que ses logs soient envoyés vers un compartiment S3 ou vers Cloudwatch. Assurez-vous d'inclure `amazon_elastic_transcoder` dans le préfixe.
