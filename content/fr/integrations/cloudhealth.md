...
ddtype: crawler
dependencies: []
description: "Optimisez CloudHealth\_: offrez-lui vos métriques par instance depuis Datadog."
...
short_description: "Optimisez CloudHealth\_: offrez-lui vos métriques par instance depuis Datadog."
version: '1.0'
---
## Présentation
...
{{< img src="integrations/cloudhealth/cloudhealth_config_2.png" alt="Config Cloudhealth 2" responsive="true" popup="true">}}
...
2. Remplissez le formulaire avec les informations du compte Datadog que vous souhaitez intégrer :
    ...
    * Application Key : les clés d'application, utilisées conjointement avec la clé d'API de votre organisation, donnent accès à l'API de Datadog. La plateforme CloudHealth interroge uniquement Datadog pour obtenir des informations sur des métriques et des hosts. Elle ne rédige rien dans Datadog.
...
{{< img src="integrations/cloudhealth/cloudhealth_config_1.png" alt="Config Cloudhealth 1" responsive="true" popup="true">}}
