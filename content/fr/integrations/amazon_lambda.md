...
Datadog s'intègre à [AWS X-Ray][12] pour recueillir et visualiser vos traces sans serveur à partir d'applications basées sur Lambda dans l'[IU Cloud Functions][6]. Vous pouvez en savoir plus sur la configuration de cette intégration dans la [documentation relative aux fonctions Datadog Cloud][7].
