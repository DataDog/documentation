...
{{< alert >}}Toutes les métriques récupérées par cette intégration sont considérées comme des <a href="https://docs.datadoghq.com/metrics/custom_metrics">métriques custom</a>.{{< /alert >}}
