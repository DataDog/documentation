...
Renvoie `CRITICAL` si l'Agent n'est pas capable de se connecter à l'instance Hazelcast qu'il surveille et d'y recueillir des métriques. Si ce n'est pas le cas, renvoie `OK`.
