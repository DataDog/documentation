...
```json
{
    ...
    "priority": "normal",
    "tags": ["alertType:${Switch(${AlertTypeId},'0', 'Inconnu','2', 'Longueur d\'octet','3','Correspondance de contenu','4', 'Échec du host','7', 'Calcul du temps','9', 'Échec du test', '10',Information', '11','Échec JavaScript', '12', 'Ping',13, 'Requêtes')}"],
