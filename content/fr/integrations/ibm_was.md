...
Le check IBM WAS est inclus avec le paquet de l'[Agent Datadog][4].
...
[Lancez la sous-commande status de l'Agent][7] et cherchez `ibm_was` dans la section Checks.
