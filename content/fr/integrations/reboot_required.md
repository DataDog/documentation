...
1. Modifiez le fichier `reboot_required.d/conf.yaml` dans le dossier `conf.d/` à la racine du [répertoire de configuration de votre Agent][7]. Consultez le [fichier d'exemple reboot_required.d/conf.yaml][8] pour découvrir toutes les options de configuration disponibles.
