...
name: amazon_elb
public_title: Intégration Datadog/AWS Load Balancer
...
#### Activer la journalisation d'AWS ELB

Commencez par activer la journalisation sur votre ELB pour recueillir vos logs. Les logs ELB peuvent être écrits dans un compartiment AWS S3 et [lus par une fonction Lambda][6]. [Pour en savoir plus, consultez la documentation AWS][7]
