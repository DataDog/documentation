...
instances:
  ...
  ##
  ## Cela correspond à tous les services qui commencent par service, comme si service.* était configuré.
  ...
  ##
  ## Pour en savoir plus sur le tagging, consultez https://docs.datadoghq.com/tagging
  #
  #  tags:
  #    - <KEY_1>:<VALUE_1>
  #    - <KEY_2>:<VALUE_2>
