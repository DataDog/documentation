...
1. Modifiez le fichier `mcache.d/conf.yaml` dans le dossier `conf.d/` à la racine du [répertoire de configuration de votre Agent][3]. Consultez le [fichier d'exemple mcache.d/conf.yaml][4] pour découvrir toutes les options de configuration disponibles :
