...
- Navigateur nouvelle génération optimisé pour les développeurs permettant de concevoir en peu de temps des sites Web rapides et réactifs
...
Vous pouvez souscrire un abonnement à LambdaTest par l'intermédiaire du Marketplace Datadog. Une fois votre compte LambdaTest configuré (si ce n'était pas déjà fait), accédez au [carré d'intégration](/integrations/lambdatest) pour commencer à envoyer des données à Datadog.
