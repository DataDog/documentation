...
* Les fonctionnalités Live Tail, Rehydrate from Archives et Generate Metrics sont désactivées
...
* Il n'est pas possible de [partager][6] des logs (ou des traces) à partir de l'Explorer via une intégration web.
...
[6]: /fr/logs/explorer/#share-views