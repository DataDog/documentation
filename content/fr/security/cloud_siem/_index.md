...
{{< img src="security/security_monitoring/signals_page.png" alt="La page Signals de Cloud SIEM, avec un filtre basé sur le type de règle de détection des logs, un graphique à barres représentant le statut des signaux ainsi qu'une liste de signaux" >}}
...
{{< img src="security/security_monitoring/new_detection_rule.png" alt="La page de création d'une règle de détection, avec une règle de détection de logs basée sur un seuil sélectionnée" style="width:65%;" >}}
