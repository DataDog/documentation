...
description: Voir les règles pour plusieurs langages pour l'analyse statique du code.
further_reading:
...
rulesets:
  ...
  php-code-style:
    description: 'Règles pour imposer le style de code PHP.
      ...
      '
    title: Imposer le style de code PHP
  php-security:
    description: 'Règles axées sur la détection des problèmes de sécurité dans votre
      code PHP.
  ...
  python-code-style:
    description: 'Règles pour imposer le style de code Python.
      ...
      '
    title: Imposer le style de code Python
  python-design:
  ...
  ruby-code-style:
    description: 'Règles de sécurité du code pour écrire des règles Ruby qui respectent
      les normes de codage établies.
  ...
  swift-code-style:
    description: 'Règles de sécurité du code pour écrire des règles Swift qui respectent
      les normes de codage établies.
