...
{{< img src="security/cspm/findings/findings-time-window.png" alt="Choisir un intervalle à l'aide du menu déroulant" style="width:65%;">}}
...
{{< img src="security/cspm/findings/posture-management-overview.png" alt="Aperçu de la page des résultats Posture Management" style="width:100%;">}}
