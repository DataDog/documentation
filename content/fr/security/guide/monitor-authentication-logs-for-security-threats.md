...
{{< img src="security/security_monitoring/guide/monitor-authentication-logs-for-security-threats/credential-stuffing-attack-signal.png" alt="Signal d'attaque par credential stuffing dans le Security Signals Explorer">}}
...
{{< img src="security/security_monitoring/guide/monitor-authentication-logs-for-security-threats/investigation-dashboard-example.mp4" alt="Analyser les signaux de sécurité déclenchés dans le dashboard d'analyse" video=true >}}
