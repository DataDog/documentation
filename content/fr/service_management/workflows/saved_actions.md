...
1. Cliquez sur l'icône **Saved Actions** et sélectionnez **Save action configurations**.
...
{{< img src="service_management/workflows/save_action.mp4" alt="Cliquez sur l'icône Saved Action pour enregistrer une action pour l'utiliser plus tard." video="true" width=80% >}}
