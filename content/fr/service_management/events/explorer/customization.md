...
Personnalisez votre vue Events Explorer afin de répondre à vos besoins en matière de visualisation et d'analyse.

## Options

En haut à droite de votre tableau d'événements se trouve le bouton **Options** (icône d'engrenage). Celui-ci vous permet de modifier de plusieurs façons l'Events Explorer :
