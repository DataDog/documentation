...
Vous pouvez également appliquer un filtrage avancé à l'aide de filtres de valeur de tag basés sur des booléens ou des wildcards. Pour les requêtes sur des données autres que celles des métriques, telles que logs, traces, Network Monitoring, Real User Monitoring, Synthetics ou Security, consultez la documentation [Log Search Syntax][1] pour la configuration.
...
- Excluez les valeurs N/A.
- Appliquez une valeur minimale ou maximale aux métriques qui atteignent le seuil.
- Excluez les valeurs supérieures ou inférieures aux valeurs seuil.
