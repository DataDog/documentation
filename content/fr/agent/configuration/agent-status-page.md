...
algolia:
  ...
  - status page
aliases:
- /fr/agent/guide/agent-status-page
description: Apprenez à lire et à interpréter la page de statut de l'Agent Datadog
  pour résoudre les problèmes et surveiller l'état de l'Agent.
further_reading:
...
title: Page de statut de l'Agent
---

La page de statut de l'Agent affiche des informations sur votre Agent en cours d'exécution. Consultez les [commandes de l'Agent][1] pour obtenir la commande de statut pour votre environnement. Les sections ci-dessous fournissent des détails sur le contenu de la page de statut.
...
| Erreurs         | Le nombre de fois qu'un envoi de transaction a échoué et a été retenté.         |
...
| Checks de service                                | Le nombre total de checks de service envoyés vers l'aggregator.                                            |
...
[1]: /fr/agent/configuration/agent-commands/#agent-information
