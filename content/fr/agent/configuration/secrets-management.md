  ...
  global:
    secretBackend:
      ...
      - namespace: database
        ...
        - "database-secret"
```
***Remarque*** : Chaque espace de noms dans la liste des rôles doit également être configuré dans la variable d'environnement `WATCH_NAMESPACE` ou `DD_AGENT_WATCH_NAMESPACE` lors du déploiement de l'Opérateur Datadog.
{{% /tab %}}
{{% tab "Helm" %}}
...
À partir de l'Agent v7.76, les vérifications programmées [Autodécouverte][1] peuvent rafraîchir les secrets en temps réel si le modèle utilise la syntaxe `ENC[]`.
