...
| `DD_EXTERNAL_METRICS_MAX_AGE`                 | Âge maximal (en secondes) d'un point de données avant qu'il soit considéré comme non valide et ne puisse pas être traité. Valeur par défaut : `90` secondes.                                                              |
