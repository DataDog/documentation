...
| [Debian x86_64][2]                | Debian 7 (wheezy) et versions ultérieures, et SysVinit avec l'Agent 6.6.0+  |
...
Avec l'Agent v6+, l'interface de ligne de commande est basée sur des sous-commandes. Pour exécuter une sous-commande, commencez par invoquer le binaire de l'Agent :
