...
<div class="alert alert-info">L'installation de versions d'Agent <= 6.39/7.39 sur Amazon Linux 2022/2023 nécessitent le paquet <code>libxcrypt-compat</code>. Pour l'installer, lancez:<br/><pre><code>dnf install -y libxcrypt-compat</code></pre>.</div>
