...
`agent.image.name`
: Définit l'image à utiliser. Utilisez `gcr.io/datadoghq/agent:latest` pour l'Agent Datadog 6. Utilisez `gcr.io/datadoghq/dogstatsd:latest` pour la version autonome de DogStatsD. Utilisez `gcr.io/datadoghq/cluster-agent:latest` pour l'Agent de cluster Datadog.
