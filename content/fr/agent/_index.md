...
Les packages sont également disponibles en versions pour architectures x86 64 bits et Arm v8. Pour toute autre architecture, utilisez l'installation depuis les sources.
...
{{< whatsnext desc="Cette section aborde les sujets suivants :">}}
  ...
  {{< nextlink href="/agent/configuration/proxy">}}<u>Proxy</u> : si votre configuration réseau limite le trafic sortant, utilisez un proxy pour le trafic de l'Agent.{{< /nextlink >}}
