...
* Nombre maximum de logs dans un lot : 1 000
...
[3]: /fr/agent/configuration/proxy/
{{% /tab %}}
...
L'endpoint TCP n'est pas pris en charge pour ce site.
...
[1]: /fr/agent/configuration/agent-commands/?tab=agentv6v7#service-status
