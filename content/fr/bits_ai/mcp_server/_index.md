...
- link: https://www.datadoghq.com/blog/datadog-remote-mcp-server/
  tag: Blog
  text: Connectez vos agents IA aux outils de Datadog et au contexte en utilisant
...
- Limite de rafale de 50 requêtes en 10 secondes
- 5000 appels d'outils par jour
- 50 000 appels d'outils par mois. 

Ces limites sont **soumises à des modifications** et peuvent être ajustées si votre cas d'utilisation nécessite plus. Veuillez contacter [le support Datadog][37] pour toute demande ou question. 
...
Voir [Outils du serveur MCP Datadog][2] pour une référence complète des outils disponibles organisés par ensemble d'outils, avec des exemples de requêtes. Pour activer des ensembles d'outils spécifiques, voir [Configurer le serveur MCP Datadog][28] pour des instructions.
...
Le serveur MCP Datadog fait l'objet d'un développement important. Utilisez [ce formulaire de retour d'information][19] pour partager vos retours, cas d'utilisation ou problèmes rencontrés avec vos requêtes et questions.
