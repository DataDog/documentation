...
---
Pour envoyer vos logs à Datadog, nous vous conseillons d'activer la journalisation au sein d'un fichier avec [`lograge`][1], puis de suivre ce fichier avec l'Agent Datadog. Lorsque vous configurez le logging avec Ruby, assurez-vous de penser aux [attributs réservés][2]).
...
[7]: /fr/tracing/advanced/connect_logs_and_traces/?tab=ruby