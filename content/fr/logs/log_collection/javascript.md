...
Si vos journaux de navigateur contiennent des informations sensibles à supprimer, configurez le SDK du navigateur pour supprimer les séquences sensibles en utilisant le `beforeSend` rappel lors de l'initialisation du collecteur de journaux du navigateur.
...
Après qu'un logger a été créé, il est possible de :
