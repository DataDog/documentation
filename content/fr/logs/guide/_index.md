...
{{< whatsnext desc="Collecte de logs" >}}
    ...
    {{< nextlink href="/logs/guide/sending-events-and-logs-to-datadog-with-amazon-eventbridge-api-destinations/" >}}Envoyer des événements et des logs vers Datadog avec les destinations API pour Amazon EventBridge{{< /nextlink >}}
    {{< nextlink href="/logs/guide/send-aws-services-logs-with-the-datadog-lambda-function/" >}}Envoyer des logs de service AWS avec la fonction Lambda Datadog{{< /nextlink >}}
    ...
    {{< nextlink href="logs/guide/lambda-logs-collection-troubleshooting-guide" >}}Guide de dépannage pour la collecte de logs Lambda{{< /nextlink >}}
