...
| `OR`         | **Union** : soit le terme est contenu dans les événements sélectionnés                                             | authentication OR password   |
...
| `hello world`       | Texte libre   | Recherche uniquement dans le message du journal pour `hello` et `world` mots. Par exemple `hello beautiful world`.  |
...
### Recherche par caractères génériques {#search-wildcard}
