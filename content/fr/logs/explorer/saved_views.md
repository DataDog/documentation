...
{{< img src="logs/explorer/saved_views/edit_facet_list.png" alt="Sélection d'une vue enregistrée" style="width:90%;" >}}
...
{{< img src="logs/explorer/saved_views/saved_view_load-from-bar.png" alt="Sélection d'une vue enregistrée"  style="width:90%;" >}}
...
{{< img src="logs/explorer/saved_views/saved_view_load.mp4" alt="Chargement d'une vue enregistrée" video="true" >}}
...
Pour créer une vue enregistrée, cliquez sur le bouton _Save as_ en haut de l'écran. Nommez votre vue enregistrée, puis cliquez sur _Save_.
