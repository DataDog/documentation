...
Le sélecteur d'intervalle global vous permet de définir le même intervalle de temps pour tous les widgets  qui utilisent l'option `Global Time` au sein d'un même screenboard. Vous pouvez sélectionner un intervalle dynamique situé dans le passé (`The Past Hour`, `The Past Day`, etc.) ou un intervalle fixe avec l'option `Select Range`. Si vous avez choisi un intervalle dynamique, les widgets sont mis à jour afin de refléter votre sélection.
...
[1]: /fr/dashboards/sharing/#screenboards
[2]: /fr/events
[3]: /fr/account_management/users/default_roles
[4]: /fr/dashboards/#copy-import-export