...
{{< img src="dashboards/guide/custom_time_frames/copy_and_paste.mp4" alt="Copier et coller un intervalle de temps" video="true" >}}

Les intervalles de temps personnalisés fixes et relatifs sont pris en charge :

{{< img src="dashboards/guide/custom_time_frames/custom_fixed_time_frame.mp4" alt="Saisir un intervalle de temps fixe personnalisé" video="true" width="500" >}}

{{< img src="dashboards/guide/custom_time_frames/custom_relative_time_frame.mp4" alt="Saisir un intervalle de temps relatif personnalisé" video="true" width="500" >}}
