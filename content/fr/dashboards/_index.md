...
{{< whatsnext desc="Fonctionnalités de graphiques :">}}
    {{< nextlink href="/dashboards/widgets" >}}Widgets : Apprenez la configuration pour différentes visualisations{{< /nextlink >}}
    {{< nextlink href="/dashboards/querying" >}}Interrogation : Voir les options de formatage pour les requêtes graphiques{{< /nextlink >}}
...
## Consultez les tableaux de bord sur les appareils mobiles {#view-dashboards-on-mobile-devices}

Consultez vos tableaux de bord dans un format adapté aux mobiles avec le Datadog Mobile App, disponible sur [Apple App Store][2] et [Google Play Store][3]. Le Datadog Mobile App est équipé de widgets d'écran d'accueil mobiles qui vous permettent de surveiller la santé des services et l'infrastructure sans l'ouvrir.

**Remarque** : Pour configurer ou modifier un tableau de bord, vous devez vous connecter au Datadog Browser UI. Pour plus d'informations sur l'installation de l'application, consultez la documentation du Datadog Mobile App.

## Lectures complémentaires {#further-reading}

{{< learning-center-callout header="Essayez de créer des widgets graphiques dans le Datadog Learning Center" btn_title="Inscrivez-vous maintenant" btn_url="https://learn.datadoghq.com/courses/dashboard-graph-widgets">}} Explorez les widgets de séries temporelles, de valeur de requête, de top list, de tableau, de distribution et de graphique circulaire. Apprenez à configurer les widgets et à comprendre quand utiliser chaque type de widget. {{< /learning-center-callout >}}

{{< learning-center-callout header="Essayez de créer des widgets de tableau, de liste, de SLO et d'architecture dans le Datadog Learning Center." btn_title="Inscrivez-vous maintenant" btn_url="https://learn.datadoghq.com/courses/discovering-table-list-widgets">}} Explorez les widgets de tableau, de liste, de SLO et d'architecture. Apprenez à suivre les métriques et la performance d'une application web et découvrez comment présenter des données importantes. {{< /learning-center-callout >}}
