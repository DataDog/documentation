...
À partir de l'Agent v6.10+, l'Agent peut autodécouvrir des tags à partir des annotations de Pod. Il permet à l'Agent d'associer des étiquettes à toutes les données émises par l'ensemble des pods ou un conteneur individuel au sein de ce pod.
