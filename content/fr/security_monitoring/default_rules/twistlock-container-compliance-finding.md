...
### Stratégie
Cette règle vous permet de surveiller les logs Twistlock afin de détecter lorsque des problèmes de conformité avec un niveau de sévérité `Critical` sont découverts dans un conteneur en cours d'exécution.
