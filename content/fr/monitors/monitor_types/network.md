...
* Choisissez un type de check réseau (`ssl`, `http` ou `tcp`).
...
Consultez la documentation relative aux [monitors de métrique][4] pour en savoir plus sur les options [No data][5], [Auto resolve][6] et [Evaluation delay][7].
