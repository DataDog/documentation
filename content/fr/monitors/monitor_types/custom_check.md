...
Les monitors de checks custom désignent tout check de service non transmis par l'une des [plus de 350 intégrations][1] incluses avec l'Agent. Les checks de service custom peuvent être envoyés à Datadog à l'aide d'un [check custom de l'Agent][2], de [DogStatsD][3] ou de l'[API][4].
...
[4]: /fr/api/?lang=python#service-checks
