...
**Remarque** : les termes `moniteurs individuels`, `monitors qui le composent` et `monitors non composite` désignent tous des monitors utilisés par un monitor composite pour calculer son statut.
