...
Les monitors App Analytics vous permettent de visualiser l'évolution des données d'APM et de définir des alertes basées sur des spans analysées. Utilisez par exemple un monitor App Analytics pour recevoir des alertes en cas de hausse importante du nombre de requêtes lentes.

## Création de monitor

Pour créer un [monitor d'APM][2] dans Datadog, utilisez la navigation principale : *Monitors --> New Monitor --> APM*.

Choisissez un monitor **APM Metrics** ou **App Analytics** :
...
[1]: /fr/tracing/app_analytics/search/#search-bar
[2]: /fr/tracing/app_analytics/search/#facet-search
[3]: /fr/tracing/app_analytics/search/#numerical-values
{{% /tab %}}
{{< /tabs >}}
