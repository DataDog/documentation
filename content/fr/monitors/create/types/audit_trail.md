...
description: Envoyez des alertes lorsqu'un type d'événement de piste d'audit spécifique
  est détecté ou dépasse un seuil.
further_reading:
- link: /account_management/audit_trail/
  tag: Documentation
  text: En savoir plus sur les pistes d'audit
...
kind: documentation
title: Monitor de piste d'audit
---

## Présentation

Les monitors de piste d'audit vous envoient des alertes lorsqu'un type d'événement d'audit spécifique dépasse un seuil que vous avez défini sur une période donnée.

## Création d'un monitor

Pour créer un [monitor de piste d'audit][1] dans Datadog, utilisez la navigation principale : *Monitors --> New Monitor --> Audit Trail*.
