...
Pour obtenir des instructions détaillées concernant les options d'alerte avancées (délai d'évaluation, délai pour les nouveaux groupes, etc.), consultez la documentation relative à la [configuration des monitors][5].
...
[5]: /fr/monitors/create/configuration/#advanced-alert-conditions
