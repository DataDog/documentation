...
- **[Moniteurs désactivés depuis longtemps](#muted-for-a-long-period-of-time)** : Moniteurs qui ont été désactivés pendant de longues périodes—semaines ou même mois.
...
```json
{
    ...
    },
    {
      ...
      "definition": {
        ...
        "widgets": [
              ...
              "demandes": [
                {
                  ...
                  "format_réponse": "série_temporelle",
                  "style": {
                    "palette": "datadog16",
                    "order_by": "valeurs",
                    "line_type": "solide",
              ...
              "custom_links": [
                {
                  ...
                  "link": "https://app.datadoghq.com/monitors/quality?q=","layout": { "x": 0, "y": 4, "width": 12, "height": 4 }{{$team}}"
                }
              ]
            ,
            "id": 1376609088194674,
          ,
          {
            "title": "Équipes les plus impactées",
            "définition": {
              "type": "toplist",
              "taille_titre": "16",
              "alignement_titre": "gauche",
              "temps": { "cacher_données_coût_incomplètes": vrai },
              "query": "sum:datadog.monitor.suggested_monitor_health_by_team{!team:none,$team,$service} par {équipe,type_de_suggestion},
              "demandes": [
                {
                  "requêtes": [
                    {
                  ...
                  "count": 10,
                    "order_by": [
                    { "type": "formule", "index": 0, "order": "desc" }
              ...
              "custom_links": [
                {
                  "label": "Voir la liste des moniteurs",
                  "link": "https://app.datadoghq.com/monitors/quality?q=","layout": { "x": 0, "y": 4, "width": 12, "height": 4 }{{équipe}}"
                }
              ],
              "style": {
          ...
          ,
          {
            ...
            "définition": {
              "type": "note",
              "contenu": "Moniteurs avec des poignées cassées par équipe",
          ...
          ,
          {
            "id": 3744392131942638,
            "définition": {
              "title": "Moniteurs avec des gestionnaires cassés par équipe",
              "query": "sum:datadog.monitor.suggested_monitor_health_by_team{!team:none,$team,$service} par {équipe,type_de_suggestion},
              "demandes": [
                {
                  "requêtes": [
          ...
          ,
          {
            "id": 5392245250417816,
            "définition": {
              "title": "Moniteurs générant un grand volume d'alertes",
              "query": "sum:datadog.monitor.suggested_monitor_health_by_team{!team:none,$team,$service} par {équipe,type_de_suggestion},
              "demandes": [
                {
                  "requêtes": [
                    {
                      "nom": "requête1",
                      "source_données": "métriques",
                      "query": "sum:datadog.monitor.suggested_monitor_health_by_team{!team:none,suggestion_type:noisy_monitor,$team,$service} par {team,suggestion_type}",
                      "response_format": "scalaire",
                    }
                  ],
                  "sort": {
          ...
          ,
          {
            ...
            "définition": {
              "type": "note",
              "contenu": "Les comptes de moniteurs rapportés dans cette métrique satisfont aux conditions suivantes :\n- le moniteur a été en alerte pendant au moins 60 jours\n- le type de moniteur n'est pas `synthetics`\n\n_Vous pouvez utiliser les liens contextuels pour accéder à la liste des moniteurs affectés._",
                  ...
                  "requêtes": [
                    {
                      ...
                      "requête": "somme:datadog.monitor.suggested_monitor_health_by_team{!équipe:none,type_de_suggestion:alerte_trop_long,$équipe,$service} par {équipe,type_de_suggestion}",
                      "agrégateur": "dernier"
                    }
                  ],
                  ...
                  "requêtes": [
                    {
                      "nom": "requête1",
                      "source_de_données": "métriques",
                      "requête": "somme:datadog.monitor.suggested_monitor_health_by_team{!équipe:none,type_de_suggestion:composite_has_deleted_constituents ,$équipe,$service} par {équipe,type_de_suggestion}",
                      "agrégateur": "dernier"
                    }
                  ],
                  "format_de_réponse": "scalaire",
      ...
      "définition": {
        ...
        "widgets": [
          ...
          },
          {
            "id": 8281740697966220,
            "définition": {
              "title": "Évolution des améliorations de qualité par type au fil du temps",
              "title_size": "16",
              "title_align": "gauche",
              "show_legend": false,
              "legend_layout": "automatique"
              "légende_colonnes": ["moyenne", "min", "max", "valeur", "somme"],
              "time": { "hide_incomplete_cost_data": true },
                  ...
                  "requêtes": [
                    {
                      "nom": "requête1",
                      "source_de_données": "métriques",
                      "requête": "somme:datadog.monitor.suggested_monitor_health_by_service{$équipe, $service} par {type_de_suggestion}"
                    }
                  ],
                  "format_de_réponse": "série temporelle",
                  "style": {
                    "palette": "datadog16",
                    "trier_par": "valeurs",
                    "type_de_ligne": "solide",
                    "largeur_de_ligne": "normale"
                  },
                  "type_d'affichage": "ligne"
                }
              ],
              "liens_personnalisés": [
                {
                  ...
                  "requêtes": [
                    {
                      "nom": "requête1",
                      "source_de_données": "métriques",
                      "requête": "somme:datadog.monitor.suggested_monitor_health_by_service{!service:none,$équipe,$service} par {service,type_de_suggestion},"
                      "agrégateur": "dernier"
                    }
                  ],
                  "format_de_réponse": "scalaire",
          ...
          },
          {
            ...
            "définition": {
              "type": "note",
              "content": "Moniteurs avec des poignées cassées par service",
              "background_color": "vert_vif",
              "taille_de_police": "18",
              "alignement_du_texte": "centre"
              "alignement_vertical": "centre",
              "show_tick": false,
          ...
          },
          {
            "id": 7809748805807956,
            "définition": {
              "title": "Moniteurs avec des poignées cassées par service",
              "type": "toplist"
              "demandes": [
                {
                  "requêtes": [
          ...
          ,}
          {
            ...
            "definition": {
              "type": "note",
              "contenu": "Les Moniteurs Composites ont des Composants Supprimés",
              "couleur_de_fond": "gris",
              "taille_de_police": "18",
              "alignement_du_texte": "centre",
              "alignement_vertical": "centre",
              "afficher_tick": false,
          ...
          ,}
          {
            ...
            "definition": {
              "type": "note",
              "contenu": "Les comptes de moniteurs rapportés dans cette métrique satisfont les conditions suivantes :\n- le moniteur a alerté pendant au moins 60 jours\n- le type de moniteur n'est pas `synthetics`\n\n_Vous pouvez utiliser les liens contextuels pour accéder à la liste des moniteurs affectés._",
              "couleur_de_fond": "jaune",
              "taille_de_police": "14",
              "alignement_du_texte": "gauche",
              "alignement_vertical": "centre",
          ...
          ,}
          {
            ...
            "definition": {
              "type": "note",
              "contenu": "Les comptes de moniteurs rapportés dans cette métrique satisfont les conditions suivantes :\n- le moniteur est composite et a des composants supprimés\n- le type de moniteur n'est pas `synthetics`\n\n_Vous pouvez utiliser les liens contextuels pour accéder à la liste des moniteurs affectés._",
              "couleur_de_fond": "jaune",
              "taille_de_police": "14",
              "alignement_du_texte": "gauche",
              "alignement_vertical": "centre",
                  ...
                  "queries": [
                    {
                      "name": "query1",
                      "data_source": "metrics",
                      "requête": "sum:datadog.monitor.suggested_monitor_health_by_service{!service:none,suggestion_type:alerted_too_long,$team,$service} par {service,suggestion_type}"
                      "aggregator": "last"
                    }
                  ],
                  "response_format": "scalar",
  ...
  "type_de_mise_en_page": "ordonné",
  "liste_de_notification": [],
  "type_de_reflux": "fixe"
}
```
