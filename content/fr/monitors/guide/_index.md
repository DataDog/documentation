...
{{< whatsnext desc="Guides généraux :" >}}
    ...
    {{< nextlink href="monitors/guide/visualize-your-service-check-in-the-datadog-ui" >}}Visualisation des checks de service dans l'interface Datadog{< /nextlink >}}
    {{< nextlink href="monitors/guide/template-variable-evaluation" >}}Évaluation des template variables{{< /nextlink >}}
{{< /whatsnext >}}
