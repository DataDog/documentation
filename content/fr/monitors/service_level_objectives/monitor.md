...
- Les différents types de monitors de métrique (anomalies, APM, forecast, outlier et métriques d'intégration)
- Les monitors Synthetics
- Les checks de service (fonction en bêta)
...
Vérifiez que vous utilisez bien le type de SLI conseillé pour votre scénario. Datadog prend en charge des SLI basés sur des monitors ainsi que des SLI basés sur des métriques. Pour en savoir plus, consultez la [documentation relative aux SLO basés sur des événements][5].
...
[5]: /fr/monitors/service_level_objectives/event/