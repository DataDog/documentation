...
{{< img src="security/security_monitoring/guide/monitor-authentication-logs-for-security-threats/credential-stuffing-attack-signal.png" alt="Signal d'attaque de credential stuffing dans le Security Signals Explorer">}}
...
{{< img src="security/security_monitoring/guide/monitor-authentication-logs-for-security-threats/investigation-dashboard-example.gif" alt="Étudier des signaux de sécurité déclenchés dans le dashboard d'analyse d'adresse IP">}}
