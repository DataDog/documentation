...
{{< img src="security/security_monitoring/detection_rules/define_search_query.png" alt="Définir la requête de recherche" >}}
...
{{< img src="security/security_monitoring/detection_rules/define_rule_case.png" alt="Définir les scénarios de la règle" >}}
...
{{< img src="security/security_monitoring/detection_rules/joining_queries_define.png" alt="Définir des requêtes de recherche"  >}}
...
{{< img src="security/security_monitoring/detection_rules/group_by.png" alt="Regroupement"  >}}
...
{{< img src="security/security_monitoring/detection_rules/set_rule_cases2.png" alt="Définir des scénarios de règle"  >}}
...
{{< img src="security/security_monitoring/detection_rules/gbv2.png" alt="Définir des scénarios de règle" >}}
...
{{< img src="security/security_monitoring/detection_rules/rules_table2.png" alt="Tableau des règles de détection"  >}}
