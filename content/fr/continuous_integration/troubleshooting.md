...
2. Le wall time calculé est associé au hash pertinent. **Remarque** : si plusieurs tâches exécutent des tests, un wall time est calculé pour chaque tâche, et le wall time le plus élevé est affiché.
