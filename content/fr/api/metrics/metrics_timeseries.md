...
L'endpoint de métrique vous permet d'envoyer des données de séries temporelles pouvant être représentées graphiquement sur les dashboards de Datadog. La limite des charges utiles est de 3,2 mégaoctets (3 200 000), 
...
* **`series`** [*obligatoire*] :
    ...
    * **`interval`** [*facultatif*, *valeur par défaut*=**Aucune**] :
    ...
    * **`points`** [*obligatoire*] :
        ...
        **Remarque** : le timestamp doit être exprimé en secondes et sa valeur doit être actuelle. Le format de la valeur numérique doit être une valeur flottante.
