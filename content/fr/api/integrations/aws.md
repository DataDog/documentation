...
[En savoir plus sur l'intégration Datadog/AWS][1].
...
* **`role_name`** [*obligatoire*] :
    ...
    [Consultez l'intégration Datadog/AWS pour en savoir plus][3] sur le nom de rôle de votre compte AWS.
...
* **`filter_tags`** [*facultatif*, *défaut*=**None**] :
    ...
    [Lisez la documentation relative aux tags AWS pour en savoir plus sur l'ajout de tags EC2][4].
