---
title: Générer des métriques à partir de processus
kind: documentation
aliases:
...
{{< img src="infrastructure/process/process2metrics_overview.png" alt="Générer des métriques basées sur des processus"  style="width:80%;">}}

La génération de métriques basées sur des processus est actuellement disponible en version [bêta privée][1].

## Générer une métrique basée sur des processus

Vous pouvez générer une nouvelle métrique basée sur des processus directement à partir de requêtes sur la page Live Processes, ou en sélectionnant le bouton **Create Metric** depuis l'onglet _[Distribution Metrics][2]_.

{{< img src="infrastructure/process/process2metrics_create_LP.png" alt="Générer des métriques basées sur des processus"  style="width:80%;">}}
...
- Utilisez la [corrélation de métriques][5] pour contextualiser les chutes ou pics de consommation de ressources en les comparant avec les performances de logiciels tierces ou internes
