...
컨텍스트 메뉴에 액세스하려면 먼저 개별 범주 위로 마우스를 가져가세요. 이는 다음 예에서 **Canada** 또는 **Canada > Edge**과 같은 중첩된 범주 또는 그룹일 수 있습니다. 이후 오른쪽 상단 모서리에 드롭다운 메뉴가 나타납니다. 클릭하면 컨텍스트 메뉴가 나타납니다.

{{< img src="dashboards/widgets/treemap/context_menu_dropdown.png" alt="해당 범주 위로 마우스를 가져가면 드롭다운 화살표 버튼이 나타납니다.">}}
