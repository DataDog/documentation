...
<div class="alert alert-danger">Day before 기능이 더 이상 지원되지 않습니다. 대신 "-1d" 값으로 캘린더 시프트를 사용하세요.</div>
...
<div class="alert alert-danger">Week before 기능은 더 이상 지원되지 않습니다. 대신 "-7d" 값으로 캘린더 시프트를 사용하세요.</div>
...
<div class="alert alert-danger">Month before 기능은 더 이상 지원되지 않습니다. 필요에 따라 "-1mo", "-30d", "-4w" 값으로 캘린더 시프트를 사용하세요.</div>
