...
참고: 스팬 값은 시계열의 가중 평균 경과 시간의 2배입니다. 그러므로 `ewma_3()`은 3일 단순 이동 평균과 비교 가능합니다.
...
참고: 스팬 값은 시계열의 가중 평균 경과 시간의 2배입니다. 그러므로 `ewma_5()`은 5일 단순 이동 평균과 비교 가능합니다.
...
참고: 스팬 값은 시계열의 가중 평균 경과 시간의 2배입니다. 그러므로 `ewma_7()`은 7일 단순 이동 평균과 비교 가능합니다.
...
참고: 스팬 값은 시계열의 가중 평균 경과 시간의 2배입니다. 그러므로 `ewma_10()`은 10일 단순 이동 평균과 비교 가능합니다.
...
참고: 스팬 값은 시계열의 가중 평균 경과 시간의 2배입니다. 그러므로 `ewma_20()`은 20일 단순 이동 평균과 비교 가능합니다.
