...
다음으로 [`integrations-extras` 리포지토리][7]에 대한 풀 요청을 열어 코드를 같이 검토할 준비가 되었음을 Datadog에 알립니다. 테스트, Datadog 내부 자료 또는 기타 주제에 대해 궁금한 점이 있으시다면 —Datadog 에코시스템 팀이 도와드리겠습니다. [Community Office Hours][4]도 적극적으로 활용해 보세요.
