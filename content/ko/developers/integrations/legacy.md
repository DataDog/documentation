...
예를 들어 Datadog MySQL 통합에서 [`ci/mysql.rake` 파일][21]은 [공식 MySQL 컨테이너][22]를 사용하며 네 가지 주요 작업을 포함합니다.
...
[1]: https://docs.datadoghq.com/ko/developers/integrations/new_check_howto
...
[10]: /ko/developers/integrations/#new-integration-documentation
