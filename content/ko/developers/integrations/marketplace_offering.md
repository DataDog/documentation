...
[Datadog 마켓플레이스][2]는 기술 파트너가 유료 제품/서비스를 Datadog 사용자에게 제공할 수 있는 디지털 마켓플레이스입니다.
...
## Datadog 마켓플레이스에 함께하기

기술 파트너는 즉시 사용 가능한 통합을 등록할 수 있지만 마켓플레이스 파트너는 기술 파트너에게 제공되지 않는 고유한 혜택을 누릴 수 있습니다.

- 예를 들어, 블로그 게시물, 보도 자료를 위한 견적, 소셜 미디어 강화 등을 포함하는 **출시(GTM) 협력**이 제공됩니다. 파트너 성장에 집중하는 전용 판매 및 마케팅 리소스를 활용할 수 있습니다.
...
개발자 샌드박스를 만드는 데는 최대 1~2 영업일이 소요될 수 있습니다. 샌드박스가 생성되면 공동 작업을 위해 [조직의 새 구성원 초대][6]할 수 있습니다.
