...
- 배너 이미지, 명확한 카피, 유용한 링크, 우수한 타이포그래피 계층 구조를 포함하고 눈길을 사로잡는 **소개** 그룹 
...
-  명확한 그래프 제목을 사용합니다. 제목이 가장 중요한 정보로 시작하도록 합니다. "개수"와 같은 일반적인 구문을 피하고 통합 제목(예: "Memcached 로드")를 포함하지 않습니다.
