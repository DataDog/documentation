...
좌절 신호에는 조치가 필요합니다. `trackFrustrations`를 활성화하면 자동으로 `trackUserInteractions`가 활성화됩니다.
...
### 사용자가 키보드의 키(예: Delete)를 누를 때 분노 클릭이 생성되지 않는 이유는 무엇인가요?

좌절 신호는 키보드 입력이 아닌 마우스 클릭으로 생성됩니다.

### 사이드 패널에 이벤트 타임라인과 다른 수의 좌절 신호가 세션에 있는 것으로 표시되는 이유는 무엇인가요?
...
[3]: /ko/real_user_monitoring/dashboards/usage#frustration-signals
[4]: https://app.datadoghq.com/rum/explorer
[5]: /ko/dashboards/
[6]: /ko/monitors/
[7]: https://app.datadoghq.com/rum/replay/sessions/
[8]: /ko/real_user_monitoring/session_replay/
