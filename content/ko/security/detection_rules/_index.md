...
Datadog에서 기본 및 커스텀 탐지 규칙을 보려면 [**Security** > **Configuration**][15] 페이지로 이동하세요. 각 제품별로 별도 페이지에서 규칙 목록을 확인할 수 있습니다(Application Security, Clound Security Management, Cloud SIEM).
...
[4]: /ko/security/misconfigurations/
