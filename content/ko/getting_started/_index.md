...
{{< nextlink href="/getting_started/monitors" >}}<u>모니터</u>: 팀에게 중요한 변경 사항을 알리도록 경고 및 알림을 설정합니다.{{< /nextlink >}}
{{< nextlink href="/getting_started/logs" >}}<u>로그</u>: 첫 번째 로그를 보내고 로그 처리를 사용하여 로그를 강화합니다.{{< /nextlink >}}
{{< nextlink href="/getting_started/tracing" >}}<u>트레이스</u>: 작은 애플리케이션을 트레이스하도록 Agent를 설정합니다.{{< /nextlink >}}
