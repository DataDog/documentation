...
인프라스트럭처 DevSecOps Pro에는 [컨테이너][1], [서버리스][2] 및 [CSM Pro][3]가 포함됩니다. 또한 [800개 이상의 즉시 사용 가능한 통합][4]이 포함됩니다.
...
인프라스트럭처 DevSecOps Enterprise에는 [컨테이너][1], [서버리스][2], [실시간 프로세스][3] 및 [CSM Enterprise][4]가 포함됩니다. 또한 [800개 이상의 즉시 사용 가능한 통합][5]이 포함됩니다.
