...
{{< img src="actions/workflows/save_action.mp4" alt="저장한 작업 아이콘을 클릭하여 나중에 사용할 수 있도록 작업을 저장합니다." video="true" width=80% >}}
...
{{< img src="actions/workflows/edit_saved_action.png" alt="작업 카탈로그에서 저장된 작업을 미리보기, 편집 또는 삭제합니다." style="width:80%;" >}}
