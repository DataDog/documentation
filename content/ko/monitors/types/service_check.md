...
* 포함 필드는 `AND` 로직을 사용합니다. 나열된 모든 호스트 이름과 태그가 포함되려면 호스트에 있어야 합니다.
...
{{< img src="monitors/monitor_types/process_check/cluster_check_thresholds.png" alt="클러스터 검사 임계값s" style="width:90%;">}}
