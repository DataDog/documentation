...
{{< img src="monitors/incidents/clipboard-full.png" alt="기본 클립보드">}}
...
클립보드를 열려면 그래프를 복사한 다음 토스트에서 **클립보드 열기**를 클릭합니다.

{{< img src="monitors/incidents/open-clipboard.png" alt="클립보드에서 그래프 열기" style="width:80%;">}}
...
{{< img src="monitors/incidents/add-page.png" alt="클립보드에 대시보드 추가" style="width:80%;">}}
...
{{< img src="monitors/incidents/managing-clips.png" alt="클립 관리" style="width:80%;">}}
...
{{< img src="monitors/incidents/exporting.png" alt="클립보드에서 내보내기" style="width:80%;">}}
