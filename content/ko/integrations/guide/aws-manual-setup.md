...
2. 액세스 유형에 대해 `Role Delegation`을 선택하고 `AWS External ID`를 복사합니다. 외부 ID에 대한 자세한 내용은 [IAM User Guide][2]를 참조하세요.
...
4. **JSON** 탭을 선택합니다. 텍스트 상자에 [권한 정책](#aws-integration-iam-policy)을 붙여넣습니다.
...
20. 이전 섹션에서 생성한 역할의 이름을 입력하고 **Save**를 클릭합니다.
