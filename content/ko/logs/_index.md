...
---
{{< learning-center-callout header="활성화 웨비나 세션에 참가하기" hide_image="true" btn_title="Sign Up" btn_url="https://www.datadoghq.com/technical-enablement/sessions/?tags.topics-0=Logs">}}
...
{{< img src="/logs/explore.png" alt="수집한 로그 탐색" style="width:80%;">}}
 ...
 [저장된 뷰][12]: 저장된 뷰를 사용하여 Log Explorer를 자동 설정합니다.


{{< learning-center-callout header="학습 센터에서 Log Management 소개 시도" btn_title="Enroll Now" btn_url="https://learn.datadoghq.com/courses/intro-to-log-management">}}
...
[7]: /ko/logs/guide/correlatelogswithmetrics/
