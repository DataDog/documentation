...
### 새 표준 속성 생성
**관리자 사용자**는 표준 속성 목록을 고를 수 있습니다.
1. 표준 속성 [구성 페이지][3]으로 이동합니다.
1. **New Standard Attribute**를 클릭합니다.
1. 표준 속성을 정의합니다.
    - `Path`: JSON에서 찾을 수 있는 표준 속성 경로(예: network.client.ip)
    - `Type`: (`string`, `integer`, `double`, `boolean`): 재매핑 목록의 요소를 캐스팅하는 데 사용되는 속성의 유형.
    - `Description`: 사람이 읽을 수 있는 속성 설명
    - (선택 사항)`Remapping list`: 표준 속성에 리매핑되어야 하는 비표준 속성 목록, 쉼표로 구분됨
...
| 표준 속성               | 설명                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [네트워크/통신][10]     | 이러한 속성은 네트워크 통신에 사용되는 데이터와 관련이 있습니다. 모든 필드와 메트릭 앞에는 `network`가 접두사로 붙습니다.                                                                                                                                                                                                                                                                                                                                                                             |
| [지리적 위치][11]                | 이러한 속성은 네트워크 통신에 사용되는 IP 주소의 지리적 위치와 관련됩니다. 모든 필드에는 `network.client.geoip` 또는 `network.destination.geoip` 접두사가 붙습니다.                                                                                                                                                                                                                                                                                                                     |
| [HTTP 요청][12]              | 이 속성은 HTTP 요청과 액세스에서 일반적으로 사용되는 데이터와 관련이 있습니다. 모든 속성에는 접두사 `http`가 있습니다. 이 속성에 의존하는 일반적인 통합으로는 [Apache][4], Rails, [AWS CloudFront][13], 웹 애플리케이션 서버 등이 있습니다. URL 상세 속성에는 접두사 `http.url_details`가 있습니다. 이 속성은 HTTP URL의 파싱된 부분의 상세 정보를 제공합니다. 이 정보는 [URL 구분 분석기][14]가 생성합니다.                             |
| [소스 코드][15]                | 이러한 속성은 커스텀 애플리케이션의 로거로 인해 로그 또는 오류가 생성될 때 사용되는 데이터와 관련이 있습니다. 모든 속성에는 `logger` 또는 `error` 접두사가 붙습니다. 이 속성에 의존하는 일반적인 통합에는 Java, Node.js, .NET, Golang, Python 등이 있습니다.                                                                                                                                                                        |
| [데이터베이스][16]                   | 이러한 속성을 사용하는 일반적인 통합은 [Cassandra][17], [MySQL][18], [RDS][19], [Elasticsearch][20] 등입니다.                                                                                                                                                                                                                                                                                                                                                                         |
| [성능][21]                | 이러한 속성은 성능 메트릭과 관련이 있습니다. 이 속성에 대한 로그 내의 모든 기간이 [트레이스 검색][23]의 기본 [측정값][1]으로 표시되고 사용되므로 [리매핑][22]할 것을 권장합니다.                                                                                                                                                                                                                                                                           |
| [사용자 관련 속성][24]    | 모든 속성과 측정값에는 `usr` 접두사가 붙습니다.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [Syslog 및 로그 운송자][25]    | 이러한 속성은 syslog 또는 로그 운송자 에이전트가 추가한 데이터와 관련이 있습니다. 모든 필드와 메트릭에는 접두사`syslog`가 붙습니다. 이 통합에 의존하는 통합에는 [Rsyslog][26], [NxLog][27], [Syslog-ng][28], [Fluentd][29], [Logstash][30]가 있습니다.                                                                                                                                                                                                                                              |
| [DNS][31]                        | 모든 속성과 측정값에는 `dns` 접두사가 붙습니다.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [이벤트][32]                     | 모든 속성에는 `evt` 접두사가 붙습니다.                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
