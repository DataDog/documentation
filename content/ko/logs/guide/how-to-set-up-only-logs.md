...
<div class="alert alert-danger">인프라스트럭처 모니터링은 애플리케이션 성능 모니터링(APM) 사용의 전제 조건입니다. 애플리케이션 성능 모니터링(APM) 고객이시라면 메트릭 수집을 비활성화하지 마시기 바랍니다. 그렇지 않으면 중요한 텔레메트리 및 메트릭 수집 정보가 손실될 수 있습니다.</div>
