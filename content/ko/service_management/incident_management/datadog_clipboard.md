...
{{< img src="incident_response/incident_management/clipboard-full.png" alt="메인 클립보드">}}
...
{{< img src="incident_response/incident_management/open-clipboard.png" alt="클립보드에서 그래프 열기" style="width:80%;">}}
...
{{< img src="incident_response/incident_management/add-page.png" alt="클립보드에 대시보드 추가하기" style="width:80%;">}}
...
{{< img src="incident_response/incident_management/managing-clips.png" alt="클립 관리하기" style="width:80%;">}}
...
{{< img src="incident_response/incident_management/exporting.png" alt="클립보드에서 내보내기" style="width:80%;">}}
