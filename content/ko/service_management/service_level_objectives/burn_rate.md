...
**참고: 다음 SLO 유형에 대해 번 레이트 알림을 사용할 수 있습니다:

- [메트릭 기반 SLO][1],
- 메트릭 모니터 유형(메트릭, 통합, APM 메트릭, 이상치, 예측 또는 아웃라이어 모니터)으로만 구성된 [모니터 기반 SLO][2]
- [타임 슬라이스 SLO][7]

{{< img src="service_management/service_level_objectives/slo-burn-rate-alert-v2.png" alt="번 레이트 알림 설정">}}
