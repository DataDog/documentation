...
3. **Assign Roles** 드롭다운 메뉴를 사용하여 서비스 계정에 대한 하나 이상의 역할을 선택하세요.
...
서비스 계정을 비활성화하려면 사용자에게 Service Account Write 권한 외에도 User Manage Access 권한이 있어야 합니다.

서비스 계정을 비활성화하려면 이전 절차에 따라 서비스 계정을 수정하고 상태를 **Disabled**로 설정합니다.
