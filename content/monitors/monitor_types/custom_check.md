...
Refer to the [Guide to Agent Checks](/developers/agent_checks/) for detailed information on writing your own checks that send metrics, events, or service checks.
