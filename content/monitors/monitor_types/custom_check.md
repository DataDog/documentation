...
Refer to the [Guide to Agent Checks](/agent/advanced_features/agent_checks/) for detailed information on writing your own checks that send metrics, events, or service checks.
