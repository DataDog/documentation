---
title: Envoi d'événements Datadog à votre instance Moogsoft AIOps.
kind: faq
further_reading:
...
6. Cliquez sur Installer l'intégration pour valider l'endpoint final Webhook et l'activer.
