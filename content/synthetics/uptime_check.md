...
Click on **Add new assertion** to add up to ten assertions for your Uptime Check. 
...
2. Enter a **message** for the Uptime Check. This field allows standard [Markdown formatting][3]. Notification messages include the **message** defined in this section and information about which assertion failed and why.
