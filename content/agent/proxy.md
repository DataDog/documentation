...
* `DD_NO_PROXY`: Sets a list of hosts that should bypass the proxy. The list is space-separated.
...
1. `DD_PROXY_HTTPS`, `DD_PROXY_HTTP`, and `DD_NO_PROXY` environment variables
