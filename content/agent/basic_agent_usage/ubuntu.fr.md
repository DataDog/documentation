...
platform: Ubuntu
aliases:
  - '/[object Object]/guides/basic_agent_usage/ubuntu/'
further_reading:
  - link: logs/
    tag: Documentation
...
Si vous n'avez pas encore installé l'Agent, les instructions d'installation peuvent être trouvées [sur la page d'intégration de l'agent Datadog](https://app.datadoghq.com/account/settings#agent/ubuntu).
