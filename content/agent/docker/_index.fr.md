...
| `DD_PROCESS_AGENT_ENABLED` | Active la collecte de live processes dans [process-agent][4]. Par défaut, la vue Live Container est déjà activée si le socket Docker est activé. |
