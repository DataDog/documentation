...
{{< img src="agent/tagging/eventtags.png" alt="Events List and Tags" >}}
...
{{< img src="agent/tagging/dashboardtags_1.png" alt="Tags in Dashboards from textbox" >}}
...
{{< img src="agent/tagging/dashboardtags.png" alt="Tags in Dashboards avgby textbox" >}}
...
{{< img src="agent/tagging/infrastructuretags.png" alt="Tags in the Infrastructure List" >}}
...
{{< img src="agent/tagging/monitortags.png" alt="from textbox tags in Monitors" >}}

* Use tags in the ```excluding:``` textbox to remove the corresponding metrics of the monitor scope.
{{< img src="agent/tagging/monitortags_1.png" alt="excluding textbox tags in Monitors" >}}

* Use tags in the ```avg by``` textbox transform your monitor into a multi-alert monitor on each value of this tags.
{{< img src="agent/tagging/monitortags_2.png" alt="excluding textbox tags in Monitors" >}}
