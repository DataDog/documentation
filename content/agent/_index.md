...
your behalf so that you can do something useful with your monitoring and performance data. The Datadog Agent is open source, view the source code on GitHub for {{< link-github >}}[Agent v5][1] and {{< link-github >}}[Agent v6][2]. To see all changes between Agent v5 and v6,[consult our dedicated changes documentation][3].
