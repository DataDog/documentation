---
title: Autodiscovery avec l'Agent 5
kind: faq
---

<div class="alert alert-info">
Autodiscovery était auparavant appelée Service Discovery. Il est toujours appelé Service Discovery dans tout le code de l'agent et dans certaines options de configuration.
</div>
...
[Redémarrez l'Agent][23] pour prendre en compte le changement de configuration.
...
#### Exemple Docker: NGINX Dockerfile
