...
Now we [restart the agent](/agent/#start-stop-restart-the-agent) and we make sure that the check is collecting metrics, it can take up to 1 minute to update:
