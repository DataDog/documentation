---
title: Installer des intégrations Core & Extra
kind: documentation
aliases:
  - /fr/guides/installcoreextra/
  - /fr/agent/installcoreextra/
disable_toc: true
---
<div class="alert alert-info">
Cette documentation couvre <strong>les versions de l'Agent avant  6.0.0</strong><br>
Agent v6 est désormais disponible, <a href="https://github.com/DataDog/datadog-agent/blob/master/docs/agent/upgrade.md">mettez le à jour </a> afin de profiter de toutes les nouvelles fonctionnalités. 
</div>
