...
If you want to add JMX-related integrations to the Datadog Agent container, use a Docker image that end in `-jmx` to install a version that includes JMX, for example `datadog/agent:latest-jmx`.
