...
APM is enabled by default after Datadog agent 5.13 (on Linux and Docker), and can be disabled by adding the parameter <br>`apm_enabled: no`<br> in your Datadog agent configuration file.
</div>
