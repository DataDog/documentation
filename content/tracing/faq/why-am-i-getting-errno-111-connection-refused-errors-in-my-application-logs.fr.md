...
Si vous exécutez l'agent de trace dans un conteneur Docker, consultez la documentation [docker-dd-agent](https://github.com/DataDog/docker-dd-agent/#tracing--apm) pour plus d'informations.