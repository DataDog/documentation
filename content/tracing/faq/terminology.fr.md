...
|:----|:-----|:---|
|[Service](/tracing/visualization/service)|Le nom d'un ensemble de processus qui font le même travail. Utilisé pour regrouper les statistiques pour votre application.| Les services sont affichés sur la  [Datadog Services list](/tracing/visualization/services_list/) et on un [ensemble de graphiques de performances par défaut](/tracing/visualization/service/#out-of-the-box-graphs).|
|[Ressource](/tracing/visualization/resource)|Action particulière pour un service|Les Ressources sont affichés sur la [Resources list](/tracing/visualization/services_list/) pour chaque Service  et on un [ensemble de graphiques de performances par défaut](/tracing/visualization/resource/#out-of-the-box-graphs).|
