---
title: Language Log Collection
kind: Documentation
---

After you have [installed the Datadog Agent][1] and [enabled Log collection][2], begin sending logs to your Datadog Agent by instrumenting your application:
