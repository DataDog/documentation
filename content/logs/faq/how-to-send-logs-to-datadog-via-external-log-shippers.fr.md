---
title: Comment envoyer des logs à Datadog via des Log Shippers externes
kind: faq
further_reading:
...
## Transfert des logs d'autres shippers vers l'agent Datadog pour les logs.
...
3. (Optional) Set the files to monitor. Add the following in `/etc/rsyslog.d/datadog.conf`.
    ...
    * **Rsyslog Version >= 8**
    ...
    ```
4. Envoyer des logs à votre plateforme Datadog
