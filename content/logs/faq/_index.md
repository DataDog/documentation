...
{{< whatsnext desc="List of Frequently Asked Questions:" >}}
    ...
    {{< nextlink href="/logs/faq/why-my-logs-do-not-have-the-expected-timestamp" >}}Why my logs do not have the expected timestamp?{{< /nextlink >}}
    ...
    {{< nextlink href="/logs/faq/i-have-a-custom-log-file-with-heightened-read-permissions-how-do-i-send-it-to-datadog" >}}I have a custom log file with heightened read-permissions; how do I send it to Datadog?{{< /nextlink >}}
{{< /whatsnext >}}