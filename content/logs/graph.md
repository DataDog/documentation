...
5. Choose the graph Timesteps.
  Changing the global timeframe changes the list of available Timesteps values.
    ...
    {{< img src="logs/graph/timesteps.png" alt="Timestep" responsive="true" style="width:30%;">}}
...
{{< img src="logs/graph/log_graph_in_dashboard.png" alt="Log graph in dashboard" responsive="true" style="width:90%;">}}
