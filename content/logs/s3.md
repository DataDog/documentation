...
Configure your Datadog account to forward all the logs ingested to your own S3 bucket. This allows you to keep all the logs that you used Datadog to aggregate in long-term storage. This guide shows you how to set this up.
