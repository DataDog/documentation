...
- The Docker integration is enabled by default, as well as autodiscovery in auto config mode ((remove the listeners: -docker section in datadog.yaml to disable it).
