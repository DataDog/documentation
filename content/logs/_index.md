...
The agent supports raw string logs (in any format) and JSON objects. If you are sending logs in batch, we expect to find a new line character between each log.
