...
def insert_example_links(integration: item[:integration_title], conf:  integration.downcase.tr(" ", "_"), check: integration.downcase.tr(" ", "_"), yaml_extension: "example", include_intro: true)
  ...
  yaml_example = conf!="none" ? "<li><a href='https://github.com/DataDog/integrations-core/blob/master/" + conf + "/conf.yaml.example"'> "+ integration + " YAML example</a></li>" : ""
  checks_file =  check!="none" ? "<li><a href='https://github.com/DataDog/integrations-core/blob/master/" + check + "/check.py'>" + integration + " checks.d</a></li>" : ""
