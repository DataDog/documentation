...
Database Monitoring runs as an integration on top of the base Agent ([see benchmarks][100]). <br/><br/>
...
[100]: /database_monitoring/setup_sql_server/#agent-integration-overhead
