...
**Note**: If you want to update the environment variables, you need to update them in the `/etc/default/observability-pipelines-worker` file. Running the one-step command does not update that file.
