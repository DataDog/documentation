- Splunk HEC token:
    - The Splunk HEC token for the Splunk indexer. **Note**: Depending on your OS and shell version, you may want to avoid adding quotes to the environment variable.
