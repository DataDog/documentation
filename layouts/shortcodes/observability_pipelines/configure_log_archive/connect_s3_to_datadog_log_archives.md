...
1. Navigate to Datadog [Log Forwarding][1001].
...
1. Optionally, add tags and define the maximum scan size for rehydration. See [Advanced settings][1002] for more information.
1. Click **Save**.

See the [Log Archives documentation][1003] for additional information.

[1001]: https://app.datadoghq.com/logs/pipelines/log-forwarding
[1002]: /logs/log_configuration/archives/?tab=awss3#advanced-settings
[1003]: /logs/log_configuration/archives