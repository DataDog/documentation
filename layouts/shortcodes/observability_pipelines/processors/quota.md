...
1. Set the **Drop events** dropdown to **True** if you want to drop all events when your quota is met. Leave it at **False** if you plan to set up [a monitor][Datadog monitors link] that sends an alert when the quota is met.