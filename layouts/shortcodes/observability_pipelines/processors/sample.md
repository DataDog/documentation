...
1. Set the **retain** field with your desired sampling rate expressed as a percentage. For example, entering `2` means 2% of logs are retained out of all the logs that match the filter query.
