...
For any attribute, tag, or `key:value` pair that is not a [reserved attribute][401], your query must start with `@`. Conversely, to filter reserved attributes, you do not need to append `@` in front of your filter query.
...
Learn more about writing filter queries in [Datadog's Log Search Syntax][402].

[401]: /logs/log_configuration/attributes_naming_convention/#reserved-attributes
[402]: /logs/explorer/search_syntax/