...
4. Select the type of reference table you want to use, **File** or **GeoIP**.
   - For the **File** type:
        1. Enter the file path. **Note**: The file path must be under the data directory: `/var/lib/observability-pipelines-worker/config/`. For example: `/var/lib/observability-pipelines-worker/config/enrichment/file.csv`
