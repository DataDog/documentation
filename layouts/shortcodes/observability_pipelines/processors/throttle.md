Use this processor to specify a quota for a specific time window, for example, if you only want to send a maximum of 100 logs per second. This can help you catch any spikes in log ingestion and prevent unexpected billing costs.
