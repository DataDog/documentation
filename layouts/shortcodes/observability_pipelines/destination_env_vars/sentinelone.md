...
1. Navigate to the Singularity Data Lake (SDL) "API Keys" page. To access it from the console, click on "Visibility" on the left menu to go to SDL, then click on your username and "API Keys".
