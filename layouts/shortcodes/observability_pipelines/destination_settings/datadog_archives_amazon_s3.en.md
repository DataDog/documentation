...
1. Optionally, select an AWS authentication option. If you are only using the [user or role you created earlier][10054] for authentication, leave the AWS authentication option at **None**. If you select **Assume role**:
