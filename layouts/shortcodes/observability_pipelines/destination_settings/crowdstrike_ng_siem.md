...
1. Optionally, toggle the switch to enable TLS. If you enable TLS, the following certificate and key files are required. **Note**: All file paths must be under the data directory `/var/lib/observability-pipelines-worker/config/`.
