#### Datadog Agent installed in a container
...
#### Datadog Agent installed in Linux, OS X, or Windows

To send Datadog Agent logs to the Observability Pipelines Worker, add the following environment variables to your [Agent configuration file][1031]:

```
observability_pipelines_worker.logs.enabled: true
observability_pipelines_worker.logs.url: <http://localhost:8282>
```
