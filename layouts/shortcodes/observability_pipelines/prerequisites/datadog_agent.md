...
- The Datadog Agent address, including the port. This is the bind address that your Observability Pipelines Worker listens on to receive logs from your Datadog Agents.
