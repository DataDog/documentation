To use Observability Pipelines's Syslog source, your applications must be sending data in one of the following formats: [RFC 6587][9151], [RFC 5424][9152], [RFC 3164][9153]. You also need to have the following information available:
