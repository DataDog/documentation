...
2. If the endpoint requires authentication, the credentials for your chosen authentication strategy (a username and password, a bearer token, or a custom `Authorization` header value).
