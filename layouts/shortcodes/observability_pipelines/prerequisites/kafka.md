...
- The hosts and ports of the Kafka bootstrap servers, which clients should use to connect to the Kafka cluster and discovers all the other hosts in the cluster.
