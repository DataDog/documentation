...
1. In the **DdUrl** field, enter the DNS or IP address of the load balancer for your VM. **Note**: Datadog recommends fronting your Worker with a load balancer.
1. In the **DdPort** field, enter `9997`.
