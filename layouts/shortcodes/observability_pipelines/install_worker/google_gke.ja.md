1. Google GKE 用の [Helm チャート values ファイル][801]をダウンロードします。
...
パイプラインの構成を変更したい場合は、[既存のパイプラインの更新][802]を参照してください。

[801]: /resources/yaml/observability_pipelines/v2/setup/google_gke.yaml
[802]: /ja/observability_pipelines/configuration/update_existing_pipelines