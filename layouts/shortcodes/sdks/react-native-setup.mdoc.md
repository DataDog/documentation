...
4. To disable automatic user data collection for client IP or geolocation data, uncheck the boxes for those settings.
   ...
   ![Create a RUM application for React Native in Datadog](/real_user_monitoring/react_native/reactnative_setup.png)
...
4. To disable automatic user data collection for client IP or geolocation data, uncheck the boxes for those settings.
   ...
   ![Create an application for React Native in Datadog](/real_user_monitoring/error_tracking/mobile-new-application.png)
