...
This is the recommended option as it allows to automatically link test results to [logs][105] and [underlying host metrics][106].
...
_If you use the Datadog Operator, there is no need to download and inject the tracer library since the Admission Controller can do this for you, so you can skip the corresponding step below.
...
**Note**: When using this method, tests will not be correlated with [logs][105] and [infrastructure metrics][106].
