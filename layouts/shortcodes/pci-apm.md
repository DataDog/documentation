...
- All spans sent to the PCI endpoints using HTTPS only. If you are using the Agent, you should enforce HTTPS transport.
...
If you have any questions about how Application Performance Monitoring satisfies the applicable requirements under PCI DSS, contact your account manager. For PCI compliant Log Management, see [here][104].
