### UI activation
You, or a user in your organization with "Intelligent Test Runner Activation" permissions, must activate the Intelligent Test Runner on the [Test Service Settings][101] page.
