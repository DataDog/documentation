...
**Notes**:
   ...
   - Enabling resource collection can also impact your AWS CloudWatch costs. To avoid these charges, disable **Usage** metrics in the **Metric Collection** tab of the [Datadog AWS Integration][100].

  [100]: /integrations/amazon-web-services
