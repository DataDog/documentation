...
To unmask sensitive data, navigate to the [Summary page][101], click on a scanning rule, and then click on a finding. If you have permission to see masked data, that data has an eye icon next to it. Click the eye icon to reveal the data. You can also use the [Log Explorer][102], [Trace Explorer][103], or [RUM Explorer][104] to view masked data.
