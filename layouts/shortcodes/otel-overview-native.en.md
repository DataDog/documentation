...
{{ if $alternative }}This is an alternative to using {{ $alternative }} and means you can write code against the standard OTel interfaces whilst benefiting from all the features of the Datadog SDK.{{ else }}You can write code against the standard OTel interfaces whilst benefiting from all the features of the Datadog SDK.{{ end }}
