...
<div class="alert alert-info">Datadog Agent v7.65+ is required for MySQL schema collection.</div>
...
instances:
  - dbm: true
    ...
    collect_schemas:
      enabled: true
```
**Note**: For Agent v7.68 and lower, use `schemas_collection` instead of `collect_schemas`.
