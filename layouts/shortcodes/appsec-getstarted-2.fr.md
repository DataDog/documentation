...
1.  **Pour tester la détection des menaces Application Security Management, envoyez des patterns d'attaque connus à votre application**. Par exemple, exécutez un fichier contenant le script curl suivant afin de déclencher la règle de [détection de scanner de sécurité][203] :
    <div>
