1. (Optional) In the **Suppress specific match to ignore risk-accepted data** section, you can add conditions to ignore certain matches. See [Suppress specific match types to ignore risk-accepted data](#suppress-specific-matches-to-ignore-risk-accepted-data) for more information<br>To add a suppression:
