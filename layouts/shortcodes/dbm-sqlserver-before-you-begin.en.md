...
RDS Custom
Datadog cannot gaurantee DBM support for all RDS Custom configurations given the ability to make OS level changes. Support will depend on the customizations made not breaking compatibility with DBM. 
