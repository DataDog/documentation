...
title: Análisis de casos y eventos
---
...
{{< img src="events/correlation/case_analytics.png" alt="Configurar análisis de casos" style="width:100%;" >}}
...
Desglosa métricas de eventos por fuente, host, servicio, etc. Averigua de dónde proceden tus alertas problemáticas, y si tu carga operativa aumenta o disminuye con el tiempo.

{{< img src="events/correlation/event_analytics.png" alt="Configurar análisis de eventos" style="width:100%;" >}}
