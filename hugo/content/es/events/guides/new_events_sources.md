| Nombre del tipo de fuente antiguo           | Nombre del tipo de fuente nuevo         |
|--------------------------------|------------------------------|
...
| errortracking                  | seguimiento_de_errores               |
| viewer                         | event_viewer                 |
| GSuite                         | g_suite                      |
...
| GCPAuditLogs                   | logs_auditoría_google_cloud      |
