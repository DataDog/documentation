...
- /es/agent/basic_agent_usage/heroku/
dependencies:
...
### Activación de los perfiles del Dogstatsd Mapper (Sidekiq)

Algunas integraciones, como [Sidekiq](https://docs.datadoghq.com/integrations/sidekiq/), requieren perfiles del [DogStatsD Mapper](https://docs.datadoghq.com/developers/dogstatsd/dogstatsd_mapper/).

Para añadir un nuevo perfil del DogStatsD Mapper, añade el siguiente fragmento en tu script [prerun.sh](#prerun-script):
...
Por ejemplo, para activar la integración de Sidekiq, añade el siguiente fragmento:
