---
aliases:
- /es/data_jobs/kubernetes
description: 'Configurar Observabilidad de datos: Jobs Monitoring para aplicaciones
  de Spark de Apache en clústeres de Kubernetes con el Datadog Agent y el controlador
  de admisión.'
further_reading:
- link: /data_jobs
  tag: Documentación
  text: 'Observabilidad de los datos: Jobs Monitoring'
title: 'Observabilidad de datos: Jobs Monitoring para Spark en Kubernetes'
---

[Observabilidad de datos: Jobs Monitoring][6] proporciona visibilidad del rendimiento y la fiabilidad de las aplicaciones de Spark de Apache en Kubernetes.

## Instalación
<div class="alert alert-info">Observabilidad de datos: Jobs Monitoring requiere <a href="https://github.com/DataDog/datadog-agent/releases" target="_blank">el Datadog Agent versión</a> 7.55.0 o posterior y el <a href="https://github.com/DataDog/dd-trace-java/releases" target="_blank">rastreador de Java</a> versión 1.38.0 o posterior.</div>

Sigue estos steps (UI) / pasos (generic) para activar la Observabilidad de datos: Jobs Monitoring para Spark en Kubernetes.
...
En Datadog, consulte la page (página) [Observabilidad de datos: Jobs Monitoring][5] para ver una lista de todos tus jobs (generic) de procesamiento de datos.
