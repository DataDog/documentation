---
aliases:
- /es/serverless/google_cloud_run/containers/in_process/dotnet
code_lang: dotnet
code_lang_weight: 50
further_reading:
...
title: Instrumentación de un contenedor Cloud Run de .NET dentro del contenedor
...
{{< /code-block >}}
   ...
   {{% tab "Alpine (musl)" %}}
{{< code-block lang="dockerfile" filename="Dockerfile" disable_copy="false" collapsible="true" >}}
# Para alpine usa datadog-dotnet-apm-2.57.0-musl.tar.gz
ARG TRACER_VERSION
