---
disable_toc: false
title: Enriquecimiento de logs para Logstash
---

## Información general

Configura tu Logstash para enviar logs al worker de Observability Pipelines y enriquecer y transformar tus logs antes de enrutarlos a su destino.
