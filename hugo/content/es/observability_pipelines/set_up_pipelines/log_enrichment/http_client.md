---
aliases:
- /es/observability_pipelines/log_enrichment/http_client/
disable_toc: false
title: Enriquecimiento de logs del cliente HTTP
---

## Información general

Utiliza el worker de Observability Pipelines para enriquecer y transformar los logs de tu servidor HTTP antes de dirigirlos a su destino.
