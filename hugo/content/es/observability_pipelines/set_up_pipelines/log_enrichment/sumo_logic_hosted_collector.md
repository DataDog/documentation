---
aliases:
- /es/observability_pipelines/log_enrichment/sumo_logic_hosted_collector/
disable_toc: false
title: Enriquecimiento de logs para la fuente de logs HTTP del recopilador alojado
  en Sumo Logic
---

## Información general

Configura tu fuente de logs HTTP del recopilador alojado en Sumo Logic para enviar logs al worker de Observability Pipelines y enriquecer y transformar tus logs antes de dirigirlos a su destino.
