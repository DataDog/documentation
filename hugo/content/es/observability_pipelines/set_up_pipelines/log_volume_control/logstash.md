---
disable_toc: false
title: Control del volumen de logs para Logstash
---

## Información general

Configura el worker de Observability Pipelines con el origen de Logstash para que sólo enrute logs útiles a tus destinos.
