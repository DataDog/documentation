---
disable_toc: false
title: Control del volumen de logs para Kafka
---

## Información general

Utiliza el worker de Observability Pipelines para dirigir únicamente logs útiles desde tus temas de Kafka a sus destinos.
