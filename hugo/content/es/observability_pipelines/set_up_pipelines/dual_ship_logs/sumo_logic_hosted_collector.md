---
aliases:
- /es/observability_pipelines/dual_ship_logs/sumo_logic_hosted_collector/
disable_toc: false
title: Envío doble de logs para el origen de logs HTTP del recopilador alojado de
  Sumo Logic
---

## Información general

Configura el origen de logs HTTP del recopilador alojado de Sumo Logic para enviar logs al worker de Observability Pipelines, de modo que Observability Pipelines reciba y enrute logs desde el recopilador alojado de Sumo Logic a destinos descendentes.
...
### Recopiladores alojados de Sumo Logic
