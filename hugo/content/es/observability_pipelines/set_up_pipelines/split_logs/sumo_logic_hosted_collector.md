---
aliases:
- /es/observability_pipelines/split_logs/sumo_logic_hosted_collector/
disable_toc: false
title: Dividir logs para el origen de logs HTTP del recopilador alojado de Sumo Logic
---
...
### Recopilador alojado de Sumo Logic con el origen de logs HTTP
