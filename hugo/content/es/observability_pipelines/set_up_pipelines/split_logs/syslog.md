---
aliases:
- /es/observability_pipelines/split_logs/syslog/
disable_toc: false
title: Dividir Logs para Syslog
---

## Información general

Configura Rsyslog o Syslog-ng para enviar logs al worker de Observability Pipelines y luego procesar y enrutarlos a diferentes destinos en función de tu caso de uso.
