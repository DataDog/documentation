---
aliases:
- /es/observability_pipelines/split_logs/splunk_tcp/
disable_toc: false
title: Dividir logs para forwarders Heavy o Universal de Splunk (TCP)
---

## Información general

Configura tus forwarders Heavy o Universal de Splunk para enviar logs al worker de Observability Pipelines y, a continuación, procesarlos y enrutarlos a diferentes destinos en función de tu caso de uso.
...
1. Ingresa la dirección de Splunk TCP. Esta es la dirección y el puerto donde tus aplicaciones envían sus datos de registro. El worker de Observability Pipelines escucha esta dirección en busca de logs entrantes.
