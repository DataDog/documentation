---
disable_toc: false
title: Generar métricas para el Splunk HTTP Event Collector (HEC)
---

## Información general

Configura tus Splunk HTTP Event Collectors (HEC) para enviar logs al worker de Observability Pipelines para que puedas generar métricas a partir de esos logs.
