---
disable_toc: false
title: Generar métricas para forwarders Heavy o Universal de Splunk (TCP)
---

## Información general

Configura tus forwarders Heavy o Universal de Splunk para enviar logs al worker de Observability Pipelines para que puedas generar métricas a partir de estos logs.
...
1. [Conexión del forwarder de Splunk al worker de Observability Pipelines](#connect-splunk-forwarder-to-the-observability-pipelines-worker)

## Requisitos previos

### Forwarders Heavy o Universal de Splunk (TCP)

{{% observability_pipelines/prerequisites/splunk_tcp %}}

### Gestión de logs de Datadog
...
1. Selecciona la plantilla **Generar métricas** para crear un nuevo pipeline.
1. Selecciona **Splunk TCP** como fuente.
...
1. Introduce la dirección Splunk TCP. Esta es la dirección y el puerto donde tus aplicaciones están enviando sus datos de logs. El worker de Observability Pipelines escucha esta dirección para detectar logs entrantes.
