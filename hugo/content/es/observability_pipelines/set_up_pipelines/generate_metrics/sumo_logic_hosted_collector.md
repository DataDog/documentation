---
disable_toc: false
title: Generar métricas para la fuente de logs HTTP del recopilador alojado en Sumo
  Logic
---

## Información general

Configura tu fuente de logs HTTP del recopilador alojado en Sumo Logic para enviar logs al worker de Observability Pipelines y generar métricas a partir de esos logs.
...
### Recopiladores alojados en Sumo Logic
