---
disable_toc: false
title: Generar métricas para Syslog
---

## Información general

Configura rsyslog o syslog-ng para enviar logs al worker de Observability Pipelines para que puedas generar métricas a partir de esos logs.
