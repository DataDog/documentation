---
disable_toc: false
title: Generar métricas para Amazon Data Firehose
---

## Información general

Utiliza el worker de Observability Pipelines para generar métricas a partir de tus logs de Amazon Data Firehose.
