...
Utiliza el destino OpenSearch de Observability Pipelines para enviar logs a OpenSearch.

## Configuración

Configura el destino OpenSearch y sus variables de entorno cuando [configures un pipeline][1]. La siguiente información se configura en la interfaz de usuario del pipeline.
