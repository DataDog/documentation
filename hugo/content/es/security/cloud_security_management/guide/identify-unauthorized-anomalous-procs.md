...
title: Identificación de proceso no autorizados y anómalos
---
...
En Workload Protection, puedes [definir reglas personalizadas][1] para vigilar ejecuciones de procesos en busca de actividad maliciosa en hosts o contenedores en tiempo real. Puedes definir un lista de nombres y/o argumentos de procesos que generarán una señal de seguridad que puede utilizarse para notificar a los usuarios.
