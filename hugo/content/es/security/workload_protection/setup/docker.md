---
aliases:
- /es/security/workload_protection/setup/agent/docker
description: Habilite Workload Protection en Docker con el Datadog Agent.
disable_toc: false
title: Configurando Workload Protection en Docker
---
...
El siguiente comando inicia el Runtime Security Agent y `system-probe` en un entorno de Docker:
