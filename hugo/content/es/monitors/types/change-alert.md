...
description: Crea monitores de alertas de cambio para detectar cambios significativos
  en las métricas a lo largo del tiempo utilizando umbrales de cambio absolutos o
  porcentuales.
disable_toc: false
further_reading:
...
title: Monitor con alertas sobre cambios
---
...
Para crear un [monitor con alertas sobre cambios][9] en Datadog, utiliza la navegación principal: *Monitors --> New Monitor --> Change* (Monitores > Nuevo monitor > Cambio).

## Condiciones de evaluación

Las siguientes son las diferentes opciones que necesitas configurar en un monitor con alertas sobre cambios.

{{< img src="/monitors/monitor_types/change-alert/configure_define_the_metrics.png" alt="Opciones de configuración del método de detección de alertas sobre cambios" style="width:100%;" >}}
...
| -------  | ------------------------------------------------------------------ | -------------------- |
| Cambio   | El cambio absoluto del valor.                                  | `a - b`              |
...
Toma este monitor con alertas sobre cambios con la siguiente configuración. 

{{< img src="monitors/monitor_types/change-alert/example_monitor_config.png" alt="Página de creación de monitores con alertas sobre cambios seleccionada para evaluar el cambio porcentual del promedio de system.load.1 de la métrica durante los últimos 5 minutos, en comparación con los últimos 30 minutos" ="width:100%;" >}}
...
[2]: /es/monitors/status/#investigate-a-monitor-in-a-notebook
