...
- billing_type: tag_count
  ...
  short_description: ストレージ プールの使用済み容量 1 TB あたりの月額
  tag: terrabyte_count
  unit_label: Commvault ストレージ プールの使用済み容量 (TB)
  unit_price: 99.0
public_title: Commvault
short_description: Commvault ログを監視
supported_os:
- linux
- windows
- macos
...
Commvault は、さまざまなクラウド プラットフォームとオンプレミス環境にまたがるデータ管理とバックアップを簡素化します。多様な環境でデータのセキュリティ、コンプライアンス、スケーラビリティ、効率性を確保し、バックアップ、リカバリ、アーカイブの各プロセスを一元的に制御できるようにします。

この Commvault 連携では、クラウド/SaaS とオンプレミスの両方を監視し、可視化します。

Commvault と Datadog の連携は、次のエンドポイントからデータを取得します:
...
---
このアプリケーションは Marketplace から入手でき、Datadog テクノロジーパートナーによってサポートされています。利用するには、<a href="https://app.datadoghq.com/marketplace/app/crest-data-systems-commvault" target="_blank">Marketplace でこのアプリケーションを購入してください</a>。