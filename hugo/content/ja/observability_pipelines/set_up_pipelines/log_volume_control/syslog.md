---
aliases:
- /ja/observability_pipelines/log_volume_control/syslog/
disable_toc: false
title: Syslog 向け Log Volume Control
---

## 概要

rsyslog または syslog-ng ソースで Observability Pipelines Worker を設定し、有用なログだけを宛先にルーティングするようにします。
...
## Syslog 経由で Observability Pipelines Worker にログを送信する
