---
disable_toc: false
title: Socket ソースのログを分割する (TCP または UDP)
---

## 概要

ソケット接続でログを Observability Pipelines Worker に送信し、ユースケースに応じてそのログを処理して異なる送信先にルーティングします。
...
1. 新しいパイプラインを作成するために、**Split Logs** テンプレートを選択します。
