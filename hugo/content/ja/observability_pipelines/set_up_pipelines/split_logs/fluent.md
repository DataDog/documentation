---
aliases:
- /ja/observability_pipelines/split_logs/fluent/
disable_toc: false
title: Fluent のログの分割
---
...
Fluentd と Fluent Bit を構成して、ログを Observability Pipelines Worker に送信し、ユース ケースに応じてそのログを処理して異なる送信先にルーティングします。
...
1. [Observability Pipelines Worker にログを送信する](#send-logs-to-the-observability-pipelines-worker-over-fluent)
...
1. ソースとして **Fluentd** または **Fluent Bit** を選択します。
...
1. Fluent のソケット アドレスとポートを入力します。Observability Pipelines Worker はこのアドレスとポートで受信するログ メッセージを待ち受けます。
