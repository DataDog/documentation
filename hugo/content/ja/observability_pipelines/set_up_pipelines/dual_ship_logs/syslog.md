---
aliases:
- /ja/observability_pipelines/dual_ship_logs/syslog/
disable_toc: false
title: Syslog のログのデュアル シッピング
---

## 概要

rsyslog または syslog-ng を構成し、Observability Pipelines を設定して、Observability Pipelines Worker がアップストリーム ソースから受信するログを集約・処理した上で、Splunk を含むさまざまなアプリケーションにルーティングできるようにします。
