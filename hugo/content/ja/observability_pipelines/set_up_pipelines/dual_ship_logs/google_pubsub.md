---
disable_toc: false
title: Google Pub/Sub のログのデュアル シッピング
---

## 概要

Google Pub/Sub を構成し、Observability Pipelines を設定して、Observability Pipelines Worker がアップストリーム ソースから受信するログを集約・処理した上で、さまざまなアプリケーションにルーティングできるようにします。
