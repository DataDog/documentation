...
| Qless                      | `qless`                    | `>= 0.10.0`              | `>= 0.10.0`               | [リンク][32]                          | [リンク](https://github.com/seomoz/qless)                                      |
...
| 名前      | キー        | 対応バージョン: MRI | 対応バージョン: JRuby | 構成方法    | Gem ソース                                          |
|-----------|------------|-------------------------|---------------------------|---------------------|-----------------------------------------------------|
| Cucumber  | `cucumber` | `>= 3.0`                | `>= 1.7.16`               | [リンク][49]          | [リンク](https://github.com/cucumber/cucumber-ruby)   |
| RSpec     | `rspec`    | `>= 3.0.0`              | `>= 3.0.0`                | [リンク][50]          | [リンク](https://github.com/rspec/rspec)              |
...
[32]: https://docs.datadoghq.com/ja/tracing/trace_collection/dd_libraries/ruby#qless
...
[49]: https://docs.datadoghq.com/ja/tracing/trace_collection/dd_libraries/ruby#cucumber
[50]: https://docs.datadoghq.com/ja/tracing/trace_collection/dd_libraries/ruby#rspec