---
title: CloudFront コンポーネント
---
## 概要

CloudFront コンポーネントを使用して、Amazon Web Services のアーキテクチャから CloudFront を表現します。

{{< img src="cloudcraft/components-aws/cloudfront/component-cloudfront-diagram.png" alt="「CloudFront」AWS コンポーネントを示すアイソメトリックな Cloudcraft ダイアグラムのスクリーンショット。" responsive="true" style="width:60%;">}}
