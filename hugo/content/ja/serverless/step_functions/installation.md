...
<div class="alert alert-danger"> If you are using a different instrumentation method such as Serverless Framework or datadog-ci, enabling autosubscription may create duplicated logs. Choose one configuration method to avoid this behavior.</div>
...
[6]: /ja/logs/guide/forwarder
[7]: /ja/logs/guide/send-aws-services-logs-with-the-datadog-kinesis-firehose-destination
[8]: /ja/serverless/step_functions/enhanced-metrics
[9]: /ja/integrations/amazon_step_functions
[10]: /ja/serverless/aws_lambda/installation