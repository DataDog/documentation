...
また、Datadog は現在プレビュー版として、トレース、カスタムメトリクス、直接ログ収集を可能にする専用 Agent で [Container Apps アプリケーションをインスツルメントする][10]ソリューションも提供しています。
...
また、Datadog は現在プレビュー版として、トレース、カスタムメトリクス、直接ログ収集を可能にする専用 Agent で [Container Run アプリケーションをインスツルメントする][12]ソリューションも提供しています。
