...
{{< img src="account_management/org_settings/nav.png" alt="Datadog の組織設定に移動します" style="width:80%;" >}}
...
[**Safety Center**][14] ページには、組織内で確認すべきセキュリティアラート、警告、推奨事項が含まれます。
...
[**OAuth Apps**][15] ページでは、組織内の OAuth アプリケーションを表示または管理することができます。
