...
{{< skill-callout
    title="agent を使用して RUM をセットアップしてください"
    ...
    lang="text" >}}
https://github.com/datadog-labs/agent-skills/blob/main/dd-orchestrator/SKILL.md のスキルを使用して、Datadog RUM をプロジェクトでセットアップしてください
{{< /skill-callout >}}
