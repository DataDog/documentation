...
{{< whatsnext desc="RUM 全般:" >}}
    ...
    {{< nextlink href="https://docs.datadoghq.com/real_user_monitoring/guide/remotely-configure-rum-using-feature-flags/" >}}LaunchDarkly を使用して RUM をリモート構成する{{< /nextlink >}}
    ...
    {{< nextlink href="real_user_monitoring/guide/debug-symbols" >}}RUM デバッグシンボルを使用して難読化されたスタックトレースを調査する{{< /nextlink >}}
{{< /whatsnext >}}
...
{{< whatsnext desc="Mobile RUM:" >}}
 ...
 {{< nextlink href="real_user_monitoring/guide/proxy-mobile-rum-data" >}}モバイル RUM データをプロキシする{{< /nextlink >}}
