...
- link: https://www.datadoghq.com/blog/how-datadogs-tech-solutions-team-rum-session-replay/
  tag: ブログ
  text: Datadog のテクニカルソリューションチームが RUM、Session Replay、エラー追跡を使用して顧客の問題を解決する方法
...
## Session Replayとは{#what-is-session-replay}

Datadog の*Session Replay*は、ユーザーの Web ブラウジング体験をキャプチャし、視覚的に再生することができます。

Session Replayを RUM パフォーマンスデータと組み合わせることで、エラーの特定、再現、解決に役立ち、Web アプリケーションの使用パターンや設計上の落とし穴を把握することができます。
...
| クライアント側のトレース |  | {{< X >}} |  {{< X >}}|  |  |  |  |  |  |  |
| Session Replay | {{< X >}} | {{< X >}} | {{< X >}} | {{< X >}} | {{< X >}} |  | {{< X >}} |  | **Flutter** のSession Replayは Preview 中です。|
...
## Datadog のSession Replayを見る {#explore-datadog-session-replay}
