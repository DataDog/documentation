...
インフラストラクチャー モニタリングは、多数のインテグレーションを通じて、クラウド ホストおよびオンプレミス サーバーを含む IT 環境全体の可視性を提供します。継続的な可視性を確保するために、Host モニターを使用して、どのホストがデータを送信しているか、または送信していないかを把握します。
...
**Configure notifications and automations** セクションの詳細な手順については、[通知][3] ページを参照してください。
