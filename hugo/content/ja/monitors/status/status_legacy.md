...
* モニターは、データ提供頻度の低いメトリクスに対して完全なウィンドウのデータを必要とするよう設定されています。詳しくは [Advanced Alert Conditions][32] を参照してください。
...
[32]: /ja/monitors/types/metric/?tab=threshold#advanced-alert-conditions