...
{{< img src="/actions/app_builder/app-builder-app.png" alt="App Builder のアプリ" style="width:100%;" >}}
...
{{< img src="/actions/app_builder/app-builder-action-catalog.png" alt="Datadog App Builder は、複数のインテグレーションに対応した数百ものアクションを含むアクションカタログを提供します。" style="width:100%;" >}}
...
{{< img src="/actions/app_builder/app-builder-blueprints-2.png" alt="アプリのブループリント" style="width:100%;" >}}
...
{{< img src="/actions/app_builder/app-builder-embedded-dashboard.png" alt="ダッシュボードに埋め込まれたアプリ" style="width:100%;" >}}
...
{{< img src="/actions/app_builder/ootb-app-ec2-demo-data.png" alt="Datadog によって作成された EC2 アプリにデモデータが表示されている" style="width:100%;" >}}
...
{{< img src="actions/app_builder/app-builder-overview-dashboard.png" alt="App Builder Overview ダッシュボード" style="width:100%;" >}}
