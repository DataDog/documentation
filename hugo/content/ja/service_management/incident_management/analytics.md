...
{{< img src="incident_response/incident_management/analytics_and_reporting/incident_analytics.mp4" alt="Incident Management Analytics" video=true style="width:80%;">}}
...
{{< img src="incident_response/incident_management/incident_analytics_query_example.jpeg" alt="インシデント分析のクエリ例" style="width:80%;">}}
