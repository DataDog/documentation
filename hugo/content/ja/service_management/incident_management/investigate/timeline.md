...
{{< img src="/incident_response/incident_management/investigate/timeline/timeline_tab.png" alt="Timeline タブを表示しているインシデントの例" style="width:100%;" >}}
...
既存セルに画像を追加することも可能です:
{{< img src="/incident_response/incident_management/investigate/timeline/timeline_cell_add_image.png" alt="画像の説明" style="width:100%;" >}}
