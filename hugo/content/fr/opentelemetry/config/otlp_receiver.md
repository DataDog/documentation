---
aliases:
- /fr/opentelemetry/collector_exporter/otlp_receiver
further_reading:
...
- link: /opentelemetry/otlp_ingest_in_the_agent/
  tag: Documentation
  text: Ingestion OTLP par le Datadog Agent
- link: https://www.datadoghq.com/architecture/datadog-agent-otlp-receiver-in-kubernetes/
  tag: Architecture Center
  text: Récepteur OTLP de Datadog Agent dans Kubernetes
title: Récepteur OTLP
---
## Présentation {#overview}

Pour collecter des métriques, des logs et des traces OTLP, configurez le [récepteur OTLP][1] dans votre Collector.

Pour plus d'informations, consultez la documentation du projet OpenTelemetry concernant le [récepteur OTLP][1].

## Configuration {#setup}

Ajoutez les lignes suivantes à la configuration de votre Collector :
...
## Exemple complet de configuration {#full-example-configuration}

Pour un exemple complet de configuration fonctionnelle avec l'exportateur Datadog, consultez [`otlp.yaml`][2].

## Exemple de sortie de logs {#example-logging-output}
