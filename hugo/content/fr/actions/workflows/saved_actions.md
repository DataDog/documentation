...
{{< img src="actions/workflows/saved_actions/save_action_1.mp4" alt="Cliquez sur l'icône Saved Action pour enregistrer une action pour l'utiliser plus tard." video="true" width=80% >}}
...
{{< img src="actions/workflows/saved_actions/edit_saved_action.png" alt="Prévisualiser, modifier ou supprimer une action enregistrée depuis le catalogue des actions." style="width:80%;" >}}
