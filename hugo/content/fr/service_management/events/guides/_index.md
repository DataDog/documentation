...
{{< whatsnext desc="Assurez-vous que vos événements portent un tag :">}}
    {{< nextlink href="/events/guides/recommended_event_tags/" >}}Recommandations pour l'ajout de tags à des événements{{< /nextlink >}}
{{< /whatsnext >}}

{{< whatsnext desc="En savoir plus sur les scénarios d'utilisation d'Event Management :">}}
    {{< nextlink href="/events/guides/usage" >}}Scénarios d'utilisation pour les événements{{< /nextlink >}}
{{< /whatsnext >}}
