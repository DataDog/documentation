...
1. Sur le site Datadog, passez votre curseur sur l'option **Digital Experience** dans le menu de gauche et sélectionnez **[Tests][2]** (sous **Synthetic Monitoring & Testing**).
...
Vous pouvez non seulement planifier l'exécution de votre test Synthetic, mais également le déclencher manuellement, ou directement depuis vos [pipelines CI/CD][5].
...
Lorsque vous êtes prêt à enregistrer votre configuration de test et votre monitor, cliquez sur **Save & Edit Recording**.

Pour en savoir plus, consultez la section [Utiliser les monitors de test Synthetic][8].

## Créer un enregistrement

Une fois la configuration de votre test enregistrée, Datadog vous invite à télécharger et à installer l'extension Chrome [Datadog test recorder][9]. 
...
Le site donné en exemple renvoie régulièrement une erreur afin de faire échouer le test. Si vous ajoutez votre adresse e-mail dans le champ **Configure the monitor for this test**, vous recevez une notification par e-mail lors de l'échec et du rétablissement du test.
...
Pour identifier la cause de l'[échec d'un test][10], sélectionnez un résultat d'échec et examinez les captures d'écran jusqu'à l'étape ayant provoqué l'échec. Vous pouvez également examiner les **[erreurs et avertissements][11]** potentiels, les **[ressources][12]** et les **[signaux Web essentiels][13]** pour diagnostiquer le problème. 
...
Utilisez l'[intégration de la solution APM Datadog à la surveillance Synthetic][14] pour afficher les traces générées à partir de votre backend par les exécutions de test dans l'onglet **Traces**.
...
[10]: /fr/synthetics/browser_tests/test_results#test-failure
[11]: /fr/synthetics/browser_tests/test_results#errors
[12]: /fr/synthetics/browser_tests/test_results#resources
[13]: /fr/synthetics/browser_tests/test_results#page-performance
