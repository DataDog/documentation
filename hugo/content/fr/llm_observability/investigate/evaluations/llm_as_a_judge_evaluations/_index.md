---
aliases:
- /fr/llm_observability/evaluations/custom_llm_as_a_judge_evaluations/
- /fr/llm_observability/configure/evaluations/llm_as_a_judge_evaluations/
...
<div class="alert alert-info">Si vous avez déjà un <code>LLMJudge</code> défini dans le SDK, vous pouvez le publier directement sur Datadog sans reconstruire la configuration dans l'interface utilisateur. Consultez <a href="/llm_observability/investigate/evaluations/evaluation_developer_guide/#publishing-an-llmjudge-as-a-datadog-managed-evaluation">Publier un LLMJudge en tant qu'évaluation gérée par Datadog</a>.</div>
...
4. Configurez {{< ui >}}Assessment Criteria{{< /ui >}}.
   Cette flexibilité vous permet d'aligner les résultats de l'évaluation sur les critères de qualité de votre équipe. Le mapping pass/fail alimente également l'automatisation dans Datadog Agent Observability, permettant aux monitors et dashboards de signaler les régressions ou de suivre la santé globale.
...
2. Fournissez une fonction JavaScript pour identifier l'évaluation, la valeur et le raisonnement de l'évaluateur. Le post-traitement vous permet de mener une évaluation plus complexe que la simple utilisation d'une sortie structurée Boolean, Score ou Categorical.
    ...
    La fonction de post-traitement doit renvoyer un objet contenant une **évaluation** avec la valeur « pass » ou « fail » et, éventuellement, des chaînes de valeur ou de raisonnement. La fonction doit renvoyer un objet json au format suivant :
    ```
    {
        assessment: "pass", // "pass" | "fail" [REQUIRED],
        value: "evaluation_label" // string [OPTIONAL],
...
[2]: /fr/llm_observability/investigate/evaluations/llm_as_a_judge_evaluations/connect_to_account
[3]: /fr/events/explorer/facets/
[4]: /fr/monitors/
[5]: https://arxiv.org/abs/2504.00050
[6]: /fr/llm_observability/investigate/evaluations/compatibility
[7]: /fr/llm_observability/investigate/evaluations/llm_as_a_judge_evaluations/template_evaluations/
[8]: /fr/llm_observability/improve/experiments
[9]: /fr/llm_observability/investigate/evaluations/evaluation_developer_guide/#using-managed-evaluators
...
[15]: /fr/llm_observability/investigate/evaluations/llm_as_a_judge_evaluations/prompt_templating
[16]: /fr/llm_observability/investigate/evaluations/llm_as_a_judge_evaluations/trace_level_evaluations
[17]: /fr/llm_observability/investigate/evaluations/llm_as_a_judge_evaluations/session_level_evaluations
