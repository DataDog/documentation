...
| [Strands Agents](#strands-agents)               | >= 1.11.0          | n'importe quelle            |
...
Pour [la configuration en ligne de commande](/llm_observability/instrumentation/sdk/?tab=nodejs#command-line-setup), utilisez l'option suivante :
...
{{% tab "Node.js" %}}
L'[intégration d'Anthropic][1] fournit un traçage automatique pour les appels de messages de chat de l'[SDK Node.js d'Anthropic][2] .
...
**Remarque :** Le [SDK Python de Google GenAI][1] succède au SDK Google GenerativeAI et expose à la fois l'API développeur Gemini et Vertex.
...
**Remarque :** Le [SDK Node.js de Google GenAI][1] succède au [SDK Google GenerativeAI][6] et expose à la fois l'API développeur Gemini et Vertex.
...
{{< tabs >}}
{{% tab "Python" %}}
L'intégration [LangChain][1] fournit un traçage automatique pour le [SDK Python de LangChain][2], le modèle LLM, et les appels de chaîne.
...
{{% tab "Node.js" %}}
L'[intégration LangChain][1] fournit un traçage automatique pour le [SDK LLM de LangChain Node.js][2], le modèle de chat, la chaîne et les appels d'embeddings OpenAI.
...
{{< tabs >}}
{{% tab "Python" %}}
L'[intégration OpenAI][1] fournit un traçage automatique pour les points de terminaison de complétions et de complétions de chat du [SDK Python OpenAI][2] vers OpenAI et Azure OpenAI.
...
{{% tab "Node.js" %}}
L'[intégration OpenAI][1] fournit un traçage automatique pour les points de terminaison de [complétion, de chat et d'embeddings du SDK Node.js OpenAI][2] vers OpenAI et [Azure OpenAI][3].
...
- [Génération de contenu][3] (y compris les appels en streaming) :
...
{{< tabs >}}
{{% tab "Python" %}}
1. Utilisez la [configuration du SDK en code][1] et désactivez toutes les intégrations avec `integrations_enabled=False`.
...
{{% tab "Node.js" %}}
1. Utilisez la [configuration du SDK en code][1] et désactivez toutes les intégrations avec `plugins: false`.
...
: Une chaîne de noms d'intégration séparés par des virgules qui sont automatiquement désactivés lors de l'initialisation du tracer.<br>
**Exemple** : `DD_TRACE_DISABLED_PLUGINS=openai,http`

`DD_TRACE_DISABLED_INSTRUMENTATIONS`
: Une chaîne de noms de bibliothèques séparés par des virgules qui ne sont pas patchées lors de l'initialisation du tracer.<br>
