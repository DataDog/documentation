...
aliases:
- /fr/agent/versions
description: Aperçu des principales différences entre les versions majeures de l'Agent
  Datadog, y compris les améliorations de performance, les nouvelles fonctionnalités
  et les recommandations de mise à niveau.
further_reading:
...
L'Agent v7 est la dernière version majeure de l'Agent Datadog. La principale différence avec la v6 réside dans le fait que **cette version prend uniquement en charge Python 3 pour les intégrations et les checks custom**.
