...
그룹이 많은 monitor의 경우, 동적 그룹 보존이 기본적으로 활성화됩니다. Datadog은 데이터 보고를 중단한 그룹의 보존 기간을 자동으로 단축합니다. 그룹이 자주 생성되고 사라질수록 보존 기간이 짧아져, monitor의 속도와 효율성이 유지됩니다. 이 동작은 데이터 보고를 중단한 그룹에만 영향을 미치며, 활발하게 보고 중인 그룹은 절대 제거되지 않습니다.
...
">Cloud Metric Delay</a> 페이지를 참조하십시오.</div>
