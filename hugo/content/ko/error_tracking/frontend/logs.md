---
aliases:
- /ko/error_tracking/standalone_frontend/logs
...
아직 Datadog Browser Logs SDK를 설정하지 않은 경우 [앱 내 설정 지침][1]을 따르거나 [Browser Logs 설정 설명서][2]를 참고하세요.
...
아직 Datadog Android Logs SDK를 설정하지 않은 경우 [앱 내 설정 지침][1]을 따르거나 [Android Logs 설정 설명서][2]를 참고하세요.
...
아직 Datadog iOS Logs SDK를 설정하지 않은 경우 [앱 내 설정 지침][1]을 따르거나 [iOS Logs 설정 설명서][2]를 참고하세요.
...
아직 Datadog Kotlin Multiplatform Logs SDK를 설정하지 않은 경우 [앱 내 설정 지침][1]을 따르거나 [Kotlin Multiplatform Logs 설정 설명서][2]를 참고하세요.

1. [Datadog Kotlin Multiplatform SDK for Logs][3]의 최신 버전을 다운로드하세요.
2. [SDK 초기화][2] 시 애플리케이션의 `version`, `env`, `service`를 구성하세요.
3. 탐지된 예외를 직접 로깅하려면 옵션으로 다음을 사용할 수도 있습니다.
...
[1]: https://app.datadoghq.com/logs/onboarding/client
[2]: /ko/logs/log_collection/kotlin_multiplatform/#setup
