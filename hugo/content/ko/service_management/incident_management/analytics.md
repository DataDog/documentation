...
{{< img src="incident_response/incident_management/analytics_and_reporting/incident_analytics.mp4" alt="인시던트 관리 분석" video=true style="width:80%;">}}
...
{{< img src="incident_response/incident_management/incident_analytics_query_example.jpeg" alt="인시던트 분석 쿼리 예시" style="width:80%;">}}
