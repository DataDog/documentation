...
{{< img src="service_level_objectives/error_budget/slo-error-budget-alert-v2.png" alt="오류 예산 알림 설정">}}
...
{{< img src="service_level_objectives/error_budget/slo_create_set_alert.png" alt="SLO 생성 및 오류 예산 알림 설정" style="width:80%;">}}
