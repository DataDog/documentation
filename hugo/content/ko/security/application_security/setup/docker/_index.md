...
- link: /security/application_security/
  tag: 설명서
  text: Datadog App and API Protection을 사용하여 위협으로부터 보호합니다.
...
title: Docker에서 App and API Protection (AAP)를 설정하십시오.
---
...
컨테이너화된 서비스의 프로그래밍 언어를 선택하여 Docker 컨테이너에서 App and API Protection (AAP)를 설정하는 방법을 알아보십시오.
