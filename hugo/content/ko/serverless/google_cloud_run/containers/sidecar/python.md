...
title: 사이드카를 사용하여 Python Cloud Run 컨테이너를 계측하기
type: multi-code-lang
---
<div class="alert alert-info">샘플 애플리케이션은 <a href="https://github.com/DataDog/serverless-gcp-sample-apps/tree/main/cloud-run/sidecar/python">GitHub에서 확인할 수 있습니다</a>.</div>
...
3. **로그를 설정합니다.**
   ...
   - `ENV PYTHONUNBUFFERED=1`: 메인 컨테이너에서. Python 출력이 버퍼링되지 않고 컨테이너 로그에 즉시 표시되도록 합니다.
   - `ENV DD_LOGS_INJECTION=true`: 메인 컨테이너에서. 지원되는 로거에 대하여 로그/트레이스 상관관계를 활성화합니다.
