...
<div class="alert alert-danger">이 기능은 베타 버전입니다. 표준 지원 채널을 통해 피드백을 제공할 수 있습니다. 베타 기간 동안에는 직접 비용 없이 컨테이너 앱 모니터링 및 APM 추적을 사용할 수 있습니다. 기존 APM 고객은 스팬 수집 및 볼륨 비용이 증가할 수 있습니다.</div>
