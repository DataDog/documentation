...
For MySQL self-hosted outside AWS (on-premises or in another cloud), this AWS-side example does not apply. Follow the manual setup in the per-database setup pages from [{{< prodname >}}Database Monitoring{{< /prodname >}}][2].
