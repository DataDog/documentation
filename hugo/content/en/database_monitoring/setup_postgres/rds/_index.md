...
{{< tabs >}}
{{% tab "Host" %}}
To configure collecting {{< prodname >}}Database Monitoring{{< /prodname >}} metrics for an Agent running on a host, for example when you provision a small EC2 instance for the Agent to collect from an RDS database:
