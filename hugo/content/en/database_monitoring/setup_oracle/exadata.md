...
{{< prodname >}}Database Monitoring{{< /prodname >}} supports custom queries for Oracle databases. See the [conf.yaml.example][5] to learn more about the configuration options available.
