...
Complete the following steps to enable {{< prodname >}}Database Monitoring{{< /prodname >}} with your Oracle database:
...
{{< prodname >}}Database Monitoring{{< /prodname >}} supports custom queries for Oracle databases. See the [conf.yaml.example][9] to learn more about the configuration options available.
