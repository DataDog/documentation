...
Agentless delivery changes only the flag configuration source. Python sends experiment exposure events and aggregated Event Platform Proxy (EVP) flag evaluation events through a supported local relay.
