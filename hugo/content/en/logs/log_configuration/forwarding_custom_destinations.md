...
7. Enter a name for the destination.
8. Authentication for the Microsoft Sentinel Forwarder requires an app registration configured through the Datadog Azure integration. If you already have an app registration for the Azure integration, you can reuse it instead of creating a new one.
