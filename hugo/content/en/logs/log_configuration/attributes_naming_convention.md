...
| [Syslog and log shippers][25]    | These attributes are related to the data added by a syslog or a log-shipper agent. All fields and metrics are prefixed by `syslog`. Integrations that rely on these include [Rsyslog][26], [NxLog][27], [Syslog-ng][28], [Fluentd][29], and [Logstash][30].                                                                                                                                                                                                                                              |
| [DNS][31]                        | All attributes and measures are prefixed by `dns`.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [Events][32]                     | All attributes are prefixed by `evt`.                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
