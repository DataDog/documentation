...
`message` is a key attribute in Datadog. Its value is displayed in the {{< ui >}}Content{{< /ui >}} column of the Log Explorer to provide context on the log. You can use the search bar to find a log by the log message.
