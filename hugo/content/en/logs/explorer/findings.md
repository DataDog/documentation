...
{{< img src="logs/explorer/findings/add_finding_log_message.png" alt="The add a finding button in the Log Message section of the log side panel" style="width:80%;" >}}
