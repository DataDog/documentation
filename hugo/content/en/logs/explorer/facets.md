...
**Note**: Once a facet is created, its content is populated **for all new logs**. For an optimal usage of the {{< prodname >}}Log Management{{< /prodname >}} solution, Datadog recommends using at most 1000 facets.
...
<div class="alert alert-warning">Deleting a facet that is being used in indexes, monitors, dashboards, restriction queries, or by other teams can cause configurations to break.</div>
