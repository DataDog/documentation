...
Creating an IDP is a critical part of [Platform Engineering][7] best practices. Datadog's {{< prodname >}}Internal Developer Portal{{< /prodname >}} (IDP) is a fully managed solution that unifies live telemetry, metadata, and self-service workflows to standardize and accelerate software delivery and optimize developer experience. 
...
[8]: /account_management/teams/manage/#team-hierarchies
