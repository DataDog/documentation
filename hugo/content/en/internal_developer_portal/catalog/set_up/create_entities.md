...
aliases:
  ...
  - /internal_developer_portal/software_catalog/set_up/create_entities
further_reading:
  ...
  - link: "/api/latest/software-catalog/"
    tag: "API"
    text: "Learn about the Catalog API"
---
...
1. Navigate to the [Catalog Setup & Config][3] page.
...
To validate your service definitions ingested by Datadog's GitHub integration, you can view events when services are updated or when there is an error. To view validation errors in [{{< prodname >}}Event Management{{< /prodname >}}][12], filter by `source:software_catalog` and `status:error`. Adjust the timeframe as needed.
