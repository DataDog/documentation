...
aliases:
    ...
    - /internal_developer_portal/software_catalog/endpoints/explore_endpoints
---
...
- **Ownership tracking**: View team ownership in the **TEAM** column. This information is inherited from the associated API definition in the [Catalog][2]. The API owner owns all of the endpoints connected to the API.
