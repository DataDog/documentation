...
To configure the SDK, set the following environment variables before starting the test process. For parallel test runners, set them on the parent process so every worker inherits them.
