...
{{< whatsnext desc="This section includes the following topics:" >}}
    ...
    {{< nextlink href="/cloud_cost_management/cost_changes/monitors" >}}<u>Monitors</u>: Create custom alerts when costs exceed thresholds or change unexpectedly, including real-time AI anomaly monitors that alert within 15 minutes. Define specific conditions, filter by provider or tags, and integrate with notification channels like email, Slack, or PagerDuty.{{< /nextlink >}}
