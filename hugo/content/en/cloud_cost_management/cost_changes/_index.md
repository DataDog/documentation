...
{{< whatsnext desc="This section includes the following topics:" >}}
    {{< nextlink href="/cloud_cost_management/cost_changes/anomalies" >}}<u>Anomalies</u>: Automatically detect unusual cost patterns using machine learning. Get insights into what's driving changes and share context with teams for faster resolution.{{< /nextlink >}}
