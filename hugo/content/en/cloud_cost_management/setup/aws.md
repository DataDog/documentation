...
<div class="alert alert-caution">The AWS Cost and Usage Reports endpoint is used to validate the above fields against the CUR export in your S3 bucket. This endpoint is not FIPS validated.</div>
{{< /site-region >}}
