...
{{< img src="cloud_cost/tag_explorer/filters_1.png" alt="The filter bar on the Tags tab, with Provider, Month, Cost Type, and Allocations Enabled controls next to the tag search field" style="width:100%;" >}}
