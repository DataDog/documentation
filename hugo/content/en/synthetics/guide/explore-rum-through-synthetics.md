...
The step details side panel appears with `This Synthetic test generated data in Real User Monitoring` and includes the session ID and the {{< ui >}}Go to the View in RUM{{< /ui >}} button. 

{{< img src="synthetics/guide/rum_in_synthetics/generated_rum_data.png" alt="Synthetics Explorer" style="width:80%;" >}}

To see this test step's errors, resources, and performance data in the [RUM Explorer][3], click {{< ui >}}Go to the View in RUM{{< /ui >}}. Alternatively, click the {{< ui >}}Replay Session{{< /ui >}} button or {{< ui >}}View all sessions in RUM{{< /ui >}} to explore available session replays captured in your browser test.
...
The session panel appears with `This event was generated by a Synthetic test run` and includes the test ID and the {{< ui >}}View Synthetic Test Result{{< /ui >}} button.
