...
{{< img src="synthetics/guide/rum_in_synthetics/synthetic_test_generated_rum_data.png" alt="Test Step Details Side Panel" style="width:100%;" >}}

The step details side panel appears with `This Synthetic test generated data in Real User Monitoring` and includes the session ID and the {{< ui >}}View session in RUM{{< /ui >}} button. 

{{< img src="synthetics/guide/rum_in_synthetics/view_session_in_rum.png" alt="View session in RUM" style="width:80%;" >}}
...
In the RUM Explorer, navigate to your [list of sessions][8] and click on a session with a replay available. The session panel appears with `This event was generated by a Synthetic test run` and includes the test ID and the {{< ui >}}View Synthetic Test Result{{< /ui >}} button.

{{< img src="synthetics/guide/rum_in_synthetics/generated_by_synthetic_view_synthetic.png" alt="Sessions Details Side Panel" style="width:100%;" >}}

To navigate back to Synthetic Monitoring and your test's results, click {{< ui >}}View Synthetic Test Result{{< /ui >}}.
