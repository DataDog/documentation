...
In the [RUM Explorer][3], you can see this test run's errors, resources, and performance data. Click {{< ui >}}Replay Session{{< /ui >}} to explore available session replays captured in your browser test.
...
{{< img src="synthetics/guide/rum_in_synthetics/generated_by_synthetic_view_synthetic.png" alt="Session panel showing this event was generated by a Synthetic test run." style="width:100%;" >}}
