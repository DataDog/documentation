...
{{< img src="synthetics/guide/synthetics_test_retries/synthetics_scheduled_fast_retries.png" alt="Test Runs tab showing scheduled Synthetic test runs, with a Scheduled (fast retry) run highlighted." style="width:100%;">}}
