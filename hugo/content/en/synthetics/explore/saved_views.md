...
Saved views allow you to save the state of the {{< ui >}}Search and Manage{{< /ui >}} [Synthetic Tests page][1]. They enable effective troubleshooting by providing you with quick access to scoped queries, relevant facets, [test coverage widgets][3], and the time range. 
