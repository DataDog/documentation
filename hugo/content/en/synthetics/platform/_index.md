...
Explore the [{{< ui >}}Test Coverage{{< /ui >}}][4] page to gain insights into the overall testing coverage of your RUM applications.
...
## Connect Synthetic Monitoring and RUM

[Connect RUM][6] to view RUM data, Session Replay, and Error Tracking generated by your Synthetic browser test runs.

{{< img src="synthetics/guide/rum_in_synthetics/view_session_in_rum_2.png" alt="A RUM session generated by a Synthetic browser test run, showing errors, actions, and views loaded." style="width:100%;" >}}
