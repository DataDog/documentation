...
To link browser test results, allow the URLs you want the APM integration headers added to. You can do this in [{{< ui >}}Synthetic Settings{{< /ui >}}][5]. Use `*` for wildcards:
