...
You may create a test using one of the following options:
  ...
  - **Build a test from scratch**:
    ...
    1. To build a test from scratch, click the {{< ui >}}+ Start from scratch{{< /ui >}} template, then select the `UDP` request type.
    1. Specify the {{< ui >}}Host{{< /ui >}} and {{< ui >}}Port{{< /ui >}} to run your test on.
    ...
    1. {{< ui >}}Name{{< /ui >}} your UDP test.
    1. Add Environment {{< ui >}}Tags{{< /ui >}} as well as any other tag to your UDP test. You can then use these tags to filter through your Synthetic tests on the [{{< ui >}}Synthetic Monitoring & Continuous Testing{{< /ui >}} page][3].
    1. Click {{< ui >}}Test Host{{< /ui >}} to try out the request configuration. A response preview is displayed on the right side of your screen. <br /><br>
       ...
       {{< img src="synthetics/api_tests/udp_test_config_2.png" alt="Define UDP request" style="width:90%;" >}}
...
Select the response preview directly or click {{< ui >}}New Assertion{{< /ui >}} to create an assertion. You can create up to 20 assertions per UDP test.
...
Select the {{< ui >}}Locations{{< /ui >}} to run your UDP test from. UDP tests can run from both managed and [private locations][1] depending on your preference for running the test from outside or inside your network.
...
- {{< ui >}}On a schedule{{< /ui >}} to ensure your most important services are always accessible to your users. Select the frequency at which you want Datadog to run your UDP test.
...
You can use the [global variables defined on the {{< ui >}}Settings{{< /ui >}} page][7] in the URL and assertions of your UDP tests.
