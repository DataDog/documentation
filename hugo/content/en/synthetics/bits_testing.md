...
Bits Testing and Goal-Based tests currently only run from the [locations listed above](#run-bits-testing). Browser, HTTP and Network path tests generated by Bits Testing don't have this restriction: after they're created, they support the same locations as any other Synthetic test, including [Private Locations][5].
