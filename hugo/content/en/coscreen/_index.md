...
If you were invited to a CoScreen, click on the link. You can click on {{< ui >}}Join from browser{{< /ui >}} to join the CoScreen through the web app, or you can launch the desktop app. You can also join manually by entering your meeting link or ID.

When you join a CoScreen, it is added to your list of {{< ui >}}Recent CoScreens{{< /ui >}} in the main menu. You can rejoin these at any time.

To enable noise reduction in the desktop app, go to {{< ui >}}Settings{{< /ui >}} > {{< ui >}}Audio{{< /ui >}} and select {{< ui >}}Apply noise reduction to my microphone{{< /ui >}}.

On macOS, you can enable background blurring under {{< ui >}}Settings{{< /ui >}} > {{< ui >}}Camera{{< /ui >}} > {{< ui >}}Video Effects{{< /ui >}}.

### Invite your collaborators

Invite collaborators by sharing the link.

You can also add your closest collaborators to the list of {{< ui >}}Your Collaborators{{< /ui >}} in the main menu. After a collaborator accepts your request, you can see if they are online and available and call them with a click.
...
Click on the {{< ui >}}Share windows{{< /ui >}} button to open the window sharing dialog.
...
If you have multiple displays, you can select a display and click {{< ui >}}Share the entire display{{< /ui >}} to share all open windows on that display. While screen sharing is enabled, all windows that you open or drag onto your shared display are also shared.
...
You can see the mouse pointers of remote participants whenever they move their pointers over a shared window. When viewing a remote window, two tabs appear: {{< ui >}}Control{{< /ui >}}, which enables you to interact with the window, click on buttons, and type into text fields; and {{< ui >}}Draw{{< /ui >}}, which enables you to draw on the window.
...
To start a shared terminal, click on the {{< ui >}}Share terminal{{< /ui >}} button in the meeting menu:
...
To stop sharing, click the {{< ui >}}Unshare{{< /ui >}} tab on the terminal window, or on the button in the meeting menu. 
...
To install the CoScreen Slack app, go to [coscreen.co/slack][4] and click on {{< ui >}}Add to Slack{{< /ui >}}. To enable CoScreen in private channels, type `@coscreen` and hit enter/return, then click on {{< ui >}}Invite to Channel{{< /ui >}}. To enable CoScreen in multi-user DMs, go to {{< ui >}}View Member List{{< /ui >}} -> {{< ui >}}Add People{{< /ui >}} -> {{< ui >}}CoScreen{{< /ui >}}.

#### CoScreen + Google Calendar

To configure this integration, install the [CoScreen Chrome extension][5] and sign in. Open any Google Calendar event and use the {{< ui >}}Add CoScreen{{< /ui >}} button to make the event a CoScreen meeting.

#### CoScreen + Datadog Incident Management

In [Incident Management][9], use the {{< ui >}}Meet on CoScreen{{< /ui >}} button to start a CoScreen meeting with incident responders. To configure this, go to your [Incident Management Integration Settings][10] page and toggle on {{< ui >}}Enable click-to-join CoScreen meeting buttons{{< /ui >}}.
