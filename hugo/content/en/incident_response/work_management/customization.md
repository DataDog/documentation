...
Datadog provides five [built-in work item types][1], each designed for common workflows. To customize Work Management for your team's needs, you can define your own custom work item types. This allows you to:
...
### Enable a custom work item type

After you create a custom work item type, you must explicitly assign it to each project where it should be available. Follow the steps below to enable your new work item type within a specific Work Management project.
...
Custom attributes allow you to capture the structured data your team needs to work efficiently and report effectively. All work item types, whether Datadog-provided or custom, include five reserved attributes that cannot be removed or modified:
