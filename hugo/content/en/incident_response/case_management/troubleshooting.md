...
This guide is intended to help you resolve issues with third-party integrations in {{< prodname >}}Case Management{{< /prodname >}}. If you continue to have trouble, reach out to [Datadog support][1] for further assistance.
...
1. If you move a case that is being synced with a Jira issue to a different {{< prodname >}}Case Management{{< /prodname >}} project, the syncing stops. After it is moved, the case in the new project does not have a Jira issue attached to it. 
...
1. Updates to comments, including deletions, in either {{< prodname >}}Case Management{{< /prodname >}} or Jira are not reflected on the other side. 
...
1. If the reporter on the mirrored Jira issue is updated, it is not reflected in {{< prodname >}}Case Management{{< /prodname >}}, as the "created by" field is not editable. 
