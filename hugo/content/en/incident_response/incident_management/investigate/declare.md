...
{{< img src="incident_response/incident_management/investigate/declare/declare_monitor.png" alt="Actions dropdown menu on monitors where you can select the Declare incident option" style="width:50%;" >}}
...
{{< img src="incident_response/incident_management/from-a-graph.png" alt="Create in incident from a graph" style="width:80%;">}}
...
{{< img src="incident_response/incident_management/investigate/declare/synthetics_declare_incident.png" alt="Declare an incident from a Synthetic test." style="width:90%;" >}}
...
{{< img src="incident_response/incident_management/investigate/declare/declare_clipboard.png" alt="Declare an incident from the Datadog Clipboard" style="width:90%;" >}}
...
{{< img src="incident_response/incident_management/from-slack.png" alt="Create in incident from Slack" style="width:60%;">}}
...
{{< img src="/incident_response/incident_management/investigate/declare/handoff_notification_card.png" alt="Handoff notification card showing incident details with options to view, acknowledge, and take actions" style="width:100%;" >}}
...
[3]: /security/workload_protection/investigate_and_triage/security_signals/actions/#declare-an-incident
[4]:/security/workload_protection/investigate_and_triage/security_signals/actions/#declare-an-incident
