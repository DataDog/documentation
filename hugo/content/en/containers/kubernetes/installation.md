...
Use the [Container Images][18] page for insights into every image used in your environment. This page also displays vulnerabilities found in your container images from [{{< prodname >}}Cloud Security{{< /prodname >}}][19]. For information on how to use the Container Images page, see the [Containers Images View][20].
