...
To send Kubernetes resources and infrastructure metrics to Datadog with OpenTelemetry instead of the Datadog Agent, see [Monitor Kubernetes with OpenTelemetry][10].
