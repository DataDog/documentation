...
## View versions
From a notebook, click the {{< ui >}}Configure{{< /ui >}} icon and click {{< ui >}}Version History{{< /ui >}} to open the Version History side panel. If there are no edits within the retention period, the Version History option is disabled.
...
## Clone a version
If you do not want to change your current notebook but you'd like to create a copy of a previous version, you can create a clone from any version in your version history. From the Version History side panel after you choose the version you want to make a copy of, click the kebab menu to the right of a user profile and select {{< ui >}}Clone{{< /ui >}}.
