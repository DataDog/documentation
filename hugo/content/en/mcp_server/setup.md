...
- `code-exec`: Tools for discovering Datadog API operations and running agent-authored JavaScript in a Datadog-managed sandbox to combine queries and correlate data across products
