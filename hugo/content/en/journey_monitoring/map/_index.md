...
<div class="alert alert-caution"><p>Only frontend applications that are instrumented with RUM without Limits, Synthetic Monitoring & Testing, or Product Analytics are eligible for Journey Monitoring.</p></div>
