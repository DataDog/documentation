...
3. Click the {{< ui >}}Account{{< /ui >}} icon and select {{< ui >}}User settings{{< /ui >}}.
4. Click {{< ui >}}Manage MFA{{< /ui >}}. The 2FA barcode is displayed.
5. Open the authenticator app on your phone and scan the barcode.
6. Enter the six digit verification code generated by your authenticator app, then click {{< ui >}}Verify{{< /ui >}}.
...
2. Click the {{< ui >}}Account{{< /ui >}} icon and select {{< ui >}}User settings{{< /ui >}}.
3. Click {{< ui >}}Manage MFA{{< /ui >}}, then select {{< ui >}}Disable MFA{{< /ui >}}.
