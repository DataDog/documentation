...
The CI does not trigger {{< prodname >}}Synthetics{{< /prodname >}} monitors or incorporate them into monitor evaluations; however, failing runs will result in the CI showing a red status.
