...
| [OTLP HTTP Exporter][7]      | An OTel Collector component that sends metrics, traces, and logs to an OTLP HTTP endpoint. Datadog recommends this exporter for new standalone Collector configurations. |
