...
Use the platform attributes on this page for workload identification instead of relying on `host.name`. For hostname recommendations for direct OTLP intake, see [Hostname and Tagging][6].
...
[6]: /opentelemetry/config/hostname_tagging/#direct-otlp-intake-without-a-collector
