...
Identify workloads with the platform attributes on this page, not with `host.name`. For hostname recommendations for direct OTLP intake, see [Hostname and Tagging][6].
