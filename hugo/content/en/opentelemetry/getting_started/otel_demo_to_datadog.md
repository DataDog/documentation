...
<div class="alert alert-info">This tutorial uses the Datadog Exporter and Datadog Connector, which remain supported. For new Collector configurations, Datadog recommends the OTLP pipeline in <a href="/opentelemetry/setup/collector_exporter/">Set Up the OpenTelemetry Collector</a>.</div>
