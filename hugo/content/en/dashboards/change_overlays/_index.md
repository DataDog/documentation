...
To get started, click {{< ui >}}Show Overlays{{< /ui >}} in the upper right corner of your dashboard. Now you can enable the [{{< prodname >}}Change Tracking{{< /prodname >}}][16] timeline and change overlays on timeseries widgets.
