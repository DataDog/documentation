...
Point plots are already available in APM Traces, {{< prodname >}}Database Monitoring{{< /prodname >}}, and {{< prodname >}}Agent Observability{{< /prodname >}} explorers. This widget lets you bring that same view into your own dashboards.
...
1. Choose a data source. Supported sources include Logs, RUM, Traces, Spans, {{< prodname >}}Database Monitoring{{< /prodname >}}, and {{< prodname >}}Agent Observability{{< /prodname >}}.
