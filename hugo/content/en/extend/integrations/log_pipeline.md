...
- /developers/integrations/log_pipeline/
further_reading:
...
{{< img src="extend/integrations/pipeline_library.png" alt="Browse the integration pipeline library" style="width:100%;" >}}
...
1. Hover over your pipeline and select the **Export Pipeline** icon.
   {{< img src="extend/integrations/export_pipeline.png" alt="Click the Export Pipeline icon to export your log pipeline in Datadog" width="50%">}}
...
6. Upload the two YAML files to the Developer Platform, under **Data** > **Submitted Data** > **Logs**.
   {{< img src="extend/integrations/data_tab.png" alt="The Data tab in the Integration Developer Platform" style="width:100%;" >}}
...
[6]: /extend/integrations/?tab=integrations#join-the-datadog-partner-network
[7]: https://app.datadoghq.com/logs/pipelines
[8]: /logs/log_configuration/processors/grok_parser/
[9]: /standard-attributes/?product=log
[10]: /logs/log_configuration/processors/log_date_remapper/
[11]: /logs/log_configuration/processors/log_message_remapper/
[12]: /logs/log_configuration/processors/log_status_remapper/
[14]: /logs/log_configuration/processors/remapper/
[15]: /logs/log_configuration/processors/geoip_parser/
[16]: /logs/log_configuration/processors/category_processor/
[17]: /logs/log_configuration/processors/arithmetic_processor/
[18]: /logs/log_configuration/processors/string_builder_processor/
