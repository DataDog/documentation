...
[2]: /extend/dogstatsd/unix_socket/
...
[1]: /extend/dogstatsd/unix_socket/
{{% /tab %}}
...
Set [`shareProcessNamespace:true` in the pod spec][12] to assist the Agent for origin detection on EKS Fargate.
...
{{< nextlink href="/extend/service_checks/dogstatsd_service_checks_submission/" >}}Send service checks to Datadog with DogStatsD.{{< /nextlink >}}
{{< /whatsnext >}}
...
[7]: /extend/service_checks/dogstatsd_service_checks_submission/
[8]: /getting_started/tagging/unified_service_tagging
[9]: /extend/dogstatsd/datagram_shell/
[10]: /extend/community/libraries/
