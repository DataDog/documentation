...
<div class="alert alert-caution">Dogshell is deprecated and has been replaced by <a href="/cli/">Pup CLI</a>, a comprehensive, AI-agent-ready CLI for interacting with Datadog APIs.</div>
...
{{< img src="extend/guide/dogshell_test1.png" alt="Observing test_dogshell_metric from the Metrics explorer" >}}
