...
### Limitations
For other queue technologies, Datadog SDKs add a context propagation header to messages. However, context propagation for IBM MQ is error-prone, as unexpected additional fields can appear in messages. To avoid risk to customer services, Datadog does not propagate context for IBM MQ traces.
