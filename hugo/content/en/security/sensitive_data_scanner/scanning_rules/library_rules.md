...
<div class="alert alert-info">Most library rules are available for all data sources (Logs, APM, RUM, {{< prodname >}}Agent Observability{{< /prodname >}}, {{< prodname >}}Observability Pipelines{{< /prodname >}}, Secret Scanning, and Cloud Storage). Check the <b>Available For</b> column to see which data sources each rule supports.</div>
