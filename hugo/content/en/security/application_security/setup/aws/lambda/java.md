...
2. Setting up {{< prodname >}}App and API Protection{{< /prodname >}} instrumentation by using either the [Datadog CLI][9], [AWS CDK][10], [Datadog Serverless Framework plugin][2], or manually by using the Datadog tracing layers.
