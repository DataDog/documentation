...
1. Identifying functions that are vulnerable or are under attack and would most benefit from {{< prodname >}}App and API Protection{{< /prodname >}}. Find them on [the Security tab of your Catalog][1].
...
The [Datadog Serverless Framework plugin][1] can be used to automatically configure and deploy your Lambda functions with {{< prodname >}}App and API Protection{{< /prodname >}}.
