...
2. Setting up {{< prodname >}}App and API Protection{{< /prodname >}} instrumentation by using either the [Datadog CLI][2], [AWS CDK][3], [Datadog Serverless Framework plugin][4], or manually by using the Datadog tracing layers.
