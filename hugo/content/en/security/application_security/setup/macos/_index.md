---
title: Set up App and API Protection on macOS
...
Learn how to set up {{< prodname >}}App and API Protection{{< /prodname >}} (AAP) on your macOS services by selecting the service's programming language.
