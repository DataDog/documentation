...
2. Update your nginx tracing module to at least version 1.2.0. Visit
...
If you want to use {{< prodname >}}App and API Protection{{< /prodname >}} without APM tracing functionality, you can deploy with tracing disabled:
