...
In addition to reviewing and responding to misconfigurations, you can set notifications for failed misconfigurations, and configure signals to correlate and triage misconfigurations in the same view as real-time threats generated by [{{< prodname >}}Cloud SIEM{{< /prodname >}}][2] and [{{< prodname >}}Workload Protection{{< /prodname >}}][3]. This enables you to accelerate investigations, as the root causes for many of today's cloud breaches are misconfigured services that have been exploited by attackers.
