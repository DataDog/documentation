...
With custom frameworks, you can define and measure compliance against your own cloud security baseline. Custom frameworks are listed on the {{< prodname >}}Cloud Security{{< /prodname >}} [Compliance][6] page, have their own real-time report and [security posture score][7], and are queryable within explorers and dashboards.
