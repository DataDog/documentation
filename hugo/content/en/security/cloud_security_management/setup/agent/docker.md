...
**Note**: On Agent versions earlier than 7.79.0, this feature is enabled through [Workload Protection][4] and affects its usage. From 7.79.0 it runs independently.
