...
1. Click the three-dot menu next to the rule you want to test, and choose {{< ui >}}Run as Historical Job{{< /ui >}}.
...
1. Click {{< ui >}}Run Historical Job{{< /ui >}}.
...
1. In the {{< ui >}}Results{{< /ui >}} section of a Historical Job panel, click one of the results in the list to open a details panel for that result.
1. Click {{< ui >}}Convert to Signal{{< /ui >}}.
...
1. Click {{< ui >}}Convert to Signals{{< /ui >}}.
...
1. Navigate to the [Historial Jobs list][3].
1. Click {{< ui >}}New Job{{< /ui >}}.
1. Find the [Define Search Queries][6] section.
1. Click {{< ui >}}Add{{< /ui >}}.
1. Select {{< ui >}}Calculated Fields{{< /ui >}} from the options.
