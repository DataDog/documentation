...
2. Update your Datadog SDK to at least the minimum version needed to turn on {{< prodname >}}Code Security{{< /prodname >}}. For details, see [Library Compatibility][4] page.
...
To see {{< prodname >}}Code Security{{< /prodname >}} in action, browse your service and find code-level vulnerabilities in the [{{< ui >}}Vulnerability Explorer{{< /ui >}}][4].
