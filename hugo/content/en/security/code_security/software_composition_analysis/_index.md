...
|---|---|---|---|---|
| Static SCA | Repository | Repository scan | Datadog detects a vulnerable library in a scanned repository. | The vulnerability was not detected in the latest scanned commit. |
