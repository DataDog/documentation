...
{{< img src="service_level_objectives/metric/metric_slo_side_panel.png" alt="example metric-based SLO" >}}

## Setup

On the [SLO status page][5], click {{< ui >}}+ New SLO{{< /ui >}}. Then select, [{{< ui >}}By Count{{< /ui >}}][6].
...
{{< img src="service_level_objectives/metric/good_bad_events_creation.png" alt="grouped metric-based SLO editor" >}}
...
{{< img src="service_level_objectives/metric/good_bad_events_status.png" alt="metric-based SLO group results" >}}
...
[2]: https://docs.datadoghq.com/real_user_monitoring/measure_health_with_metrics/create_custom_metrics
