...
The retention filters page shows a breakdown of retained user sessions, including sessions blocked after the quota is reached. For dashboards and alerts, use the metric `rum.measure.usage.quota_blocked_sessions`.
