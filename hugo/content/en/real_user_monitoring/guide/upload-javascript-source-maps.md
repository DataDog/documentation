...
The plugin uploads each source map with the debug ID injected into its corresponding JavaScript bundle. For the full list of plugin options, see [Build Plugins: Source Maps][8].
