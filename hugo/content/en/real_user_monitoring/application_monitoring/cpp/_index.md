...
## Start monitoring C / C++ applications

To get started with RUM for C / C++, create an application and configure the C++ SDK.

{{< whatsnext desc="This section includes the following topics:">}}
  {{< nextlink href="/real_user_monitoring/application_monitoring/cpp/setup">}}<u>Setup</u>: Learn how to set up the C++ SDK and send data to Datadog.{{< /nextlink >}}
  ...
  {{< nextlink href="/real_user_monitoring/setup/data_collected/?platform=cpp">}}<u>Data Collected</u>: Review data collected by the RUM C++ SDK.{{< /nextlink >}}
