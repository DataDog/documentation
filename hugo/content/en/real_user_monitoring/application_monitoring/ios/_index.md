---
title: Apple Platform Monitoring
description: Collect RUM and Error Tracking data from your Apple platform applications.
aliases:
...
## Start monitoring Apple platform applications

To get started with RUM for Apple platforms, create an application and configure the iOS SDK. The Datadog iOS SDK covers all platforms listed in [Supported Versions][1].
...
{{< whatsnext desc="This section includes the following topics:">}}
  ...
  {{< nextlink href="/real_user_monitoring/enrich_rum_data/track_navigation_across_web_views/?platform=ios">}}<u>Web View Tracking</u>: Monitor web views and eliminate blind spots in your mobile applications.{{< /nextlink >}}
...
[1]: /real_user_monitoring/application_monitoring/ios/supported_versions
