...
<div class="alert alert-info">Session Replays from these sessions follow their own <a href="/data_security/data_retention_periods/">data retention periods</a> (30 days by default, and up to 15 months with <a href="/session_replay/#extend-data-retention">extended retention</a>).</div>
...
After a session is recovered, the corresponding row in the {{< ui >}}Managed Archive{{< /ui >}} UI is visually marked and the session becomes available in the RUM Explorer.
