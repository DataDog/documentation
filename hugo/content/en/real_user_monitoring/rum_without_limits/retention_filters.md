...
<div class="alert alert-danger">APM traces indexed through a cross-product retention filter on the {{< prodname >}}Synthetics{{< /prodname >}} or Forced Replay permanent filters are subject to APM billing.</div>
