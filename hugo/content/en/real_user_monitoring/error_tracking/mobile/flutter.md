...
To verify your Flutter Crash Reporting and {{< prodname >}}Error Tracking{{< /prodname >}} configuration, issue an error in your application and confirm that the error appears in Datadog.
