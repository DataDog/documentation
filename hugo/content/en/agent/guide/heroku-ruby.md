...
Navigate to the [Catalog][20] to see all your application services and your application service view:

{{< img src="agent/guide/heroku_ruby/ruby_service.png" alt="Catalog in Datadog" >}}
...
Finally, add a name for your metric and click {{< ui >}}Create Metric{{< /ui >}}:

{{< img src="agent/guide/heroku_ruby/custom_metric.png" alt="Creation of a new log based metric" >}}

Once the rule has been created, wait for a few minutes to gather the new metrics. Then, click on {{< ui >}}See in Metric Explorer{{< /ui >}} to have a look to your new metric:
