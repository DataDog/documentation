...
Remotely upgrade the SDKs that power APM, Profiler, {{< prodname >}}Dynamic Instrumentation{{< /prodname >}}, and more. Request access to join the preview.
{{< /callout >}}

Fleet Automation can centrally manage remote upgrades to the SDKs that power APM, Continuous Profiler, {{< prodname >}}Dynamic Instrumentation{{< /prodname >}}, and more. Keeping your services' SDK versions up to date lets you benefit from the latest features, performance improvements, bug fixes, and security updates.
