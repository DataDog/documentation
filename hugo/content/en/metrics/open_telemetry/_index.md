...
The Datadog Agent and OTel Collector can both ingest metrics in the OpenTelemetry format (OTLP), which can be produced by OpenTelemetry-instrumented applications. Configure the OpenTelemetry Collector with the OTLP HTTP exporter to send metrics to Datadog.
