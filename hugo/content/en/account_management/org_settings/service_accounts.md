...
<div class="alert alert-caution">Service account application keys are one-time read only. Make sure to securely store your application key immediately after creation, as the key secret cannot be retrieved later.</div>
{{< /site-region >}}
