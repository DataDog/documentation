...
<div class="alert alert-caution">Customer Contracts is not available for the selected <a href="/getting_started/site">Datadog site</a> ({{< region-param key="dd_site_name" >}}).</div>
{{< /site-region >}}
...
You can set a customer's rates from the {{< ui >}}Custom Pricing Configuration{{< /ui >}} tab of this panel instead of going to the [Customer Pricing][2] page.
