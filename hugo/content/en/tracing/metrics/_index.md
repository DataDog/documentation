...
Enable [runtime metrics collection][3] in supported SDKs to gain insights into an application's performance. These metrics are sent to the Datadog Agent over the configured DogStatsD port.
