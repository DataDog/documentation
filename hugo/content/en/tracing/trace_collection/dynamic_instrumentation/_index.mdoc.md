...
further_reading:
  ...
  - link: "/tracing/live_debugger/sensitive-data-scrubbing/"
    tag: "Documentation"
    text: "Protect sensitive data captured by Live Debugger"
...
Dynamic spans, span tags, and metrics are an alternative to adding custom instrumentation directly to your source code. Datadog receives the instrumentation configurations you define and dynamically applies them to the running service without requiring restarts.
