...
- Exclusive [{{< prodname >}}App and API Protection{{< /prodname >}}][7] **Exploit Prevention** feature. [Exploit Prevention][15] is a Runtime Application Self-Protection (RASP) implementation and includes RASP methods such as Local File Inclusion (LFI).
