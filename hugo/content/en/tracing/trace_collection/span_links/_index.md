...
**Note***: This section documents minimum support for generating span links with {{< prodname >}}Datadog APM{{< /prodname >}} client libraries (with the OpenTelemetry API). Span links generated by the OpenTelemetry SDK are sent to Datadog through [OTLP Ingest][8].
