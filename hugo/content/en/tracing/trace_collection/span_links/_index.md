...
How you create span links depends on how your application is instrumented.

### Datadog SDK

The Python, Node.js, Go, and PHP SDKs provide an API for adding span links. See the examples for [Python][10], [Node.js][11], [Go][12], or [PHP][1].

For Java, .NET, and Ruby, add span links with the OpenTelemetry API. The Datadog SDK sends span links created with the OpenTelemetry API to Datadog. To use the OpenTelemetry API with the Datadog SDK, see [Custom Instrumentation with the OpenTelemetry API][13]. For the span links API, see the OpenTelemetry documentation for [Java][3], [.NET][14], or [Ruby][15].

### OpenTelemetry SDK

Follow the OpenTelemetry instrumentation documentation for your language. For example, see the [span API for Java][3].
...
[1]: /tracing/trace_collection/custom_instrumentation/server-side/?api_type=dd_api&prog_lang=php#adding-span-links-php
...
[10]: /tracing/trace_collection/custom_instrumentation/server-side/?api_type=dd_api&prog_lang=python#adding-span-links-python
[11]: /tracing/trace_collection/custom_instrumentation/server-side/?api_type=dd_api&prog_lang=node_js#adding-span-links-nodejs
[12]: /tracing/trace_collection/custom_instrumentation/server-side/?api_type=dd_api&prog_lang=go#adding-span-links-go
[13]: /tracing/trace_collection/custom_instrumentation/server-side/?api_type=otel_api
