...
- **Database Spans:** When `DD_DJANGO_INSTRUMENT_DATABASES=true` (default `false`), the SDK merges Django-specific tags into the driver spans rather than creating separate spans.
