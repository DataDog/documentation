...
<div class="alert alert-info">To calculate APM metrics from unsampled OpenTelemetry data, configure the <a href="/opentelemetry/setup/collector_exporter/install/#span-metrics-connector"><code>span_metrics</code> connector</a> before the sampling processor. The Datadog Connector remains fully supported for existing configurations.</div>
