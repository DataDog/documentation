...
{{< whatsnext desc="Choose your language and environment:" >}}
    {{< nextlink href="tracing/guide/apm-quickstart-python-linux" >}}{{< img src="/integrations_logos/python-avatar.png" inline="true">}} {{< img src="tracing/guide/tutorials/tutorial-host-icon.png" inline="true">}} Quickstart: Send a Python Trace from Linux with SSI{{< /nextlink >}}
