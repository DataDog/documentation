...
Configuring your services with the `version` tag enables [Automatic Faulty Deployment Detection][2].
...
If [Continuous Profiler is enabled][3], you also see comparisons of key performance metrics, such as CPU Time or Allocated Memory, broken down per APM resource. From there, you can pivot to the [Profile Comparison Page][4]:
