...
VPN monitoring provides visibility into your devices' VPN tunnels within {{< prodname >}}Network Device Monitoring{{< /prodname >}} (NDM). This feature allows you to keep track of critical data and metrics to examine the health of your VPN tunnels.
