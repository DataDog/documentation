...
The {{< ui >}}Recommended Actions{{< /ui >}} section highlights the most critical issues detected in your network. These are prioritized based on:
...
Hover over a service name to pivot to APM, or click {{< ui >}}Remediate{{< /ui >}} to view remediation steps along with options to create a [{{< ui >}}New Workflow{{< /ui >}}][2], [{{< ui >}}Create a Case{{< /ui >}}][3], or [{{< ui >}}Declare an Incident{{< /ui >}}][4].
...
The {{< ui >}}Watchdog Insights{{< /ui >}} section displays anomalous network behavior detected by Watchdog, focusing on spikes in TCP retransmits. An increase in retransmits compared to your baseline (typically the previous week) often indicates an underlying network issue. See the [Watchdog Insights][5] documentation for more information.
...
- {{< ui >}}Expired certificates{{< /ui >}}: Certificates that are invalid and blocking traffic
...
Click an expired certificate to view steps for renewing it in AWS, or to create a [{{< ui >}}New Workflow{{< /ui >}}][2], [{{< ui >}}Create a Case{{< /ui >}}][3], or [{{< ui >}}Declare an Incident{{< /ui >}}][4].
...
The {{< ui >}}DNS Failures{{< /ui >}} section shows:

- {{< ui >}}Failure reason{{< /ui >}}: The cause of the DNS failure
- {{< ui >}}Impacted DNS server{{< /ui >}}: The DNS server experiencing elevated failure rates
- {{< ui >}}Impacted services{{< /ui >}}: The client and server services affected by the DNS failure
...
Hover over a service name to pivot to APM, or click on a recommended action to view remediation steps along with options to create a [{{< ui >}}New workflow{{< /ui >}}][2], [{{< ui >}}Create a Case{{< /ui >}}][3], or [{{< ui >}}Declare an Incident{{< /ui >}}][4].
...
The {{< ui >}}Security Groups{{< /ui >}} section identifies:
...
2. Select {{< ui >}}View in AWS{{< /ui >}} to navigate to the AWS console.
3. Review and modify the inbound and outbound rules.
4. Use the {{< ui >}}Infrastructure Change Tracking{{< /ui >}} data in the side panel to identify when the change occurred and revert it if necessary.

## Filtering

Use the filters at the top of the page to narrow the scope of displayed issues. Available filters include:

- {{< ui >}}Service{{< /ui >}}: View issues affecting a particular service
- {{< ui >}}Team{{< /ui >}}: View issues owned by a specific team
...
[3]: /incident_response/work_management/create_work_item
