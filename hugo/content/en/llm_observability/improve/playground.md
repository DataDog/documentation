...
{{< img src="llm_observability/improve/playground/playground-arbitrary-input.png" alt="Agent Observability Playground showing a user message with {{category}} and {{approach}} variable placeholders and the model response in the output panel." style="width:100%;" >}}
