...
End-user feedback captures input from users of your LLM application in {{< prodname >}}Agent Observability{{< /prodname >}}. Examples include thumbs-up or thumbs-down ratings, whether a user accepted an agent's change, and free-text comments about a response.
...
Submitted feedback appears when viewing {{< prodname >}}Agent Observability{{< /prodname >}} sessions, traces, or spans.
