...
1. (Optional) Under **Clustering instructions**, provide free-form guidance for the dimension or criteria Datadog should use to group interactions and generate topics, such as user intent, agent task, product used, or failure reason. Leave this blank to group interactions by each interaction's main goal.
