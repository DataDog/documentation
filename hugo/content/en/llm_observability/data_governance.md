...
You can also restrict individual Agent Observability projects, including their experiments, datasets, dataset records, and annotation queues. See [Data Access Control in Agent Observability][14].
