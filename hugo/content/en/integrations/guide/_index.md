...
{{< header-list header="General guides" >}}
    ...
    {{< nextlink href="integrations/guide/slack-actions" tag=" Slack" >}}Slack Actions for Incidents, {{< prodname >}}On-Call{{< /prodname >}}, Monitors, Dashboards, Workflows, and Accounts{{< /nextlink >}}
{{< /header-list >}}
