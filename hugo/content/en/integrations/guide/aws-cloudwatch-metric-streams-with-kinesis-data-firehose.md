...
5. Update the Firehose HTTP destination configuration and save it (for example, change its retry duration). A configuration update can restart a stalled destination. Use the Firehose [`UpdateDestination` API][11].
