...
4. Optionally disables metric collection for the AWS infrastructure. This is useful for {{< prodname >}}Cloud Cost Management{{< /prodname >}} (CCM) or Cloud Security Misconfigurations specific use cases.
...
2. **Specify StackSet details**
    ...
    - *Optionally:*  
        ...
        1. Disable metric collection if you do not want to monitor your AWS infrastructure. This is recommended only for [{{< prodname >}}Cloud Cost Management{{< /prodname >}}][6] (CCM) or [Cloud Security Misconfigurations][5] specific use cases.
