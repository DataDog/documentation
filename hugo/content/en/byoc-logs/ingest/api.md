...
You can send logs to BYOC (Bring Your Own Cloud) Logs using direct REST API calls. This method is useful for custom integrations or scripts that can't use a Datadog Agent or {{< prodname >}}Observability Pipelines{{< /prodname >}}.
