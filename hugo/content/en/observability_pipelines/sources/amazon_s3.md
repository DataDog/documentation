...
See [Component metrics][6] and [Source buffer metrics][7] for more information on metrics emitted by all sources. To filter or group by Amazon S3 source metrics, use the tag `component_type:aws_s3`.
