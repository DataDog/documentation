...
Use Observability Pipelines' Datadog Agent source to receive logs, metrics, or traces ({{< tooltip text="in Preview" tooltip="Traces for Observability Pipelines is in Preview. Contact your account manager to request access." >}}) from the Datadog Agent.
