...
**Note**: The Datadog Forwarder sends logs tagged with `ddsource`, not `source`. When you define processor queries or filters for these logs, use `ddsource` instead of `source`.
