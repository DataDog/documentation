...
Follow the [Cloudflare Logpush HTTP destination documentation][5] to set up Logpush to send logs to an HTTP endpoint.
  - For the **HTTP endpoint**: If you use HTTP Basic authorization, the authorization headers in the URL need to be base64 encoded: `https://subdomain.your-domain.com?header_Authorization=Basic%20<base64-encoded-credentials>`
