...
This document describes how to use the Datadog Lambda Extension to send AWS vended logs to {{< prodname >}}Observability Pipelines{{< /prodname >}}. The setup steps are:
