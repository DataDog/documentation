...
As you scale your {{< prodname >}}Observability Pipelines{{< /prodname >}} architecture to cover your different use cases:
...
- {{< prodname >}}Observability Pipelines{{< /prodname >}} uses backpressure signals and buffering to handle situations where the system cannot process events immediately upon receiving them. See [Buffering and Backpressure][2] for more information.
...
[2]: /observability_pipelines/scaling_and_performance/buffering_and_backpressure/
