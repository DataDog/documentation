...
description: Learn how to send logs to Microsoft Sentinel using the Observability Pipelines Worker.
disable_toc: false
products:
- name: Logs
  icon: logs
...
<div class="alert alert-caution">For Secrets Management: Only enter the identifiers for the Microsoft Sentinel client secret and Data Collection Endpoint. Do <b>not</b> enter the actual values.</div>
