...
description: Learn how to send logs to OpenSearch using the Observability Pipelines Worker.
disable_toc: false
products:
- name: Logs
  icon: logs
...
<div class="alert alert-caution">For Secrets Management: Only enter the identifiers for the OpenSearch endpoint URL, username, and password. Do <b>not</b> enter the actual values.</div>
