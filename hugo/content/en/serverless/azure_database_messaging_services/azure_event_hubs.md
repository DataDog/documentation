...
{{< prodname >}}Datadog APM{{< /prodname >}} uses **inferred spans** to collect traces and trace metrics from Azure Event Hubs. These spans are generated by the Datadog tracers SDKs and appear directly in flame graph and waterfall views. 
