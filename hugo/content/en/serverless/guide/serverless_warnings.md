...
**Resolution:** Investigate the attack attempts in AAP by clicking the {{< ui >}}Security Signals{{< /ui >}} button to determine how to respond. If immediate action is needed, you can block the attacking IP in your WAF through the [Workflows integration][11].
