...
{{< img src="mobile/guide/android_edit_home.png" style="width:100%; background:none; border:none; box-shadow:none;" alt="Android home screen on the mobile app.">}}
...
{{< img src="mobile/guide/ios_dashboard_widget.png" style="width:80%; background:none; border:none; box-shadow:none;" alt="iOS home screen dashboard widgets">}}
