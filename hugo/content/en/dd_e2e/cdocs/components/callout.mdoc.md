...
{% callout url="https://www.example.com" header="Join the Preview!" btn_hidden=false %}
This callout has a visible button that links to an external URL. Use it to drive users to sign up or take action.
{% /callout %}

### With button hidden

{% callout url="https://www.example.com" header="New Feature Available" btn_hidden=true %}
