- Prometheus address:
    ...
    - The default environment variable is `DD_OP_SOURCE_PROMETHEUS_REMOTE_WRITE_ADDRESS`.
- If you are using plain authentication:
	- Prometheus endpoint authentication username:
		- The default environment variable is `DD_OP_SOURCE_PROMETHEUS_REMOTE_WRITE_USERNAME`.
	- Prometheus endpoint authentication password:
		- The default environment variable is `DD_OP_SOURCE_PROMETHEUS_REMOTE_WRITE_PASSWORD`.
