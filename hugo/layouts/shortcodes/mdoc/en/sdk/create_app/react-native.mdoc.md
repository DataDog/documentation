...
For data security, you must use a client token. If you used only [Datadog API keys](/account_management/api-app-keys/#api-keys) to configure the `@datadog/mobile-react-native` library, they would be exposed client-side in the React Native application's code.
