...
To protect end-user privacy, regardless of your privacy configuration, the following HTML elements are **always masked**:
...
{% alert level="info" %}
Datadog is working to add more privacy features to RUM & Session Replay. Have something in mind that you would like to see? [Contact Datadog support][4].
{% /alert %}
{% /if %}
<!-- end Browser -->
...
{% /table %}
{% /if %}
<!-- end Android, iOS, React Native, or Flutter -->

[1]: /session_replay/privacy_options/?platform=browser
...
[4]: /help
[5]: /session_replay/privacy_options/?platform=android#privacy-overrides
