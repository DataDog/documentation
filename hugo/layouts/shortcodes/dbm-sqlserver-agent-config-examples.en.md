...
<div class="alert alert-caution">SQL Server Agent Jobs monitoring is not available for Azure SQL Database.</div>
...
### Collecting schemas
<div class="alert alert-caution">Datadog Agent v7.56+ and SQL Server 2017 or higher are required for SQL Server schema collection.</div>
