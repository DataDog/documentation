...
The Datadog Agent hostname is used. See [How does Datadog determine the Agent hostname?](http://localhost:1313/agent/faq/how-datadog-agent-determines-the-hostname/) for more information.
{% /tab %}
