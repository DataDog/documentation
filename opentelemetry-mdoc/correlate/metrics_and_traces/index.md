...
For the complete, working configuration, including Kubernetes-specific setup, see the [Host Metrics](http://localhost:1313/opentelemetry/integrations/host_metrics) documentation.
