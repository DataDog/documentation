...
DD_APM_INSTRUMENTATION_LIBRARIES=java DD_API_KEY=${DD_API_KEY} DD_INSTALL_ONLY=true DD_APM_INSTRUMENTATION_ENABLED=host bash -c "$(curl --retry 10 -L https://install.datadoghq.com/scripts/install_script_agent7.sh)"
